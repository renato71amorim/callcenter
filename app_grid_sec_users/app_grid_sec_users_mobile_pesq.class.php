...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_login"  <?php echo $str_hide_login?>><INPUT  type="text" id="SC_login" name="login" value="<?php echo NM_encode_input($login) ?>"  size=23 alt="{datatype: 'text', maxLength: 23, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_name"  <?php echo $str_hide_name?>><INPUT  type="text" id="SC_name" name="name" value="<?php echo NM_encode_input($name) ?>"  size=35 alt="{datatype: 'text', maxLength: 35, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_email"  <?php echo $str_hide_email?>><INPUT  type="text" id="SC_email" name="email" value="<?php echo NM_encode_input($email) ?>"  size=35 alt="{datatype: 'text', maxLength: 35, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_active_cond" name="active_cond" onChange="nm_campos_between(document.getElementById('id_vis_active'), this, 'active')">
      ...
      <br><span id="id_hide_active"  <?php echo $str_hide_active?>><INPUT  type="text" id="SC_active" name="active" value="<?php echo NM_encode_input($active) ?>"  size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_priv_admin_cond" name="priv_admin_cond" onChange="nm_campos_between(document.getElementById('id_vis_priv_admin'), this, 'priv_admin')">
      ...
      <br><span id="id_hide_priv_admin"  <?php echo $str_hide_priv_admin?>><INPUT  type="text" id="SC_priv_admin" name="priv_admin" value="<?php echo NM_encode_input($priv_admin) ?>"  size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
