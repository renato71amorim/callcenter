...
class app_grid_sec_users_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . app_grid_sec_users_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . app_grid_sec_users_pack_protect_string($Tipo_filter[0]) . "\">.." . app_grid_sec_users_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tble_sec_users'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>app_grid_sec_users/app_grid_sec_users_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="app_grid_sec_users_ajax_search.js"></script>
 <script type="text/javascript" src="app_grid_sec_users_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="app_grid_sec_users_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_active_cond#NMF#' + search_get_sel_txt('SC_active_cond') + '@NMF@';
  str_out += 'SC_active#NMF#' + search_get_text('SC_active') + '@NMF@';
  str_out += 'SC_priv_admin_cond#NMF#' + search_get_sel_txt('SC_priv_admin_cond') + '@NMF@';
  str_out += 'SC_priv_admin#NMF#' + search_get_text('SC_priv_admin') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tble_sec_users'] ?></span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $login = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca']['login']; 
          $login_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca']['login_cond']; 
          $name = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca']['name']; 
          $name_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca']['name_cond']; 
          $email = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca']['email']; 
          $email_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca']['email_cond']; 
          $active = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca']['active']; 
          $active_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca']['active_cond']; 
          $priv_admin = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca']['priv_admin']; 
          $priv_admin_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca']['priv_admin_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($active_cond) || empty($active_cond))
      {
         $active_cond = "eq";
      }
      if (!isset($priv_admin_cond) || empty($priv_admin_cond))
      {
         $priv_admin_cond = "eq";
      }
      ...
      $str_hide_active = (in_array($active_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_priv_admin = (in_array($priv_admin_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = strpos($active, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $active = substr($active, 0, $tmp_pos);
         }
      }
      if (!isset($priv_admin) || $priv_admin == "")
      {
          $priv_admin = "";
      }
      if (isset($priv_admin) && !empty($priv_admin))
      {
         $tmp_pos = strpos($priv_admin, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $priv_admin = substr($priv_admin, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_login_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['login'])) ? $this->New_label['login'] : "" . $this->Ini->Nm_lang['lang_sec_users_fild_login'] . ""; ?></TD>
...
?>
<INPUT  type="text" id="SC_login" name="login" value="<?php echo NM_encode_input($login) ?>"  size=23 alt="{datatype: 'text', maxLength: 23, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_name_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['name'])) ? $this->New_label['name'] : "" . $this->Ini->Nm_lang['lang_sec_users_fild_name'] . ""; ?></TD>
...
?>
<INPUT  type="text" id="SC_name" name="name" value="<?php echo NM_encode_input($name) ?>"  size=35 alt="{datatype: 'text', maxLength: 35, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_email_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['email'])) ? $this->New_label['email'] : "" . $this->Ini->Nm_lang['lang_sec_users_fild_email'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
?>
<INPUT  type="text" id="SC_email" name="email" value="<?php echo NM_encode_input($email) ?>"  size=35 alt="{datatype: 'text', maxLength: 35, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_active_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['active'])) ? $this->New_label['active'] : "" . $this->Ini->Nm_lang['lang_sec_users_fild_active'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_active_cond" name="active_cond" onChange="nm_campos_between(document.getElementById('id_vis_active'), this, 'active')">
       <OPTION value="eq" <?php if ("eq" == $active_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $active_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $active_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $active_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_active" <?php echo $str_hide_active?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['active'])) ? $this->New_label['active'] : "" . $this->Ini->Nm_lang['lang_sec_users_fild_active'] . "";
 $nmgp_tab_label .= "active?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_active" name="active" value="<?php echo NM_encode_input($active) ?>"  size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_priv_admin_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['priv_admin'])) ? $this->New_label['priv_admin'] : "" . $this->Ini->Nm_lang['lang_sec_users_fild_priv_admin'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_priv_admin_cond" name="priv_admin_cond" onChange="nm_campos_between(document.getElementById('id_vis_priv_admin'), this, 'priv_admin')">
       <OPTION value="eq" <?php if ("eq" == $priv_admin_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $priv_admin_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $priv_admin_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $priv_admin_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_priv_admin" <?php echo $str_hide_priv_admin?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['priv_admin'])) ? $this->New_label['priv_admin'] : "" . $this->Ini->Nm_lang['lang_sec_users_fild_priv_admin'] . "";
 $nmgp_tab_label .= "priv_admin?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_priv_admin" name="priv_admin" value="<?php echo NM_encode_input($priv_admin) ?>"  size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
...
?>
<?php
   if (is_file("app_grid_sec_users_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['app_grid_sec_users']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['app_grid_sec_users']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.login_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_login'), document.F1.login_cond, 'login');
   document.F1.login.value = "";
   document.F1.name_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_name'), document.F1.name_cond, 'name');
   document.F1.name.value = "";
   document.F1.email_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_email'), document.F1.email_cond, 'email');
   document.F1.email.value = "";
   document.F1.active_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_active'), document.F1.active_cond, 'active');
   document.F1.active.value = "";
   document.F1.priv_admin_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_priv_admin'), document.F1.priv_admin_cond, 'priv_admin');
   document.F1.priv_admin.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "dinamica_publicado/app_grid_sec_users";
             ...
             if (@is_file($this->NM_path_filter . $NM_patch . "/" . $NM_arq))
             {
                 ...
                 if (substr($NMcmp_filter[0], 0, 6) == "SC_V6_" || substr($NMcmp_filter[0], 0, 6) == "SC_V8_")
                 {
                     ...
                     if (!empty($Name_filter))
                     {
                         ...
                         if ($_SESSION['scriptcase']['charset'] != "UTF-8")
                         {
                             $this->NM_fil_ant[$Name_filter][1] = sc_convert_encoding("Public", $_SESSION['scriptcase']['charset'], "UTF-8");
                         }
                         else
                         {
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_active_cond'] = 'cond';
      $tp_fields['SC_active'] = 'text';
      $tp_fields['SC_priv_admin_cond'] = 'cond';
      $tp_fields['SC_priv_admin'] = 'text';
   ...
   function trata_campos()
   {
      global $login_cond, $login,
             ...
             $email_cond, $email,
             $active_cond, $active,
             $priv_admin_cond, $priv_admin, $nmgp_tab_label;
      ...
      $active_cond_salva = $active_cond; 
      if (!isset($active_input_2) || $active_input_2 == "")
      {
          $active_input_2 = $active;
      }
      $priv_admin_cond_salva = $priv_admin_cond; 
      if (!isset($priv_admin_input_2) || $priv_admin_input_2 == "")
      {
          $priv_admin_input_2 = $priv_admin;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca']['login'] = $login; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca']['login_cond'] = $login_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca']['name'] = $name; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca']['name_cond'] = $name_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca']['email'] = $email; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca']['email_cond'] = $email_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca']['active'] = $active; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca']['active_cond'] = $active_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca']['priv_admin'] = $priv_admin; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca']['priv_admin_cond'] = $priv_admin_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $Conteudo = $active;
      $this->cmp_formatado['active'] = $Conteudo;
      $Conteudo = $priv_admin;
      $this->cmp_formatado['priv_admin'] = $Conteudo;
      ...
      //----- $active
      $this->Date_part = false;
      if (isset($active) || $active_cond == "nu" || $active_cond == "nn" || $active_cond == "ep" || $active_cond == "ne")
      {
         $this->monta_condicao("active", $active_cond, $active, "", "active");
      }

      //----- $priv_admin
      $this->Date_part = false;
      if (isset($priv_admin) || $priv_admin_cond == "nu" || $priv_admin_cond == "nn" || $priv_admin_cond == "ep" || $priv_admin_cond == "ne")
      {
         $this->monta_condicao("priv_admin", $priv_admin_cond, $priv_admin, "", "priv_admin");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['cond_pesq'] .= $this->NM_operador;
