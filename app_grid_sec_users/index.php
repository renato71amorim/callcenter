<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_perfil']          = "pabx";
   $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_prod']       = "/principal/prod";
   $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_imagens']    = "/principal/file/img";
   $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_imag_temp']  = "/principal/tmp";
   $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_doc']        = "/var/ww/doc";
   $_SESSION['scriptcase']['app_grid_sec_users']['glo_con_unicep']         = "unicep";
...
//
   function init($Tp_init = "")
   {
      ...
      $this->nm_nome_apl     = "Grid of the users"; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_dt_criacao   = "20190801"; 
      $this->nm_hr_criacao   = "234707"; 
...
// 
      ...
      { 
          $_SESSION['sc_session'][$this->sc_page]['app_grid_sec_users']['Gera_log_access'] = true;
          $_SESSION['sc_session'][$this->sc_page]['app_grid_sec_users']['initialize']      = false;
      } 
      $this->conectDB();
      $this->conectExtra();
...
/*NM*/            $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_perfil'] = $NM_con_dest;
      ...
      if (!empty($perfil_trab))
      {
          ...
          carrega_perfil($_SESSION['scriptcase']['app_grid_sec_users']['glo_con_unicep'], $this->path_libs, "S", $this->path_conf);
          $this->nm_con_unicep['servidor']               = $_SESSION['scriptcase']['glo_servidor'];
          $this->nm_con_unicep['usuario']                = $_SESSION['scriptcase']['glo_usuario'];
          $this->nm_con_unicep['banco']                  = $_SESSION['scriptcase']['glo_banco'];
          $this->nm_con_unicep['senha']                  = $_SESSION['scriptcase']['glo_senha'];
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_conexao'], $this->root . $this->path_prod, 'dinamica_publicado', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
//
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->nm_db_unicep->qstr($usr) . ", 'app_grid_sec_users', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->nm_db_unicep->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->nm_db_unicep->qstr($usr) . ", 'app_grid_sec_users', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->nm_db_unicep->qstr($texto) . ")"; 
       } 
...
//----- 
   function controle($linhas = 0)
   {
      ...
      { 
          ...
          if (isset($str_where_admin)) 
          {
              $_SESSION['str_where_admin'] = $str_where_admin;
              nm_limpa_str_app_grid_sec_users($_SESSION["str_where_admin"]);
          }
          if (isset($usr_priv_admin)) 
          {
              $_SESSION['usr_priv_admin'] = $usr_priv_admin;
              nm_limpa_str_app_grid_sec_users($_SESSION["usr_priv_admin"]);
          }
          if (isset($usr_login)) 
          {
              $_SESSION['usr_login'] = $usr_login;
              nm_limpa_str_app_grid_sec_users($_SESSION["usr_login"]);
          }
      } 
      if ($Parms_form_pdf)
      { 
      ...
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['sc_modal']))
      {
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_grid_sec_users']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_grid_sec_users']['label'] = "" . $this->Ini->Nm_lang['lang_othr_grid_titl'] . " - " . $this->Ini->Nm_lang['lang_tble_sec_users'] . "";
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['Gera_log_access'])
      {
          $this->Ini->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['Gera_log_access'] = false;
      }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['pdf_det'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] = 'pdf';
          $_SESSION['sc_session'][$script_case_init]['app_grid_sec_users']['opc_pdf']['pdf_zip'] = (isset($Det_pdf_zip) && !empty($Det_pdf_zip)) ? $Det_pdf_zip : "N";
          if ($Det_use_pass_pdf != "__APL__")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['use_pass_pdf'] = $Det_use_pass_pdf;
          } 
          $nmgp_opcao = 'pdf';
      }
      if ($nmgp_opcao == 'pdf')
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['pdf_res'] = false;
      if ($nmgp_opcao == 'pdf_res')
      {
          ...
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['pdf_res'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opc_liga']['inicial']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opc_liga']['inicial'];
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['det_print'] = "";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] == "det_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao']     = "detalhe";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['det_print'] = "print";
          if (!empty($nmgp_password)) {
          ...
          {
              $this->Ini->Export_img_zip = true;
              $nm_arquivo_html = "/sc_app_grid_sec_users_det_" . session_id() . ".html";
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_html);
          }
      } 
...
//----------------------------------->
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] == "xls_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "app_grid_sec_users/app_grid_sec_users_res_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "app_grid_sec_users_res_xls.class.php"); 
          } 
          $this->xls  = new app_grid_sec_users_res_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] == "xml_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "app_grid_sec_users/app_grid_sec_users_res_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "app_grid_sec_users_res_xml.class.php"); 
          } 
          $this->xml  = new app_grid_sec_users_res_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] == "csv_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "app_grid_sec_users/app_grid_sec_users_res_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "app_grid_sec_users_res_csv.class.php"); 
          } 
          $this->csv  = new app_grid_sec_users_res_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] == "rtf_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "app_grid_sec_users/app_grid_sec_users_res_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "app_grid_sec_users_res_rtf.class.php"); 
          } 
          $this->rtf  = new app_grid_sec_users_res_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] == "detalhe" || $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['pdf_det'])  
          { 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'])
              { 
                  require_once($this->Ini->path_embutida . "app_grid_sec_users/app_grid_sec_users_det.class.php"); 
              } 
              else 
              { 
                  require_once($this->Ini->path_aplicacao . "app_grid_sec_users_det.class.php"); 
              } 
              $this->det  = new app_grid_sec_users_det();
...
$NM_volta  = "volta_grid";
$NM_target = "_parent";
if ($_SESSION['sc_session'][$script_case_init]['app_grid_sec_users']['pdf_res'])
{
  $NM_volta  = "resumo";
  $NM_target = "_self";
?>
...
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tble_sec_users'] ?> :: Doc</TITLE>
...
<?php
 ...
 $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users'][$path_doc_md5][0] = $nm_arquivo_pdf_det;
 $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users'][$path_doc_md5][1] = "app_grid_sec_users_det.pdf";
?>
 <META http-equiv="Expires" content="Fri, Jan 01 1900 00:00:00 GMT"/>
 <META http-equiv="Last-Modified" content="<?php echo gmdate("D, d M Y H:i:s"); ?> GMT"/>
 <META http-equiv="Cache-Control" content="no-store, no-cache, must-revalidate"/>
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_imag_temp'] . "/sc_apl_default_dinamica_publicado.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_imag_temp'] . "/sc_apl_default_dinamica_publicado.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_dinamica_publicado'])) {
               $_SESSION['scriptcase']['app_grid_sec_users']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_dinamica_publicado'];
           }
       }
   }
   ...
   { 
       ...
       if ($_SESSION['sc_session'][$script_case_init]['app_grid_sec_users']['opcao'] == "detalhe" && isset($nmgp_chave_det))  
       { 
           $_SESSION['sc_session'][$script_case_init]['app_grid_sec_users']['chave_det'] = $nmgp_chave_det;
           $_SESSION['sc_session'][$script_case_init]['app_grid_sec_users']['cmp_acum']  = $nmgp_parm_acum;
       }   
       if (isset($Sc_seq_det))  
       { 
           $_SESSION['sc_session'][$script_case_init]['app_grid_sec_users']['Sc_seq_det'] = $Sc_seq_det;
       } 
       if (isset($_POST["str_where_admin"])) 
       {
           $_SESSION["str_where_admin"] = $_POST["str_where_admin"];
           nm_limpa_str_app_grid_sec_users($_SESSION["str_where_admin"]);
       }
       if (isset($_GET["str_where_admin"])) 
       {
           $_SESSION["str_where_admin"] = $_GET["str_where_admin"];
           nm_limpa_str_app_grid_sec_users($_SESSION["str_where_admin"]);
       }
       if (!isset($_SESSION["str_where_admin"])) 
       {
           $_SESSION["str_where_admin"] = "";
       }
...
// 
      ...
      if ('ajax_filter_save' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['app_grid_sec_users']['opcao'] = "busca";
          $contr_app_grid_sec_users->NM_ajax_flag = true;
          $contr_app_grid_sec_users->NM_ajax_opcao = "ajax_filter_save";
      }
      if ('ajax_filter_delete' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['app_grid_sec_users']['opcao'] = "busca";
          $contr_app_grid_sec_users->NM_ajax_flag = true;
          $contr_app_grid_sec_users->NM_ajax_opcao = "ajax_filter_delete";
      }
      if ('ajax_filter_select' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['app_grid_sec_users']['opcao'] = "busca";
          $contr_app_grid_sec_users->NM_ajax_flag = true;
          $contr_app_grid_sec_users->NM_ajax_opcao = "ajax_filter_select";
      }
