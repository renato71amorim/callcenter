...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____app_grid_sec_users"]))
   {
      unset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____app_grid_sec_users"]);
   }
