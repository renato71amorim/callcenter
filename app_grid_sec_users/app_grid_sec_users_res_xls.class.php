...
class app_grid_sec_users_res_xls
{
   ...
   function monta_xls()
   {
      ...
      $this->grava_arquivo();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['xls_res_grid']))
      {
          return;
      }
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['xls_res_grid']) && !$this->Ini->sc_export_ajax) {
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['xls_res_grid']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['xls_res_sheet'] = $this->Xls_f;
      }
