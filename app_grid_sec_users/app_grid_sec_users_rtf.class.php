...
$_SESSION['scriptcase']['app_grid_sec_users']['contr_erro'] = 'off'; 
   ...
   function NM_export_priv_admin()
   {
         ...
         $this->look_priv_admin = str_replace('<', '&lt;', $this->look_priv_admin);
         $this->look_priv_admin = str_replace('>', '&gt;', $this->look_priv_admin);
         $this->Texto_tag .= "<td>" . $this->look_priv_admin . "</td>\r\n";
   }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tble_sec_users'] ?> :: RTF</TITLE>
