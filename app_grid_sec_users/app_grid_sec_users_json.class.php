...
$_SESSION['scriptcase']['app_grid_sec_users']['contr_erro'] = 'off'; 
   ...
   function NM_export_priv_admin()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->look_priv_admin;
   }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tble_sec_users'] ?> :: JSON</TITLE>
