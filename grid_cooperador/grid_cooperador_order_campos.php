...
<?php
   ...
   $Ord_Cmp = new grid_cooperador_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_cooperador_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cooperador']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cooperador']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cooperador']['labels']["codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_cooperador']['labels']["codigo"] : "Codigo";
   $tab_ger_campos['dia'] = "on";
   $tab_def_campos['dia'] = "Dia";
   $tab_labels["dia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cooperador']['labels']["dia"])) ? $_SESSION['sc_session'][$sc_init]['grid_cooperador']['labels']["dia"] : "Dia";
   $tab_ger_campos['mes'] = "on";
   $tab_def_campos['mes'] = "Mes";
   $tab_labels["mes"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cooperador']['labels']["mes"])) ? $_SESSION['sc_session'][$sc_init]['grid_cooperador']['labels']["mes"] : "Mes";
   $tab_ger_campos['ano'] = "on";
   $tab_def_campos['ano'] = "Ano";
   $tab_labels["ano"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cooperador']['labels']["ano"])) ? $_SESSION['sc_session'][$sc_init]['grid_cooperador']['labels']["ano"] : "Ano";
   $tab_ger_campos['valor'] = "on";
   $tab_def_campos['valor'] = "Valor";
   $tab_labels["valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cooperador']['labels']["valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_cooperador']['labels']["valor"] : "Valor";
   $tab_ger_campos['operador'] = "on";
   $tab_def_campos['operador'] = "Operador";
   $tab_labels["operador"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cooperador']['labels']["operador"])) ? $_SESSION['sc_session'][$sc_init]['grid_cooperador']['labels']["operador"] : "Operador";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cooperador']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cooperador']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cooperador']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cooperador']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cooperador']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cooperador']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cooperador']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cooperador']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_cooperador']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_cooperador']['ordem_quebra'] as $campo => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_cooperador']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_cooperador']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_cooperador_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_cooperador']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_cooperador']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_cooperador']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_cooperador']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_cooperador']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
