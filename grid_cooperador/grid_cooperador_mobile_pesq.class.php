...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "Carteirinha";$Nm_datas[] = "Carteirinha";$Nm_datas[] = "DataNovoCoop";$Nm_datas[] = "DataNovoCoop";$Nm_datas[] = "UltimoContato";$Nm_datas[] = "UltimoContato";$Nm_datas[] = "DataRef";$Nm_datas[] = "DataRef";$Nm_datas[] = "DataComissionamento";$Nm_datas[] = "DataComissionamento";$Nm_numeric[] = "codigo";$Nm_numeric[] = "dia";$Nm_numeric[] = "mes";$Nm_numeric[] = "ano";$Nm_numeric[] = "valor";$Nm_numeric[] = "parceiro";$Nm_numeric[] = "ncodigo";$Nm_numeric[] = "codigocompanhia";$Nm_numeric[] = "autorizado";$Nm_numeric[] = "auditado";$Nm_numeric[] = "adiantarmensal";$Nm_numeric[] = "origem";$Nm_numeric[] = "comissionado";$Nm_numeric[] = "prob";$Nm_numeric[] = "frequencia";$Nm_numeric[] = "valorespecial";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_ano_cond" name="ano_cond" onChange="nm_campos_between(document.getElementById('id_vis_ano'), this, 'ano')">
      ...
      <br><span id="id_hide_ano"  <?php echo $str_hide_ano?>><?php
      if ($ano != "")
      {
      $ano_look = substr($this->Db->qstr($ano), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_ano" name="ano_autocomp" size="11"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_ano"  <?php echo $str_display_ano; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_ano_input_2" name="ano_input_2" value="<?php echo NM_encode_input($ano_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_dia_cond" name="dia_cond" onChange="nm_campos_between(document.getElementById('id_vis_dia'), this, 'dia')">
      ...
      <br><span id="id_hide_dia"  <?php echo $str_hide_dia?>><?php
      if ($dia != "")
      {
      $dia_look = substr($this->Db->qstr($dia), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_dia" name="dia_autocomp" size="5"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_dia"  <?php echo $str_display_dia; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_dia_input_2" name="dia_input_2" value="<?php echo NM_encode_input($dia_input_2) ?>"  size=5 alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_mes_cond" name="mes_cond" onChange="nm_campos_between(document.getElementById('id_vis_mes'), this, 'mes')">
      ...
      <br><span id="id_hide_mes"  <?php echo $str_hide_mes?>><?php
      if ($mes != "")
      {
      $mes_look = substr($this->Db->qstr($mes), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_mes" name="mes_autocomp" size="5"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_mes"  <?php echo $str_display_mes; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_mes_input_2" name="mes_input_2" value="<?php echo NM_encode_input($mes_input_2) ?>"  size=5 alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
