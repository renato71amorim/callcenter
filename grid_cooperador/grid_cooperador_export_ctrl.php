<?php
@session_start() ;
$_SESSION['scriptcase']['grid_cooperador']['sc_process_barr'] = true;
require_once('../grid_cooperador/index.php');
unset($_SESSION['scriptcase']['grid_cooperador']['sc_process_barr']);
$ExportCtrl = new grid_cooperador_export_control;
$ExportCtrl->Export_barr();

class grid_cooperador_export_control
{
