...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_cooperador"]))
   {
      unset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_cooperador"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_cooperador'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cooperador']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cooperador']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cooperador']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cooperador']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cooperador']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cooperador']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cooperador']['embutida_filho'] as $ind => $sc_init)
          {
