...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_grid_cooperador').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_grid_cooperador').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_grid_cooperador').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_grid_cooperador').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_grid_cooperador').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_grid_cooperador').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_grid_cooperador').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_grid_cooperador').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_grid_cooperador').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_grid_cooperador').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_grid_cooperador').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_grid_cooperador').style.width  = '0px';
        if (oResp["setValue"]) {
