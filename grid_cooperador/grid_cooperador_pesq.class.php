...
class grid_cooperador_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_cooperador_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_cooperador_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_cooperador_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_ano')
      {
          $ano = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_ano($ano);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_dia')
      {
          $dia = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_dia($dia);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_mes')
      {
          $mes = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_mes($mes);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_ano($ano)
   {
      $ano = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $ano);
      $ano = substr($this->Db->qstr($ano), 1, -1);
            $ano_look = substr($this->Db->qstr($ano), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct Ano from " . $this->Ini->nm_tabela . " where  Ano like '%" . $ano . "%' order by Ano"; 
      }
   ...
   function lookup_ajax_dia($dia)
   {
      $dia = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $dia);
      $dia = substr($this->Db->qstr($dia), 1, -1);
            $dia_look = substr($this->Db->qstr($dia), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct Dia from " . $this->Ini->nm_tabela . " where  Dia like '%" . $dia . "%' order by Dia"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct Dia from " . $this->Ini->nm_tabela . " where  Dia like '%" . $dia . "%' order by Dia"; 
   ...
   function lookup_ajax_mes($mes)
   {
      $mes = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $mes);
      $mes = substr($this->Db->qstr($mes), 1, -1);
            $mes_look = substr($this->Db->qstr($mes), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct Mes from " . $this->Ini->nm_tabela . " where  Mes like '%" . $mes . "%' order by Mes"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct Mes from " . $this->Ini->nm_tabela . " where  Mes like '%" . $mes . "%' order by Mes"; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "Carteirinha";$Nm_datas[] = "Carteirinha";$Nm_datas[] = "DataNovoCoop";$Nm_datas[] = "DataNovoCoop";$Nm_datas[] = "UltimoContato";$Nm_datas[] = "UltimoContato";$Nm_datas[] = "DataRef";$Nm_datas[] = "DataRef";$Nm_datas[] = "DataComissionamento";$Nm_datas[] = "DataComissionamento";
      if (in_array($campo_join, $Nm_datas))
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - cooperador</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_cooperador/grid_cooperador_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_cooperador_ajax_search.js"></script>
 <script type="text/javascript" src="grid_cooperador_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_cooperador_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_cooperador']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_cooperador']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_ano_cond#NMF#' + search_get_sel_txt('SC_ano_cond') + '@NMF@';
  str_out += 'SC_ano#NMF#' + search_get_text('SC_ano') + '@NMF@';
  str_out += 'id_ac_ano#NMF#' + search_get_text('id_ac_ano') + '@NMF@';
  str_out += 'SC_ano_input_2#NMF#' + search_get_text('SC_ano_input_2') + '@NMF@';
  ...
  str_out += 'SC_dia_cond#NMF#' + search_get_sel_txt('SC_dia_cond') + '@NMF@';
  str_out += 'SC_dia#NMF#' + search_get_text('SC_dia') + '@NMF@';
  str_out += 'id_ac_dia#NMF#' + search_get_text('id_ac_dia') + '@NMF@';
  str_out += 'SC_dia_input_2#NMF#' + search_get_text('SC_dia_input_2') + '@NMF@';
  str_out += 'SC_mes_cond#NMF#' + search_get_sel_txt('SC_mes_cond') + '@NMF@';
  str_out += 'SC_mes#NMF#' + search_get_text('SC_mes') + '@NMF@';
  str_out += 'id_ac_mes#NMF#' + search_get_text('id_ac_mes') + '@NMF@';
  str_out += 'SC_mes_input_2#NMF#' + search_get_text('SC_mes_input_2') + '@NMF@';
   ...
   $("#id_ac_dia").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_dia",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
   ...
   $("#id_ac_mes").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_mes",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
   ...
   $("#id_ac_ano").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_ano",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - cooperador</span></td>
...
<?php
   ...
   {
      global 
             $ano_cond, $ano, $ano_input_2, $ano_autocomp,
             $codigo_cond, $codigo, $codigo_input_2, $codigo_autocomp,
             $dia_cond, $dia, $dia_input_2, $dia_autocomp,
             $mes_cond, $mes, $mes_input_2, $mes_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']['ano']; 
          $ano_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']['ano_input_2']; 
          $ano_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']['ano_cond']; 
          $codigo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']['codigo']; 
          $codigo_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']['codigo_input_2']; 
          $codigo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']['codigo_cond']; 
          $dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']['dia']; 
          $dia_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']['dia_input_2']; 
          $dia_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']['dia_cond']; 
          $mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']['mes']; 
          $mes_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']['mes_input_2']; 
          $mes_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']['mes_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']['NM_operador']; 
      } 
      if (!isset($ano_cond) || empty($ano_cond))
      {
         $ano_cond = "gt";
      }
      ...
      if (!isset($mes_cond) || empty($mes_cond))
      {
         $mes_cond = "gt";
      }
      ...
      $str_hide_ano = (in_array($ano_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_codigo = (in_array($codigo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_dia = (in_array($dia_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_mes = (in_array($mes_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_ano = ('bw' == $ano_cond) ? $display_aberto : $display_fechado;
      $str_display_codigo = ('bw' == $codigo_cond) ? $display_aberto : $display_fechado;
      $str_display_dia = ('bw' == $dia_cond) ? $display_aberto : $display_fechado;
      $str_display_mes = ('bw' == $mes_cond) ? $display_aberto : $display_fechado;
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_ano_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['ano'])) ? $this->New_label['ano'] : "Ano"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_ano_cond" name="ano_cond" onChange="nm_campos_between(document.getElementById('id_vis_ano'), this, 'ano')">
       <OPTION value="gt" <?php if ("gt" == $ano_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $ano_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $ano_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $ano_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ano" <?php echo $str_hide_ano?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['ano'])) ? $this->New_label['ano'] : "Ano";
 $nmgp_tab_label .= "ano?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct Ano from " . $this->Ini->nm_tabela . " where Ano = $ano_look order by Ano"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct Ano from " . $this->Ini->nm_tabela . " where Ano = $ano_look order by Ano"; 
      ...
      if (isset($nmgp_def_dados[0][$ano]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$ano];
      }
      else
      {
            nmgp_Form_Num_Val($ano, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $ano;
      }
?>
<INPUT  type="text" id="SC_ano" name="ano" value="<?php echo NM_encode_input($ano) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_ano" name="ano_autocomp" size="11"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_ano"  <?php echo $str_display_ano; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_ano_input_2" name="ano_input_2" value="<?php echo NM_encode_input($ano_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_codigo" name="codigo_autocomp" size="19"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_dia_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['dia'])) ? $this->New_label['dia'] : "Dia"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_dia_cond" name="dia_cond" onChange="nm_campos_between(document.getElementById('id_vis_dia'), this, 'dia')">
       <OPTION value="gt" <?php if ("gt" == $dia_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $dia_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $dia_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $dia_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_dia" <?php echo $str_hide_dia?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct Dia from " . $this->Ini->nm_tabela . " where Dia = $dia_look order by Dia"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct Dia from " . $this->Ini->nm_tabela . " where Dia = $dia_look order by Dia"; 
      ...
      if (isset($nmgp_def_dados[0][$dia]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$dia];
      }
      else
      {
            nmgp_Form_Num_Val($dia, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $dia;
      }
?>
<INPUT  type="text" id="SC_dia" name="dia" value="<?php echo NM_encode_input($dia) ?>" size=5 alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_dia" name="dia_autocomp" size="5"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_dia"  <?php echo $str_display_dia; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_dia_input_2" name="dia_input_2" value="<?php echo NM_encode_input($dia_input_2) ?>"  size=5 alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_mes_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['mes'])) ? $this->New_label['mes'] : "Mes"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_mes_cond" name="mes_cond" onChange="nm_campos_between(document.getElementById('id_vis_mes'), this, 'mes')">
       <OPTION value="gt" <?php if ("gt" == $mes_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $mes_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $mes_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $mes_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_mes" <?php echo $str_hide_mes?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['mes'])) ? $this->New_label['mes'] : "Mes";
 $nmgp_tab_label .= "mes?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct Mes from " . $this->Ini->nm_tabela . " where Mes = $mes_look order by Mes"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct Mes from " . $this->Ini->nm_tabela . " where Mes = $mes_look order by Mes"; 
      ...
      if (isset($nmgp_def_dados[0][$mes]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$mes];
      }
      else
      {
            nmgp_Form_Num_Val($mes, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $mes;
      }
?>
<INPUT  type="text" id="SC_mes" name="mes" value="<?php echo NM_encode_input($mes) ?>" size=5 alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_mes" name="mes_autocomp" size="5"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_mes"  <?php echo $str_display_mes; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_mes_input_2" name="mes_input_2" value="<?php echo NM_encode_input($mes_input_2) ?>"  size=5 alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">
...
?>
<?php
   if (is_file("grid_cooperador_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cooperador']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_cooperador']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.ano_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_ano'), document.F1.ano_cond, 'ano');
   document.F1.ano.value = "";
   document.F1.ano_autocomp.value = "";
   document.F1.ano_input_2.value = "";
   ...
   document.F1.dia_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_dia'), document.F1.dia_cond, 'dia');
   document.F1.dia.value = "";
   document.F1.dia_autocomp.value = "";
   document.F1.dia_input_2.value = "";
   document.F1.mes_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_mes'), document.F1.mes_cond, 'mes');
   document.F1.mes.value = "";
   document.F1.mes_autocomp.value = "";
   document.F1.mes_input_2.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "dinamica_publicado/grid_cooperador";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_ano_cond'] = 'cond';
      $tp_fields['SC_ano'] = 'text_aut';
      $tp_fields['id_ac_ano'] = 'text_aut';
      $tp_fields['SC_ano_input_2'] = 'text';
      $tp_fields['SC_codigo_cond'] = 'cond';
      $tp_fields['SC_codigo'] = 'text_aut';
      $tp_fields['id_ac_codigo'] = 'text_aut';
      $tp_fields['SC_codigo_input_2'] = 'text';
      $tp_fields['SC_dia_cond'] = 'cond';
      $tp_fields['SC_dia'] = 'text_aut';
      $tp_fields['id_ac_dia'] = 'text_aut';
      $tp_fields['SC_dia_input_2'] = 'text';
      $tp_fields['SC_mes_cond'] = 'cond';
      $tp_fields['SC_mes'] = 'text_aut';
      $tp_fields['id_ac_mes'] = 'text_aut';
      $tp_fields['SC_mes_input_2'] = 'text';
   ...
   {
      global $ano_cond, $ano, $ano_input_2, $ano_autocomp,
             $codigo_cond, $codigo, $codigo_input_2, $codigo_autocomp,
             $dia_cond, $dia, $dia_input_2, $dia_autocomp,
             $mes_cond, $mes, $mes_input_2, $mes_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($ano_autocomp) && empty($ano))
      {
          $ano = $ano_autocomp;
      }
      ...
      if (!empty($dia_autocomp) && empty($dia))
      {
          $dia = $dia_autocomp;
      }
      if (!empty($mes_autocomp) && empty($mes))
      {
          $mes = $mes_autocomp;
      }
      $ano_cond_salva = $ano_cond; 
      if (!isset($ano_input_2) || $ano_input_2 == "")
      {
          $ano_input_2 = $ano;
      }
      ...
      $mes_cond_salva = $mes_cond; 
      if (!isset($mes_input_2) || $mes_input_2 == "")
      {
          $mes_input_2 = $mes;
      }
      if ($ano_cond != "in")
      {
          nm_limpa_numero($ano, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($ano_cond != "in")
      {
          nm_limpa_numero($ano_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($codigo_cond != "in")
      {
      ...
      if ($dia_cond != "in")
      {
          nm_limpa_numero($dia, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($dia_cond != "in")
      {
          nm_limpa_numero($dia_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($mes_cond != "in")
      {
          nm_limpa_numero($mes, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($mes_cond != "in")
      {
          nm_limpa_numero($mes_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']['ano'] = $ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']['ano_input_2'] = $ano_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']['ano_cond'] = $ano_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']['codigo'] = $codigo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']['codigo_input_2'] = $codigo_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']['codigo_cond'] = $codigo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']['dia'] = $dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']['dia_input_2'] = $dia_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']['dia_cond'] = $dia_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']['mes'] = $mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']['mes_input_2'] = $mes_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']['mes_cond'] = $mes_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca'] = $Temp_Busca;
      }
      if ($ano_cond != "in" && $ano_cond != "bw" && !empty($ano) && !is_numeric($ano))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Ano";
      }
      if ($ano_cond == "bw" && ((!empty($ano) && !is_numeric($ano)) || (!empty($ano_input_2) && !is_numeric($ano_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Ano";
      }
      ...
      if ($dia_cond != "in" && $dia_cond != "bw" && !empty($dia) && !is_numeric($dia))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Dia";
      }
      if ($dia_cond == "bw" && ((!empty($dia) && !is_numeric($dia)) || (!empty($dia_input_2) && !is_numeric($dia_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Dia";
      }
      if ($mes_cond != "in" && $mes_cond != "bw" && !empty($mes) && !is_numeric($mes))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Mes";
      }
      if ($mes_cond == "bw" && ((!empty($mes) && !is_numeric($mes)) || (!empty($mes_input_2) && !is_numeric($mes_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Mes";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      $Conteudo = $ano_input_2;
      if (strtoupper($ano_cond) != "II" && strtoupper($ano_cond) != "QP" && strtoupper($ano_cond) != "NP" && strtoupper($ano_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['ano_input_2'] = $Conteudo;
      $codigo_look = substr($this->Db->qstr($codigo), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($codigo))
   { 
   ...
   { 
      ...
      $Conteudo = $dia_input_2;
      if (strtoupper($dia_cond) != "II" && strtoupper($dia_cond) != "QP" && strtoupper($dia_cond) != "NP" && strtoupper($dia_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
   ...
   { 
      ...
      $Conteudo = $mes_input_2;
      if (strtoupper($mes_cond) != "II" && strtoupper($mes_cond) != "QP" && strtoupper($mes_cond) != "NP" && strtoupper($mes_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['mes_input_2'] = $Conteudo;

      //----- $ano
      $this->Date_part = false;
      if (isset($ano) || $ano_cond == "nu" || $ano_cond == "nn" || $ano_cond == "ep" || $ano_cond == "ne")
      {
         $this->monta_condicao("Ano", $ano_cond, $ano, $ano_input_2, "ano");
      }
      ...
      //----- $dia
      $this->Date_part = false;
      if (isset($dia) || $dia_cond == "nu" || $dia_cond == "nn" || $dia_cond == "ep" || $dia_cond == "ne")
      {
         $this->monta_condicao("Dia", $dia_cond, $dia, $dia_input_2, "dia");
      }

      //----- $mes
      $this->Date_part = false;
      if (isset($mes) || $mes_cond == "nu" || $mes_cond == "nn" || $mes_cond == "ep" || $mes_cond == "ne")
      {
         $this->monta_condicao("Mes", $mes_cond, $mes, $mes_input_2, "mes");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cooperador']['cond_pesq'] .= $this->NM_operador;
