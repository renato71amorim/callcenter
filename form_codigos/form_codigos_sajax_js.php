  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_codigos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_codigos_form();
	}

  // ---------- Validate codigorua
  function do_ajax_form_codigos_validate_codigorua()
  {
    var nomeCampo_codigorua = "codigorua";
    var var_codigorua = scAjaxGetFieldText(nomeCampo_codigorua);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_codigos_validate_codigorua(var_codigorua, var_script_case_init, do_ajax_form_codigos_validate_codigorua_cb);
  } // do_ajax_form_codigos_validate_codigorua

  function do_ajax_form_codigos_validate_codigorua_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_codigos_validate_codigorua_cb

  // ---------- Validate codigocontribuinte
  function do_ajax_form_codigos_validate_codigocontribuinte()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_codigos_validate_codigocontribuinte(var_codigocontribuinte, var_script_case_init, do_ajax_form_codigos_validate_codigocontribuinte_cb);
  } // do_ajax_form_codigos_validate_codigocontribuinte

  function do_ajax_form_codigos_validate_codigocontribuinte_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_codigos_validate_codigocontribuinte_cb

  // ---------- Validate codigooperador
  function do_ajax_form_codigos_validate_codigooperador()
  {
    var nomeCampo_codigooperador = "codigooperador";
    var var_codigooperador = scAjaxGetFieldText(nomeCampo_codigooperador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_codigos_validate_codigooperador(var_codigooperador, var_script_case_init, do_ajax_form_codigos_validate_codigooperador_cb);
  } // do_ajax_form_codigos_validate_codigooperador

  function do_ajax_form_codigos_validate_codigooperador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_codigos_validate_codigooperador_cb

  // ---------- Validate codigocobrador
  function do_ajax_form_codigos_validate_codigocobrador()
  {
    var nomeCampo_codigocobrador = "codigocobrador";
    var var_codigocobrador = scAjaxGetFieldText(nomeCampo_codigocobrador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_codigos_validate_codigocobrador(var_codigocobrador, var_script_case_init, do_ajax_form_codigos_validate_codigocobrador_cb);
  } // do_ajax_form_codigos_validate_codigocobrador

  function do_ajax_form_codigos_validate_codigocobrador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_codigos_validate_codigocobrador_cb

  // ---------- Validate serie
  function do_ajax_form_codigos_validate_serie()
  {
    var nomeCampo_serie = "serie";
    var var_serie = scAjaxGetFieldText(nomeCampo_serie);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_codigos_validate_serie(var_serie, var_script_case_init, do_ajax_form_codigos_validate_serie_cb);
  } // do_ajax_form_codigos_validate_serie

  function do_ajax_form_codigos_validate_serie_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "serie";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_codigos_validate_serie_cb

  // ---------- Validate numerorecibo
  function do_ajax_form_codigos_validate_numerorecibo()
  {
    var nomeCampo_numerorecibo = "numerorecibo";
    var var_numerorecibo = scAjaxGetFieldText(nomeCampo_numerorecibo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_codigos_validate_numerorecibo(var_numerorecibo, var_script_case_init, do_ajax_form_codigos_validate_numerorecibo_cb);
  } // do_ajax_form_codigos_validate_numerorecibo

  function do_ajax_form_codigos_validate_numerorecibo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_codigos_validate_numerorecibo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_codigos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_codigos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_codigos_submit_form(var_codigorua, var_codigocontribuinte, var_codigooperador, var_codigocobrador, var_serie, var_numerorecibo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_codigos_submit_form_cb);
  } // do_ajax_form_codigos_submit_form

  function do_ajax_form_codigos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_codigos_submit_form_cb_after_alert);
  } // do_ajax_form_codigos_submit_form_cb
  function do_ajax_form_codigos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_codigos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_codigos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_codigos_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_codigos_navigate_form_cb);
  } // do_ajax_form_codigos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_codigos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_codigos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_codigos_navigate_form_cb_after_alert);
  } // do_ajax_form_codigos_navigate_form_cb
  function do_ajax_form_codigos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_codigos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_codigos_navigate_form_cb_after_alert
  function sc_hide_form_codigos_form()
  {
