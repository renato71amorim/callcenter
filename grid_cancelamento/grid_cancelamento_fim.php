...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_cancelamento"]))
   {
      unset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_cancelamento"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_cancelamento'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cancelamento']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cancelamento']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cancelamento']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cancelamento']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cancelamento']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cancelamento']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cancelamento']['embutida_filho'] as $ind => $sc_init)
          {
