<?php
@session_start() ;
$_SESSION['scriptcase']['grid_cancelamento']['sc_process_barr'] = true;
require_once('../grid_cancelamento/index.php');
unset($_SESSION['scriptcase']['grid_cancelamento']['sc_process_barr']);
$ExportCtrl = new grid_cancelamento_export_control;
$ExportCtrl->Export_barr();

class grid_cancelamento_export_control
{
