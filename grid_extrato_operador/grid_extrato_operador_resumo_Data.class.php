...
class grid_extrato_operador_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_data_inicial;
   var $array_total_data_final;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_data_inicial = array();
      $this->array_total_data_final   = array();
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_extrato_operador']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_extrato_operador']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['contr_total_geral'] == "OK")
      {
          $this->array_total_data_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['arr_total']['data_inicial'];
          $this->array_total_data_final = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['arr_total']['data_final'];
      }
      else
      {
          $this->array_total_data_inicial = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['tot_geral'][2];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['tot_geral'][3];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['tot_geral'][4];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['tot_geral'][5];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['arr_total']['data_inicial'] = $this->array_total_data_inicial;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['arr_total']['data_final'] = $this->array_total_data_final;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['json_use_label'])
       {
          $Lab_data_inicial = "data_inicial";
          $Lab_data_final = "data_final";
       }
       else
       {
          $Lab_data_inicial = "Data Inicial";
          $Lab_data_final = "Data Final";
       }
       $this->comp_field = array(
           $Lab_data_inicial,
           $Lab_data_final,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['usuario_automatico']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['usuario_automatico'] = "Usuario Automatico"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['nome']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['nome'] = "Nome"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['ligacoes']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['ligacoes'] = "Ligacoes"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['doacoes']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['doacoes'] = "Doacoes"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['ndoacoes']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['ndoacoes'] = "Ndoacoes"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['outras']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['outras'] = "Outras"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['tempo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['tempo'] = "Tempo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['id_extrato']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['id_extrato'] = "Id Extrato"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['pesquisa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['pesquisa'] = "Pesquisa"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['data_inicial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['data_inicial'] = "Data Inicial"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['data_final']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['data_final'] = "Data Final"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['operador']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['operador'] = "Operador"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['recibos_gerados']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['recibos_gerados'] = "Recibos Gerados"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['valor_recibos_gerados']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['valor_recibos_gerados'] = "Valor Recibos Gerados"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['recibos_auditados']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['recibos_auditados'] = "Recibos Auditados"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['valor_auditado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['labels']['valor_auditado'] = "Valor Auditado"; 
       }
       //-----
       $this->comp_field_nm = array(
           'data_inicial' => 0,
       ...
       $this->comp_sum = array(
           ...
           3 => "Ligacoes(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
           4 => "Doacoes(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
           5 => "Ndoacoes(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
           6 => "Outras(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['summarizing_fields_order']['Data']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['summarizing_fields_order']['Data'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['summarizing_fields_order']['Data'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['summarizing_fields_display']['Data'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['summarizing_fields_display']['Data'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['summarizing_fields_display']['Data'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['summarizing_fields_display']['Data'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['summarizing_fields_display']['Data'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['summarizing_fields_display']['Data'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['summarizing_fields_display']['Data'] as $i_sum => $d_sum)
           {
       ...
       $this->comp_sum_lnk = array(
           ...
           3 => array('field' => "ligacoes", 'show' => true),
           4 => array('field' => "doacoes", 'show' => true),
           5 => array('field' => "ndoacoes", 'show' => true),
           6 => array('field' => "outras", 'show' => true),
       );
       ...
       //-----
       foreach ($this->array_total_data_inicial as $i_data_inicial => $d_data_inicial) {
           if (!in_array($i_data_inicial, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_data_inicial[7] ] = $d_data_inicial[6];
               $this->comp_label[0][ $d_data_inicial[7] ] = $d_data_inicial[6];
           }
           foreach ($this->array_total_data_final[$i_data_inicial] as $i_data_final => $d_data_final) {
               if (!in_array($i_data_final, $this->comp_label[1][ $d_data_inicial[7] ], true)) {
                   $this->comp_index[1][ $d_data_final[7] ] = $d_data_final[6];
                   $this->comp_label[1][ $d_data_inicial[7] ][ $d_data_final[7] ] = $d_data_final[6];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'data_inicial', 'prot' => '@aspass@'),
           array('name' => 'data_final', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_data_inicial => $l_data_inicial) {
           if (isset($this->array_total_data_inicial[$i_data_inicial])) {
               $this->comp_group[$i_data_inicial] = array();
           }
           foreach ($this->comp_label[1][$i_data_inicial] as $i_data_final => $l_data_final) {
               if (isset($this->array_total_data_final[$i_data_inicial][$i_data_final])) {
                   $this->comp_group[$i_data_inicial][$i_data_final] = array();
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_data_inicial;
       }
       elseif (1 == $level) {
           $return = $this->array_total_data_final;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_extrato_operador@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'data_inicial',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_data_inicial)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           '0|2' => array(
               'title'    => $this->getChartText(strip_tags("Ligacoes(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'data_inicial',
               'field_y'  => $this->comp_sum_nm[3],
               'label_x'  => $this->getChartText(strip_tags($Lab_data_inicial)),
               'label_y'  => $this->getChartText(strip_tags("Ligacoes(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'format'   => $this->formatChartValue(2),
           ),
           '0|3' => array(
               'title'    => $this->getChartText(strip_tags("Doacoes(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'data_inicial',
               'field_y'  => $this->comp_sum_nm[4],
               'label_x'  => $this->getChartText(strip_tags($Lab_data_inicial)),
               'label_y'  => $this->getChartText(strip_tags("Doacoes(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'format'   => $this->formatChartValue(3),
           ),
           '0|4' => array(
               'title'    => $this->getChartText(strip_tags("Ndoacoes(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'data_inicial',
               'field_y'  => $this->comp_sum_nm[5],
               'label_x'  => $this->getChartText(strip_tags($Lab_data_inicial)),
               'label_y'  => $this->getChartText(strip_tags("Ndoacoes(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'format'   => $this->formatChartValue(4),
           ),
           '0|5' => array(
               'title'    => $this->getChartText(strip_tags("Outras(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'data_inicial',
               'field_y'  => $this->comp_sum_nm[6],
               'label_x'  => $this->getChartText(strip_tags($Lab_data_inicial)),
               'label_y'  => $this->getChartText(strip_tags("Outras(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
           ...
           '1|1' => array(
               ...
               'field_x'  => 'data_final',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_data_final)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           '1|2' => array(
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_extrato_operador_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_extrato_operador_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_extrato_operador_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_Data("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_data_inicial);
      ksort($this->array_total_data_final);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_extrato_operador/grid_extrato_operador_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_extrato_operador_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_extrato_operador_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_extrato_operador_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['num_css'] . '.css');
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['dashboard_info']['remove_margin'] ? ' style="margin: 0"' : '';
          $nm_saida->saida(" <BODY class=\"" . $this->css_scGridPage . "\"" . $remove_margin . ">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_extrato_operador/grid_extrato_operador_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=" . s . "&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=N&nm_label_group=S&nm_all_cab=N&nm_all_label=N&pdf_zip=N&nm_orient_grid=2&origem=res&language=pt_br&conf_socor=S&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_extrato_operador&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_extrato_operador/grid_extrato_operador_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=AM&nm_res_cons=s&nm_ini_word_res=resume&nm_all_modules=grid,resume,chart&password=n&origem=res&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "nm_gp_xls_conf('xls', 'resume', '','N');", "nm_gp_xls_conf('xls', 'resume', '','N');", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_extrato_operador/grid_extrato_operador_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=resume&nm_all_modules=grid,resume,chart&password=n&origem=res&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_extrato_operador/grid_extrato_operador_config_graf_flash.php?nome_apl=grid_extrato_operador&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_extrato_operador/grid_extrato_operador_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_extrato_operador/grid_extrato_operador_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_extrato_operador_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_extrato_operador']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_extrato_operador']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_extrato_operador_config_pivot.php?nome_apl=grid_extrato_operador&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_extrato_operador_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_extrato_operador/grid_extrato_operador_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $data_inicial = $Busca_temp['data_inicial']; 
          $tmp_pos = strpos($data_inicial, "##@@");
          if ($tmp_pos !== false && !is_array($data_inicial))
          {
              $data_inicial = substr($data_inicial, 0, $tmp_pos);
          }
          $usuario_automatico = $Busca_temp['usuario_automatico']; 
          $tmp_pos = strpos($usuario_automatico, "##@@");
          if ($tmp_pos !== false && !is_array($usuario_automatico))
          {
              $usuario_automatico = substr($usuario_automatico, 0, $tmp_pos);
          }
      } 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['cond_pesq'], 0, $trab_pos);
     ...
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['proc_pdf_vert']) {
      ...
      $nm_saida->saida("    	<tr>\r\n");
      $nm_saida->saida("        	<td id=\"lin1_col1\" class=\"" . $this->css_scGridHeaderFont . "\"><span>" . $this->Ini->Nm_lang['lang_othr_grid_titl'] . " - extrato_operador</span></td>\r\n");
   ...
   //---- 
   function adiciona_registro($sum_ligacoes, $sum_doacoes, $sum_ndoacoes, $sum_outras, $quebra_data_inicial, $quebra_data_final, $quebra_data_inicial_orig, $quebra_data_final_orig)
   {
      //----- " . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "
      if (!isset($this->array_total_data_inicial[$quebra_data_inicial_orig]))
      {
         $this->array_total_data_inicial[$quebra_data_inicial_orig][0] = 1;
         $this->array_total_data_inicial[$quebra_data_inicial_orig][1] = $sum_ligacoes;
         $this->array_total_data_inicial[$quebra_data_inicial_orig][2] = $sum_doacoes;
         $this->array_total_data_inicial[$quebra_data_inicial_orig][3] = $sum_ndoacoes;
         $this->array_total_data_inicial[$quebra_data_inicial_orig][4] = $sum_outras;
         $this->array_total_data_inicial[$quebra_data_inicial_orig][5] = 1;
         $this->array_total_data_inicial[$quebra_data_inicial_orig][6] = $quebra_data_inicial;
         $this->array_total_data_inicial[$quebra_data_inicial_orig][7] = $quebra_data_inicial_orig;
      }
      else
      {
         $this->array_total_data_inicial[$quebra_data_inicial_orig][0]++;
         $this->array_total_data_inicial[$quebra_data_inicial_orig][1] += $sum_ligacoes;
         $this->array_total_data_inicial[$quebra_data_inicial_orig][2] += $sum_doacoes;
         $this->array_total_data_inicial[$quebra_data_inicial_orig][3] += $sum_ndoacoes;
         $this->array_total_data_inicial[$quebra_data_inicial_orig][4] += $sum_outras;
         $this->array_total_data_inicial[$quebra_data_inicial_orig][5]++;
      }
      //----- " . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "
      if (!isset($this->array_total_data_final[$quebra_data_inicial_orig][$quebra_data_final_orig]))
      {
         $this->array_total_data_final[$quebra_data_inicial_orig][$quebra_data_final_orig][0] = 1;
         $this->array_total_data_final[$quebra_data_inicial_orig][$quebra_data_final_orig][1] = $sum_ligacoes;
         $this->array_total_data_final[$quebra_data_inicial_orig][$quebra_data_final_orig][2] = $sum_doacoes;
         $this->array_total_data_final[$quebra_data_inicial_orig][$quebra_data_final_orig][3] = $sum_ndoacoes;
         $this->array_total_data_final[$quebra_data_inicial_orig][$quebra_data_final_orig][4] = $sum_outras;
         $this->array_total_data_final[$quebra_data_inicial_orig][$quebra_data_final_orig][5] = 1;
         $this->array_total_data_final[$quebra_data_inicial_orig][$quebra_data_final_orig][6] = $quebra_data_final;
         $this->array_total_data_final[$quebra_data_inicial_orig][$quebra_data_final_orig][7] = $quebra_data_final_orig;
      }
      else
      {
         $this->array_total_data_final[$quebra_data_inicial_orig][$quebra_data_final_orig][0]++;
         $this->array_total_data_final[$quebra_data_inicial_orig][$quebra_data_final_orig][1] += $sum_ligacoes;
         $this->array_total_data_final[$quebra_data_inicial_orig][$quebra_data_final_orig][2] += $sum_doacoes;
         $this->array_total_data_final[$quebra_data_inicial_orig][$quebra_data_final_orig][3] += $sum_ndoacoes;
         $this->array_total_data_final[$quebra_data_inicial_orig][$quebra_data_final_orig][4] += $sum_outras;
         $this->array_total_data_final[$quebra_data_inicial_orig][$quebra_data_final_orig][5]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'data_inicial');
     $campos_order = $this->Ini->Get_date_order_groupby("data_inicial", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'data_final');
     $campos_order = $this->Ini->Get_date_order_groupby("data_final", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->usuario_automatico = $rs_res->fields[0] ;  
            $this->nome = $rs_res->fields[1] ;  
            $this->ligacoes = $rs_res->fields[2] ;  
            $this->doacoes = $rs_res->fields[3] ;  
            $this->ndoacoes = $rs_res->fields[4] ;  
            $this->outras = $rs_res->fields[5] ;  
            $this->tempo = $rs_res->fields[6] ;  
            $this->id_extrato = $rs_res->fields[7] ;  
            $this->pesquisa = $rs_res->fields[8] ;  
            $this->data_inicial = $rs_res->fields[9] ;  
            $this->data_final = $rs_res->fields[10] ;  
            $this->operador = $rs_res->fields[11] ;  
            ...
            $this->data_inicial_orig = $this->Ini->Get_arg_groupby($TP_Time . $this->data_inicial, $Format_tst);
            $this->data_inicial = $this->Ini->GB_date_format($TP_Time . $this->data_inicial, $Format_tst, $Prefix_dat);
            ...
            $this->data_final_orig = $this->Ini->Get_arg_groupby($TP_Time . $this->data_final, $Format_tst);
            $this->data_final = $this->Ini->GB_date_format($TP_Time . $this->data_final, $Format_tst, $Prefix_dat);
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->ligacoes, $this->doacoes, $this->ndoacoes, $this->outras, $this->data_inicial, $this->data_final, $this->data_inicial_orig,  $this->data_final_orig);
            }
   }
//
