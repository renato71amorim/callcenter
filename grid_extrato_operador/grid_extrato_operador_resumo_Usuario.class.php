...
class grid_extrato_operador_resumo
{
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_usuario_automatico;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_usuario_automatico = array();
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_usuario_automatico = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['arr_total']['usuario_automatico'];
      }
      else
      {
          $this->array_total_usuario_automatico = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['arr_total']['usuario_automatico'] = $this->array_total_usuario_automatico;
   ...
   function completeMatrix()
   {
       ...
       {
          $Lab_usuario_automatico = "usuario_automatico";
       }
       else
       {
          $Lab_usuario_automatico = "Usuario Automatico";
       }
       $this->comp_field = array(
           $Lab_usuario_automatico,
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['summarizing_fields_order']['Usuario']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['summarizing_fields_order']['Usuario'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['summarizing_fields_order']['Usuario'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['summarizing_fields_display']['Usuario'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['summarizing_fields_display']['Usuario'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['summarizing_fields_display']['Usuario'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['summarizing_fields_display']['Usuario'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['summarizing_fields_display']['Usuario'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['summarizing_fields_display']['Usuario'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['summarizing_fields_display']['Usuario'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_usuario_automatico as $i_usuario_automatico => $d_usuario_automatico) {
           if (!in_array($i_usuario_automatico, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_usuario_automatico[7] ] = $d_usuario_automatico[6];
               $this->comp_label[0][ $d_usuario_automatico[7] ] = $d_usuario_automatico[6];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'usuario_automatico', 'prot' => '@aspass@'),
       );
       ...
       //-----
       foreach ($this->comp_label[0] as $i_usuario_automatico => $l_usuario_automatico) {
           if (isset($this->array_total_usuario_automatico[$i_usuario_automatico])) {
               $this->comp_group[$i_usuario_automatico] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_usuario_automatico;
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'usuario_automatico',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_usuario_automatico)),
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_Usuario("res");
      ...
      ksort($this->array_total_usuario_automatico);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_ligacoes, $sum_doacoes, $sum_ndoacoes, $sum_outras, $quebra_usuario_automatico, $quebra_usuario_automatico_orig)
   {
      //----- Usuario Automatico
      if (!isset($this->array_total_usuario_automatico[$quebra_usuario_automatico_orig]))
      {
         $this->array_total_usuario_automatico[$quebra_usuario_automatico_orig][0] = 1;
         $this->array_total_usuario_automatico[$quebra_usuario_automatico_orig][1] = $sum_ligacoes;
         $this->array_total_usuario_automatico[$quebra_usuario_automatico_orig][2] = $sum_doacoes;
         $this->array_total_usuario_automatico[$quebra_usuario_automatico_orig][3] = $sum_ndoacoes;
         $this->array_total_usuario_automatico[$quebra_usuario_automatico_orig][4] = $sum_outras;
         $this->array_total_usuario_automatico[$quebra_usuario_automatico_orig][5] = 1;
         $this->array_total_usuario_automatico[$quebra_usuario_automatico_orig][6] = $quebra_usuario_automatico;
         $this->array_total_usuario_automatico[$quebra_usuario_automatico_orig][7] = $quebra_usuario_automatico_orig;
      }
      else
      {
         $this->array_total_usuario_automatico[$quebra_usuario_automatico_orig][0]++;
         $this->array_total_usuario_automatico[$quebra_usuario_automatico_orig][1] += $sum_ligacoes;
         $this->array_total_usuario_automatico[$quebra_usuario_automatico_orig][2] += $sum_doacoes;
         $this->array_total_usuario_automatico[$quebra_usuario_automatico_orig][3] += $sum_ndoacoes;
         $this->array_total_usuario_automatico[$quebra_usuario_automatico_orig][4] += $sum_outras;
         $this->array_total_usuario_automatico[$quebra_usuario_automatico_orig][5]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'usuario_automatico');
     $campos_order = $this->Ini->Get_date_order_groupby("usuario_automatico", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->usuario_automatico_orig = $this->usuario_automatico;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->ligacoes, $this->doacoes, $this->ndoacoes, $this->outras, $this->usuario_automatico, $this->usuario_automatico_orig);
            }
   }
//
