<?php
@session_start() ;
$_SESSION['scriptcase']['grid_extrato_operador']['sc_process_barr'] = true;
require_once('../grid_extrato_operador/index.php');
unset($_SESSION['scriptcase']['grid_extrato_operador']['sc_process_barr']);
$ExportCtrl = new grid_extrato_operador_export_control;
$ExportCtrl->Export_barr();

class grid_extrato_operador_export_control
{
