...
<?php
   ...
   $Ord_Cmp = new grid_extrato_operador_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_extrato_operador_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['usuario_automatico'] = "usuario_automatico";
   $tab_labels["usuario_automatico"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['labels']["usuario_automatico"])) ? $_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['labels']["usuario_automatico"] : "Usuario Automatico";
   $tab_ger_campos['nome'] = "on";
   $tab_def_campos['nome'] = "nome";
   $tab_labels["nome"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['labels']["nome"])) ? $_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['labels']["nome"] : "Nome";
   $tab_ger_campos['ligacoes'] = "on";
   $tab_def_campos['ligacoes'] = "ligacoes";
   $tab_labels["ligacoes"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['labels']["ligacoes"])) ? $_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['labels']["ligacoes"] : "Ligacoes";
   $tab_ger_campos['doacoes'] = "on";
   $tab_def_campos['doacoes'] = "doacoes";
   $tab_labels["doacoes"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['labels']["doacoes"])) ? $_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['labels']["doacoes"] : "Doacoes";
   $tab_ger_campos['ndoacoes'] = "on";
   $tab_def_campos['ndoacoes'] = "ndoacoes";
   $tab_labels["ndoacoes"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['labels']["ndoacoes"])) ? $_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['labels']["ndoacoes"] : "Ndoacoes";
   $tab_ger_campos['outras'] = "on";
   $tab_def_campos['outras'] = "outras";
   $tab_labels["outras"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['labels']["outras"])) ? $_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['labels']["outras"] : "Outras";
   $tab_ger_campos['tempo'] = "on";
   $tab_def_campos['tempo'] = "tempo";
   $tab_labels["tempo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['labels']["tempo"])) ? $_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['labels']["tempo"] : "Tempo";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['ordem_quebra'] as $campo => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_extrato_operador_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_extrato_operador']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
