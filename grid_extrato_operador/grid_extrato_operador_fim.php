...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_extrato_operador"]))
   {
      unset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_extrato_operador"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_extrato_operador']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_extrato_operador']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_extrato_operador']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_extrato_operador']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_extrato_operador']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_extrato_operador</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_extrato_operador']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_extrato_operador']['embutida_filho'] as $ind => $sc_init)
          {
