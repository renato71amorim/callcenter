...
<?php
   ...
   function inicializa_vars()
   {
      ...
      //---- Label
      $this->label    = array();
      $this->label[0] = "Usuario Automatico";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['contr_label_graf']['usuario_automatico']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['contr_label_graf']['usuario_automatico']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_extrato_operador']['contr_label_graf']['usuario_automatico'];
      }
   }
