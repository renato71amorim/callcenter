  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_colaborador" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_colaborador_form();
	}

  // ---------- Validate codigo
  function do_ajax_form_colaborador_validate_codigo()
  {
    var nomeCampo_codigo = "codigo";
    var var_codigo = scAjaxGetFieldText(nomeCampo_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colaborador_validate_codigo(var_codigo, var_script_case_init, do_ajax_form_colaborador_validate_codigo_cb);
  } // do_ajax_form_colaborador_validate_codigo

  function do_ajax_form_colaborador_validate_codigo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colaborador_validate_codigo_cb

  // ---------- Validate nomerecibo
  function do_ajax_form_colaborador_validate_nomerecibo()
  {
    var nomeCampo_nomerecibo = "nomerecibo";
    var var_nomerecibo = scAjaxGetFieldText(nomeCampo_nomerecibo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colaborador_validate_nomerecibo(var_nomerecibo, var_script_case_init, do_ajax_form_colaborador_validate_nomerecibo_cb);
  } // do_ajax_form_colaborador_validate_nomerecibo

  function do_ajax_form_colaborador_validate_nomerecibo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colaborador_validate_nomerecibo_cb

  // ---------- Validate observacao
  function do_ajax_form_colaborador_validate_observacao()
  {
    var nomeCampo_observacao = "observacao";
    var var_observacao = scAjaxGetFieldText(nomeCampo_observacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colaborador_validate_observacao(var_observacao, var_script_case_init, do_ajax_form_colaborador_validate_observacao_cb);
  } // do_ajax_form_colaborador_validate_observacao

  function do_ajax_form_colaborador_validate_observacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "observacao";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colaborador_validate_observacao_cb

  // ---------- Validate dtiniciocolab
  function do_ajax_form_colaborador_validate_dtiniciocolab()
  {
    var nomeCampo_dtiniciocolab = "dtiniciocolab";
    var var_dtiniciocolab = scAjaxGetFieldText(nomeCampo_dtiniciocolab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colaborador_validate_dtiniciocolab(var_dtiniciocolab, var_script_case_init, do_ajax_form_colaborador_validate_dtiniciocolab_cb);
  } // do_ajax_form_colaborador_validate_dtiniciocolab

  function do_ajax_form_colaborador_validate_dtiniciocolab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dtiniciocolab";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colaborador_validate_dtiniciocolab_cb

  // ---------- Validate dtultimacolab
  function do_ajax_form_colaborador_validate_dtultimacolab()
  {
    var nomeCampo_dtultimacolab = "dtultimacolab";
    var var_dtultimacolab = scAjaxGetFieldText(nomeCampo_dtultimacolab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colaborador_validate_dtultimacolab(var_dtultimacolab, var_script_case_init, do_ajax_form_colaborador_validate_dtultimacolab_cb);
  } // do_ajax_form_colaborador_validate_dtultimacolab

  function do_ajax_form_colaborador_validate_dtultimacolab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dtultimacolab";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colaborador_validate_dtultimacolab_cb

  // ---------- Validate operadoravulso
  function do_ajax_form_colaborador_validate_operadoravulso()
  {
    var nomeCampo_operadoravulso = "operadoravulso";
    var var_operadoravulso = scAjaxGetFieldText(nomeCampo_operadoravulso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colaborador_validate_operadoravulso(var_operadoravulso, var_script_case_init, do_ajax_form_colaborador_validate_operadoravulso_cb);
  } // do_ajax_form_colaborador_validate_operadoravulso

  function do_ajax_form_colaborador_validate_operadoravulso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colaborador_validate_operadoravulso_cb

  // ---------- Validate operadormensal
  function do_ajax_form_colaborador_validate_operadormensal()
  {
    var nomeCampo_operadormensal = "operadormensal";
    var var_operadormensal = scAjaxGetFieldText(nomeCampo_operadormensal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colaborador_validate_operadormensal(var_operadormensal, var_script_case_init, do_ajax_form_colaborador_validate_operadormensal_cb);
  } // do_ajax_form_colaborador_validate_operadormensal

  function do_ajax_form_colaborador_validate_operadormensal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colaborador_validate_operadormensal_cb

  // ---------- Validate valoravulso
  function do_ajax_form_colaborador_validate_valoravulso()
  {
    var nomeCampo_valoravulso = "valoravulso";
    var var_valoravulso = scAjaxGetFieldText(nomeCampo_valoravulso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colaborador_validate_valoravulso(var_valoravulso, var_script_case_init, do_ajax_form_colaborador_validate_valoravulso_cb);
  } // do_ajax_form_colaborador_validate_valoravulso

  function do_ajax_form_colaborador_validate_valoravulso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colaborador_validate_valoravulso_cb

  // ---------- Validate valormensal
  function do_ajax_form_colaborador_validate_valormensal()
  {
    var nomeCampo_valormensal = "valormensal";
    var var_valormensal = scAjaxGetFieldText(nomeCampo_valormensal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colaborador_validate_valormensal(var_valormensal, var_script_case_init, do_ajax_form_colaborador_validate_valormensal_cb);
  } // do_ajax_form_colaborador_validate_valormensal

  function do_ajax_form_colaborador_validate_valormensal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colaborador_validate_valormensal_cb

  // ---------- Validate cobrador
  function do_ajax_form_colaborador_validate_cobrador()
  {
    var nomeCampo_cobrador = "cobrador";
    var var_cobrador = scAjaxGetFieldText(nomeCampo_cobrador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colaborador_validate_cobrador(var_cobrador, var_script_case_init, do_ajax_form_colaborador_validate_cobrador_cb);
  } // do_ajax_form_colaborador_validate_cobrador

  function do_ajax_form_colaborador_validate_cobrador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colaborador_validate_cobrador_cb

  // ---------- Validate dtultimacolabav
  function do_ajax_form_colaborador_validate_dtultimacolabav()
  {
    var nomeCampo_dtultimacolabav = "dtultimacolabav";
    var var_dtultimacolabav = scAjaxGetFieldText(nomeCampo_dtultimacolabav);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colaborador_validate_dtultimacolabav(var_dtultimacolabav, var_script_case_init, do_ajax_form_colaborador_validate_dtultimacolabav_cb);
  } // do_ajax_form_colaborador_validate_dtultimacolabav

  function do_ajax_form_colaborador_validate_dtultimacolabav_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dtultimacolabav";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colaborador_validate_dtultimacolabav_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_colaborador_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_colaborador_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_codigo = scAjaxGetFieldText("codigo");
    var var_nomerecibo = scAjaxGetFieldText("nomerecibo");
    var var_observacao = scAjaxGetFieldText("observacao");
    var var_dtiniciocolab = scAjaxGetFieldText("dtiniciocolab");
    var var_dtultimacolab = scAjaxGetFieldText("dtultimacolab");
    ...
    var var_dtultimacolabav = scAjaxGetFieldText("dtultimacolabav");
    ...
    scAjaxProcOn();
    x_ajax_form_colaborador_submit_form(var_codigo, var_nomerecibo, var_observacao, var_dtiniciocolab, var_dtultimacolab, var_operadoravulso, var_operadormensal, var_valoravulso, var_valormensal, var_cobrador, var_dtultimacolabav, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_colaborador_submit_form_cb);
  } // do_ajax_form_colaborador_submit_form

  function do_ajax_form_colaborador_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("observacao");
      scAjaxHideErrorDisplay("dtiniciocolab");
      scAjaxHideErrorDisplay("dtultimacolab");
      ...
      scAjaxHideErrorDisplay("dtultimacolabav");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_colaborador_submit_form_cb_after_alert);
  } // do_ajax_form_colaborador_submit_form_cb
  function do_ajax_form_colaborador_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_colaborador_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_colaborador_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_colaborador_navigate_form(var_codigo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_colaborador_navigate_form_cb);
  } // do_ajax_form_colaborador_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_colaborador_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_colaborador_navigate_form_cb_after_alert);
  } // do_ajax_form_colaborador_navigate_form_cb
  function do_ajax_form_colaborador_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_colaborador_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_colaborador_navigate_form_cb_after_alert
  function sc_hide_form_colaborador_form()
  {
  ...
  ajax_field_list[1] = "nomerecibo";
  ajax_field_list[2] = "observacao";
  ajax_field_list[3] = "dtiniciocolab";
  ajax_field_list[4] = "dtultimacolab";
  ajax_field_list[5] = "operadoravulso";
  ajax_field_list[6] = "operadormensal";
  ajax_field_list[7] = "valoravulso";
  ajax_field_list[8] = "valormensal";
  ajax_field_list[9] = "cobrador";
  ajax_field_list[10] = "dtultimacolabav";
  ...
  var ajax_error_list = {
    ...
    "observacao": {"label": "Observacao", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "dtiniciocolab": {"label": "Dt Inicio Colab", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "dtultimacolab": {"label": "Dt Ultima Colab", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "dtultimacolabav": {"label": "Dt Ultima Colab Av", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "observacao": new Array(),
    "dtiniciocolab": new Array(),
    "dtultimacolab": new Array(),
    "operadoravulso": new Array(),
    "operadormensal": new Array(),
    "valoravulso": new Array(),
    "valormensal": new Array(),
    "cobrador": new Array(),
    "dtultimacolabav": new Array()
  };
  ajax_field_mult["codigo"][1] = "codigo";
  ajax_field_mult["nomerecibo"][1] = "nomerecibo";
  ajax_field_mult["observacao"][1] = "observacao";
  ajax_field_mult["dtiniciocolab"][1] = "dtiniciocolab";
  ajax_field_mult["dtultimacolab"][1] = "dtultimacolab";
  ...
  ajax_field_mult["dtultimacolabav"][1] = "dtultimacolabav";
  ...
  var ajax_field_id = {
    ...
    "observacao": new Array("hidden_field_label_observacao", "hidden_field_data_observacao"),
    "dtiniciocolab": new Array("hidden_field_label_dtiniciocolab", "hidden_field_data_dtiniciocolab"),
    "dtultimacolab": new Array("hidden_field_label_dtultimacolab", "hidden_field_data_dtultimacolab"),
    ...
    "dtultimacolabav": new Array("hidden_field_label_dtultimacolabav", "hidden_field_data_dtultimacolabav")
  };
