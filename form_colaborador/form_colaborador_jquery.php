...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_dtiniciocolab_hora' + iSeqRow).bind('blur', function() { sc_form_colaborador_dtiniciocolab_hora_onblur(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_colaborador_dtiniciocolab_hora_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_dtultimacolab_hora' + iSeqRow).bind('blur', function() { sc_form_colaborador_dtultimacolab_hora_onblur(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_colaborador_dtultimacolab_hora_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_dtultimacolabav_hora' + iSeqRow).bind('blur', function() { sc_form_colaborador_dtultimacolabav_hora_onblur(this, iSeqRow) })
                                                  .bind('focus', function() { sc_form_colaborador_dtultimacolabav_hora_onfocus(this, iSeqRow) });
} // scJQEventsAdd
...
function sc_form_colaborador_dtiniciocolab_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_colaborador_validate_dtiniciocolab();
  scCssBlur(oThis);
}
...
function sc_form_colaborador_dtiniciocolab_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_colaborador_dtultimacolab_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_colaborador_validate_dtultimacolab();
  scCssBlur(oThis);
}
...
function sc_form_colaborador_dtultimacolab_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_colaborador_dtultimacolabav_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_colaborador_validate_dtultimacolabav();
  scCssBlur(oThis);
}
...
function sc_form_colaborador_dtultimacolabav_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_colaborador_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_dtiniciocolab" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_colaborador_validate_dtiniciocolab(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_dtultimacolab" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_colaborador_validate_dtultimacolab(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_dtultimacolabav" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_colaborador_validate_dtultimacolabav(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
