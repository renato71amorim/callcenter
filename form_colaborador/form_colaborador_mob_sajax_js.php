  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_colaborador_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_colaborador_mob_form();
	}

  // ---------- Validate codigo
  function do_ajax_form_colaborador_mob_validate_codigo()
  {
    var nomeCampo_codigo = "codigo";
    var var_codigo = scAjaxGetFieldText(nomeCampo_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colaborador_mob_validate_codigo(var_codigo, var_script_case_init, do_ajax_form_colaborador_mob_validate_codigo_cb);
  } // do_ajax_form_colaborador_mob_validate_codigo

  function do_ajax_form_colaborador_mob_validate_codigo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colaborador_mob_validate_codigo_cb

  // ---------- Validate nomerecibo
  function do_ajax_form_colaborador_mob_validate_nomerecibo()
  {
    var nomeCampo_nomerecibo = "nomerecibo";
    var var_nomerecibo = scAjaxGetFieldText(nomeCampo_nomerecibo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colaborador_mob_validate_nomerecibo(var_nomerecibo, var_script_case_init, do_ajax_form_colaborador_mob_validate_nomerecibo_cb);
  } // do_ajax_form_colaborador_mob_validate_nomerecibo

  function do_ajax_form_colaborador_mob_validate_nomerecibo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colaborador_mob_validate_nomerecibo_cb

  // ---------- Validate observacao
  function do_ajax_form_colaborador_mob_validate_observacao()
  {
    var nomeCampo_observacao = "observacao";
    var var_observacao = scAjaxGetFieldText(nomeCampo_observacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colaborador_mob_validate_observacao(var_observacao, var_script_case_init, do_ajax_form_colaborador_mob_validate_observacao_cb);
  } // do_ajax_form_colaborador_mob_validate_observacao

  function do_ajax_form_colaborador_mob_validate_observacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colaborador_mob_validate_observacao_cb

  // ---------- Validate dtiniciocolab
  function do_ajax_form_colaborador_mob_validate_dtiniciocolab()
  {
    var nomeCampo_dtiniciocolab = "dtiniciocolab";
    var var_dtiniciocolab = scAjaxGetFieldText(nomeCampo_dtiniciocolab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colaborador_mob_validate_dtiniciocolab(var_dtiniciocolab, var_script_case_init, do_ajax_form_colaborador_mob_validate_dtiniciocolab_cb);
  } // do_ajax_form_colaborador_mob_validate_dtiniciocolab

  function do_ajax_form_colaborador_mob_validate_dtiniciocolab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colaborador_mob_validate_dtiniciocolab_cb

  // ---------- Validate dtultimacolab
  function do_ajax_form_colaborador_mob_validate_dtultimacolab()
  {
    var nomeCampo_dtultimacolab = "dtultimacolab";
    var var_dtultimacolab = scAjaxGetFieldText(nomeCampo_dtultimacolab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colaborador_mob_validate_dtultimacolab(var_dtultimacolab, var_script_case_init, do_ajax_form_colaborador_mob_validate_dtultimacolab_cb);
  } // do_ajax_form_colaborador_mob_validate_dtultimacolab

  function do_ajax_form_colaborador_mob_validate_dtultimacolab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colaborador_mob_validate_dtultimacolab_cb

  // ---------- Validate operadoravulso
  function do_ajax_form_colaborador_mob_validate_operadoravulso()
  {
    var nomeCampo_operadoravulso = "operadoravulso";
    var var_operadoravulso = scAjaxGetFieldText(nomeCampo_operadoravulso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colaborador_mob_validate_operadoravulso(var_operadoravulso, var_script_case_init, do_ajax_form_colaborador_mob_validate_operadoravulso_cb);
  } // do_ajax_form_colaborador_mob_validate_operadoravulso

  function do_ajax_form_colaborador_mob_validate_operadoravulso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colaborador_mob_validate_operadoravulso_cb

  // ---------- Validate operadormensal
  function do_ajax_form_colaborador_mob_validate_operadormensal()
  {
    var nomeCampo_operadormensal = "operadormensal";
    var var_operadormensal = scAjaxGetFieldText(nomeCampo_operadormensal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colaborador_mob_validate_operadormensal(var_operadormensal, var_script_case_init, do_ajax_form_colaborador_mob_validate_operadormensal_cb);
  } // do_ajax_form_colaborador_mob_validate_operadormensal

  function do_ajax_form_colaborador_mob_validate_operadormensal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colaborador_mob_validate_operadormensal_cb

  // ---------- Validate valoravulso
  function do_ajax_form_colaborador_mob_validate_valoravulso()
  {
    var nomeCampo_valoravulso = "valoravulso";
    var var_valoravulso = scAjaxGetFieldText(nomeCampo_valoravulso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colaborador_mob_validate_valoravulso(var_valoravulso, var_script_case_init, do_ajax_form_colaborador_mob_validate_valoravulso_cb);
  } // do_ajax_form_colaborador_mob_validate_valoravulso

  function do_ajax_form_colaborador_mob_validate_valoravulso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colaborador_mob_validate_valoravulso_cb

  // ---------- Validate valormensal
  function do_ajax_form_colaborador_mob_validate_valormensal()
  {
    var nomeCampo_valormensal = "valormensal";
    var var_valormensal = scAjaxGetFieldText(nomeCampo_valormensal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colaborador_mob_validate_valormensal(var_valormensal, var_script_case_init, do_ajax_form_colaborador_mob_validate_valormensal_cb);
  } // do_ajax_form_colaborador_mob_validate_valormensal

  function do_ajax_form_colaborador_mob_validate_valormensal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colaborador_mob_validate_valormensal_cb

  // ---------- Validate cobrador
  function do_ajax_form_colaborador_mob_validate_cobrador()
  {
    var nomeCampo_cobrador = "cobrador";
    var var_cobrador = scAjaxGetFieldText(nomeCampo_cobrador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colaborador_mob_validate_cobrador(var_cobrador, var_script_case_init, do_ajax_form_colaborador_mob_validate_cobrador_cb);
  } // do_ajax_form_colaborador_mob_validate_cobrador

  function do_ajax_form_colaborador_mob_validate_cobrador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colaborador_mob_validate_cobrador_cb

  // ---------- Validate dtultimacolabav
  function do_ajax_form_colaborador_mob_validate_dtultimacolabav()
  {
    var nomeCampo_dtultimacolabav = "dtultimacolabav";
    var var_dtultimacolabav = scAjaxGetFieldText(nomeCampo_dtultimacolabav);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colaborador_mob_validate_dtultimacolabav(var_dtultimacolabav, var_script_case_init, do_ajax_form_colaborador_mob_validate_dtultimacolabav_cb);
  } // do_ajax_form_colaborador_mob_validate_dtultimacolabav

  function do_ajax_form_colaborador_mob_validate_dtultimacolabav_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colaborador_mob_validate_dtultimacolabav_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_colaborador_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_colaborador_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_colaborador_mob_submit_form(var_codigo, var_nomerecibo, var_observacao, var_dtiniciocolab, var_dtultimacolab, var_operadoravulso, var_operadormensal, var_valoravulso, var_valormensal, var_cobrador, var_dtultimacolabav, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_colaborador_mob_submit_form_cb);
  } // do_ajax_form_colaborador_mob_submit_form

  function do_ajax_form_colaborador_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_colaborador_mob_submit_form_cb_after_alert);
  } // do_ajax_form_colaborador_mob_submit_form_cb
  function do_ajax_form_colaborador_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_colaborador_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_colaborador_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_colaborador_mob_navigate_form(var_codigo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_colaborador_mob_navigate_form_cb);
  } // do_ajax_form_colaborador_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_colaborador_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_colaborador_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_colaborador_mob_navigate_form_cb
  function do_ajax_form_colaborador_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_colaborador_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_colaborador_mob_navigate_form_cb_after_alert
  function sc_hide_form_colaborador_mob_form()
  {
