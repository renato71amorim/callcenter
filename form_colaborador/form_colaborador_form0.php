...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_colaborador_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_colaborador_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_colaborador_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_colaborador'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_colaborador'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_codigo_label" id="hidden_field_label_codigo" style="<?php echo $sStyleHidden_codigo; ?>"><span id="id_label_codigo"><?php echo $this->nm_new_label['codigo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['php_cmp_required']['codigo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['php_cmp_required']['codigo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dtiniciocolab_label" id="hidden_field_label_dtiniciocolab" style="<?php echo $sStyleHidden_dtiniciocolab; ?>"><span id="id_label_dtiniciocolab"><?php echo $this->nm_new_label['dtiniciocolab']; ?></span></TD>
    <TD class="scFormDataOdd css_dtiniciocolab_line" id="hidden_field_data_dtiniciocolab" style="<?php echo $sStyleHidden_dtiniciocolab; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dtiniciocolab_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dtultimacolab_label" id="hidden_field_label_dtultimacolab" style="<?php echo $sStyleHidden_dtultimacolab; ?>"><span id="id_label_dtultimacolab"><?php echo $this->nm_new_label['dtultimacolab']; ?></span></TD>
    <TD class="scFormDataOdd css_dtultimacolab_line" id="hidden_field_data_dtultimacolab" style="<?php echo $sStyleHidden_dtultimacolab; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dtultimacolab_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dtultimacolabav_label" id="hidden_field_label_dtultimacolabav" style="<?php echo $sStyleHidden_dtultimacolabav; ?>"><span id="id_label_dtultimacolabav"><?php echo $this->nm_new_label['dtultimacolabav']; ?></span></TD>
    <TD class="scFormDataOdd css_dtultimacolabav_line" id="hidden_field_data_dtultimacolabav" style="<?php echo $sStyleHidden_dtultimacolabav; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dtultimacolabav_line" style="vertical-align: top;padding: 0px">
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_colaborador");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_colaborador");
 parent.scAjaxDetailHeight("form_colaborador", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_colaborador']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
