...
class grid_contribuinte_lista_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_contribuinte_lista']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_contribuinte_lista']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang ;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_lista']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_lista']['tot_geral'] = array() ;  
      $nm_comando = "select count(*), count(codigo) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_lista']['where_pesq']; 
      ...
      if ($rt->fields[0] == 0)
      { 
          if (!isset($Contrl_Interat) && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_lista']['where_pesq_filtro']) && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_lista']['where_pesq_fast']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_lista']['interativ_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_lista']['interativ_search']))
          {
              $Contrl_Interat = 1;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_lista']['where_pesq']       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_lista']['where_sem_interativ'];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_lista']['interativ_search'] = array();
              $this->quebra_geral_sc_free_total();
          }
          
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_lista']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_lista']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_lista']['tot_geral'][2] = $rt->fields[1]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_lista']['contr_total_geral'] = "OK";
   } 
