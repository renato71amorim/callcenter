<?php
@session_start() ;
$_SESSION['scriptcase']['grid_contribuinte_lista']['sc_process_barr'] = true;
require_once('../grid_contribuinte_lista/index.php');
unset($_SESSION['scriptcase']['grid_contribuinte_lista']['sc_process_barr']);
$ExportCtrl = new grid_contribuinte_lista_export_control;
$ExportCtrl->Export_barr();

class grid_contribuinte_lista_export_control
{
