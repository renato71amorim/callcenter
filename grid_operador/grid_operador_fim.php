...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_operador"]))
   {
      unset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_operador"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_operador'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_operador']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_operador']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_operador']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_operador']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_operador']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_operador']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_operador']['embutida_filho'] as $ind => $sc_init)
          {
