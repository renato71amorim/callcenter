<?php
@session_start() ;
$_SESSION['scriptcase']['grid_operador']['sc_process_barr'] = true;
require_once('../grid_operador/index.php');
unset($_SESSION['scriptcase']['grid_operador']['sc_process_barr']);
$ExportCtrl = new grid_operador_export_control;
$ExportCtrl->Export_barr();

class grid_operador_export_control
{
