...
<?php
   ...
   $Ord_Cmp = new grid_operador_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_operador_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_operador']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_operador']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["codigooperador"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_operador']['labels']["codigooperador"])) ? $_SESSION['sc_session'][$sc_init]['grid_operador']['labels']["codigooperador"] : "Codigo Operador";
   $tab_ger_campos['nome'] = "on";
   $tab_def_campos['nome'] = "Nome";
   $tab_labels["nome"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_operador']['labels']["nome"])) ? $_SESSION['sc_session'][$sc_init]['grid_operador']['labels']["nome"] : "Nome";
   $tab_ger_campos['tipo'] = "on";
   $tab_def_campos['tipo'] = "Tipo";
   $tab_labels["tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_operador']['labels']["tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_operador']['labels']["tipo"] : "Tipo";
   $tab_ger_campos['datacadastro'] = "on";
   $tab_def_campos['datacadastro'] = "DataCadastro";
   $tab_labels["datacadastro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_operador']['labels']["datacadastro"])) ? $_SESSION['sc_session'][$sc_init]['grid_operador']['labels']["datacadastro"] : "Data Cadastro";
   $tab_ger_campos['central'] = "on";
   $tab_def_campos['central'] = "Central";
   $tab_labels["central"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_operador']['labels']["central"])) ? $_SESSION['sc_session'][$sc_init]['grid_operador']['labels']["central"] : "Central";
   $tab_ger_campos['datasaida'] = "on";
   $tab_def_campos['datasaida'] = "DataSaida";
   $tab_labels["datasaida"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_operador']['labels']["datasaida"])) ? $_SESSION['sc_session'][$sc_init]['grid_operador']['labels']["datasaida"] : "Data Saida";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_operador']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_operador']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_operador']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_operador']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_operador']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_operador']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_operador']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_operador']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_operador']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_operador']['ordem_quebra'] as $campo => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_operador']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_operador']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_operador_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_operador']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_operador']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_operador']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_operador']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_operador']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
