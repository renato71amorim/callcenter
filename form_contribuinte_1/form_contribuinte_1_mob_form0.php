...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_contribuinte_1_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_contribuinte_1_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_contribuinte_1']['error_buffer']) && '' != $_SESSION['scriptcase']['form_contribuinte_1']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_contribuinte_1']['error_buffer'];
}
...
<?php
 include_once("form_contribuinte_1_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_contribuinte_1_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_contribuinte_1_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_contribuinte_1_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_codigo_line" id="hidden_field_data_codigo" style="<?php echo $sStyleHidden_codigo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_codigo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_codigo_label"><span id="id_label_codigo"><?php echo $this->nm_new_label['codigo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['php_cmp_required']['codigo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['php_cmp_required']['codigo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_doador_line" id="hidden_field_data_doador" style="<?php echo $sStyleHidden_doador; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_doador_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_doador_label"><span id="id_label_doador"><?php echo $this->nm_new_label['doador']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_dataaniv_line" id="hidden_field_data_dataaniv" style="<?php echo $sStyleHidden_dataaniv; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dataaniv_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_dataaniv_label"><span id="id_label_dataaniv"><?php echo $this->nm_new_label['dataaniv']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_datalistagem_line" id="hidden_field_data_datalistagem" style="<?php echo $sStyleHidden_datalistagem; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_datalistagem_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_datalistagem_label"><span id="id_label_datalistagem"><?php echo $this->nm_new_label['datalistagem']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fone3_line" id="hidden_field_data_fone3" style="<?php echo $sStyleHidden_fone3; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fone3_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fone3_label"><span id="id_label_fone3"><?php echo $this->nm_new_label['fone3']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fone4_line" id="hidden_field_data_fone4" style="<?php echo $sStyleHidden_fone4; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fone4_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fone4_label"><span id="id_label_fone4"><?php echo $this->nm_new_label['fone4']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_statusc_line" id="hidden_field_data_statusc" style="<?php echo $sStyleHidden_statusc; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_statusc_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_statusc_label"><span id="id_label_statusc"><?php echo $this->nm_new_label['statusc']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_classificacao_line" id="hidden_field_data_classificacao" style="<?php echo $sStyleHidden_classificacao; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_classificacao_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_classificacao_label"><span id="id_label_classificacao"><?php echo $this->nm_new_label['classificacao']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idclientecompanhia_line" id="hidden_field_data_idclientecompanhia" style="<?php echo $sStyleHidden_idclientecompanhia; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idclientecompanhia_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idclientecompanhia_label"><span id="id_label_idclientecompanhia"><?php echo $this->nm_new_label['idclientecompanhia']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_dgidclientecompanhia_line" id="hidden_field_data_dgidclientecompanhia" style="<?php echo $sStyleHidden_dgidclientecompanhia; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dgidclientecompanhia_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_dgidclientecompanhia_label"><span id="id_label_dgidclientecompanhia"><?php echo $this->nm_new_label['dgidclientecompanhia']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idclientenosso_line" id="hidden_field_data_idclientenosso" style="<?php echo $sStyleHidden_idclientenosso; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idclientenosso_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idclientenosso_label"><span id="id_label_idclientenosso"><?php echo $this->nm_new_label['idclientenosso']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_produtoincluido_line" id="hidden_field_data_produtoincluido" style="<?php echo $sStyleHidden_produtoincluido; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_produtoincluido_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_produtoincluido_label"><span id="id_label_produtoincluido"><?php echo $this->nm_new_label['produtoincluido']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_statusinclusaoproduto_line" id="hidden_field_data_statusinclusaoproduto" style="<?php echo $sStyleHidden_statusinclusaoproduto; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_statusinclusaoproduto_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_statusinclusaoproduto_label"><span id="id_label_statusinclusaoproduto"><?php echo $this->nm_new_label['statusinclusaoproduto']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_permiteemail_line" id="hidden_field_data_permiteemail" style="<?php echo $sStyleHidden_permiteemail; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_permiteemail_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_permiteemail_label"><span id="id_label_permiteemail"><?php echo $this->nm_new_label['permiteemail']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ultimoaudiocampanha_line" id="hidden_field_data_ultimoaudiocampanha" style="<?php echo $sStyleHidden_ultimoaudiocampanha; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ultimoaudiocampanha_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ultimoaudiocampanha_label"><span id="id_label_ultimoaudiocampanha"><?php echo $this->nm_new_label['ultimoaudiocampanha']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_datainclusaoproduto_line" id="hidden_field_data_datainclusaoproduto" style="<?php echo $sStyleHidden_datainclusaoproduto; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_datainclusaoproduto_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_datainclusaoproduto_label"><span id="id_label_datainclusaoproduto"><?php echo $this->nm_new_label['datainclusaoproduto']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_reajustedata_line" id="hidden_field_data_reajustedata" style="<?php echo $sStyleHidden_reajustedata; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_reajustedata_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_reajustedata_label"><span id="id_label_reajustedata"><?php echo $this->nm_new_label['reajustedata']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_qtdinvalido_line" id="hidden_field_data_qtdinvalido" style="<?php echo $sStyleHidden_qtdinvalido; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_qtdinvalido_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_qtdinvalido_label"><span id="id_label_qtdinvalido"><?php echo $this->nm_new_label['qtdinvalido']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_data_higienizacao_line" id="hidden_field_data_data_higienizacao" style="<?php echo $sStyleHidden_data_higienizacao; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_data_higienizacao_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_data_higienizacao_label"><span id="id_label_data_higienizacao"><?php echo $this->nm_new_label['data_higienizacao']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_status_higienizacao_line" id="hidden_field_data_status_higienizacao" style="<?php echo $sStyleHidden_status_higienizacao; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_status_higienizacao_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_status_higienizacao_label"><span id="id_label_status_higienizacao"><?php echo $this->nm_new_label['status_higienizacao']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_higienizado_line" id="hidden_field_data_higienizado" style="<?php echo $sStyleHidden_higienizado; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_higienizado_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_higienizado_label"><span id="id_label_higienizado"><?php echo $this->nm_new_label['higienizado']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ligou_line" id="hidden_field_data_ligou" style="<?php echo $sStyleHidden_ligou; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ligou_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ligou_label"><span id="id_label_ligou"><?php echo $this->nm_new_label['ligou']; ?></span></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_contribuinte_1_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_contribuinte_1_mob");
 parent.scAjaxDetailHeight("form_contribuinte_1_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte_1_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
