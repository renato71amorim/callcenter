...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_dataaniv_hora' + iSeqRow).bind('blur', function() { sc_form_contribuinte_1_dataaniv_hora_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_contribuinte_1_dataaniv_hora_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_datalistagem_hora' + iSeqRow).bind('blur', function() { sc_form_contribuinte_1_datalistagem_hora_onblur(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_contribuinte_1_datalistagem_hora_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_datainclusaoproduto_hora' + iSeqRow).bind('blur', function() { sc_form_contribuinte_1_datainclusaoproduto_hora_onblur(this, iSeqRow) })
                                                      .bind('focus', function() { sc_form_contribuinte_1_datainclusaoproduto_hora_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_reajustedata_hora' + iSeqRow).bind('blur', function() { sc_form_contribuinte_1_reajustedata_hora_onblur(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_contribuinte_1_reajustedata_hora_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_data_higienizacao_hora' + iSeqRow).bind('blur', function() { sc_form_contribuinte_1_data_higienizacao_hora_onblur(this, iSeqRow) })
                                                    .bind('focus', function() { sc_form_contribuinte_1_data_higienizacao_hora_onfocus(this, iSeqRow) });
...
function sc_form_contribuinte_1_dataaniv_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_contribuinte_1_validate_dataaniv();
  scCssBlur(oThis);
}
...
function sc_form_contribuinte_1_dataaniv_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_contribuinte_1_datalistagem_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_contribuinte_1_validate_datalistagem();
  scCssBlur(oThis);
}
...
function sc_form_contribuinte_1_datalistagem_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_contribuinte_1_datainclusaoproduto_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_contribuinte_1_validate_datainclusaoproduto();
  scCssBlur(oThis);
}
...
function sc_form_contribuinte_1_datainclusaoproduto_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_contribuinte_1_reajustedata_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_contribuinte_1_validate_reajustedata();
  scCssBlur(oThis);
}
...
function sc_form_contribuinte_1_reajustedata_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_contribuinte_1_data_higienizacao_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_contribuinte_1_validate_data_higienizacao();
  scCssBlur(oThis);
}
...
function sc_form_contribuinte_1_data_higienizacao_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_contribuinte_1_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_dataaniv" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_contribuinte_1_validate_dataaniv(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_datalistagem" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_contribuinte_1_validate_datalistagem(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_datainclusaoproduto" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_contribuinte_1_validate_datainclusaoproduto(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_reajustedata" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_contribuinte_1_validate_reajustedata(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_data_higienizacao" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_contribuinte_1_validate_data_higienizacao(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
