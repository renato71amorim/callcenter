  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_vicidial_list_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_vicidial_list_mob_form();
	}

  // ---------- Validate sc_field_1
  function do_ajax_form_vicidial_list_mob_validate_sc_field_1()
  {
    var nomeCampo_sc_field_1 = "sc_field_1";
    var var_sc_field_1 = scAjaxGetFieldText(nomeCampo_sc_field_1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_mob_validate_sc_field_1(var_sc_field_1, var_script_case_init, do_ajax_form_vicidial_list_mob_validate_sc_field_1_cb);
  } // do_ajax_form_vicidial_list_mob_validate_sc_field_1

  function do_ajax_form_vicidial_list_mob_validate_sc_field_1_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_mob_validate_sc_field_1_cb

  // ---------- Validate comments
  function do_ajax_form_vicidial_list_mob_validate_comments()
  {
    var nomeCampo_comments = "comments";
    var var_comments = scAjaxGetFieldHidden(nomeCampo_comments);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_mob_validate_comments(var_comments, var_script_case_init, do_ajax_form_vicidial_list_mob_validate_comments_cb);
  } // do_ajax_form_vicidial_list_mob_validate_comments

  function do_ajax_form_vicidial_list_mob_validate_comments_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_mob_validate_comments_cb

  // ---------- Validate modify_date
  function do_ajax_form_vicidial_list_mob_validate_modify_date()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_mob_validate_modify_date(var_modify_date, var_modify_date_hora, var_script_case_init, do_ajax_form_vicidial_list_mob_validate_modify_date_cb);
  } // do_ajax_form_vicidial_list_mob_validate_modify_date

  function do_ajax_form_vicidial_list_mob_validate_modify_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_mob_validate_modify_date_cb

  // ---------- Validate user
  function do_ajax_form_vicidial_list_mob_validate_user()
  {
    var nomeCampo_user = "user";
    var var_user = scAjaxGetFieldHidden(nomeCampo_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_mob_validate_user(var_user, var_script_case_init, do_ajax_form_vicidial_list_mob_validate_user_cb);
  } // do_ajax_form_vicidial_list_mob_validate_user

  function do_ajax_form_vicidial_list_mob_validate_user_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_mob_validate_user_cb

  // ---------- Validate phone_number
  function do_ajax_form_vicidial_list_mob_validate_phone_number()
  {
    var nomeCampo_phone_number = "phone_number";
    var var_phone_number = scAjaxGetFieldText(nomeCampo_phone_number);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_mob_validate_phone_number(var_phone_number, var_script_case_init, do_ajax_form_vicidial_list_mob_validate_phone_number_cb);
  } // do_ajax_form_vicidial_list_mob_validate_phone_number

  function do_ajax_form_vicidial_list_mob_validate_phone_number_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_mob_validate_phone_number_cb

  // ---------- Validate alt_phone
  function do_ajax_form_vicidial_list_mob_validate_alt_phone()
  {
    var nomeCampo_alt_phone = "alt_phone";
    var var_alt_phone = scAjaxGetFieldText(nomeCampo_alt_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_mob_validate_alt_phone(var_alt_phone, var_script_case_init, do_ajax_form_vicidial_list_mob_validate_alt_phone_cb);
  } // do_ajax_form_vicidial_list_mob_validate_alt_phone

  function do_ajax_form_vicidial_list_mob_validate_alt_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_mob_validate_alt_phone_cb

  // ---------- Validate email
  function do_ajax_form_vicidial_list_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_mob_validate_email(var_email, var_script_case_init, do_ajax_form_vicidial_list_mob_validate_email_cb);
  } // do_ajax_form_vicidial_list_mob_validate_email

  function do_ajax_form_vicidial_list_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_mob_validate_email_cb

  // ---------- Validate status
  function do_ajax_form_vicidial_list_mob_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_mob_validate_status(var_status, var_script_case_init, do_ajax_form_vicidial_list_mob_validate_status_cb);
  } // do_ajax_form_vicidial_list_mob_validate_status

  function do_ajax_form_vicidial_list_mob_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_mob_validate_status_cb

  // ---------- Validate gender
  function do_ajax_form_vicidial_list_mob_validate_gender()
  {
    var nomeCampo_gender = "gender";
    var var_gender = scAjaxGetFieldSelect(nomeCampo_gender);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_mob_validate_gender(var_gender, var_script_case_init, do_ajax_form_vicidial_list_mob_validate_gender_cb);
  } // do_ajax_form_vicidial_list_mob_validate_gender

  function do_ajax_form_vicidial_list_mob_validate_gender_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "gender";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_mob_validate_gender_cb

  // ---------- Validate first_name
  function do_ajax_form_vicidial_list_mob_validate_first_name()
  {
    var nomeCampo_first_name = "first_name";
    var var_first_name = scAjaxGetFieldText(nomeCampo_first_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_mob_validate_first_name(var_first_name, var_script_case_init, do_ajax_form_vicidial_list_mob_validate_first_name_cb);
  } // do_ajax_form_vicidial_list_mob_validate_first_name

  function do_ajax_form_vicidial_list_mob_validate_first_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_mob_validate_first_name_cb

  // ---------- Validate postal_code
  function do_ajax_form_vicidial_list_mob_validate_postal_code()
  {
    var nomeCampo_postal_code = "postal_code";
    var var_postal_code = scAjaxGetFieldText(nomeCampo_postal_code);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_mob_validate_postal_code(var_postal_code, var_script_case_init, do_ajax_form_vicidial_list_mob_validate_postal_code_cb);
  } // do_ajax_form_vicidial_list_mob_validate_postal_code

  function do_ajax_form_vicidial_list_mob_validate_postal_code_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_mob_validate_postal_code_cb

  // ---------- Validate address1
  function do_ajax_form_vicidial_list_mob_validate_address1()
  {
    var nomeCampo_address1 = "address1";
    var var_address1 = scAjaxGetFieldText(nomeCampo_address1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_mob_validate_address1(var_address1, var_script_case_init, do_ajax_form_vicidial_list_mob_validate_address1_cb);
  } // do_ajax_form_vicidial_list_mob_validate_address1

  function do_ajax_form_vicidial_list_mob_validate_address1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_mob_validate_address1_cb

  // ---------- Validate middle_initial
  function do_ajax_form_vicidial_list_mob_validate_middle_initial()
  {
    var nomeCampo_middle_initial = "middle_initial";
    var var_middle_initial = scAjaxGetFieldText(nomeCampo_middle_initial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_mob_validate_middle_initial(var_middle_initial, var_script_case_init, do_ajax_form_vicidial_list_mob_validate_middle_initial_cb);
  } // do_ajax_form_vicidial_list_mob_validate_middle_initial

  function do_ajax_form_vicidial_list_mob_validate_middle_initial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_mob_validate_middle_initial_cb

  // ---------- Validate address2
  function do_ajax_form_vicidial_list_mob_validate_address2()
  {
    var nomeCampo_address2 = "address2";
    var var_address2 = scAjaxGetFieldText(nomeCampo_address2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_mob_validate_address2(var_address2, var_script_case_init, do_ajax_form_vicidial_list_mob_validate_address2_cb);
  } // do_ajax_form_vicidial_list_mob_validate_address2

  function do_ajax_form_vicidial_list_mob_validate_address2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_mob_validate_address2_cb

  // ---------- Validate address3
  function do_ajax_form_vicidial_list_mob_validate_address3()
  {
    var nomeCampo_address3 = "address3";
    var var_address3 = scAjaxGetFieldText(nomeCampo_address3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_mob_validate_address3(var_address3, var_script_case_init, do_ajax_form_vicidial_list_mob_validate_address3_cb);
  } // do_ajax_form_vicidial_list_mob_validate_address3

  function do_ajax_form_vicidial_list_mob_validate_address3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_mob_validate_address3_cb

  // ---------- Validate source_id
  function do_ajax_form_vicidial_list_mob_validate_source_id()
  {
    var nomeCampo_source_id = "source_id";
    var var_source_id = scAjaxGetFieldText(nomeCampo_source_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_mob_validate_source_id(var_source_id, var_script_case_init, do_ajax_form_vicidial_list_mob_validate_source_id_cb);
  } // do_ajax_form_vicidial_list_mob_validate_source_id

  function do_ajax_form_vicidial_list_mob_validate_source_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_mob_validate_source_id_cb

  // ---------- Validate city
  function do_ajax_form_vicidial_list_mob_validate_city()
  {
    var nomeCampo_city = "city";
    var var_city = scAjaxGetFieldText(nomeCampo_city);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_mob_validate_city(var_city, var_script_case_init, do_ajax_form_vicidial_list_mob_validate_city_cb);
  } // do_ajax_form_vicidial_list_mob_validate_city

  function do_ajax_form_vicidial_list_mob_validate_city_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "city";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_mob_validate_city_cb

  // ---------- Validate state
  function do_ajax_form_vicidial_list_mob_validate_state()
  {
    var nomeCampo_state = "state";
    var var_state = scAjaxGetFieldText(nomeCampo_state);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_mob_validate_state(var_state, var_script_case_init, do_ajax_form_vicidial_list_mob_validate_state_cb);
  } // do_ajax_form_vicidial_list_mob_validate_state

  function do_ajax_form_vicidial_list_mob_validate_state_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "state";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_mob_validate_state_cb

  // ---------- Validate country_code
  function do_ajax_form_vicidial_list_mob_validate_country_code()
  {
    var nomeCampo_country_code = "country_code";
    var var_country_code = scAjaxGetFieldText(nomeCampo_country_code);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_mob_validate_country_code(var_country_code, var_script_case_init, do_ajax_form_vicidial_list_mob_validate_country_code_cb);
  } // do_ajax_form_vicidial_list_mob_validate_country_code

  function do_ajax_form_vicidial_list_mob_validate_country_code_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_mob_validate_country_code_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_vicidial_list_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_vicidial_list_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_country_code = scAjaxGetFieldText("country_code");
    ...
    scAjaxProcOn();
    x_ajax_form_vicidial_list_mob_submit_form(var_sc_field_1, var_comments, var_modify_date, var_modify_date_hora, var_user, var_phone_number, var_alt_phone, var_email, var_status, var_gender, var_first_name, var_postal_code, var_address1, var_middle_initial, var_address2, var_address3, var_source_id, var_city, var_state, var_country_code, var_lead_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_vicidial_list_mob_submit_form_cb);
  } // do_ajax_form_vicidial_list_mob_submit_form

  function do_ajax_form_vicidial_list_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_vicidial_list_mob_submit_form_cb_after_alert);
  } // do_ajax_form_vicidial_list_mob_submit_form_cb
  function do_ajax_form_vicidial_list_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_vicidial_list_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_vicidial_list_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_vicidial_list_mob_navigate_form(var_lead_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_vicidial_list_mob_navigate_form_cb);
  } // do_ajax_form_vicidial_list_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_vicidial_list_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_vicidial_list_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_vicidial_list_mob_navigate_form_cb
  function do_ajax_form_vicidial_list_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_vicidial_list_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_vicidial_list_mob_navigate_form_cb_after_alert
  function sc_hide_form_vicidial_list_mob_form()
  {
  ...
  ajax_field_list[0] = "sc_field_1";
  ajax_field_list[1] = "comments";
  ajax_field_list[2] = "modify_date";
  ajax_field_list[3] = "user";
  ajax_field_list[4] = "phone_number";
  ajax_field_list[5] = "alt_phone";
  ...
  var ajax_error_list = {
    "sc_field_1": {"label": "Informação", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
