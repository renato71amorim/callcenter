...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form/form_vicidial_list_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_vicidial_list_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_vicidial_list_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_vicidial_list_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_vicidial_list'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_vicidial_list'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
   if (!isset($this->nmgp_cmp_hidden['country_code']))
   {
       $this->nmgp_cmp_hidden['country_code'] = 'off';
   }
?>
<TABLE align="center" id="hidden_bloco_0" class="scFormTable" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['sc_field_1'] = "Informação";
    }
?>
<?php
...
<?php
$sc_field_1_val = str_replace('<br />', '__SC_BREAK_LINE__', nl2br($sc_field_1));
...
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["sc_field_1"]) &&  $this->nmgp_cmp_readonly["sc_field_1"] == "on") { 
 ...
 ?>
<input type="hidden" name="sc_field_1" value="<?php echo $this->form_encode_input($sc_field_1) . "\">" . $sc_field_1_val . ""; ?>
<?php } else { ?>
<span id="id_read_on_sc_field_1" class="sc-ui-readonly-sc_field_1 css_sc_field_1_line" style="<?php echo $sStyleReadLab_sc_field_1; ?>"><?php echo $sc_field_1_val; ?></span><span id="id_read_off_sc_field_1" class="css_read_off_sc_field_1" style="white-space: nowrap;<?php echo $sStyleReadInp_sc_field_1; ?>">
 <textarea  class="sc-js-input scFormObjectOdd css_sc_field_1_obj" style="white-space: pre-wrap;" name="sc_field_1" id="id_sc_field_sc_field_1" rows="2" cols="50"
 alt="{datatype: 'text', maxLength: 20, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: 'Use esta tela apenas para mudar o status! Demais alterações somente em fichas doadas.', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" >
<?php echo $sc_field_1; ?>
</textarea>
</span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_comments_line" id="hidden_field_data_comments" style="<?php echo $sStyleHidden_comments; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_comments_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_comments_label"><span id="id_label_comments"><?php echo $this->nm_new_label['comments']; ?></span></span><br><input type="hidden" name="comments" value="<?php echo $this->form_encode_input($comments); ?>"><span id="id_ajax_label_comments"><?php echo nl2br($comments); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_modify_date_hora_line" id="hidden_field_data_modify_date" style="<?php echo $sStyleHidden_modify_date; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_modify_date_hora_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_modify_date_label"><span id="id_label_modify_date"><?php echo $this->nm_new_label['modify_date']; ?></span></span><br><input type="hidden" name="modify_date" value="<?php echo $this->form_encode_input($modify_date); ?>"><span id="id_ajax_label_modify_date"><?php echo nl2br($modify_date); ?></span>
<?php
...
<?php } 
?> 
<?php $sStyleHidden_comments_dumb = ('' == $sStyleHidden_comments) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_comments_dumb" style="<?php echo $sStyleHidden_comments_dumb; ?>"></TD>
<?php $sStyleHidden_modify_date_dumb = ('' == $sStyleHidden_modify_date) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_modify_date_dumb" style="<?php echo $sStyleHidden_modify_date_dumb; ?>"></TD>
<?php $sStyleHidden_user_dumb = ('' == $sStyleHidden_user) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_user_dumb" style="<?php echo $sStyleHidden_user_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_alt_phone_line" id="hidden_field_data_alt_phone" style="<?php echo $sStyleHidden_alt_phone; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_alt_phone_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_alt_phone_label"><span id="id_label_alt_phone"><?php echo $this->nm_new_label['alt_phone']; ?></span></span><br>
...
<?php $sStyleHidden_phone_number_dumb = ('' == $sStyleHidden_phone_number) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_phone_number_dumb" style="<?php echo $sStyleHidden_phone_number_dumb; ?>"></TD>
<?php $sStyleHidden_alt_phone_dumb = ('' == $sStyleHidden_alt_phone) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_alt_phone_dumb" style="<?php echo $sStyleHidden_alt_phone_dumb; ?>"></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['Lookup_gender'][] = 'M'; ?>
 <option  value="F" <?php  if ($this->gender == "F") { echo " selected" ;} ?>>Feminino</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['Lookup_gender'][] = 'F'; ?>
 <option  value="N" <?php  if ($this->gender == "N") { echo " selected" ;} ?>>Não se aplica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['Lookup_gender'][] = 'N'; ?>
 </select></span>
</span><?php  }?>
...
<?php $sStyleHidden_gender_dumb = ('' == $sStyleHidden_gender) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_gender_dumb" style="<?php echo $sStyleHidden_gender_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_first_name_line" id="hidden_field_data_first_name" style="<?php echo $sStyleHidden_first_name; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_first_name_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_first_name_label"><span id="id_label_first_name"><?php echo $this->nm_new_label['first_name']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_postal_code_line" id="hidden_field_data_postal_code" style="<?php echo $sStyleHidden_postal_code; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_postal_code_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_postal_code_label"><span id="id_label_postal_code"><?php echo $this->nm_new_label['postal_code']; ?></span></span><br>
...
<span id="id_read_on_postal_code" class="sc-ui-readonly-postal_code css_postal_code_line" style="<?php echo $sStyleReadLab_postal_code; ?>"><?php echo $this->postal_code; ?></span><span id="id_read_off_postal_code" class="css_read_off_postal_code" style="white-space: nowrap;<?php echo $sStyleReadInp_postal_code; ?>">
 ...
 size=8 maxlength=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php } 
?> 
<?php $sStyleHidden_first_name_dumb = ('' == $sStyleHidden_first_name) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_first_name_dumb" style="<?php echo $sStyleHidden_first_name_dumb; ?>"></TD>
<?php $sStyleHidden_postal_code_dumb = ('' == $sStyleHidden_postal_code) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_postal_code_dumb" style="<?php echo $sStyleHidden_postal_code_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_middle_initial_line" id="hidden_field_data_middle_initial" style="<?php echo $sStyleHidden_middle_initial; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_middle_initial_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_middle_initial_label"><span id="id_label_middle_initial"><?php echo $this->nm_new_label['middle_initial']; ?></span></span><br>
...
<?php $sStyleHidden_middle_initial_dumb = ('' == $sStyleHidden_middle_initial) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_middle_initial_dumb" style="<?php echo $sStyleHidden_middle_initial_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_address2_line" id="hidden_field_data_address2" style="<?php echo $sStyleHidden_address2; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_address2_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_address2_label"><span id="id_label_address2"><?php echo $this->nm_new_label['address2']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_address3_line" id="hidden_field_data_address3" style="<?php echo $sStyleHidden_address3; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_address3_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_address3_label"><span id="id_label_address3"><?php echo $this->nm_new_label['address3']; ?></span></span><br>
...
<?php $sStyleHidden_address3_dumb = ('' == $sStyleHidden_address3) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_address3_dumb" style="<?php echo $sStyleHidden_address3_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_source_id_line" id="hidden_field_data_source_id" style="<?php echo $sStyleHidden_source_id; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_source_id_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_source_id_label"><span id="id_label_source_id"><?php echo $this->nm_new_label['source_id']; ?></span></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_source_id_dumb = ('' == $sStyleHidden_source_id) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_source_id_dumb" style="<?php echo $sStyleHidden_source_id_dumb; ?>"></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_state_line" id="hidden_field_data_state" style="<?php echo $sStyleHidden_state; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_state_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_state_label"><span id="id_label_state"><?php echo $this->nm_new_label['state']; ?></span></span><br>
...
<input type="hidden" name="country_code" value="<?php echo $this->form_encode_input($country_code) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_country_code_line" id="hidden_field_data_country_code" style="<?php echo $sStyleHidden_country_code; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_country_code_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_country_code_label"><span id="id_label_country_code"><?php echo $this->nm_new_label['country_code']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["country_code"]) &&  $this->nmgp_cmp_readonly["country_code"] == "on") { 
 ...
 ?>
<input type="hidden" name="country_code" value="<?php echo $this->form_encode_input($country_code) . "\">" . $country_code . ""; ?>
<?php } else { ?>
<span id="id_read_on_country_code" class="sc-ui-readonly-country_code css_country_code_line" style="<?php echo $sStyleReadLab_country_code; ?>"><?php echo $this->country_code; ?></span><span id="id_read_off_country_code" class="css_read_off_country_code" style="white-space: nowrap;<?php echo $sStyleReadInp_country_code; ?>">
 <input class="sc-js-input scFormObjectOdd css_country_code_obj" style="" id="id_sc_field_country_code" type=text name="country_code" value="<?php echo $this->form_encode_input($country_code) ?>"
...
<?php 
    if ($opcao_botoes != "novo") {
        $sCondStyle = ($this->nmgp_botoes['update'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "balterar", "scBtnFn_sys_format_alt()", "scBtnFn_sys_format_alt()", "sc_b_upd_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-5", "", "");?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_vicidial_list");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_vicidial_list");
 parent.scAjaxDetailHeight("form_vicidial_list", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
