...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_modify_date_hora' + iSeqRow).bind('blur', function() { sc_form_vicidial_list_modify_date_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_vicidial_list_modify_date_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_vicidial_list_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_modify_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_vicidial_list_mob_validate_modify_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_entry_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_vicidial_list_mob_validate_entry_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_date_of_birth" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_vicidial_list_mob_validate_date_of_birth(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_last_local_call_time" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_vicidial_list_mob_validate_last_local_call_time(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
