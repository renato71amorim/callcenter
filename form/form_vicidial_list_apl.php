...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_vicidial_list']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_vicidial_list']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_vicidial_list']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_vicidial_list']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_vicidial_list']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_vicidial_list']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_vicidial_list']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_vicidial_list']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_vicidial_list']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_vicidial_list']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_vicidial_list']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_vicidial_list']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_vicidial_list']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_vicidial_list']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_vicidial_list']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_vicidial_list_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("pt_br");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_vicidial_list']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_vicidial_list']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_vicidial_list'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vicidial_list']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vicidial_list']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_vicidial_list') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vicidial_list']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - vicidial_list";
      ...
      $_SESSION['scriptcase']['error_icon']['form_vicidial_list']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_vicidial_list'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_vicidial_list'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_vicidial_list'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_vicidial_list", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form/form_vicidial_list_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_vicidial_list_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_vicidial_list_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_vicidial_list_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form/form_vicidial_list_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_vicidial_list_erro.class.php"); 
      }
      $this->Erro      = new form_vicidial_list_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['opcao']))
         { 
             if ($this->lead_id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      ...
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['dados_select']['modify_date']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->modify_date = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['dados_select']['modify_date'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['dados_select']['user']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->user = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['dados_select']['user'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_vicidial_list.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_vicidial_list_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_vicidial_list"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       $delim  = "'";
       $delim1 = "'";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['SC_sep_date1'];
       }
       $dt  = $delim . date('Y-m-d H:i:s') . $delim1;
       $usr = isset($_SESSION['usr_login']) ? $_SESSION['usr_login'] : "";
       if (in_array(strtolower($this->Ini->nm_con_unicep['tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Ini->nm_db_unicep->qstr($usr) . ", 'form_vicidial_list', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Ini->nm_db_unicep->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Ini->nm_db_unicep->qstr($usr) . ", 'form_vicidial_list', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Ini->nm_db_unicep->qstr($texto) . ")"; 
       } 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_vicidial_list']) || !is_array($this->NM_ajax_info['errList']['geral_form_vicidial_list']))
              {
                  $this->NM_ajax_info['errList']['geral_form_vicidial_list'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_vicidial_list'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_status(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->status) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['Lookup_status']) && !in_array($this->status, $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['Lookup_status']))
               {
                   $hasError = true;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['lead_id']['keyVal'] = form_vicidial_list_pack_protect_string($this->nmgp_dados_form['lead_id']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['grid_goautodial_recordings_views_script_case_init'] ]['grid_goautodial_recordings_views']['embutida_form_full'] = false;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['grid_goautodial_recordings_views_script_case_init'] ]['grid_goautodial_recordings_views']['embutida_form']       = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['grid_goautodial_recordings_views_script_case_init'] ]['grid_goautodial_recordings_views']['embutida_pai']        = "form_vicidial_list";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['grid_goautodial_recordings_views_script_case_init'] ]['grid_goautodial_recordings_views']['embutida_form_parms'] = "lead_id*scin" . $this->nmgp_dados_form['lead_id'] . "*scoutuser*scin" . $this->nmgp_dados_form['user'] . "*scoutNMSC_inicial*scininicio*scout";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['grid_goautodial_recordings_views_script_case_init'] ]['grid_goautodial_recordings_views']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['grid_goautodial_recordings_views_script_case_init'] ]['grid_goautodial_recordings_views']['total']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['Lookup_status']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['Lookup_status'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['Lookup_status']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['Lookup_status'] = array(); 
}
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_vicidial_list_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_vicidial_list_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['Lookup_status'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['status']['valList'][$i] = form_vicidial_list_pack_protect_string($v);
          }
...
$aLookup[] = array(form_vicidial_list_pack_protect_string('M') => form_vicidial_list_pack_protect_string("Masculino"));
$aLookup[] = array(form_vicidial_list_pack_protect_string('F') => form_vicidial_list_pack_protect_string("Feminino"));
$aLookup[] = array(form_vicidial_list_pack_protect_string('N') => form_vicidial_list_pack_protect_string("Não se aplica"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['Lookup_gender'][] = 'M';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['Lookup_gender'][] = 'F';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['Lookup_gender'][] = 'N';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['gender']['valList'][$i] = form_vicidial_list_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_country_code($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->lead_id)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['opcao'] = '';
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
    ...
    if ("update" == $this->sc_evento && $this->nmgp_opcao != "nada") {
        ...
        $_SESSION['scriptcase']['form_vicidial_list']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_vicidial_list']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['parms'] = "lead_id?#?$this->lead_id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['parms'] = ""; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['dados_select'] = $this->nmgp_dados_select;
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['dados_select'];
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_vicidial_list_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_vicidial_list = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['total'] = $qt_geral_reg_form_vicidial_list;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_vicidial_list_pack_ajax_response();
      ...
      $Nm_datas['entry_date'] = "datetime";$Nm_datas['modify_date'] = "timestamp";$Nm_datas['date_of_birth'] = "date";$Nm_datas['last_local_call_time'] = "datetime";
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (isset($Nm_datas[$campo_join]))
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_vicidial_list_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_vicidial_list_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list']['retorno_edit'] = "";
   }
