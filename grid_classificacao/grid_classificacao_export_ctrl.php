<?php
@session_start() ;
$_SESSION['scriptcase']['grid_classificacao']['sc_process_barr'] = true;
require_once('../grid_classificacao/index.php');
unset($_SESSION['scriptcase']['grid_classificacao']['sc_process_barr']);
$ExportCtrl = new grid_classificacao_export_control;
$ExportCtrl->Export_barr();

class grid_classificacao_export_control
{
