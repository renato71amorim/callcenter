...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_classificacao"]))
   {
      unset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_classificacao"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_classificacao'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_classificacao']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_classificacao']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_classificacao']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_classificacao']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_classificacao']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_classificacao</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_classificacao']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_classificacao']['embutida_filho'] as $ind => $sc_init)
          {
