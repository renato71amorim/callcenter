...
class grid_classificacao_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_classificacao_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_classificacao_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_classificacao_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_classificacao')
      {
          $classificacao = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_classificacao($classificacao);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_classificacao($classificacao)
   {
      $classificacao = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $classificacao);
      $classificacao = substr($this->Db->qstr($classificacao), 1, -1);
            $classificacao_look = substr($this->Db->qstr($classificacao), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct Classificacao from " . $this->Ini->nm_tabela . " where  Classificacao like '%" . $classificacao . "%' order by Classificacao"; 
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - classificacao</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_classificacao/grid_classificacao_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_classificacao_ajax_search.js"></script>
 <script type="text/javascript" src="grid_classificacao_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_classificacao_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_classificacao']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_classificacao']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_classificacao_cond#NMF#' + search_get_sel_txt('SC_classificacao_cond') + '@NMF@';
  str_out += 'SC_classificacao#NMF#' + search_get_text('SC_classificacao') + '@NMF@';
  str_out += 'id_ac_classificacao#NMF#' + search_get_text('id_ac_classificacao') + '@NMF@';
  str_out += 'SC_classificacao_input_2#NMF#' + search_get_text('SC_classificacao_input_2') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_classificacao").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_classificacao",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_classificacao").val(ui.item.value);
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - classificacao</span></td>
...
<?php
   ...
   {
      global 
             $classificacao_cond, $classificacao, $classificacao_input_2, $classificacao_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $classificacao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['campos_busca']['classificacao']; 
          $classificacao_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['campos_busca']['classificacao_input_2']; 
          $classificacao_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['campos_busca']['classificacao_cond']; 
          $descricao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['campos_busca']['descricao']; 
          $descricao_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['campos_busca']['descricao_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['campos_busca']['NM_operador']; 
      } 
      if (!isset($classificacao_cond) || empty($classificacao_cond))
      {
         $classificacao_cond = "gt";
      }
      ...
      $str_hide_classificacao = (in_array($classificacao_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_descricao = (in_array($descricao_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_classificacao = ('bw' == $classificacao_cond) ? $display_aberto : $display_fechado;
      $str_display_descricao = ('bw' == $descricao_cond) ? $display_aberto : $display_fechado;

      if (!isset($classificacao) || $classificacao == "")
      {
          $classificacao = "";
      }
      if (isset($classificacao) && !empty($classificacao))
      {
         $tmp_pos = strpos($classificacao, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $classificacao = substr($classificacao, 0, $tmp_pos);
         }
      }
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_classificacao_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['classificacao'])) ? $this->New_label['classificacao'] : "Classificacao"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_classificacao_cond" name="classificacao_cond" onChange="nm_campos_between(document.getElementById('id_vis_classificacao'), this, 'classificacao')">
       <OPTION value="gt" <?php if ("gt" == $classificacao_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $classificacao_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $classificacao_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $classificacao_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_classificacao" <?php echo $str_hide_classificacao?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['classificacao'])) ? $this->New_label['classificacao'] : "Classificacao";
 $nmgp_tab_label .= "classificacao?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct Classificacao from " . $this->Ini->nm_tabela . " where Classificacao = $classificacao_look order by Classificacao"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct Classificacao from " . $this->Ini->nm_tabela . " where Classificacao = $classificacao_look order by Classificacao"; 
      ...
      if (isset($nmgp_def_dados[0][$classificacao]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$classificacao];
      }
      else
      {
            nmgp_Form_Num_Val($classificacao, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $classificacao;
      }
?>
<INPUT  type="text" id="SC_classificacao" name="classificacao" value="<?php echo NM_encode_input($classificacao) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_classificacao" name="classificacao_autocomp" size="10"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_classificacao"  <?php echo $str_display_classificacao; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_classificacao_input_2" name="classificacao_input_2" value="<?php echo NM_encode_input($classificacao_input_2) ?>"  size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_descricao_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['descricao'])) ? $this->New_label['descricao'] : "Descricao"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_descricao_cond" name="descricao_cond" onChange="nm_campos_between(document.getElementById('id_vis_descricao'), this, 'descricao')">
...
?>
<INPUT  type="text" id="SC_descricao" name="descricao" value="<?php echo NM_encode_input($descricao) ?>"  size=40 alt="{datatype: 'text', maxLength: 40, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_descricao" name="descricao_autocomp" size="40"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 40, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_classificacao_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_classificacao']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_classificacao']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.classificacao_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_classificacao'), document.F1.classificacao_cond, 'classificacao');
   document.F1.classificacao.value = "";
   document.F1.classificacao_autocomp.value = "";
   document.F1.classificacao_input_2.value = "";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "dinamica_publicado/grid_classificacao";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_classificacao_cond'] = 'cond';
      $tp_fields['SC_classificacao'] = 'text_aut';
      $tp_fields['id_ac_classificacao'] = 'text_aut';
      $tp_fields['SC_classificacao_input_2'] = 'text';
   ...
   {
      global $classificacao_cond, $classificacao, $classificacao_input_2, $classificacao_autocomp,
             $descricao_cond, $descricao, $descricao_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($classificacao_autocomp) && empty($classificacao))
      {
          $classificacao = $classificacao_autocomp;
      }
      if (!empty($descricao_autocomp) && empty($descricao))
      {
          $descricao = $descricao_autocomp;
      }
      $classificacao_cond_salva = $classificacao_cond; 
      if (!isset($classificacao_input_2) || $classificacao_input_2 == "")
      {
          $classificacao_input_2 = $classificacao;
      }
      ...
      if ($classificacao_cond != "in")
      {
          nm_limpa_numero($classificacao, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($classificacao_cond != "in")
      {
          nm_limpa_numero($classificacao_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['campos_busca']['classificacao'] = $classificacao; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['campos_busca']['classificacao_input_2'] = $classificacao_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['campos_busca']['classificacao_cond'] = $classificacao_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['campos_busca']['descricao'] = $descricao; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['campos_busca']['descricao_cond'] = $descricao_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['campos_busca'] = $Temp_Busca;
      }
      if ($classificacao_cond != "in" && $classificacao_cond != "bw" && !empty($classificacao) && !is_numeric($classificacao))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Classificacao";
      }
      if ($classificacao_cond == "bw" && ((!empty($classificacao) && !is_numeric($classificacao)) || (!empty($classificacao_input_2) && !is_numeric($classificacao_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Classificacao";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['classificacao'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['classificacao'] = $cmp1;
      }
      else
      {
          $cmp1 = $classificacao;
      ...
      $Conteudo = $classificacao_input_2;
      if (strtoupper($classificacao_cond) != "II" && strtoupper($classificacao_cond) != "QP" && strtoupper($classificacao_cond) != "NP" && strtoupper($classificacao_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['classificacao_input_2'] = $Conteudo;
      $descricao_look = substr($this->Db->qstr($descricao), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Descricao from " . $this->Ini->nm_tabela . " where Descricao = '$descricao_look' order by Descricao"; 
      unset($cmp1,$cmp2);
      ...
      if (isset($classificacao) || $classificacao_cond == "nu" || $classificacao_cond == "nn" || $classificacao_cond == "ep" || $classificacao_cond == "ne")
      {
         $this->monta_condicao("Classificacao", $classificacao_cond, $classificacao, $classificacao_input_2, "classificacao");
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_classificacao']['cond_pesq'] .= $this->NM_operador;
