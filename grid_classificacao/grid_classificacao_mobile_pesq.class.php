...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "classificacao";$Nm_numeric[] = "classificacao";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_classificacao_cond" name="classificacao_cond" onChange="nm_campos_between(document.getElementById('id_vis_classificacao'), this, 'classificacao')">
      ...
      <br><span id="id_hide_classificacao"  <?php echo $str_hide_classificacao?>><?php
      if ($classificacao != "")
      {
      $classificacao_look = substr($this->Db->qstr($classificacao), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_classificacao" name="classificacao_autocomp" size="10"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_classificacao"  <?php echo $str_display_classificacao; ?> class="scFilterFieldFontOdd">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_descricao_cond" name="descricao_cond" onChange="nm_campos_between(document.getElementById('id_vis_descricao'), this, 'descricao')">
