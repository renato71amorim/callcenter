...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - desc_status</TITLE>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_status_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['status'])) ? $this->New_label['status'] : "Status"; ?></TD>
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_status" name="status_autocomp" size="10"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
       ...
       <TR valign="top">
        <TD id="id_vis_status"  <?php echo $str_display_status; ?> class="scFilterFieldFontOdd">
