<?php
@session_start() ;
$_SESSION['scriptcase']['grid_desc_status']['sc_process_barr'] = true;
require_once('../grid_desc_status/index.php');
unset($_SESSION['scriptcase']['grid_desc_status']['sc_process_barr']);
$ExportCtrl = new grid_desc_status_export_control;
$ExportCtrl->Export_barr();

class grid_desc_status_export_control
{
