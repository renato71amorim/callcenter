...
<?php
   ...
   $Ord_Cmp = new grid_doacoes_auditar_1_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_doacoes_auditar_1_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['codigoidentificador'] = "CodigoIdentificador";
   $tab_labels["codigoidentificador"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['labels']["codigoidentificador"])) ? $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['labels']["codigoidentificador"] : "Codigo Identificador";
   $tab_ger_campos['codigo'] = "on";
   $tab_def_campos['codigo'] = "Codigo";
   $tab_labels["codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['labels']["codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['labels']["codigo"] : "Codigo";
   $tab_ger_campos['nome'] = "on";
   $tab_def_campos['nome'] = "Nome";
   $tab_labels["nome"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['labels']["nome"])) ? $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['labels']["nome"] : "Nome";
   $tab_ger_campos['sexo'] = "on";
   $tab_def_campos['sexo'] = "Sexo";
   $tab_labels["sexo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['labels']["sexo"])) ? $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['labels']["sexo"] : "Sexo";
   $tab_ger_campos['tipo'] = "on";
   $tab_def_campos['tipo'] = "Tipo";
   $tab_labels["tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['labels']["tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['labels']["tipo"] : "Tipo";
   $tab_ger_campos['ddd'] = "on";
   $tab_def_campos['ddd'] = "DDD";
   $tab_labels["ddd"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['labels']["ddd"])) ? $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['labels']["ddd"] : "DDD";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['ordem_quebra'] as $campo => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_doacoes_auditar_1_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar_1']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
