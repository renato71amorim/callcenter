...
class grid_doacoes_auditar_1_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_doacoes_auditar_1_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_doacoes_auditar_1_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_doacoes_auditar_1_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_sexo($sexo)
   {
      ...
      $nm_comando = "select distinct Sexo from " . $this->Ini->nm_tabela . " where  Sexo like '%" . $sexo . "%' order by Sexo"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_codigoidentificador($codigoidentificador)
   {
      ...
      {
          $nm_comando = "select distinct CodigoIdentificador from " . $this->Ini->nm_tabela . " where  CodigoIdentificador like '%" . $codigoidentificador . "%' order by CodigoIdentificador"; 
      }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - doacoes_auditar</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_doacoes_auditar_1/grid_doacoes_auditar_1_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_doacoes_auditar_1_ajax_search.js"></script>
 <script type="text/javascript" src="grid_doacoes_auditar_1_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_doacoes_auditar_1_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_doacoes_auditar_1']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_doacoes_auditar_1']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - doacoes_auditar</span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $sexo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca']['sexo']; 
          $sexo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca']['sexo_cond']; 
          $codigoidentificador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca']['codigoidentificador']; 
          $codigoidentificador_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca']['codigoidentificador_input_2']; 
          $codigoidentificador_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca']['codigoidentificador_cond']; 
          $codigo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca']['codigo']; 
          $codigo_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca']['codigo_input_2']; 
          $codigo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca']['codigo_cond']; 
          $nome = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca']['nome']; 
          $nome_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca']['nome_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca']['NM_operador']; 
      } 
...
<?php
      ...
      $sexo_look = substr($this->Db->qstr($sexo), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Sexo from " . $this->Ini->nm_tabela . " where Sexo = '$sexo_look' order by Sexo"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct CodigoIdentificador from " . $this->Ini->nm_tabela . " where CodigoIdentificador = $codigoidentificador_look order by CodigoIdentificador"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct CodigoIdentificador from " . $this->Ini->nm_tabela . " where CodigoIdentificador = $codigoidentificador_look order by CodigoIdentificador"; 
...
?>
<?php
   if (is_file("grid_doacoes_auditar_1_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_doacoes_auditar_1']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_doacoes_auditar_1']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['orig_pesq'] == "grid")
   {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "dinamica_publicado/grid_doacoes_auditar_1";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_doacoes_auditar_1/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function trata_campos()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca']['sexo'] = $sexo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca']['sexo_cond'] = $sexo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca']['codigoidentificador'] = $codigoidentificador; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca']['codigoidentificador_input_2'] = $codigoidentificador_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca']['codigoidentificador_cond'] = $codigoidentificador_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca']['codigo'] = $codigo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca']['codigo_input_2'] = $codigo_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca']['codigo_cond'] = $codigo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca']['nome'] = $nome; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca']['nome_cond'] = $nome_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca'] = $Temp_Busca;
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar_1']['cond_pesq'] .= $this->NM_operador;
