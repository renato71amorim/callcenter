...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_doacoes_auditar_1"]))
   {
      unset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_doacoes_auditar_1"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_doacoes_auditar_2'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_doacoes_auditar_1']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_doacoes_auditar_1']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_doacoes_auditar_1']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_doacoes_auditar_1']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_doacoes_auditar_1']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_doacoes_auditar_1</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_doacoes_auditar_1']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_doacoes_auditar_1']['embutida_filho'] as $ind => $sc_init)
          {
