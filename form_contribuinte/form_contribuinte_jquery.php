...
function displayChange_field_recibo(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_financeiro")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_financeiro")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_contribuinte_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_dataaniv" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_contribuinte_validate_dataaniv(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_datalistagem" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_contribuinte_validate_datalistagem(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_datainclusaoproduto" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_contribuinte_validate_datainclusaoproduto(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_reajustedata" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_contribuinte_validate_reajustedata(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_data_higienizacao" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_contribuinte_validate_data_higienizacao(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
