  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_contribuinte" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_contribuinte_form();
	}

  // ---------- Validate codigo
  function do_ajax_form_contribuinte_validate_codigo()
  {
    var nomeCampo_codigo = "codigo";
    var var_codigo = scAjaxGetFieldText(nomeCampo_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contribuinte_validate_codigo(var_codigo, var_script_case_init, do_ajax_form_contribuinte_validate_codigo_cb);
  } // do_ajax_form_contribuinte_validate_codigo

  function do_ajax_form_contribuinte_validate_codigo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contribuinte_validate_codigo_cb

  // ---------- Validate ddd
  function do_ajax_form_contribuinte_validate_ddd()
  {
    var nomeCampo_ddd = "ddd";
    var var_ddd = scAjaxGetFieldText(nomeCampo_ddd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contribuinte_validate_ddd(var_ddd, var_script_case_init, do_ajax_form_contribuinte_validate_ddd_cb);
  } // do_ajax_form_contribuinte_validate_ddd

  function do_ajax_form_contribuinte_validate_ddd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ddd";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contribuinte_validate_ddd_cb

  // ---------- Validate fone1
  function do_ajax_form_contribuinte_validate_fone1()
  {
    var nomeCampo_fone1 = "fone1";
    var var_fone1 = scAjaxGetFieldText(nomeCampo_fone1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contribuinte_validate_fone1(var_fone1, var_script_case_init, do_ajax_form_contribuinte_validate_fone1_cb);
  } // do_ajax_form_contribuinte_validate_fone1

  function do_ajax_form_contribuinte_validate_fone1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fone1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contribuinte_validate_fone1_cb

  // ---------- Validate fone2
  function do_ajax_form_contribuinte_validate_fone2()
  {
    var nomeCampo_fone2 = "fone2";
    var var_fone2 = scAjaxGetFieldText(nomeCampo_fone2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contribuinte_validate_fone2(var_fone2, var_script_case_init, do_ajax_form_contribuinte_validate_fone2_cb);
  } // do_ajax_form_contribuinte_validate_fone2

  function do_ajax_form_contribuinte_validate_fone2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fone2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contribuinte_validate_fone2_cb

  // ---------- Validate tipo
  function do_ajax_form_contribuinte_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldText(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contribuinte_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_contribuinte_validate_tipo_cb);
  } // do_ajax_form_contribuinte_validate_tipo

  function do_ajax_form_contribuinte_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contribuinte_validate_tipo_cb

  // ---------- Validate setor_rua
  function do_ajax_form_contribuinte_validate_setor_rua()
  {
    var nomeCampo_setor_rua = "setor_rua";
    var var_setor_rua = scAjaxGetFieldText(nomeCampo_setor_rua);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contribuinte_validate_setor_rua(var_setor_rua, var_script_case_init, do_ajax_form_contribuinte_validate_setor_rua_cb);
  } // do_ajax_form_contribuinte_validate_setor_rua

  function do_ajax_form_contribuinte_validate_setor_rua_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contribuinte_validate_setor_rua_cb

  // ---------- Validate sounds
  function do_ajax_form_contribuinte_validate_sounds()
  {
    var nomeCampo_sounds = "sounds";
    var var_sounds = scAjaxGetFieldText(nomeCampo_sounds);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contribuinte_validate_sounds(var_sounds, var_script_case_init, do_ajax_form_contribuinte_validate_sounds_cb);
  } // do_ajax_form_contribuinte_validate_sounds

  function do_ajax_form_contribuinte_validate_sounds_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sounds";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contribuinte_validate_sounds_cb

  // ---------- Validate nome
  function do_ajax_form_contribuinte_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contribuinte_validate_nome(var_nome, var_script_case_init, do_ajax_form_contribuinte_validate_nome_cb);
  } // do_ajax_form_contribuinte_validate_nome

  function do_ajax_form_contribuinte_validate_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contribuinte_validate_nome_cb

  // ---------- Validate sexo
  function do_ajax_form_contribuinte_validate_sexo()
  {
    var nomeCampo_sexo = "sexo";
    var var_sexo = scAjaxGetFieldText(nomeCampo_sexo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contribuinte_validate_sexo(var_sexo, var_script_case_init, do_ajax_form_contribuinte_validate_sexo_cb);
  } // do_ajax_form_contribuinte_validate_sexo

  function do_ajax_form_contribuinte_validate_sexo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sexo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contribuinte_validate_sexo_cb

  // ---------- Validate codigorua
  function do_ajax_form_contribuinte_validate_codigorua()
  {
    var nomeCampo_codigorua = "codigorua";
    var var_codigorua = scAjaxGetFieldText(nomeCampo_codigorua);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contribuinte_validate_codigorua(var_codigorua, var_script_case_init, do_ajax_form_contribuinte_validate_codigorua_cb);
  } // do_ajax_form_contribuinte_validate_codigorua

  function do_ajax_form_contribuinte_validate_codigorua_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contribuinte_validate_codigorua_cb

  // ---------- Validate rua
  function do_ajax_form_contribuinte_validate_rua()
  {
    var nomeCampo_rua = "rua";
    var var_rua = scAjaxGetFieldText(nomeCampo_rua);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contribuinte_validate_rua(var_rua, var_script_case_init, do_ajax_form_contribuinte_validate_rua_cb);
  } // do_ajax_form_contribuinte_validate_rua

  function do_ajax_form_contribuinte_validate_rua_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rua";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contribuinte_validate_rua_cb

  // ---------- Validate numero
  function do_ajax_form_contribuinte_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldText(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contribuinte_validate_numero(var_numero, var_script_case_init, do_ajax_form_contribuinte_validate_numero_cb);
  } // do_ajax_form_contribuinte_validate_numero

  function do_ajax_form_contribuinte_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contribuinte_validate_numero_cb

  // ---------- Validate complemento
  function do_ajax_form_contribuinte_validate_complemento()
  {
    var nomeCampo_complemento = "complemento";
    var var_complemento = scAjaxGetFieldText(nomeCampo_complemento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contribuinte_validate_complemento(var_complemento, var_script_case_init, do_ajax_form_contribuinte_validate_complemento_cb);
  } // do_ajax_form_contribuinte_validate_complemento

  function do_ajax_form_contribuinte_validate_complemento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contribuinte_validate_complemento_cb

  // ---------- Validate bairro
  function do_ajax_form_contribuinte_validate_bairro()
  {
    var nomeCampo_bairro = "bairro";
    var var_bairro = scAjaxGetFieldText(nomeCampo_bairro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contribuinte_validate_bairro(var_bairro, var_script_case_init, do_ajax_form_contribuinte_validate_bairro_cb);
  } // do_ajax_form_contribuinte_validate_bairro

  function do_ajax_form_contribuinte_validate_bairro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bairro";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contribuinte_validate_bairro_cb

  // ---------- Validate cep
  function do_ajax_form_contribuinte_validate_cep()
  {
    var nomeCampo_cep = "cep";
    var var_cep = scAjaxGetFieldText(nomeCampo_cep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contribuinte_validate_cep(var_cep, var_script_case_init, do_ajax_form_contribuinte_validate_cep_cb);
  } // do_ajax_form_contribuinte_validate_cep

  function do_ajax_form_contribuinte_validate_cep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cep";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contribuinte_validate_cep_cb

  // ---------- Validate cidade
  function do_ajax_form_contribuinte_validate_cidade()
  {
    var nomeCampo_cidade = "cidade";
    var var_cidade = scAjaxGetFieldText(nomeCampo_cidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contribuinte_validate_cidade(var_cidade, var_script_case_init, do_ajax_form_contribuinte_validate_cidade_cb);
  } // do_ajax_form_contribuinte_validate_cidade

  function do_ajax_form_contribuinte_validate_cidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cidade";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contribuinte_validate_cidade_cb

  // ---------- Validate recibo
  function do_ajax_form_contribuinte_validate_recibo()
  {
    var nomeCampo_recibo = "recibo";
    var var_recibo = scAjaxGetFieldText(nomeCampo_recibo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contribuinte_validate_recibo(var_recibo, var_script_case_init, do_ajax_form_contribuinte_validate_recibo_cb);
  } // do_ajax_form_contribuinte_validate_recibo

  function do_ajax_form_contribuinte_validate_recibo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "recibo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contribuinte_validate_recibo_cb

  // ---------- Event onchange codigorua
  function do_ajax_form_contribuinte_event_codigorua_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_contribuinte_event_codigorua_onchange(var_codigorua, var_rua, var_bairro, var_cidade, var_cep, var_setor_rua, var_script_case_init, do_ajax_form_contribuinte_event_codigorua_onchange_cb);
  } // do_ajax_form_contribuinte_event_codigorua_onchange

  function do_ajax_form_contribuinte_event_codigorua_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "codigorua";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_contribuinte_event_codigorua_onchange_cb_after_alert);
  } // do_ajax_form_contribuinte_event_codigorua_onchange_cb
  function do_ajax_form_contribuinte_event_codigorua_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_contribuinte_event_codigorua_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_contribuinte_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_contribuinte_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_contribuinte_submit_form(var_codigo, var_ddd, var_fone1, var_fone2, var_tipo, var_setor_rua, var_nome, var_sexo, var_codigorua, var_rua, var_numero, var_complemento, var_bairro, var_cep, var_cidade, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_contribuinte_submit_form_cb);
  } // do_ajax_form_contribuinte_submit_form

  function do_ajax_form_contribuinte_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_contribuinte_submit_form_cb_after_alert);
  } // do_ajax_form_contribuinte_submit_form_cb
  function do_ajax_form_contribuinte_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_contribuinte_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_goautodial_recordings_views"] = "off";
  scStatusDetail["form_financeiro"] = "off";

  function do_ajax_form_contribuinte_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scStatusDetail["form_financeiro"] = "on";
    x_ajax_form_contribuinte_navigate_form(var_codigo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_contribuinte_navigate_form_cb);
  } // do_ajax_form_contribuinte_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_contribuinte_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_financeiro"] && "nmsc_iframe_liga_form_financeiro" != scMasterDetailIframe["nmsc_iframe_liga_form_financeiro"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_financeiro"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_financeiro').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_financeiro').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_financeiro').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_contribuinte_navigate_form_cb_after_alert);
  } // do_ajax_form_contribuinte_navigate_form_cb
  function do_ajax_form_contribuinte_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_contribuinte_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_contribuinte_navigate_form_cb_after_alert
  function sc_hide_form_contribuinte_form()
  {
  ...
  function do_ajax_form_contribuinte_lkpedt_refresh_codigorua()
  {
    var var_codigorua = scAjaxGetFieldText("codigorua");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "codigorua";
    x_ajax_form_contribuinte_lkpedt_refresh_codigorua(var_codigorua, nmgp_refresh_fields, var_script_case_init, do_ajax_form_contribuinte_lkpedt_refresh_codigorua_cb);
  } // do_ajax_form_contribuinte_lkpedt_refresh_codigorua

  function do_ajax_form_contribuinte_lkpedt_refresh_codigorua_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_contribuinte_lkpedt_refresh_codigorua_cb
  ...
  {
    if ("off" == scStatusDetail["grid_goautodial_recordings_views"] && "off" == scStatusDetail["form_financeiro"])
    {
      return true;
    }
    return false;
