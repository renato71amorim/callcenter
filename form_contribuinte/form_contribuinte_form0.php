...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_contribuinte_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_contribuinte_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_contribuinte_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_contribuinte'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_contribuinte'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_codigo_line" id="hidden_field_data_codigo" style="<?php echo $sStyleHidden_codigo; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_codigo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_codigo_label"><span id="id_label_codigo"><?php echo $this->nm_new_label['codigo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['php_cmp_required']['codigo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['php_cmp_required']['codigo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sounds'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sounds'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['grid_goautodial_recordings_views_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sounds'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['grid_goautodial_recordings_views_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 if (isset($this->Ini->sc_lig_md5["grid_goautodial_recordings_views"]) && $this->Ini->sc_lig_md5["grid_goautodial_recordings_views"] == "S") {
     ...
     $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_contribuinte@SC_par@" . md5($Parms_Lig);
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
 } else {
     $Md5_Lig  = "codigo*scin" . $this->nmgp_dados_form['codigo'] . "*scoutNMSC_inicial*scininicio*scout";
 }
 $parms_lig_cons = "&nmgp_parms=" . $Md5_Lig;
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_contribuinte_empty.htm' : $this->Ini->link_grid_goautodial_recordings_views_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_sounds']) && 'nmsc_iframe_liga_grid_goautodial_recordings_views' != $this->Ini->sc_lig_target['C_@scinf_sounds'])
{
    ...
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_sounds'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['grid_goautodial_recordings_views_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nome_line" id="hidden_field_data_nome" style="<?php echo $sStyleHidden_nome; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nome_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_codigorua_line" id="hidden_field_data_codigorua" style="<?php echo $sStyleHidden_codigorua; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_codigorua_line" style="vertical-align: top;padding: 0px">
...
<span id="id_read_on_codigorua" class="sc-ui-readonly-codigorua css_codigorua_line" style="<?php echo $sStyleReadLab_codigorua; ?>"><?php echo $this->codigorua; ?></span><span id="id_read_off_codigorua" class="css_read_off_codigorua" style="white-space: nowrap;<?php echo $sStyleReadInp_codigorua; ?>">
 ...
 size=19 maxlength=19 alt="{datatype: 'text', maxLength: 19, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_form_contribuinte*scout' : '';
...
<?php if (!$this->Ini->Export_img_zip) { ?><?php echo nmButtonOutput($this->arr_buttons, "bform_captura", "scModalCapture('" . $this->Ini->link_grid_ruas_cons_psq . "?script_case_init=" . $this->Ini->sc_page . "&script_case_session=" . session_id() . "&nmgp_parms=" . $Md5_Lig . "&SC_lig_apl_orig=form_contribuinte&KeepThis=true&TB_iframe=true&height=440&width=630&modal=true')", "scModalCapture('" . $this->Ini->link_grid_ruas_cons_psq . "?script_case_init=" . $this->Ini->sc_page . "&script_case_session=" . session_id() . "&nmgp_parms=" . $Md5_Lig . "&SC_lig_apl_orig=form_contribuinte&KeepThis=true&TB_iframe=true&height=440&width=630&modal=true')", "cap_codigorua", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php } ?>
<?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rua_line" id="hidden_field_data_rua" style="<?php echo $sStyleHidden_rua; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rua_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_numero_line" id="hidden_field_data_numero" style="<?php echo $sStyleHidden_numero; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_numero_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_complemento_line" id="hidden_field_data_complemento" style="<?php echo $sStyleHidden_complemento; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_complemento_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_bairro_line" id="hidden_field_data_bairro" style="<?php echo $sStyleHidden_bairro; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_bairro_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cidade_line" id="hidden_field_data_cidade" style="<?php echo $sStyleHidden_cidade; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cidade_line" style="vertical-align: top;padding: 0px">
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_recibo'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_recibo'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['form_financeiro_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_recibo'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['form_financeiro_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['form_financeiro_script_case_init'] ]['form_financeiro']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['form_financeiro_script_case_init'] ]['form_financeiro']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['form_financeiro_script_case_init'] ]['form_financeiro']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['form_financeiro_script_case_init'] ]['form_financeiro']['embutida_multi'] = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['form_financeiro_script_case_init'] ]['form_financeiro']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['form_financeiro_script_case_init'] ]['form_financeiro']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['form_financeiro_script_case_init'] ]['form_financeiro']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['form_financeiro_script_case_init'] ]['form_financeiro']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['form_financeiro_script_case_init'] ]['form_financeiro']['embutida_liga_grid_edit'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['form_financeiro_script_case_init'] ]['form_financeiro']['embutida_liga_grid_edit_link'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['form_financeiro_script_case_init'] ]['form_financeiro']['embutida_liga_qtd_reg'] = '3';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['form_financeiro_script_case_init'] ]['form_financeiro']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['form_financeiro_script_case_init'] ]['form_contribuinte']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_contribuinte_empty.htm' : $this->Ini->link_form_financeiro_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_recibo']) && 'nmsc_iframe_liga_form_financeiro' != $this->Ini->sc_lig_target['C_@scinf_recibo'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_recibo'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['form_financeiro_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_financeiro"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_financeiro"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_contribuinte");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_contribuinte");
 parent.scAjaxDetailHeight("form_contribuinte", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_contribuinte']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
