...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["sounds" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
  ...
  scEventControl_data["rua" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
  ...
  scEventControl_data["recibo" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
}
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["sounds" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["sounds" + iSeqRow]["change"]) {
    return true;
  }
  ...
  if (scEventControl_data["recibo" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["recibo" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_codigo' + iSeqRow).bind('blur', function() { sc_form_contribuinte_codigo_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_contribuinte_codigo_onfocus(this, iSeqRow) });
  $('#id_sc_field_nome' + iSeqRow).bind('blur', function() { sc_form_contribuinte_nome_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_contribuinte_nome_onfocus(this, iSeqRow) });
  $('#id_sc_field_codigorua' + iSeqRow).bind('blur', function() { sc_form_contribuinte_codigorua_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_contribuinte_codigorua_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_contribuinte_codigorua_onfocus(this, iSeqRow) });
  $('#id_sc_field_numero' + iSeqRow).bind('blur', function() { sc_form_contribuinte_numero_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_contribuinte_numero_onfocus(this, iSeqRow) });
  $('#id_sc_field_complemento' + iSeqRow).bind('blur', function() { sc_form_contribuinte_complemento_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_contribuinte_complemento_onfocus(this, iSeqRow) });
  $('#id_sc_field_tipo' + iSeqRow).bind('blur', function() { sc_form_contribuinte_tipo_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_contribuinte_tipo_onfocus(this, iSeqRow) });
  $('#id_sc_field_sexo' + iSeqRow).bind('blur', function() { sc_form_contribuinte_sexo_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_contribuinte_sexo_onfocus(this, iSeqRow) });
  $('#id_sc_field_fone1' + iSeqRow).bind('blur', function() { sc_form_contribuinte_fone1_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_contribuinte_fone1_onfocus(this, iSeqRow) });
  $('#id_sc_field_fone2' + iSeqRow).bind('blur', function() { sc_form_contribuinte_fone2_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_contribuinte_fone2_onfocus(this, iSeqRow) });
  $('#id_sc_field_ddd' + iSeqRow).bind('blur', function() { sc_form_contribuinte_ddd_onblur(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_contribuinte_ddd_onfocus(this, iSeqRow) });
  $('#id_sc_field_rua' + iSeqRow).bind('blur', function() { sc_form_contribuinte_rua_onblur(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_contribuinte_rua_onfocus(this, iSeqRow) });
  $('#id_sc_field_bairro' + iSeqRow).bind('blur', function() { sc_form_contribuinte_bairro_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_contribuinte_bairro_onfocus(this, iSeqRow) });
  $('#id_sc_field_cep' + iSeqRow).bind('blur', function() { sc_form_contribuinte_cep_onblur(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_contribuinte_cep_onfocus(this, iSeqRow) });
  $('#id_sc_field_cidade' + iSeqRow).bind('blur', function() { sc_form_contribuinte_cidade_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_contribuinte_cidade_onfocus(this, iSeqRow) });
  $('#id_sc_field_setor_rua' + iSeqRow).bind('blur', function() { sc_form_contribuinte_setor_rua_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_contribuinte_setor_rua_onfocus(this, iSeqRow) });
  $('#id_sc_field_sounds' + iSeqRow).bind('blur', function() { sc_form_contribuinte_sounds_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_contribuinte_sounds_onfocus(this, iSeqRow) });
  $('#id_sc_field_recibo' + iSeqRow).bind('blur', function() { sc_form_contribuinte_recibo_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_contribuinte_recibo_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_contribuinte_codigo_onblur(oThis, iSeqRow) {
  do_ajax_form_contribuinte_mob_validate_codigo();
  scCssBlur(oThis);
}

function sc_form_contribuinte_codigo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_contribuinte_nome_onblur(oThis, iSeqRow) {
  do_ajax_form_contribuinte_mob_validate_nome();
  scCssBlur(oThis);
}

function sc_form_contribuinte_nome_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_contribuinte_codigorua_onblur(oThis, iSeqRow) {
  do_ajax_form_contribuinte_mob_validate_codigorua();
  scCssBlur(oThis);
}

function sc_form_contribuinte_codigorua_onchange(oThis, iSeqRow) {
  do_ajax_form_contribuinte_mob_event_codigorua_onchange();
}

function sc_form_contribuinte_codigorua_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_contribuinte_numero_onblur(oThis, iSeqRow) {
  do_ajax_form_contribuinte_mob_validate_numero();
  scCssBlur(oThis);
}

function sc_form_contribuinte_numero_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_contribuinte_complemento_onblur(oThis, iSeqRow) {
  do_ajax_form_contribuinte_mob_validate_complemento();
  scCssBlur(oThis);
}

function sc_form_contribuinte_complemento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_contribuinte_tipo_onblur(oThis, iSeqRow) {
  do_ajax_form_contribuinte_mob_validate_tipo();
  scCssBlur(oThis);
}

function sc_form_contribuinte_tipo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_contribuinte_sexo_onblur(oThis, iSeqRow) {
  do_ajax_form_contribuinte_mob_validate_sexo();
  scCssBlur(oThis);
}

function sc_form_contribuinte_sexo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_contribuinte_fone1_onblur(oThis, iSeqRow) {
  do_ajax_form_contribuinte_mob_validate_fone1();
  scCssBlur(oThis);
}

function sc_form_contribuinte_fone1_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_contribuinte_fone2_onblur(oThis, iSeqRow) {
  do_ajax_form_contribuinte_mob_validate_fone2();
  scCssBlur(oThis);
}

function sc_form_contribuinte_fone2_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_contribuinte_ddd_onblur(oThis, iSeqRow) {
  do_ajax_form_contribuinte_mob_validate_ddd();
  scCssBlur(oThis);
}

function sc_form_contribuinte_ddd_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_contribuinte_rua_onblur(oThis, iSeqRow) {
  do_ajax_form_contribuinte_mob_validate_rua();
  scCssBlur(oThis);
}

function sc_form_contribuinte_rua_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_contribuinte_bairro_onblur(oThis, iSeqRow) {
  do_ajax_form_contribuinte_mob_validate_bairro();
  scCssBlur(oThis);
}

function sc_form_contribuinte_bairro_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_contribuinte_cep_onblur(oThis, iSeqRow) {
  do_ajax_form_contribuinte_mob_validate_cep();
  scCssBlur(oThis);
}

function sc_form_contribuinte_cep_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_contribuinte_cidade_onblur(oThis, iSeqRow) {
  do_ajax_form_contribuinte_mob_validate_cidade();
  scCssBlur(oThis);
}

function sc_form_contribuinte_cidade_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_contribuinte_setor_rua_onblur(oThis, iSeqRow) {
  do_ajax_form_contribuinte_mob_validate_setor_rua();
  scCssBlur(oThis);
}

function sc_form_contribuinte_setor_rua_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_contribuinte_sounds_onblur(oThis, iSeqRow) {
  do_ajax_form_contribuinte_mob_validate_sounds();
  scCssBlur(oThis);
}

function sc_form_contribuinte_sounds_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_contribuinte_recibo_onblur(oThis, iSeqRow) {
  do_ajax_form_contribuinte_mob_validate_recibo();
  scCssBlur(oThis);
}

function sc_form_contribuinte_recibo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_block_1(status) {
	displayChange_field("sounds", "", status);
}
...
function displayChange_block_2(status) {
	...
	displayChange_field("rua", "", status);
...
function displayChange_block_3(status) {
	displayChange_field("recibo", "", status);
}
...
function displayChange_row(row, status) {
	...
	displayChange_field_recibo(row, status);
}
...
function displayChange_field_sounds(row, status) {
...
function displayChange_field_rua(row, status) {
}
...
function displayChange_field_recibo(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_financeiro_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_financeiro_mob")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_contribuinte_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_dataaniv" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_contribuinte_mob_validate_dataaniv(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_datalistagem" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_contribuinte_mob_validate_datalistagem(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_datainclusaoproduto" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_contribuinte_mob_validate_datainclusaoproduto(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_reajustedata" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_contribuinte_mob_validate_reajustedata(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_data_higienizacao" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_contribuinte_mob_validate_data_higienizacao(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
