...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_datacadastro_hora' + iSeqRow).bind('blur', function() { sc_form_operador_datacadastro_onblur(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_operador_datacadastro_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_datasaida_hora' + iSeqRow).bind('blur', function() { sc_form_operador_datasaida_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_operador_datasaida_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_operador_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_datacadastro" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_operador_mob_validate_datacadastro(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_datasaida" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_operador_mob_validate_datasaida(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
