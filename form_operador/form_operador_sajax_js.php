  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_operador" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_operador_form();
	}

  // ---------- Validate codigooperador
  function do_ajax_form_operador_validate_codigooperador()
  {
    var nomeCampo_codigooperador = "codigooperador";
    var var_codigooperador = scAjaxGetFieldText(nomeCampo_codigooperador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operador_validate_codigooperador(var_codigooperador, var_script_case_init, do_ajax_form_operador_validate_codigooperador_cb);
  } // do_ajax_form_operador_validate_codigooperador

  function do_ajax_form_operador_validate_codigooperador_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operador_validate_codigooperador_cb

  // ---------- Validate nome
  function do_ajax_form_operador_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operador_validate_nome(var_nome, var_script_case_init, do_ajax_form_operador_validate_nome_cb);
  } // do_ajax_form_operador_validate_nome

  function do_ajax_form_operador_validate_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operador_validate_nome_cb

  // ---------- Validate tipo
  function do_ajax_form_operador_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldText(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operador_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_operador_validate_tipo_cb);
  } // do_ajax_form_operador_validate_tipo

  function do_ajax_form_operador_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operador_validate_tipo_cb

  // ---------- Validate datacadastro
  function do_ajax_form_operador_validate_datacadastro()
  {
    var nomeCampo_datacadastro = "datacadastro";
    var var_datacadastro = scAjaxGetFieldText(nomeCampo_datacadastro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operador_validate_datacadastro(var_datacadastro, var_script_case_init, do_ajax_form_operador_validate_datacadastro_cb);
  } // do_ajax_form_operador_validate_datacadastro

  function do_ajax_form_operador_validate_datacadastro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operador_validate_datacadastro_cb

  // ---------- Validate central
  function do_ajax_form_operador_validate_central()
  {
    var nomeCampo_central = "central";
    var var_central = scAjaxGetFieldText(nomeCampo_central);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operador_validate_central(var_central, var_script_case_init, do_ajax_form_operador_validate_central_cb);
  } // do_ajax_form_operador_validate_central

  function do_ajax_form_operador_validate_central_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "central";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operador_validate_central_cb

  // ---------- Validate datasaida
  function do_ajax_form_operador_validate_datasaida()
  {
    var nomeCampo_datasaida = "datasaida";
    var var_datasaida = scAjaxGetFieldText(nomeCampo_datasaida);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operador_validate_datasaida(var_datasaida, var_script_case_init, do_ajax_form_operador_validate_datasaida_cb);
  } // do_ajax_form_operador_validate_datasaida

  function do_ajax_form_operador_validate_datasaida_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operador_validate_datasaida_cb

  // ---------- Validate sala
  function do_ajax_form_operador_validate_sala()
  {
    var nomeCampo_sala = "sala";
    var var_sala = scAjaxGetFieldText(nomeCampo_sala);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operador_validate_sala(var_sala, var_script_case_init, do_ajax_form_operador_validate_sala_cb);
  } // do_ajax_form_operador_validate_sala

  function do_ajax_form_operador_validate_sala_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sala";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operador_validate_sala_cb

  // ---------- Validate inativo
  function do_ajax_form_operador_validate_inativo()
  {
    var nomeCampo_inativo = "inativo";
    var var_inativo = scAjaxGetFieldText(nomeCampo_inativo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operador_validate_inativo(var_inativo, var_script_case_init, do_ajax_form_operador_validate_inativo_cb);
  } // do_ajax_form_operador_validate_inativo

  function do_ajax_form_operador_validate_inativo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "inativo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operador_validate_inativo_cb

  // ---------- Validate usuario_automatico
  function do_ajax_form_operador_validate_usuario_automatico()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operador_validate_usuario_automatico(var_usuario_automatico, var_script_case_init, do_ajax_form_operador_validate_usuario_automatico_cb);
  } // do_ajax_form_operador_validate_usuario_automatico

  function do_ajax_form_operador_validate_usuario_automatico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operador_validate_usuario_automatico_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_operador_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_operador_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_operador_submit_form(var_codigooperador, var_nome, var_tipo, var_datacadastro, var_central, var_datasaida, var_sala, var_inativo, var_usuario_automatico, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_operador_submit_form_cb);
  } // do_ajax_form_operador_submit_form

  function do_ajax_form_operador_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_operador_submit_form_cb_after_alert);
  } // do_ajax_form_operador_submit_form_cb
  function do_ajax_form_operador_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_operador_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_operador_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_operador_navigate_form(var_codigooperador, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_operador_navigate_form_cb);
  } // do_ajax_form_operador_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_operador']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_operador_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_operador_navigate_form_cb_after_alert);
  } // do_ajax_form_operador_navigate_form_cb
  function do_ajax_form_operador_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_operador_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_operador_navigate_form_cb_after_alert
  function sc_hide_form_operador_form()
  {
