  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_operador_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_operador_mob_form();
	}

  // ---------- Validate codigooperador
  function do_ajax_form_operador_mob_validate_codigooperador()
  {
    var nomeCampo_codigooperador = "codigooperador";
    var var_codigooperador = scAjaxGetFieldText(nomeCampo_codigooperador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operador_mob_validate_codigooperador(var_codigooperador, var_script_case_init, do_ajax_form_operador_mob_validate_codigooperador_cb);
  } // do_ajax_form_operador_mob_validate_codigooperador

  function do_ajax_form_operador_mob_validate_codigooperador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codigooperador";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operador_mob_validate_codigooperador_cb

  // ---------- Validate nome
  function do_ajax_form_operador_mob_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operador_mob_validate_nome(var_nome, var_script_case_init, do_ajax_form_operador_mob_validate_nome_cb);
  } // do_ajax_form_operador_mob_validate_nome

  function do_ajax_form_operador_mob_validate_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operador_mob_validate_nome_cb

  // ---------- Validate tipo
  function do_ajax_form_operador_mob_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldText(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operador_mob_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_operador_mob_validate_tipo_cb);
  } // do_ajax_form_operador_mob_validate_tipo

  function do_ajax_form_operador_mob_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operador_mob_validate_tipo_cb

  // ---------- Validate datacadastro
  function do_ajax_form_operador_mob_validate_datacadastro()
  {
    var nomeCampo_datacadastro = "datacadastro";
    var var_datacadastro = scAjaxGetFieldText(nomeCampo_datacadastro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operador_mob_validate_datacadastro(var_datacadastro, var_script_case_init, do_ajax_form_operador_mob_validate_datacadastro_cb);
  } // do_ajax_form_operador_mob_validate_datacadastro

  function do_ajax_form_operador_mob_validate_datacadastro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "datacadastro";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operador_mob_validate_datacadastro_cb

  // ---------- Validate central
  function do_ajax_form_operador_mob_validate_central()
  {
    var nomeCampo_central = "central";
    var var_central = scAjaxGetFieldText(nomeCampo_central);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operador_mob_validate_central(var_central, var_script_case_init, do_ajax_form_operador_mob_validate_central_cb);
  } // do_ajax_form_operador_mob_validate_central

  function do_ajax_form_operador_mob_validate_central_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "central";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operador_mob_validate_central_cb

  // ---------- Validate datasaida
  function do_ajax_form_operador_mob_validate_datasaida()
  {
    var nomeCampo_datasaida = "datasaida";
    var var_datasaida = scAjaxGetFieldText(nomeCampo_datasaida);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operador_mob_validate_datasaida(var_datasaida, var_script_case_init, do_ajax_form_operador_mob_validate_datasaida_cb);
  } // do_ajax_form_operador_mob_validate_datasaida

  function do_ajax_form_operador_mob_validate_datasaida_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "datasaida";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operador_mob_validate_datasaida_cb

  // ---------- Validate sala
  function do_ajax_form_operador_mob_validate_sala()
  {
    var nomeCampo_sala = "sala";
    var var_sala = scAjaxGetFieldText(nomeCampo_sala);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operador_mob_validate_sala(var_sala, var_script_case_init, do_ajax_form_operador_mob_validate_sala_cb);
  } // do_ajax_form_operador_mob_validate_sala

  function do_ajax_form_operador_mob_validate_sala_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sala";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operador_mob_validate_sala_cb

  // ---------- Validate inativo
  function do_ajax_form_operador_mob_validate_inativo()
  {
    var nomeCampo_inativo = "inativo";
    var var_inativo = scAjaxGetFieldText(nomeCampo_inativo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operador_mob_validate_inativo(var_inativo, var_script_case_init, do_ajax_form_operador_mob_validate_inativo_cb);
  } // do_ajax_form_operador_mob_validate_inativo

  function do_ajax_form_operador_mob_validate_inativo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "inativo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operador_mob_validate_inativo_cb

  // ---------- Validate usuario_automatico
  function do_ajax_form_operador_mob_validate_usuario_automatico()
  {
    var nomeCampo_usuario_automatico = "usuario_automatico";
    var var_usuario_automatico = scAjaxGetFieldText(nomeCampo_usuario_automatico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operador_mob_validate_usuario_automatico(var_usuario_automatico, var_script_case_init, do_ajax_form_operador_mob_validate_usuario_automatico_cb);
  } // do_ajax_form_operador_mob_validate_usuario_automatico

  function do_ajax_form_operador_mob_validate_usuario_automatico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario_automatico";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operador_mob_validate_usuario_automatico_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_operador_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_operador_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_codigooperador = scAjaxGetFieldText("codigooperador");
    var var_nome = scAjaxGetFieldText("nome");
    var var_tipo = scAjaxGetFieldText("tipo");
    var var_datacadastro = scAjaxGetFieldText("datacadastro");
    var var_central = scAjaxGetFieldText("central");
    var var_datasaida = scAjaxGetFieldText("datasaida");
    var var_sala = scAjaxGetFieldText("sala");
    var var_inativo = scAjaxGetFieldText("inativo");
    var var_usuario_automatico = scAjaxGetFieldText("usuario_automatico");
    ...
    scAjaxProcOn();
    x_ajax_form_operador_mob_submit_form(var_codigooperador, var_nome, var_tipo, var_datacadastro, var_central, var_datasaida, var_sala, var_inativo, var_usuario_automatico, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_operador_mob_submit_form_cb);
  } // do_ajax_form_operador_mob_submit_form

  function do_ajax_form_operador_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("codigooperador");
      scAjaxHideErrorDisplay("nome");
      scAjaxHideErrorDisplay("tipo");
      scAjaxHideErrorDisplay("datacadastro");
      scAjaxHideErrorDisplay("central");
      scAjaxHideErrorDisplay("datasaida");
      scAjaxHideErrorDisplay("sala");
      scAjaxHideErrorDisplay("inativo");
      scAjaxHideErrorDisplay("usuario_automatico");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_operador_mob_submit_form_cb_after_alert);
  } // do_ajax_form_operador_mob_submit_form_cb
  function do_ajax_form_operador_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_operador_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_operador_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("inativo");
    scAjaxHideErrorDisplay("usuario_automatico");
    var var_codigooperador = document.F2.codigooperador.value;
    ...
    scAjaxProcOn();
    x_ajax_form_operador_mob_navigate_form(var_codigooperador, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_operador_mob_navigate_form_cb);
  } // do_ajax_form_operador_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_operador_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_operador_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.codigooperador.value = scAjaxGetKeyValue("codigooperador");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_operador_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_operador_mob_navigate_form_cb
  function do_ajax_form_operador_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_operador_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_operador_mob_navigate_form_cb_after_alert
  function sc_hide_form_operador_mob_form()
  {
  ...
  ajax_field_list[0] = "codigooperador";
  ajax_field_list[1] = "nome";
  ajax_field_list[2] = "tipo";
  ajax_field_list[3] = "datacadastro";
  ajax_field_list[4] = "central";
  ajax_field_list[5] = "datasaida";
  ajax_field_list[6] = "sala";
  ajax_field_list[7] = "inativo";
  ajax_field_list[8] = "usuario_automatico";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "codigooperador": {"label": "Codigo Operador", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "datacadastro": {"label": "Data Cadastro", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "central": {"label": "Central", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "datasaida": {"label": "Data Saida", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sala": {"label": "Sala", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "inativo": {"label": "Inativo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usuario_automatico": {"label": "Usuario Automatico", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "codigooperador": new Array(),
    "nome": new Array(),
    "tipo": new Array(),
    "datacadastro": new Array(),
    "central": new Array(),
    "datasaida": new Array(),
    "sala": new Array(),
    "inativo": new Array(),
    "usuario_automatico": new Array()
  };
  ajax_field_mult["codigooperador"][1] = "codigooperador";
  ajax_field_mult["nome"][1] = "nome";
  ajax_field_mult["tipo"][1] = "tipo";
  ajax_field_mult["datacadastro"][1] = "datacadastro";
  ajax_field_mult["central"][1] = "central";
  ajax_field_mult["datasaida"][1] = "datasaida";
  ajax_field_mult["sala"][1] = "sala";
  ajax_field_mult["inativo"][1] = "inativo";
  ajax_field_mult["usuario_automatico"][1] = "usuario_automatico";

  var ajax_field_id = {
    "codigooperador": new Array("hidden_field_label_codigooperador", "hidden_field_data_codigooperador"),
    ...
    "datacadastro": new Array("hidden_field_label_datacadastro", "hidden_field_data_datacadastro"),
    "central": new Array("hidden_field_label_central", "hidden_field_data_central"),
    "datasaida": new Array("hidden_field_label_datasaida", "hidden_field_data_datasaida"),
    "sala": new Array("hidden_field_label_sala", "hidden_field_data_sala"),
    "inativo": new Array("hidden_field_label_inativo", "hidden_field_data_inativo"),
    "usuario_automatico": new Array("hidden_field_label_usuario_automatico", "hidden_field_data_usuario_automatico")
  };
