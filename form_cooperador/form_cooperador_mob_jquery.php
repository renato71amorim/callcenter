...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_carteirinha_hora' + iSeqRow).bind('blur', function() { sc_form_cooperador_carteirinha_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_cooperador_carteirinha_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_datanovocoop_hora' + iSeqRow).bind('blur', function() { sc_form_cooperador_datanovocoop_onblur(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_cooperador_datanovocoop_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_timestamp_hora' + iSeqRow).bind('blur', function() { sc_form_cooperador_timestamp_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_cooperador_timestamp_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_ultimocontato_hora' + iSeqRow).bind('blur', function() { sc_form_cooperador_ultimocontato_onblur(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_cooperador_ultimocontato_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_dataref_hora' + iSeqRow).bind('blur', function() { sc_form_cooperador_dataref_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_cooperador_dataref_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_datacomissionamento_hora' + iSeqRow).bind('blur', function() { sc_form_cooperador_datacomissionamento_onblur(this, iSeqRow) })
                                                      .bind('focus', function() { sc_form_cooperador_datacomissionamento_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_cooperador_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_carteirinha" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_cooperador_mob_validate_carteirinha(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_datanovocoop" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_cooperador_mob_validate_datanovocoop(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_timestamp" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_cooperador_mob_validate_timestamp(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_ultimocontato" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_cooperador_mob_validate_ultimocontato(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_dataref" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_cooperador_mob_validate_dataref(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_datacomissionamento" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_cooperador_mob_validate_datacomissionamento(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
