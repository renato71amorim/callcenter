...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_cooperador_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_cooperador_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_cooperador_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_cooperador'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_cooperador'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_codigo_label" id="hidden_field_label_codigo" style="<?php echo $sStyleHidden_codigo; ?>"><span id="id_label_codigo"><?php echo $this->nm_new_label['codigo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['php_cmp_required']['codigo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['php_cmp_required']['codigo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dia_label" id="hidden_field_label_dia" style="<?php echo $sStyleHidden_dia; ?>"><span id="id_label_dia"><?php echo $this->nm_new_label['dia']; ?></span></TD>
    <TD class="scFormDataOdd css_dia_line" id="hidden_field_data_dia" style="<?php echo $sStyleHidden_dia; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dia_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_mes_label" id="hidden_field_label_mes" style="<?php echo $sStyleHidden_mes; ?>"><span id="id_label_mes"><?php echo $this->nm_new_label['mes']; ?></span></TD>
    <TD class="scFormDataOdd css_mes_line" id="hidden_field_data_mes" style="<?php echo $sStyleHidden_mes; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_mes_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_carteirinha_label" id="hidden_field_label_carteirinha" style="<?php echo $sStyleHidden_carteirinha; ?>"><span id="id_label_carteirinha"><?php echo $this->nm_new_label['carteirinha']; ?></span></TD>
    <TD class="scFormDataOdd css_carteirinha_line" id="hidden_field_data_carteirinha" style="<?php echo $sStyleHidden_carteirinha; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_carteirinha_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ncodigo_label" id="hidden_field_label_ncodigo" style="<?php echo $sStyleHidden_ncodigo; ?>"><span id="id_label_ncodigo"><?php echo $this->nm_new_label['ncodigo']; ?></span></TD>
    <TD class="scFormDataOdd css_ncodigo_line" id="hidden_field_data_ncodigo" style="<?php echo $sStyleHidden_ncodigo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ncodigo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_datanovocoop_label" id="hidden_field_label_datanovocoop" style="<?php echo $sStyleHidden_datanovocoop; ?>"><span id="id_label_datanovocoop"><?php echo $this->nm_new_label['datanovocoop']; ?></span></TD>
    <TD class="scFormDataOdd css_datanovocoop_line" id="hidden_field_data_datanovocoop" style="<?php echo $sStyleHidden_datanovocoop; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_datanovocoop_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_adiantarmensal_label" id="hidden_field_label_adiantarmensal" style="<?php echo $sStyleHidden_adiantarmensal; ?>"><span id="id_label_adiantarmensal"><?php echo $this->nm_new_label['adiantarmensal']; ?></span></TD>
    <TD class="scFormDataOdd css_adiantarmensal_line" id="hidden_field_data_adiantarmensal" style="<?php echo $sStyleHidden_adiantarmensal; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_adiantarmensal_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dataref_label" id="hidden_field_label_dataref" style="<?php echo $sStyleHidden_dataref; ?>"><span id="id_label_dataref"><?php echo $this->nm_new_label['dataref']; ?></span></TD>
    <TD class="scFormDataOdd css_dataref_line" id="hidden_field_data_dataref" style="<?php echo $sStyleHidden_dataref; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dataref_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_comissionado_label" id="hidden_field_label_comissionado" style="<?php echo $sStyleHidden_comissionado; ?>"><span id="id_label_comissionado"><?php echo $this->nm_new_label['comissionado']; ?></span></TD>
    <TD class="scFormDataOdd css_comissionado_line" id="hidden_field_data_comissionado" style="<?php echo $sStyleHidden_comissionado; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_comissionado_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_datacomissionamento_label" id="hidden_field_label_datacomissionamento" style="<?php echo $sStyleHidden_datacomissionamento; ?>"><span id="id_label_datacomissionamento"><?php echo $this->nm_new_label['datacomissionamento']; ?></span></TD>
    <TD class="scFormDataOdd css_datacomissionamento_line" id="hidden_field_data_datacomissionamento" style="<?php echo $sStyleHidden_datacomissionamento; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_datacomissionamento_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_prob_label" id="hidden_field_label_prob" style="<?php echo $sStyleHidden_prob; ?>"><span id="id_label_prob"><?php echo $this->nm_new_label['prob']; ?></span></TD>
    <TD class="scFormDataOdd css_prob_line" id="hidden_field_data_prob" style="<?php echo $sStyleHidden_prob; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_prob_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_frequencia_label" id="hidden_field_label_frequencia" style="<?php echo $sStyleHidden_frequencia; ?>"><span id="id_label_frequencia"><?php echo $this->nm_new_label['frequencia']; ?></span></TD>
    <TD class="scFormDataOdd css_frequencia_line" id="hidden_field_data_frequencia" style="<?php echo $sStyleHidden_frequencia; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_frequencia_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_valorespecial_label" id="hidden_field_label_valorespecial" style="<?php echo $sStyleHidden_valorespecial; ?>"><span id="id_label_valorespecial"><?php echo $this->nm_new_label['valorespecial']; ?></span></TD>
    <TD class="scFormDataOdd css_valorespecial_line" id="hidden_field_data_valorespecial" style="<?php echo $sStyleHidden_valorespecial; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_valorespecial_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_operadorespecial_label" id="hidden_field_label_operadorespecial" style="<?php echo $sStyleHidden_operadorespecial; ?>"><span id="id_label_operadorespecial"><?php echo $this->nm_new_label['operadorespecial']; ?></span></TD>
    <TD class="scFormDataOdd css_operadorespecial_line" id="hidden_field_data_operadorespecial" style="<?php echo $sStyleHidden_operadorespecial; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_operadorespecial_line" style="vertical-align: top;padding: 0px">
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_cooperador");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_cooperador");
 parent.scAjaxDetailHeight("form_cooperador", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cooperador']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
