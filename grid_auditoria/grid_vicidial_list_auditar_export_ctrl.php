<?php
@session_start() ;
$_SESSION['scriptcase']['grid_vicidial_list_auditar']['sc_process_barr'] = true;
require_once('../grid_auditoria/index.php');
unset($_SESSION['scriptcase']['grid_vicidial_list_auditar']['sc_process_barr']);
$ExportCtrl = new grid_vicidial_list_auditar_export_control;
$ExportCtrl->Export_barr();

class grid_vicidial_list_auditar_export_control
{
