...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_doacoes_auditar_2_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_doacoes_auditar_2_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_doacoes_auditar_2_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_doacoes_auditar_2'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_doacoes_auditar_2'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_codigoidentificador_label" id="hidden_field_label_codigoidentificador" style="<?php echo $sStyleHidden_codigoidentificador; ?>"><span id="id_label_codigoidentificador"><?php echo $this->nm_new_label['codigoidentificador']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['php_cmp_required']['codigoidentificador']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['php_cmp_required']['codigoidentificador'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_logadouro_label" id="hidden_field_label_logadouro" style="<?php echo $sStyleHidden_logadouro; ?>"><span id="id_label_logadouro"><?php echo $this->nm_new_label['logadouro']; ?></span></TD>
    <TD class="scFormDataOdd css_logadouro_line" id="hidden_field_data_logadouro" style="<?php echo $sStyleHidden_logadouro; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_logadouro_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pontodereferencia_label" id="hidden_field_label_pontodereferencia" style="<?php echo $sStyleHidden_pontodereferencia; ?>"><span id="id_label_pontodereferencia"><?php echo $this->nm_new_label['pontodereferencia']; ?></span></TD>
    <TD class="scFormDataOdd css_pontodereferencia_line" id="hidden_field_data_pontodereferencia" style="<?php echo $sStyleHidden_pontodereferencia; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pontodereferencia_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_localidade_label" id="hidden_field_label_localidade" style="<?php echo $sStyleHidden_localidade; ?>"><span id="id_label_localidade"><?php echo $this->nm_new_label['localidade']; ?></span></TD>
    <TD class="scFormDataOdd css_localidade_line" id="hidden_field_data_localidade" style="<?php echo $sStyleHidden_localidade; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_localidade_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_setor_rua_label" id="hidden_field_label_setor_rua" style="<?php echo $sStyleHidden_setor_rua; ?>"><span id="id_label_setor_rua"><?php echo $this->nm_new_label['setor_rua']; ?></span></TD>
    <TD class="scFormDataOdd css_setor_rua_line" id="hidden_field_data_setor_rua" style="<?php echo $sStyleHidden_setor_rua; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_setor_rua_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_lead_id_label" id="hidden_field_label_lead_id" style="<?php echo $sStyleHidden_lead_id; ?>"><span id="id_label_lead_id"><?php echo $this->nm_new_label['lead_id']; ?></span></TD>
    <TD class="scFormDataOdd css_lead_id_line" id="hidden_field_data_lead_id" style="<?php echo $sStyleHidden_lead_id; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_lead_id_line" style="vertical-align: top;padding: 0px">
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_doacoes_auditar_2");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_doacoes_auditar_2");
 parent.scAjaxDetailHeight("form_doacoes_auditar_2", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar_2']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
