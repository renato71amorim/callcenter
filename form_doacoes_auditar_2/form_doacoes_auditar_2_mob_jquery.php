...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_dataemissao_hora' + iSeqRow).bind('blur', function() { sc_form_doacoes_auditar_2_dataemissao_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_doacoes_auditar_2_dataemissao_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_datavencimento_hora' + iSeqRow).bind('blur', function() { sc_form_doacoes_auditar_2_datavencimento_onblur(this, iSeqRow) })
                                                 .bind('focus', function() { sc_form_doacoes_auditar_2_datavencimento_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_timestamp_hora' + iSeqRow).bind('blur', function() { sc_form_doacoes_auditar_2_timestamp_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_doacoes_auditar_2_timestamp_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_doacoes_auditar_2_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_dataemissao" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_doacoes_auditar_2_mob_validate_dataemissao(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_datavencimento" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_doacoes_auditar_2_mob_validate_datavencimento(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_timestamp" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_doacoes_auditar_2_mob_validate_timestamp(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
