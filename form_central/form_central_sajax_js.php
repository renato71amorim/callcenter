  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_central" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_central_form();
	}

  // ---------- Validate codigocentral
  function do_ajax_form_central_validate_codigocentral()
  {
    var nomeCampo_codigocentral = "codigocentral";
    var var_codigocentral = scAjaxGetFieldHidden(nomeCampo_codigocentral);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_central_validate_codigocentral(var_codigocentral, var_script_case_init, do_ajax_form_central_validate_codigocentral_cb);
  } // do_ajax_form_central_validate_codigocentral

  function do_ajax_form_central_validate_codigocentral_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_central_validate_codigocentral_cb

  // ---------- Validate descricao
  function do_ajax_form_central_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_central_validate_descricao(var_descricao, var_script_case_init, do_ajax_form_central_validate_descricao_cb);
  } // do_ajax_form_central_validate_descricao

  function do_ajax_form_central_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_central_validate_descricao_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_central_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_central_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_central_submit_form(var_codigocentral, var_descricao, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_central_submit_form_cb);
  } // do_ajax_form_central_submit_form

  function do_ajax_form_central_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_central_submit_form_cb_after_alert);
  } // do_ajax_form_central_submit_form_cb
  function do_ajax_form_central_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_central_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_central_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_central_navigate_form(var_codigocentral, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_central_navigate_form_cb);
  } // do_ajax_form_central_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_central']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_central_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_central_navigate_form_cb_after_alert);
  } // do_ajax_form_central_navigate_form_cb
  function do_ajax_form_central_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_central_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_central_navigate_form_cb_after_alert
  function sc_hide_form_central_form()
  {
