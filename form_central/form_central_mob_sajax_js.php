  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_central_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_central_mob_form();
	}

  // ---------- Validate codigocentral
  function do_ajax_form_central_mob_validate_codigocentral()
  {
    var nomeCampo_codigocentral = "codigocentral";
    var var_codigocentral = scAjaxGetFieldHidden(nomeCampo_codigocentral);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_central_mob_validate_codigocentral(var_codigocentral, var_script_case_init, do_ajax_form_central_mob_validate_codigocentral_cb);
  } // do_ajax_form_central_mob_validate_codigocentral

  function do_ajax_form_central_mob_validate_codigocentral_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codigocentral";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_central_mob_validate_codigocentral_cb

  // ---------- Validate descricao
  function do_ajax_form_central_mob_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_central_mob_validate_descricao(var_descricao, var_script_case_init, do_ajax_form_central_mob_validate_descricao_cb);
  } // do_ajax_form_central_mob_validate_descricao

  function do_ajax_form_central_mob_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_central_mob_validate_descricao_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_central_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_central_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_codigocentral = scAjaxGetFieldHidden("codigocentral");
    ...
    scAjaxProcOn();
    x_ajax_form_central_mob_submit_form(var_codigocentral, var_descricao, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_central_mob_submit_form_cb);
  } // do_ajax_form_central_mob_submit_form

  function do_ajax_form_central_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("codigocentral");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_central_mob_submit_form_cb_after_alert);
  } // do_ajax_form_central_mob_submit_form_cb
  function do_ajax_form_central_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_central_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_central_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("codigocentral");
    scAjaxHideErrorDisplay("descricao");
    var var_codigocentral = document.F2.codigocentral.value;
    ...
    scAjaxProcOn();
    x_ajax_form_central_mob_navigate_form(var_codigocentral, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_central_mob_navigate_form_cb);
  } // do_ajax_form_central_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_central_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_central_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.codigocentral.value = scAjaxGetKeyValue("codigocentral");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_central_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_central_mob_navigate_form_cb
  function do_ajax_form_central_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_central_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_central_mob_navigate_form_cb_after_alert
  function sc_hide_form_central_mob_form()
  {
  ...
  ajax_field_list[0] = "codigocentral";
  ...
  var ajax_error_list = {
    "codigocentral": {"label": "Codigo Central", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "codigocentral": new Array(),
    "descricao": new Array()
  };
  ajax_field_mult["codigocentral"][1] = "codigocentral";
  ajax_field_mult["descricao"][1] = "descricao";

  var ajax_field_id = {
    "codigocentral": new Array("hidden_field_label_codigocentral", "hidden_field_data_codigocentral"),
