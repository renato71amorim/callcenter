<?php
@session_start() ;
$_SESSION['scriptcase']['grid_goautodial_recordings_views']['sc_process_barr'] = true;
require_once('../grid_goautodial_recordings_views/index.php');
unset($_SESSION['scriptcase']['grid_goautodial_recordings_views']['sc_process_barr']);
$ExportCtrl = new grid_goautodial_recordings_views_export_control;
$ExportCtrl->Export_barr();

class grid_goautodial_recordings_views_export_control
{
