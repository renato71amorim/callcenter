<?php
@session_start() ;
$_SESSION['scriptcase']['grid_audios']['sc_process_barr'] = true;
require_once('../grid_audios/index.php');
unset($_SESSION['scriptcase']['grid_audios']['sc_process_barr']);
$ExportCtrl = new grid_audios_export_control;
$ExportCtrl->Export_barr();

class grid_audios_export_control
{
