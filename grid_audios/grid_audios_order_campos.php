...
<?php
   ...
   $Ord_Cmp = new grid_audios_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_audios_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_audios']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_audios']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['comments'] = "comments";
   $tab_labels["comments"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_audios']['labels']["comments"])) ? $_SESSION['sc_session'][$sc_init]['grid_audios']['labels']["comments"] : "Código";
   $tab_ger_campos['first_name'] = "on";
   $tab_def_campos['first_name'] = "first_name";
   $tab_labels["first_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_audios']['labels']["first_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_audios']['labels']["first_name"] : "Nome";
   $tab_ger_campos['phone_number'] = "on";
   $tab_def_campos['phone_number'] = "phone_number";
   $tab_labels["phone_number"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_audios']['labels']["phone_number"])) ? $_SESSION['sc_session'][$sc_init]['grid_audios']['labels']["phone_number"] : "Telefone";
   $tab_ger_campos['start_time'] = "on";
   $tab_def_campos['start_time'] = "start_time";
   $tab_labels["start_time"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_audios']['labels']["start_time"])) ? $_SESSION['sc_session'][$sc_init]['grid_audios']['labels']["start_time"] : "Início";
   $tab_ger_campos['location'] = "on";
   $tab_def_campos['location'] = "location";
   $tab_labels["location"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_audios']['labels']["location"])) ? $_SESSION['sc_session'][$sc_init]['grid_audios']['labels']["location"] : "URL";
   $tab_ger_campos['user'] = "on";
   $tab_def_campos['user'] = "user";
   $tab_labels["user"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_audios']['labels']["user"])) ? $_SESSION['sc_session'][$sc_init]['grid_audios']['labels']["user"] : "User";
   $tab_ger_campos['cadastro'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cadastro'] = "Cadastro";
   }
   else
   {
       $tab_def_campos['cadastro'] = "";
   }
   $tab_labels["cadastro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_audios']['labels']["cadastro"])) ? $_SESSION['sc_session'][$sc_init]['grid_audios']['labels']["cadastro"] : "Cadastro";
   $tab_ger_campos['cadastro'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_audios']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_audios']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_audios']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_audios']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_audios']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_audios']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_audios']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_audios']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_audios']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_audios']['ordem_quebra'] as $campo => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_audios']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_audios']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_audios_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_audios']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_audios']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_audios']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_audios']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_audios']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
