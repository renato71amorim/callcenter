...
class grid_audios_rtf
{
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_audios']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audios']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audios']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_audios']['rtf_name']);
      }
   ...
   function NM_export_comments()
   {
         ...
         $this->comments = str_replace('>', '&gt;', $this->comments);
         $this->Texto_tag .= "<td>" . $this->comments . "</td>\r\n";
   }
   //----- first_name
   function NM_export_first_name()
   {
         ...
         $this->first_name = str_replace('>', '&gt;', $this->first_name);
         $this->Texto_tag .= "<td>" . $this->first_name . "</td>\r\n";
   }
   //----- phone_number
   function NM_export_phone_number()
   {
         ...
         $this->phone_number = str_replace('>', '&gt;', $this->phone_number);
         $this->Texto_tag .= "<td>" . $this->phone_number . "</td>\r\n";
   }
   //----- start_time
   ...
   function NM_export_cadastro()
   {
         ...
         $this->cadastro = str_replace('<', '&lt;', $this->cadastro);
         $this->cadastro = str_replace('>', '&gt;', $this->cadastro);
         $this->Texto_tag .= "<td>" . $this->cadastro . "</td>\r\n";
   }
   //----- lead_id
   function NM_export_lead_id()
   {
         ...
         $this->lead_id = str_replace('<', '&lt;', $this->lead_id);
         $this->lead_id = str_replace('>', '&gt;', $this->lead_id);
         $this->Texto_tag .= "<td>" . $this->lead_id . "</td>\r\n";
   }
   //----- alt_phone
   function NM_export_alt_phone()
   {
         ...
         $this->alt_phone = str_replace('>', '&gt;', $this->alt_phone);
         $this->Texto_tag .= "<td>" . $this->alt_phone . "</td>\r\n";
   }
   //----- extension
   function NM_export_extension()
   {
         ...
         $this->extension = str_replace('<', '&lt;', $this->extension);
         $this->extension = str_replace('>', '&gt;', $this->extension);
         $this->Texto_tag .= "<td>" . $this->extension . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_audios']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audios']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - audios :: RTF</TITLE>
