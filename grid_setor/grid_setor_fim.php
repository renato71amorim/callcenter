...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_setor"]))
   {
      unset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_setor"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_setor'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_setor']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_setor']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_setor']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_setor']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_setor']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_setor']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_setor']['embutida_filho'] as $ind => $sc_init)
          {
