<?php
@session_start() ;
$_SESSION['scriptcase']['grid_setor']['sc_process_barr'] = true;
require_once('../grid_setor/index.php');
unset($_SESSION['scriptcase']['grid_setor']['sc_process_barr']);
$ExportCtrl = new grid_setor_export_control;
$ExportCtrl->Export_barr();

class grid_setor_export_control
{
