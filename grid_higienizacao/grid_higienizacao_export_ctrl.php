<?php
@session_start() ;
$_SESSION['scriptcase']['grid_higienizacao']['sc_process_barr'] = true;
require_once('../grid_higienizacao/index.php');
unset($_SESSION['scriptcase']['grid_higienizacao']['sc_process_barr']);
$ExportCtrl = new grid_higienizacao_export_control;
$ExportCtrl->Export_barr();

class grid_higienizacao_export_control
{
