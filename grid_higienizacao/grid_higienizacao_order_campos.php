...
<?php
   ...
   $Ord_Cmp = new grid_higienizacao_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_higienizacao_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_higienizacao']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_higienizacao']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['idhigienizacao'] = "idhigienizacao";
   $tab_labels["idhigienizacao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_higienizacao']['labels']["idhigienizacao"])) ? $_SESSION['sc_session'][$sc_init]['grid_higienizacao']['labels']["idhigienizacao"] : "id";
   $tab_ger_campos['phone'] = "on";
   $tab_def_campos['phone'] = "phone";
   $tab_labels["phone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_higienizacao']['labels']["phone"])) ? $_SESSION['sc_session'][$sc_init]['grid_higienizacao']['labels']["phone"] : "Discagem";
   $tab_ger_campos['amdstatus'] = "on";
   $tab_def_campos['amdstatus'] = "amdstatus";
   $tab_labels["amdstatus"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_higienizacao']['labels']["amdstatus"])) ? $_SESSION['sc_session'][$sc_init]['grid_higienizacao']['labels']["amdstatus"] : "Status";
   $tab_ger_campos['called'] = "on";
   $tab_def_campos['called'] = "called";
   $tab_labels["called"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_higienizacao']['labels']["called"])) ? $_SESSION['sc_session'][$sc_init]['grid_higienizacao']['labels']["called"] : "Ligou";
   $tab_ger_campos['codigocontribuinte'] = "on";
   $tab_def_campos['codigocontribuinte'] = "codigocontribuinte";
   $tab_labels["codigocontribuinte"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_higienizacao']['labels']["codigocontribuinte"])) ? $_SESSION['sc_session'][$sc_init]['grid_higienizacao']['labels']["codigocontribuinte"] : "Contribuinte";
   ...
   $tab_labels["timestamp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_higienizacao']['labels']["timestamp"])) ? $_SESSION['sc_session'][$sc_init]['grid_higienizacao']['labels']["timestamp"] : "Atualizado";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_higienizacao']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_higienizacao']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_higienizacao']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_higienizacao']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_higienizacao']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_higienizacao']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_higienizacao']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_higienizacao']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_higienizacao']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_higienizacao']['ordem_quebra'] as $campo => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_higienizacao']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_higienizacao']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_higienizacao_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_higienizacao']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_higienizacao']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_higienizacao']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_higienizacao']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_higienizacao']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
