...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_higienizacao"]))
   {
      unset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_higienizacao"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_higienizacao']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_higienizacao']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_higienizacao']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_higienizacao']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_higienizacao']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_higienizacao']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_higienizacao']['embutida_filho'] as $ind => $sc_init)
          {
