<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_contribuinte_todos']['glo_nm_path_imag_temp'] . "/sc_apl_default_dinamica_publicado.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_contribuinte_todos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_contribuinte_todos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['labels']["codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['labels']["codigo"] : "Codigo";
   $tab_ger_campos['nome'] = "on";
   $tab_def_campos['nome'] = "nome";
   $tab_labels["nome"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['labels']["nome"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['labels']["nome"] : "Nome";
   $tab_ger_campos['tipo'] = "on";
   $tab_def_campos['tipo'] = "tipo";
   $tab_labels["tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['labels']["tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['labels']["tipo"] : "Tipo";
   $tab_ger_campos['nomerua'] = "on";
   $tab_def_campos['nomerua'] = "nomerua";
   $tab_labels["nomerua"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['labels']["nomerua"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['labels']["nomerua"] : "Nomerua";
   $tab_ger_campos['bairro'] = "on";
   $tab_def_campos['bairro'] = "bairro";
   $tab_labels["bairro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['labels']["bairro"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['labels']["bairro"] : "Bairro";
   $tab_ger_campos['cidade'] = "on";
   $tab_def_campos['cidade'] = "cidade";
   $tab_labels["cidade"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['labels']["cidade"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['labels']["cidade"] : "Cidade";
   $tab_ger_campos['ddd'] = "on";
   $tab_def_campos['ddd'] = "ddd";
   $tab_labels["ddd"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['labels']["ddd"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['labels']["ddd"] : "DDD";
   $tab_ger_campos['fone1'] = "on";
   $tab_def_campos['fone1'] = "fone1";
   $tab_labels["fone1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['labels']["fone1"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['labels']["fone1"] : "Fone 1";
   $tab_ger_campos['fone2'] = "on";
   $tab_def_campos['fone2'] = "fone2";
   $tab_labels["fone2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['labels']["fone2"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['labels']["fone2"] : "Fone 2";
   $tab_ger_campos['fone3'] = "on";
   $tab_def_campos['fone3'] = "fone3";
   $tab_labels["fone3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['labels']["fone3"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['labels']["fone3"] : "Fone 3";
   $tab_ger_campos['fone4'] = "on";
   $tab_def_campos['fone4'] = "fone4";
   $tab_labels["fone4"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['labels']["fone4"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['labels']["fone4"] : "Fone 4";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['ordem_quebra'] as $campo => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> Todos os Contribuintes</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_contribuinte_todos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_contribuinte_todos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
