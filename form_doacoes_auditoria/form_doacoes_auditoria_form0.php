...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_doacoes_auditoria_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_doacoes_auditoria_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_doacoes_auditoria_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_doacoes_auditoria'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_doacoes_auditoria'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['Lookup_sexo'][] = 'M'; ?>
 <option  value="F" <?php  if ($this->sexo == "F") { echo " selected" ;} ?>>Feminino</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['Lookup_sexo'][] = 'F'; ?>
 <option  value="N" <?php  if ($this->sexo == "N") { echo " selected" ;} ?>>Não se aplica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['Lookup_sexo'][] = 'N'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['Lookup_tipo'][] = 'L'; ?>
 <option  value="A" <?php  if ($this->tipo == "A") { echo " selected" ;} ?>>Avulso</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['Lookup_tipo'][] = 'A'; ?>
 <option  value="M" <?php  if ($this->tipo == "M") { echo " selected" ;} ?>>Mensal</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['Lookup_tipo'][] = 'M'; ?>
 <option  value="B" <?php  if ($this->tipo == "B") { echo " selected" ;} ?>>Bimestral</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['Lookup_tipo'][] = 'B'; ?>
 <option  value="T" <?php  if ($this->tipo == "T") { echo " selected" ;} ?>>Trimestral</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['Lookup_tipo'][] = 'T'; ?>
 <option  value="S" <?php  if ($this->tipo == "S") { echo " selected" ;} ?>>Semestral</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['Lookup_tipo'][] = 'S'; ?>
 </select></span>
</span><?php  }?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_audios'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_audios'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['grid_goautodial_recordings_views_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_audios'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['grid_goautodial_recordings_views_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 if (isset($this->Ini->sc_lig_md5["grid_goautodial_recordings_views"]) && $this->Ini->sc_lig_md5["grid_goautodial_recordings_views"] == "S") {
     ...
     $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_doacoes_auditoria@SC_par@" . md5($Parms_Lig);
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
 } else {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_doacoes_auditoria_empty.htm' : $this->Ini->link_grid_goautodial_recordings_views_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_audios']) && 'nmsc_iframe_liga_grid_goautodial_recordings_views' != $this->Ini->sc_lig_target['C_@scinf_audios'])
{
    ...
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_audios'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['grid_goautodial_recordings_views_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<span id="id_read_on_codigorua" class="sc-ui-readonly-codigorua css_codigorua_line" style="<?php echo $sStyleReadLab_codigorua; ?>"><?php echo $this->codigorua; ?></span><span id="id_read_off_codigorua" class="css_read_off_codigorua" style="white-space: nowrap;<?php echo $sStyleReadInp_codigorua; ?>">
 ...
 size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['codigorua']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['codigorua']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['codigorua']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_form_doacoes_auditoria*scout' : '';
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['Lookup_mesmensal'][] = '00'; ?>
 <option  value="01" <?php  if ($this->mesmensal == "01") { echo " selected" ;} ?>>Janeiro</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['Lookup_mesmensal'][] = '01'; ?>
 <option  value="02" <?php  if ($this->mesmensal == "02") { echo " selected" ;} ?>>Fevereiro</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['Lookup_mesmensal'][] = '02'; ?>
 <option  value="03" <?php  if ($this->mesmensal == "03") { echo " selected" ;} ?>>Março</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['Lookup_mesmensal'][] = '03'; ?>
 <option  value="04" <?php  if ($this->mesmensal == "04") { echo " selected" ;} ?>>Abril</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['Lookup_mesmensal'][] = '04'; ?>
 <option  value="05" <?php  if ($this->mesmensal == "05") { echo " selected" ;} ?>>Maio</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['Lookup_mesmensal'][] = '05'; ?>
 <option  value="06" <?php  if ($this->mesmensal == "06") { echo " selected" ;} ?>>Junho</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['Lookup_mesmensal'][] = '06'; ?>
 <option  value="07" <?php  if ($this->mesmensal == "07") { echo " selected" ;} ?>>Julho</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['Lookup_mesmensal'][] = '07'; ?>
 <option  value="08" <?php  if ($this->mesmensal == "08") { echo " selected" ;} ?>>Agosto</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['Lookup_mesmensal'][] = '08'; ?>
 <option  value="09" <?php  if ($this->mesmensal == "09") { echo " selected" ;} ?>>Setembro</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['Lookup_mesmensal'][] = '09'; ?>
 <option  value="10" <?php  if ($this->mesmensal == "10") { echo " selected" ;} ?>>Outubro</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['Lookup_mesmensal'][] = '10'; ?>
 <option  value="11" <?php  if ($this->mesmensal == "11") { echo " selected" ;} ?>>Novembro</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['Lookup_mesmensal'][] = '11'; ?>
 <option  value="12" <?php  if ($this->mesmensal == "12") { echo " selected" ;} ?>>Dezembro</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['Lookup_mesmensal'][] = '12'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['Lookup_status'][] = '1'; ?>
 <option  value="2" <?php  if ($this->status == "2") { echo " selected" ;} ?>>Realizado</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['Lookup_status'][] = '2'; ?>
 <option  value="3" <?php  if ($this->status == "3") { echo " selected" ;} ?>>Descartado</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['Lookup_status'][] = '3'; ?>
 </select></span>
</span><?php  }?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_doacoes_auditoria");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_doacoes_auditoria");
 parent.scAjaxDetailHeight("form_doacoes_auditoria", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
