...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_doacoes_auditoria/form_doacoes_auditoria_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_doacoes_auditoria_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_doacoes_auditoria_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_doacoes_auditoria']['error_buffer']) && '' != $_SESSION['scriptcase']['form_doacoes_auditoria']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_doacoes_auditoria']['error_buffer'];
}
...
<?php
 include_once("form_doacoes_auditoria_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_doacoes_auditoria_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['insert_validation']; ?>">
<?php
}
?>
...
<input type="hidden" name="codigoidentificador" value="<?php  echo $this->form_encode_input($this->codigoidentificador) ?>">
<input type="hidden" name="_sc_force_mobile" id="sc-id-mobile-control" value="" />
<?php
$_SESSION['scriptcase']['error_span_title']['form_doacoes_auditoria_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_doacoes_auditoria_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_codigo_line" id="hidden_field_data_codigo" style="<?php echo $sStyleHidden_codigo; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_codigo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_codigo_label"><span id="id_label_codigo"><?php echo $this->nm_new_label['codigo']; ?></span></span><br><input type="hidden" name="codigo" value="<?php echo $this->form_encode_input($codigo); ?>"><span id="id_ajax_label_codigo"><?php echo nl2br($codigo); ?></span>
...
$sexo_look = "";
 ...
 if ($this->sexo == "N") { $sexo_look .= "Não se aplica" ;} 
...
$sexo_look = "";
 ...
 if (empty($sexo_look)) { $sexo_look = $this->sexo; }
?>
<span id="id_read_on_sexo" class="css_sexo_line"  style="<?php echo $sStyleReadLab_sexo; ?>"><?php echo $this->form_encode_input($sexo_look); ?></span><span id="id_read_off_sexo" class="css_read_off_sexo" style="white-space: nowrap; <?php echo $sStyleReadInp_sexo; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lookup_sexo'][] = 'M'; ?>
 <option  value="F" <?php  if ($this->sexo == "F") { echo " selected" ;} ?>>Feminino</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lookup_sexo'][] = 'F'; ?>
 <option  value="N" <?php  if ($this->sexo == "N") { echo " selected" ;} ?>>Não se aplica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lookup_sexo'][] = 'N'; ?>
 </select></span>
</span><?php  }?>
...
$tipo_look = "";
 if ($this->tipo == "L") { $tipo_look .= "Lista" ;} 
 if ($this->tipo == "A") { $tipo_look .= "Avulso" ;} 
 if ($this->tipo == "M") { $tipo_look .= "Mensal" ;} 
 if ($this->tipo == "B") { $tipo_look .= "Bimestral" ;} 
 if ($this->tipo == "T") { $tipo_look .= "Trimestral" ;} 
 if ($this->tipo == "S") { $tipo_look .= "Semestral" ;} 
...
$tipo_look = "";
 ...
 if (empty($tipo_look)) { $tipo_look = $this->tipo; }
?>
<span id="id_read_on_tipo" class="css_tipo_line"  style="<?php echo $sStyleReadLab_tipo; ?>"><?php echo $this->form_encode_input($tipo_look); ?></span><span id="id_read_off_tipo" class="css_read_off_tipo" style="white-space: nowrap; <?php echo $sStyleReadInp_tipo; ?>">
 ...
 <option  value="L" <?php  if ($this->tipo == "L") { echo " selected" ;} ?>>Lista</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lookup_tipo'][] = 'L'; ?>
 <option  value="A" <?php  if ($this->tipo == "A") { echo " selected" ;} ?>>Avulso</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lookup_tipo'][] = 'A'; ?>
 <option  value="M" <?php  if ($this->tipo == "M") { echo " selected" ;} ?>>Mensal</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lookup_tipo'][] = 'M'; ?>
 <option  value="B" <?php  if ($this->tipo == "B") { echo " selected" ;} ?>>Bimestral</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lookup_tipo'][] = 'B'; ?>
 <option  value="T" <?php  if ($this->tipo == "T") { echo " selected" ;} ?>>Trimestral</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lookup_tipo'][] = 'T'; ?>
 <option  value="S" <?php  if ($this->tipo == "S") { echo " selected" ;} ?>>Semestral</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lookup_tipo'][] = 'S'; ?>
 </select></span>
</span><?php  }?>
...
<TABLE align="center" id="hidden_bloco_1" class="scFormTable" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['audios']))
    {
        $this->nm_new_label['audios'] = "audios";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $audios = $this->audios;
   $sStyleHidden_audios = '';
   if (isset($this->nmgp_cmp_hidden['audios']) && $this->nmgp_cmp_hidden['audios'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['audios']);
       $sStyleHidden_audios = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_audios = 'display: none;';
   $sStyleReadInp_audios = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['audios']) && $this->nmgp_cmp_readonly['audios'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['audios']);
       $sStyleReadLab_audios = '';
       $sStyleReadInp_audios = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['audios']) && $this->nmgp_cmp_hidden['audios'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="audios" value="<?php echo $this->form_encode_input($audios) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_audios_line" id="hidden_field_data_audios" style="<?php echo $sStyleHidden_audios; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td width="100%" class="scFormDataFontOdd css_audios_line" style="vertical-align: top;padding: 0px">
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_audios'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_audios'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['grid_goautodial_recordings_views_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_audios'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['grid_goautodial_recordings_views_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 if (isset($this->Ini->sc_lig_md5["grid_goautodial_recordings_views"]) && $this->Ini->sc_lig_md5["grid_goautodial_recordings_views"] == "S") {
     $Parms_Lig  = "codigo*scin" . $this->nmgp_dados_form['codigo'] . "*scoutagent*scin" . $this->nmgp_dados_form['usuario'] . "*scoutNMSC_inicial*scininicio*scout";
     $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_doacoes_auditoria_mob@SC_par@" . md5($Parms_Lig);
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
 } else {
     $Md5_Lig  = "codigo*scin" . $this->nmgp_dados_form['codigo'] . "*scoutagent*scin" . $this->nmgp_dados_form['usuario'] . "*scoutNMSC_inicial*scininicio*scout";
 }
 $parms_lig_cons = "&nmgp_parms=" . $Md5_Lig;
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_doacoes_auditoria_mob_empty.htm' : $this->Ini->link_grid_goautodial_recordings_views_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y' . $parms_lig_cons;
...
if (isset($this->Ini->sc_lig_target['C_@scinf_audios']) && 'nmsc_iframe_liga_grid_goautodial_recordings_views' != $this->Ini->sc_lig_target['C_@scinf_audios'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_audios'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['grid_goautodial_recordings_views_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
    scOpenMasterDetail("<?php echo $this->Ini->sc_lig_target['C_@scinf_audios'] ?>", "<?php echo $sDetailSrc; ?>");
});
</script>
<?php
}
...
?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_audios_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_audios_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php $sStyleHidden_audios_dumb = ('' == $sStyleHidden_audios) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_audios_dumb" style="<?php echo $sStyleHidden_audios_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<TABLE align="center" id="hidden_bloco_3" class="scFormTable" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['codigorua'] = "Código Rua";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<span id="id_read_on_codigorua" class="sc-ui-readonly-codigorua css_codigorua_line" style="<?php echo $sStyleReadLab_codigorua; ?>"><?php echo $this->codigorua; ?></span><span id="id_read_off_codigorua" class="css_read_off_codigorua" style="white-space: nowrap;<?php echo $sStyleReadInp_codigorua; ?>">
 ...
 size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['codigorua']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['codigorua']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['codigorua']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_form_doacoes_auditoria_mob*scout' : '';
   if (isset($this->Ini->sc_lig_md5["grid_ruas"]) && $this->Ini->sc_lig_md5["grid_ruas"] == "S") {
       $Parms_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,codigorua,codigorua*scoutnm_evt_ret_busca*scinsc_form_doacoes_auditoria_codigorua_onchange(this)*scout" . $Sc_iframe_master;
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_doacoes_auditoria_mob@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,codigorua,codigorua*scoutnm_evt_ret_busca*scinsc_form_doacoes_auditoria_codigorua_onchange(this)*scout" . $Sc_iframe_master;
   }
?>

<?php if (!$this->Ini->Export_img_zip) { ?><?php echo nmButtonOutput($this->arr_buttons, "bform_captura", "nm_submit_cap('" . $this->Ini->link_grid_ruas_cons_psq. "', '" . $Md5_Lig . "')", "nm_submit_cap('" . $this->Ini->link_grid_ruas_cons_psq. "', '" . $Md5_Lig . "')", "cap_codigorua", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php } ?>
<?php } ?>
...
?>
<tr><td class="scFormPopupTopRight scFormPopupCorner"></td><td class="scFormPopupTop"></td><td class="scFormPopupTopLeft scFormPopupCorner"></td></tr><tr><td class="scFormPopupRight"></td><td class="scFormPopupContent">Este campo é atualizado dinamicamente, quando altera o código da rua. Alterações diretas aqui serão ignoradas.</td><td class="scFormPopupLeft"></td></tr><tr><td class="scFormPopupBottomRight scFormPopupCorner"></td><td class="scFormPopupBottom"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Ini->Bubble_tail; ?>" /></td><td class="scFormPopupBottomLeft scFormPopupCorner"></td></tr><?php
} else {
?>
<tr><td class="scFormPopupTopLeft scFormPopupCorner"></td><td class="scFormPopupTop"></td><td class="scFormPopupTopRight scFormPopupCorner"></td></tr><tr><td class="scFormPopupLeft"></td><td class="scFormPopupContent">Este campo é atualizado dinamicamente, quando altera o código da rua. Alterações diretas aqui serão ignoradas.</td><td class="scFormPopupRight"></td></tr><tr><td class="scFormPopupBottomLeft scFormPopupCorner"></td><td class="scFormPopupBottom"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Ini->Bubble_tail; ?>" /></td><td class="scFormPopupBottomRight scFormPopupCorner"></td></tr><?php
}
?>
</tbody></table></span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_cep_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_cep_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['logadouro'] = "Logradouro";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_logadouro_line" id="hidden_field_data_logadouro" style="<?php echo $sStyleHidden_logadouro; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_logadouro_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_logadouro_label"><span id="id_label_logadouro"><?php echo $this->nm_new_label['logadouro']; ?></span></span><br>
...
?>
</tbody></table></span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_logadouro_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_logadouro_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pontodereferencia_line" id="hidden_field_data_pontodereferencia" style="<?php echo $sStyleHidden_pontodereferencia; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pontodereferencia_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_pontodereferencia_label"><span id="id_label_pontodereferencia"><?php echo $this->nm_new_label['pontodereferencia']; ?></span></span><br>
...
?>
</tbody></table></span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_bairro_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_bairro_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_localidade_line" id="hidden_field_data_localidade" style="<?php echo $sStyleHidden_localidade; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_localidade_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_localidade_label"><span id="id_label_localidade"><?php echo $this->nm_new_label['localidade']; ?></span></span><br>
...
?>
</tbody></table></span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_localidade_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_localidade_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
?>
</tbody></table></span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_setor_rua_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_setor_rua_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<input type=hidden name="operador" value="<?php echo $this->form_encode_input($this->operador) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
...
else
{
   ...
   while (!empty($todo[$x])) 
   {
          ...
          if (isset($this->Embutida_ronly) && $this->Embutida_ronly && isset($this->operador_1))
          {
              foreach ($this->operador_1 as $tmp_operador)
              {
                  if (trim($tmp_operador) === trim($cadaselect[1])) { $operador_look .= $cadaselect[0] . '__SC_BREAK_LINE__'; }
              }
          }
          elseif (trim($this->operador) === trim($cadaselect[1])) { $operador_look .= $cadaselect[0]; } 
          $x++; 
   }

?>
<input type="hidden" name="operador" value="<?php echo $this->form_encode_input($operador) . "\">" . $operador_look . ""; ?>
<?php } else { ?>
<?php
   $todo = $this->Form_lookup_operador();
   $x = 0 ; 
   $operador_look = ""; 
   while (!empty($todo[$x])) 
   {
          ...
          if (empty($operador_look))
          {
              $operador_look = $this->operador;
          }
   $x = 0; 
   echo "<span id=\"id_read_on_operador\" class=\"css_operador_line\" style=\"" .  $sStyleReadLab_operador . "\">" . $this->form_encode_input($operador_look) . "</span><span id=\"id_read_off_operador\" class=\"css_read_off_operador\" style=\"white-space: nowrap; " . $sStyleReadInp_operador . "\">";
   echo " <span id=\"idAjaxSelect_operador\"><select class=\"sc-js-input scFormObjectOdd css_operador_obj\" style=\"\" id=\"id_sc_field_operador\" name=\"operador\" size=\"1\" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          ...
          if (trim($this->operador) === trim($cadaselect[1])) 
          {
              echo " selected" ; 
          }
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['datavencimento'] = "Vencto";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_datavencimento_line" id="hidden_field_data_datavencimento" style="<?php echo $sStyleHidden_datavencimento; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_datavencimento_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_datavencimento_label"><span id="id_label_datavencimento"><?php echo $this->nm_new_label['datavencimento']; ?></span></span><br>
...
<span class='trigger-picker-<?php echo $miniCalendarButton[1]; ?>'>
 ...
 size=18 alt="{datatype: 'date', dateSep: '<?php echo $this->field_config['datavencimento']['date_sep']; ?>', dateFormat: '<?php echo $this->field_config['datavencimento']['date_format']; ?>', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_valor_line" id="hidden_field_data_valor" style="<?php echo $sStyleHidden_valor; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_valor_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_valor_label"><span id="id_label_valor"><?php echo $this->nm_new_label['valor']; ?></span></span><br>
...
<span id="id_read_on_valor" class="sc-ui-readonly-valor css_valor_line" style="<?php echo $sStyleReadLab_valor; ?>"><?php echo $this->valor; ?></span><span id="id_read_off_valor" class="css_read_off_valor" style="white-space: nowrap;<?php echo $sStyleReadInp_valor; ?>">
 ...
 size=12 alt="{datatype: 'decimal', maxLength: 8, precision: 2, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['valor']['symbol_dec']); ?>', thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['valor']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['valor']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['valor']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<span id="id_read_on_obs" class="sc-ui-readonly-obs css_obs_line" style="<?php echo $sStyleReadLab_obs; ?>"><?php echo $this->obs; ?></span><span id="id_read_off_obs" class="css_read_off_obs" style="white-space: nowrap;<?php echo $sStyleReadInp_obs; ?>">
 ...
 size=50 maxlength=100 alt="{datatype: 'text', maxLength: 100, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: 'Observação referente a esta doação!', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<input type=hidden name="mesmensal" value="<?php echo $this->form_encode_input($this->mesmensal) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_mesmensal_line" id="hidden_field_data_mesmensal" style="<?php echo $sStyleHidden_mesmensal; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_mesmensal_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_mesmensal_label"><span id="id_label_mesmensal"><?php echo $this->nm_new_label['mesmensal']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["mesmensal"]) &&  $this->nmgp_cmp_readonly["mesmensal"] == "on") { 

$mesmensal_look = "";
 if ($this->mesmensal == "00") { $mesmensal_look .= "Não é mensal" ;} 
 if ($this->mesmensal == "01") { $mesmensal_look .= "Janeiro" ;} 
 if ($this->mesmensal == "02") { $mesmensal_look .= "Fevereiro" ;} 
 if ($this->mesmensal == "03") { $mesmensal_look .= "Março" ;} 
 if ($this->mesmensal == "04") { $mesmensal_look .= "Abril" ;} 
 if ($this->mesmensal == "05") { $mesmensal_look .= "Maio" ;} 
 if ($this->mesmensal == "06") { $mesmensal_look .= "Junho" ;} 
 if ($this->mesmensal == "07") { $mesmensal_look .= "Julho" ;} 
 if ($this->mesmensal == "08") { $mesmensal_look .= "Agosto" ;} 
 if ($this->mesmensal == "09") { $mesmensal_look .= "Setembro" ;} 
 if ($this->mesmensal == "10") { $mesmensal_look .= "Outubro" ;} 
 if ($this->mesmensal == "11") { $mesmensal_look .= "Novembro" ;} 
 if ($this->mesmensal == "12") { $mesmensal_look .= "Dezembro" ;} 
 if (empty($mesmensal_look)) { $mesmensal_look = $this->mesmensal; }
?>
<input type="hidden" name="mesmensal" value="<?php echo $this->form_encode_input($mesmensal) . "\">" . $mesmensal_look . ""; ?>
<?php } else { ?>
<?php
...
$mesmensal_look = "";
 ...
 if (empty($mesmensal_look)) { $mesmensal_look = $this->mesmensal; }
?>
<span id="id_read_on_mesmensal" class="css_mesmensal_line"  style="<?php echo $sStyleReadLab_mesmensal; ?>"><?php echo $this->form_encode_input($mesmensal_look); ?></span><span id="id_read_off_mesmensal" class="css_read_off_mesmensal" style="white-space: nowrap; <?php echo $sStyleReadInp_mesmensal; ?>">
 <span id="idAjaxSelect_mesmensal"><select class="sc-js-input scFormObjectOdd css_mesmensal_obj" style="" id="id_sc_field_mesmensal" name="mesmensal" size="1" alt="{type: 'select', enterTab: false}">
 <option  value="00" <?php  if ($this->mesmensal == "00") { echo " selected" ;} ?><?php  if (empty($this->mesmensal)) { echo " selected" ;} ?>>Não é mensal</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lookup_mesmensal'][] = '00'; ?>
 <option  value="01" <?php  if ($this->mesmensal == "01") { echo " selected" ;} ?>>Janeiro</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lookup_mesmensal'][] = '01'; ?>
 <option  value="02" <?php  if ($this->mesmensal == "02") { echo " selected" ;} ?>>Fevereiro</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lookup_mesmensal'][] = '02'; ?>
 <option  value="03" <?php  if ($this->mesmensal == "03") { echo " selected" ;} ?>>Março</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lookup_mesmensal'][] = '03'; ?>
 <option  value="04" <?php  if ($this->mesmensal == "04") { echo " selected" ;} ?>>Abril</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lookup_mesmensal'][] = '04'; ?>
 <option  value="05" <?php  if ($this->mesmensal == "05") { echo " selected" ;} ?>>Maio</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lookup_mesmensal'][] = '05'; ?>
 <option  value="06" <?php  if ($this->mesmensal == "06") { echo " selected" ;} ?>>Junho</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lookup_mesmensal'][] = '06'; ?>
 <option  value="07" <?php  if ($this->mesmensal == "07") { echo " selected" ;} ?>>Julho</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lookup_mesmensal'][] = '07'; ?>
 <option  value="08" <?php  if ($this->mesmensal == "08") { echo " selected" ;} ?>>Agosto</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lookup_mesmensal'][] = '08'; ?>
 <option  value="09" <?php  if ($this->mesmensal == "09") { echo " selected" ;} ?>>Setembro</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lookup_mesmensal'][] = '09'; ?>
 <option  value="10" <?php  if ($this->mesmensal == "10") { echo " selected" ;} ?>>Outubro</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lookup_mesmensal'][] = '10'; ?>
 <option  value="11" <?php  if ($this->mesmensal == "11") { echo " selected" ;} ?>>Novembro</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lookup_mesmensal'][] = '11'; ?>
 <option  value="12" <?php  if ($this->mesmensal == "12") { echo " selected" ;} ?>>Dezembro</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lookup_mesmensal'][] = '12'; ?>
 </select></span>
</span><?php  }?>
...
$status_look = "";
 if ($this->status == "1") { $status_look .= "Agendado" ;} 
 if ($this->status == "2") { $status_look .= "Realizado" ;} 
 if ($this->status == "3") { $status_look .= "Descartado" ;} 
...
<span id="id_read_on_status" class="css_status_line"  style="<?php echo $sStyleReadLab_status; ?>"><?php echo $this->form_encode_input($status_look); ?></span><span id="id_read_off_status" class="css_read_off_status" style="white-space: nowrap; <?php echo $sStyleReadInp_status; ?>">
 ...
 <option  value="1" <?php  if ($this->status == "1") { echo " selected" ;} ?>>Agendado</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lookup_status'][] = '1'; ?>
 <option  value="2" <?php  if ($this->status == "2") { echo " selected" ;} ?>>Realizado</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lookup_status'][] = '2'; ?>
 <option  value="3" <?php  if ($this->status == "3") { echo " selected" ;} ?>>Descartado</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['Lookup_status'][] = '3'; ?>
 </select></span>
</span><?php  }?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_doacoes_auditoria_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_doacoes_auditoria_mob");
 parent.scAjaxDetailHeight("form_doacoes_auditoria_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditoria_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
