...
//
   ...
   $_SESSION['scriptcase']['app_Login']['glo_nm_perfil']          = "pabx";
   $_SESSION['scriptcase']['app_Login']['glo_nm_path_prod']       = "/principal/prod";
   $_SESSION['scriptcase']['app_Login']['glo_nm_path_imagens']    = "/principal/file/img";
   $_SESSION['scriptcase']['app_Login']['glo_nm_path_imag_temp']  = "/principal/tmp";
   $_SESSION['scriptcase']['app_Login']['glo_nm_path_doc']        = "/var/ww/doc";
   $_SESSION['scriptcase']['app_Login']['glo_con_unicep']         = "unicep";
   $NM_dir_atual = getcwd();
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      if (isset($_SESSION['sc_session'][$this->sc_page]['app_Login']['initialize']) && $_SESSION['sc_session'][$this->sc_page]['app_Login']['initialize'])  
      { 
          $this->conectDB();
          $_SESSION['sc_session'][$this->sc_page]['app_Login']['Gera_log_access'] = true;
      }
   }
...
/*NM*/            $_SESSION['scriptcase']['app_Login']['glo_nm_perfil'] = $NM_con_dest;
      ...
      if (!empty($perfil_trab))
      {
          ...
          carrega_perfil($_SESSION['scriptcase']['app_Login']['glo_con_unicep'], $this->path_libs, "S");
          $this->nm_con_unicep['servidor'] = $_SESSION['scriptcase']['glo_servidor'];
          $this->nm_con_unicep['usuario']  = $_SESSION['scriptcase']['glo_usuario'];
          $this->nm_con_unicep['banco']    = $_SESSION['scriptcase']['glo_banco'];
          $this->nm_con_unicep['senha']    = $_SESSION['scriptcase']['glo_senha'];
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'dinamica_publicado', 1, $this->force_db_utf8); 
      } 
      else 
      { 
...
// 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_Login']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_Login']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['app_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'dinamica_publicado', 1, $this->force_db_utf8);
    }
    else {
...
//
    ...
    if (isset($_POST['rs']) && !is_array($_POST['rs']) && 'ajax_' == substr($_POST['rs'], 0, 5) && isset($_POST['rsargs']) && !empty($_POST['rsargs']) && !isset($_SESSION['scriptcase']['app_Login']['session_timeout']['redir']))
    {
        ...
        if ('ajax_app_Login_validate_sc_field_0' == $_POST['rs'])
        {
    ...
    else
    {
        ...
        if (isset($_POST["logged_user"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['logged_user']);
        }
        ...
        if (isset($_POST["Instituição"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['Instituição']);
        }
    ...
    $inicial_app_Login->contr_app_Login->NM_ajax_info['select_html']['sc_field_0'] = " onClick=\"\" ";
    ...
    sajax_export("ajax_app_Login_validate_sc_field_0");
...
//
    ...
    function ajax_app_Login_validate_sc_field_0($sc_field_0, $script_case_init)
    {
        global $inicial_app_Login;
        //register_shutdown_function("app_Login_pack_ajax_response");
        $inicial_app_Login->contr_app_Login->NM_ajax_flag          = true;
        $inicial_app_Login->contr_app_Login->NM_ajax_opcao         = 'validate_sc_field_0';
        $inicial_app_Login->contr_app_Login->NM_ajax_info['param'] = array(
    ...
    function ajax_app_Login_submit_form($login, $pswd, $sc_field_0, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_app_Login;
        //register_shutdown_function("app_Login_pack_ajax_response");
        $inicial_app_Login->contr_app_Login->NM_ajax_flag          = true;
