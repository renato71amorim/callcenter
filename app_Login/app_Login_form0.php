...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sc_field_0_label" id="hidden_field_label_sc_field_0" style="<?php echo $sStyleHidden_sc_field_0; ?>"><span id="id_label_sc_field_0"><?php echo $this->nm_new_label['sc_field_0']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['php_cmp_required']['sc_field_0']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['php_cmp_required']['sc_field_0'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
