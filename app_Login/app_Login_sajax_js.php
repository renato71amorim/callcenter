...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate sc_field_0
  function do_ajax_app_Login_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldRadio(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_app_Login_validate_sc_field_0_cb);
  } // do_ajax_app_Login_validate_sc_field_0

  function do_ajax_app_Login_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_validate_sc_field_0_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_app_Login_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_Login_submit_form(var_login, var_pswd, var_sc_field_0, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_Login_submit_form_cb);
