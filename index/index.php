<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['index']['glo_nm_perfil']          = "unicep";
   ...
   $_SESSION['scriptcase']['index']['glo_nm_path_doc']        = "/var/ww/doc";
...
// 
      ...
      if (isset($_SESSION['scriptcase']['index']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['index']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['index']['actual_lang']) || $_SESSION['scriptcase']['index']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['index']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("index_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['index']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['index']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['index']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['index']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['index']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['index']['dashboard_info']['under_dashboard']))
      {
          ...
          $_SESSION['sc_session'][$this->sc_page]['index']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['index']['dashboard_info']['own_widget']      = '';
      ...
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['index']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['index']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['index']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['index']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['index']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
      ...
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['index']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['index']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['index']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['index']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['index']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['index']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['index']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['index']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['index']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['index']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["index"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["index"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['index']['session_timeout']['redir']))
      {
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['index']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['index']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['index']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "index_erro.class.php"); 
...
// 
      ...
      if (isset($_SESSION['scriptcase']['index']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['index']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['index']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['index']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['index']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['index']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
/*NM*/            $_SESSION['scriptcase']['index']['glo_nm_perfil'] = $NM_con_dest;
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['index']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['index']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['index']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['index']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['index']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['index']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['index']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['index']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['index']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['index']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['index']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['index']['glo_nm_conexao'], $this->root . $this->path_prod, 'dinamica_publicado', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           $delim  = "'";
           $delim1 = "'";
           if (isset($_SESSION['sc_session'][$this->sc_page]['index']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['index']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['index']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['index']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['index']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['index']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['index']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['index']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['index']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['index']['sc_outra_jan']))
      {
          ...
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['index']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('index') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['index']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "index_erro.class.php"); 
      $this->Erro      = new index_erro();
      $this->Erro->Ini = $this->Ini;
//
      $_SESSION['scriptcase']['index']['contr_erro'] = 'on';
if (!isset($_SESSION['IP_AUTOMATICO_DESENVOLVIMENTO'])) {$_SESSION['IP_AUTOMATICO_DESENVOLVIMENTO'] = "";}
if (!isset($this->sc_temp_IP_AUTOMATICO_DESENVOLVIMENTO)) {$this->sc_temp_IP_AUTOMATICO_DESENVOLVIMENTO = (isset($_SESSION['IP_AUTOMATICO_DESENVOLVIMENTO'])) ? $_SESSION['IP_AUTOMATICO_DESENVOLVIMENTO'] : "";}
if (!isset($_SESSION['EM_DESENVOLVIMENTO'])) {$_SESSION['EM_DESENVOLVIMENTO'] = "";}
if (!isset($this->sc_temp_EM_DESENVOLVIMENTO)) {$this->sc_temp_EM_DESENVOLVIMENTO = (isset($_SESSION['EM_DESENVOLVIMENTO'])) ? $_SESSION['EM_DESENVOLVIMENTO'] : "";}
 header("Cache-Control: no-cache, must-revalidate"); 
header("Expires: Sat, 26 Jul 1997 05:00:00 GMT");

 if (isset($this->sc_temp_EM_DESENVOLVIMENTO)) {$_SESSION['EM_DESENVOLVIMENTO'] = $this->sc_temp_EM_DESENVOLVIMENTO;}
 if (isset($this->sc_temp_IP_AUTOMATICO_DESENVOLVIMENTO)) {$_SESSION['IP_AUTOMATICO_DESENVOLVIMENTO'] = $this->sc_temp_IP_AUTOMATICO_DESENVOLVIMENTO;}
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('app_Login') . "/", $this->nm_location, "","_self", 440, 630, "ret_self");
 };
...
$IP_AUTOMATICO_DESENVOLVIMENTO = 'dinamica.dyndns.org';
 ...
 if (isset($EM_DESENVOLVIMENTO)) {$this->sc_temp_EM_DESENVOLVIMENTO = $EM_DESENVOLVIMENTO;}
;
 if (isset($IP_AUTOMATICO_DESENVOLVIMENTO)) {$this->sc_temp_IP_AUTOMATICO_DESENVOLVIMENTO = $IP_AUTOMATICO_DESENVOLVIMENTO;}
;
if (isset($this->sc_temp_EM_DESENVOLVIMENTO)) {$_SESSION['EM_DESENVOLVIMENTO'] = $this->sc_temp_EM_DESENVOLVIMENTO;}
if (isset($this->sc_temp_IP_AUTOMATICO_DESENVOLVIMENTO)) {$_SESSION['IP_AUTOMATICO_DESENVOLVIMENTO'] = $this->sc_temp_IP_AUTOMATICO_DESENVOLVIMENTO;}
...
<?php
   ...
   function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $alt_modal=0, $larg_modal=0, $opc="")
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['index']['iframe_print']) && $_SESSION['sc_session'][$this->Ini->sc_page]['index']['iframe_print'] )
      {
          $target = "_parent";
      }
   ?>
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['index']['glo_nm_path_imag_temp'] . "/sc_apl_default_dinamica_publicado.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['index']['glo_nm_path_imag_temp'] . "/sc_apl_default_dinamica_publicado.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "index") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['index']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['index']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['index']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_dinamica_publicado'])) {
               $_SESSION['scriptcase']['index']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_dinamica_publicado'];
           }
       }
   }
