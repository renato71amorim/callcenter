  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_setor_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_setor_mob_form();
	}

  // ---------- Validate codigosetor
  function do_ajax_form_setor_mob_validate_codigosetor()
  {
    var nomeCampo_codigosetor = "codigosetor";
    var var_codigosetor = scAjaxGetFieldHidden(nomeCampo_codigosetor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_setor_mob_validate_codigosetor(var_codigosetor, var_script_case_init, do_ajax_form_setor_mob_validate_codigosetor_cb);
  } // do_ajax_form_setor_mob_validate_codigosetor

  function do_ajax_form_setor_mob_validate_codigosetor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codigosetor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_setor_mob_validate_codigosetor_cb

  // ---------- Validate descricao
  function do_ajax_form_setor_mob_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_setor_mob_validate_descricao(var_descricao, var_script_case_init, do_ajax_form_setor_mob_validate_descricao_cb);
  } // do_ajax_form_setor_mob_validate_descricao

  function do_ajax_form_setor_mob_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_setor_mob_validate_descricao_cb

  // ---------- Validate ddd
  function do_ajax_form_setor_mob_validate_ddd()
  {
    var nomeCampo_ddd = "ddd";
    var var_ddd = scAjaxGetFieldText(nomeCampo_ddd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_setor_mob_validate_ddd(var_ddd, var_script_case_init, do_ajax_form_setor_mob_validate_ddd_cb);
  } // do_ajax_form_setor_mob_validate_ddd

  function do_ajax_form_setor_mob_validate_ddd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ddd";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_setor_mob_validate_ddd_cb

  // ---------- Validate defaltddd
  function do_ajax_form_setor_mob_validate_defaltddd()
  {
    var nomeCampo_defaltddd = "defaltddd";
    var var_defaltddd = scAjaxGetFieldText(nomeCampo_defaltddd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_setor_mob_validate_defaltddd(var_defaltddd, var_script_case_init, do_ajax_form_setor_mob_validate_defaltddd_cb);
  } // do_ajax_form_setor_mob_validate_defaltddd

  function do_ajax_form_setor_mob_validate_defaltddd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "defaltddd";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_setor_mob_validate_defaltddd_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_setor_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_setor_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_codigosetor = scAjaxGetFieldHidden("codigosetor");
    var var_descricao = scAjaxGetFieldText("descricao");
    var var_ddd = scAjaxGetFieldText("ddd");
    var var_defaltddd = scAjaxGetFieldText("defaltddd");
    ...
    scAjaxProcOn();
    x_ajax_form_setor_mob_submit_form(var_codigosetor, var_descricao, var_ddd, var_defaltddd, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_setor_mob_submit_form_cb);
  } // do_ajax_form_setor_mob_submit_form

  function do_ajax_form_setor_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("codigosetor");
      scAjaxHideErrorDisplay("descricao");
      scAjaxHideErrorDisplay("ddd");
      scAjaxHideErrorDisplay("defaltddd");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_setor_mob_submit_form_cb_after_alert);
  } // do_ajax_form_setor_mob_submit_form_cb
  function do_ajax_form_setor_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_setor_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_setor_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("ddd");
    scAjaxHideErrorDisplay("defaltddd");
    var var_codigosetor = document.F2.codigosetor.value;
    ...
    scAjaxProcOn();
    x_ajax_form_setor_mob_navigate_form(var_codigosetor, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_setor_mob_navigate_form_cb);
  } // do_ajax_form_setor_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_setor_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_setor_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.codigosetor.value = scAjaxGetKeyValue("codigosetor");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_setor_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_setor_mob_navigate_form_cb
  function do_ajax_form_setor_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_setor_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_setor_mob_navigate_form_cb_after_alert
  function sc_hide_form_setor_mob_form()
  {
  ...
  ajax_field_list[0] = "codigosetor";
  ajax_field_list[1] = "descricao";
  ajax_field_list[2] = "ddd";
  ajax_field_list[3] = "defaltddd";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "codigosetor": {"label": "Codigo Setor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "defaltddd": {"label": "Defalt DDD", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "codigosetor": new Array(),
    "descricao": new Array(),
    "ddd": new Array(),
    "defaltddd": new Array()
  };
  ajax_field_mult["codigosetor"][1] = "codigosetor";
  ajax_field_mult["descricao"][1] = "descricao";
  ajax_field_mult["ddd"][1] = "ddd";
  ajax_field_mult["defaltddd"][1] = "defaltddd";

  var ajax_field_id = {
    "codigosetor": new Array("hidden_field_label_codigosetor", "hidden_field_data_codigosetor"),
    ...
    "defaltddd": new Array("hidden_field_label_defaltddd", "hidden_field_data_defaltddd")
  };
