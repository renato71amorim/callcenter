  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_setor" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_setor_form();
	}

  // ---------- Validate codigosetor
  function do_ajax_form_setor_validate_codigosetor()
  {
    var nomeCampo_codigosetor = "codigosetor";
    var var_codigosetor = scAjaxGetFieldHidden(nomeCampo_codigosetor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_setor_validate_codigosetor(var_codigosetor, var_script_case_init, do_ajax_form_setor_validate_codigosetor_cb);
  } // do_ajax_form_setor_validate_codigosetor

  function do_ajax_form_setor_validate_codigosetor_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_setor_validate_codigosetor_cb

  // ---------- Validate descricao
  function do_ajax_form_setor_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_setor_validate_descricao(var_descricao, var_script_case_init, do_ajax_form_setor_validate_descricao_cb);
  } // do_ajax_form_setor_validate_descricao

  function do_ajax_form_setor_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_setor_validate_descricao_cb

  // ---------- Validate ddd
  function do_ajax_form_setor_validate_ddd()
  {
    var nomeCampo_ddd = "ddd";
    var var_ddd = scAjaxGetFieldText(nomeCampo_ddd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_setor_validate_ddd(var_ddd, var_script_case_init, do_ajax_form_setor_validate_ddd_cb);
  } // do_ajax_form_setor_validate_ddd

  function do_ajax_form_setor_validate_ddd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ddd";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_setor_validate_ddd_cb

  // ---------- Validate defaltddd
  function do_ajax_form_setor_validate_defaltddd()
  {
    var nomeCampo_defaltddd = "defaltddd";
    var var_defaltddd = scAjaxGetFieldText(nomeCampo_defaltddd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_setor_validate_defaltddd(var_defaltddd, var_script_case_init, do_ajax_form_setor_validate_defaltddd_cb);
  } // do_ajax_form_setor_validate_defaltddd

  function do_ajax_form_setor_validate_defaltddd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_setor_validate_defaltddd_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_setor_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_setor_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_setor_submit_form(var_codigosetor, var_descricao, var_ddd, var_defaltddd, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_setor_submit_form_cb);
  } // do_ajax_form_setor_submit_form

  function do_ajax_form_setor_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_setor_submit_form_cb_after_alert);
  } // do_ajax_form_setor_submit_form_cb
  function do_ajax_form_setor_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_setor_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_setor_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_setor_navigate_form(var_codigosetor, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_setor_navigate_form_cb);
  } // do_ajax_form_setor_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_setor']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_setor_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_setor_navigate_form_cb_after_alert);
  } // do_ajax_form_setor_navigate_form_cb
  function do_ajax_form_setor_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_setor_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_setor_navigate_form_cb_after_alert
  function sc_hide_form_setor_form()
  {
