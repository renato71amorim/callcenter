...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_Dados_Graficos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_Dados_Graficos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_Dados_Graficos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_Dados_Graficos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_Dados_Graficos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_Dados_Graficos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_Dados_Graficos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_Dados_Graficos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_Dados_Graficos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_Dados_Graficos']['embutida_filho'] as $ind => $sc_init)
          {
