<?php
@session_start() ;
$_SESSION['scriptcase']['grid_Dados_Graficos']['sc_process_barr'] = true;
require_once('../grid_Dados_Graficos/index.php');
unset($_SESSION['scriptcase']['grid_Dados_Graficos']['sc_process_barr']);
$ExportCtrl = new grid_Dados_Graficos_export_control;
$ExportCtrl->Export_barr();

class grid_Dados_Graficos_export_control
{
