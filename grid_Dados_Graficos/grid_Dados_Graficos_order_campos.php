...
<?php
   ...
   $Ord_Cmp = new grid_Dados_Graficos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_Dados_Graficos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["user"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['labels']["user"])) ? $_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['labels']["user"] : "Usuário";
   $tab_ger_campos['ligacoes'] = "on";
   $tab_def_campos['ligacoes'] = "ligacoes";
   $tab_labels["ligacoes"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['labels']["ligacoes"])) ? $_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['labels']["ligacoes"] : "Ligações";
   $tab_ger_campos['doacao'] = "on";
   $tab_def_campos['doacao'] = "doacao";
   $tab_labels["doacao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['labels']["doacao"])) ? $_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['labels']["doacao"] : "Doações";
   $tab_ger_campos['percentual'] = "on";
   $tab_def_campos['percentual'] = "percentual";
   $tab_labels["percentual"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['labels']["percentual"])) ? $_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['labels']["percentual"] : "Percentual";
   $tab_ger_campos['valor'] = "on";
   $tab_def_campos['valor'] = "valor";
   $tab_labels["valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['labels']["valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['labels']["valor"] : "Valor";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['ordem_quebra'] as $campo => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_Dados_Graficos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_Dados_Graficos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
