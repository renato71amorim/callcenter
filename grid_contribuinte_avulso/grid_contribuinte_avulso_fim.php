...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_contribuinte_avulso"]))
   {
      unset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_contribuinte_avulso"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_contribuinte_avulso']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_contribuinte_avulso']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_contribuinte_avulso']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_contribuinte_avulso']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_contribuinte_avulso']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_contribuinte_avulso</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_contribuinte_avulso']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_contribuinte_avulso']['embutida_filho'] as $ind => $sc_init)
          {
