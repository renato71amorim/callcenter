...
<?php
   ...
   $Ord_Cmp = new grid_codigos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_codigos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_codigos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_codigos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["codigorua"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_codigos']['labels']["codigorua"])) ? $_SESSION['sc_session'][$sc_init]['grid_codigos']['labels']["codigorua"] : "Codigo Rua";
   $tab_ger_campos['codigocontribuinte'] = "on";
   $tab_def_campos['codigocontribuinte'] = "CodigoContribuinte";
   $tab_labels["codigocontribuinte"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_codigos']['labels']["codigocontribuinte"])) ? $_SESSION['sc_session'][$sc_init]['grid_codigos']['labels']["codigocontribuinte"] : "Codigo Contribuinte";
   $tab_ger_campos['codigooperador'] = "on";
   $tab_def_campos['codigooperador'] = "CodigoOperador";
   $tab_labels["codigooperador"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_codigos']['labels']["codigooperador"])) ? $_SESSION['sc_session'][$sc_init]['grid_codigos']['labels']["codigooperador"] : "Codigo Operador";
   $tab_ger_campos['codigocobrador'] = "on";
   $tab_def_campos['codigocobrador'] = "CodigoCobrador";
   $tab_labels["codigocobrador"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_codigos']['labels']["codigocobrador"])) ? $_SESSION['sc_session'][$sc_init]['grid_codigos']['labels']["codigocobrador"] : "Codigo Cobrador";
   $tab_ger_campos['serie'] = "on";
   $tab_def_campos['serie'] = "Serie";
   $tab_labels["serie"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_codigos']['labels']["serie"])) ? $_SESSION['sc_session'][$sc_init]['grid_codigos']['labels']["serie"] : "Serie";
   $tab_ger_campos['numerorecibo'] = "on";
   $tab_def_campos['numerorecibo'] = "NumeroRecibo";
   $tab_labels["numerorecibo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_codigos']['labels']["numerorecibo"])) ? $_SESSION['sc_session'][$sc_init]['grid_codigos']['labels']["numerorecibo"] : "Numero Recibo";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_codigos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_codigos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_codigos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_codigos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_codigos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_codigos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_codigos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_codigos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_codigos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_codigos']['ordem_quebra'] as $campo => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_codigos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_codigos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_codigos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_codigos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_codigos']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_codigos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_codigos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_codigos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
