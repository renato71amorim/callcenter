<?php
@session_start() ;
$_SESSION['scriptcase']['grid_codigos']['sc_process_barr'] = true;
require_once('../grid_codigos/index.php');
unset($_SESSION['scriptcase']['grid_codigos']['sc_process_barr']);
$ExportCtrl = new grid_codigos_export_control;
$ExportCtrl->Export_barr();

class grid_codigos_export_control
{
