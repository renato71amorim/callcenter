  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_financeiro" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_financeiro_form();
	}

  // ---------- Validate codigoidentificador_
  function do_ajax_form_financeiro_validate_codigoidentificador_(iNumLinha)
  {
    var nomeCampo_codigoidentificador_ = "codigoidentificador_" + iNumLinha;
    var var_codigoidentificador_ = scAjaxGetFieldText(nomeCampo_codigoidentificador_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_financeiro_validate_codigoidentificador_(var_codigoidentificador_, iNumLinha, var_script_case_init, do_ajax_form_financeiro_validate_codigoidentificador__cb);
  } // do_ajax_form_financeiro_validate_codigoidentificador_

  function do_ajax_form_financeiro_validate_codigoidentificador__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "codigoidentificador_" + iLineNumber;
    }
    else
    {
      sFieldValid = "codigoidentificador_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "codigoidentificador_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "codigoidentificador_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_financeiro_validate_codigoidentificador__cb

  // ---------- Validate codigo_
  function do_ajax_form_financeiro_validate_codigo_(iNumLinha)
  {
    var nomeCampo_codigo_ = "codigo_" + iNumLinha;
    var var_codigo_ = scAjaxGetFieldText(nomeCampo_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_financeiro_validate_codigo_(var_codigo_, iNumLinha, var_script_case_init, do_ajax_form_financeiro_validate_codigo__cb);
  } // do_ajax_form_financeiro_validate_codigo_

  function do_ajax_form_financeiro_validate_codigo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_financeiro_validate_codigo__cb

  // ---------- Validate operadoravulso_
  function do_ajax_form_financeiro_validate_operadoravulso_(iNumLinha)
  {
    var nomeCampo_operadoravulso_ = "operadoravulso_" + iNumLinha;
    var var_operadoravulso_ = scAjaxGetFieldSelect(nomeCampo_operadoravulso_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_financeiro_validate_operadoravulso_(var_operadoravulso_, iNumLinha, var_script_case_init, do_ajax_form_financeiro_validate_operadoravulso__cb);
  } // do_ajax_form_financeiro_validate_operadoravulso_

  function do_ajax_form_financeiro_validate_operadoravulso__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "operadoravulso_" + iLineNumber;
    }
    else
    {
      sFieldValid = "operadoravulso_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "operadoravulso_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "operadoravulso_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_financeiro_validate_operadoravulso__cb

  // ---------- Validate valoravulso_
  function do_ajax_form_financeiro_validate_valoravulso_(iNumLinha)
  {
    var nomeCampo_valoravulso_ = "valoravulso_" + iNumLinha;
    var var_valoravulso_ = scAjaxGetFieldText(nomeCampo_valoravulso_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_financeiro_validate_valoravulso_(var_valoravulso_, iNumLinha, var_script_case_init, do_ajax_form_financeiro_validate_valoravulso__cb);
  } // do_ajax_form_financeiro_validate_valoravulso_

  function do_ajax_form_financeiro_validate_valoravulso__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "valoravulso_" + iLineNumber;
    }
    else
    {
      sFieldValid = "valoravulso_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "valoravulso_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "valoravulso_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_financeiro_validate_valoravulso__cb

  // ---------- Validate dataemissao_
  function do_ajax_form_financeiro_validate_dataemissao_(iNumLinha)
  {
    var nomeCampo_dataemissao_ = "dataemissao_" + iNumLinha;
    var var_dataemissao_ = scAjaxGetFieldText(nomeCampo_dataemissao_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_financeiro_validate_dataemissao_(var_dataemissao_, iNumLinha, var_script_case_init, do_ajax_form_financeiro_validate_dataemissao__cb);
  } // do_ajax_form_financeiro_validate_dataemissao_

  function do_ajax_form_financeiro_validate_dataemissao__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "dataemissao_" + iLineNumber;
    }
    else
    {
      sFieldValid = "dataemissao_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "dataemissao_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "dataemissao_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_financeiro_validate_dataemissao__cb

  // ---------- Validate datavencimento_
  function do_ajax_form_financeiro_validate_datavencimento_(iNumLinha)
  {
    var nomeCampo_datavencimento_ = "datavencimento_" + iNumLinha;
    var var_datavencimento_ = scAjaxGetFieldText(nomeCampo_datavencimento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_financeiro_validate_datavencimento_(var_datavencimento_, iNumLinha, var_script_case_init, do_ajax_form_financeiro_validate_datavencimento__cb);
  } // do_ajax_form_financeiro_validate_datavencimento_

  function do_ajax_form_financeiro_validate_datavencimento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "datavencimento_" + iLineNumber;
    }
    else
    {
      sFieldValid = "datavencimento_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "datavencimento_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "datavencimento_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_financeiro_validate_datavencimento__cb

  // ---------- Validate obstemp_
  function do_ajax_form_financeiro_validate_obstemp_(iNumLinha)
  {
    var nomeCampo_obstemp_ = "obstemp_" + iNumLinha;
    var var_obstemp_ = scAjaxGetFieldText(nomeCampo_obstemp_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_financeiro_validate_obstemp_(var_obstemp_, iNumLinha, var_script_case_init, do_ajax_form_financeiro_validate_obstemp__cb);
  } // do_ajax_form_financeiro_validate_obstemp_

  function do_ajax_form_financeiro_validate_obstemp__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "obstemp_" + iLineNumber;
    }
    else
    {
      sFieldValid = "obstemp_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "obstemp_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "obstemp_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_financeiro_validate_obstemp__cb

  // ---------- Validate status_
  function do_ajax_form_financeiro_validate_status_(iNumLinha)
  {
    var nomeCampo_status_ = "status_" + iNumLinha;
    var var_status_ = scAjaxGetFieldText(nomeCampo_status_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_financeiro_validate_status_(var_status_, iNumLinha, var_script_case_init, do_ajax_form_financeiro_validate_status__cb);
  } // do_ajax_form_financeiro_validate_status_

  function do_ajax_form_financeiro_validate_status__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_financeiro_validate_status__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_financeiro_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_financeiro_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_financeiro_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_financeiro_add_new_line_cb);
  } // do_ajax_form_financeiro_add_new_line

  function do_ajax_form_financeiro_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_financeiro_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_financeiro_backup_line(iNumLinha)
  {
    var var_codigoidentificador_ = scAjaxGetFieldText("codigoidentificador_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_financeiro_backup_line(var_codigoidentificador_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_financeiro_backup_line_cb);
  } // do_ajax_form_financeiro_backup_line

  function do_ajax_form_financeiro_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_financeiro_backup_line_cb

  function do_ajax_form_financeiro_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_financeiro_cancel_insert

  function do_ajax_form_financeiro_cancel_update(iSeqVert)
  {
    do_ajax_form_financeiro_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_financeiro_cancel_update

  function do_ajax_form_financeiro_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_financeiro_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_financeiro_table_refresh()
  {
    var var_codigoidentificador_ = document.F2.codigoidentificador_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_financeiro_table_refresh(var_codigoidentificador_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_financeiro_table_refresh_cb);
  } //  do_ajax_form_financeiro_table_refresh

  function do_ajax_form_financeiro_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.codigoidentificador_.value = scAjaxGetKeyValue("codigoidentificador_");
    ...
    scAjaxAlert(do_ajax_form_financeiro_table_refresh_cb_after_alert);
  } // do_ajax_form_financeiro_table_refresh_cb
  function do_ajax_form_financeiro_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_financeiro_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_financeiro_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_financeiro_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_operadoravulso_ = scAjaxGetFieldSelect("operadoravulso_" + iNumLinha);
    var var_valoravulso_ = scAjaxGetFieldText("valoravulso_" + iNumLinha);
    var var_dataemissao_ = scAjaxGetFieldText("dataemissao_" + iNumLinha);
    var var_datavencimento_ = scAjaxGetFieldText("datavencimento_" + iNumLinha);
    var var_obstemp_ = scAjaxGetFieldText("obstemp_" + iNumLinha);
    var var_status_ = scAjaxGetFieldText("status_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_financeiro_submit_form(var_codigoidentificador_, var_codigo_, var_operadoravulso_, var_valoravulso_, var_dataemissao_, var_datavencimento_, var_obstemp_, var_status_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_financeiro_submit_form_cb);
  } // do_ajax_form_financeiro_submit_form

  function do_ajax_form_financeiro_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("codigoidentificador_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("codigo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("operadoravulso_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("valoravulso_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("dataemissao_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("datavencimento_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("obstemp_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_financeiro_submit_form_cb_after_alert);
  } // do_ajax_form_financeiro_submit_form_cb
  function do_ajax_form_financeiro_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_financeiro_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_financeiro_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_financeiro_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("codigoidentificador_" + iNavForm);
      scAjaxHideErrorDisplay("codigo_" + iNavForm);
      scAjaxHideErrorDisplay("operadoravulso_" + iNavForm);
      scAjaxHideErrorDisplay("valoravulso_" + iNavForm);
      scAjaxHideErrorDisplay("dataemissao_" + iNavForm);
      scAjaxHideErrorDisplay("datavencimento_" + iNavForm);
      scAjaxHideErrorDisplay("obstemp_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_financeiro_navigate_form(var_codigoidentificador_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_financeiro_navigate_form_cb);
  } // do_ajax_form_financeiro_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_financeiro']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_financeiro_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.codigoidentificador_.value = scAjaxGetKeyValue("codigoidentificador_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_financeiro_navigate_form_cb_after_alert);
  } // do_ajax_form_financeiro_navigate_form_cb
  function do_ajax_form_financeiro_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_financeiro_navigate_form_cb_after_alert
  function sc_hide_form_financeiro_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "codigoidentificador_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "codigo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "operadoravulso_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "valoravulso_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "dataemissao_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "datavencimento_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "obstemp_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "status_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["codigoidentificador_" + iNumLinha] = {"label": "Codigo Identificador<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["operadoravulso_" + iNumLinha] = {"label": "Op Avulso<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["valoravulso_" + iNumLinha] = {"label": "Vlr Avulso<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["dataemissao_" + iNumLinha] = {"label": "Emissão<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["datavencimento_" + iNumLinha] = {"label": "Vencto<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["obstemp_" + iNumLinha] = {"label": "Obs Temp<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["codigoidentificador_"][iNumLinha] = "codigoidentificador_" + iNumLinha;
    ajax_field_mult["codigo_"][iNumLinha] = "codigo_" + iNumLinha;
    ajax_field_mult["operadoravulso_"][iNumLinha] = "operadoravulso_" + iNumLinha;
    ajax_field_mult["valoravulso_"][iNumLinha] = "valoravulso_" + iNumLinha;
    ajax_field_mult["dataemissao_"][iNumLinha] = "dataemissao_" + iNumLinha;
    ajax_field_mult["datavencimento_"][iNumLinha] = "datavencimento_" + iNumLinha;
    ajax_field_mult["obstemp_"][iNumLinha] = "obstemp_" + iNumLinha;
    ...
    ajax_field_id["operadoravulso_" + iNumLinha] = new Array("hidden_field_label_operadoravulso_", "hidden_field_data_operadoravulso_" + iNumLinha);
    ajax_field_id["valoravulso_" + iNumLinha] = new Array("hidden_field_label_valoravulso_", "hidden_field_data_valoravulso_" + iNumLinha);
    ajax_field_id["dataemissao_" + iNumLinha] = new Array("hidden_field_label_dataemissao_", "hidden_field_data_dataemissao_" + iNumLinha);
    ajax_field_id["datavencimento_" + iNumLinha] = new Array("hidden_field_label_datavencimento_", "hidden_field_data_datavencimento_" + iNumLinha);
    ajax_field_id["obstemp_" + iNumLinha] = new Array("hidden_field_label_obstemp_", "hidden_field_data_obstemp_" + iNumLinha);
    ajax_field_id["status_" + iNumLinha] = new Array("hidden_field_label_status_", "hidden_field_data_status_" + iNumLinha);
    ajax_error_count["codigoidentificador_" + iNumLinha] = "off";
    ajax_error_count["codigo_" + iNumLinha] = "off";
    ajax_error_count["operadoravulso_" + iNumLinha] = "off";
    ajax_error_count["valoravulso_" + iNumLinha] = "off";
    ajax_error_count["dataemissao_" + iNumLinha] = "off";
    ajax_error_count["datavencimento_" + iNumLinha] = "off";
    ajax_error_count["obstemp_" + iNumLinha] = "off";
    ajax_error_count["status_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["codigoidentificador_" + iNumLinha] = "on";
    ajax_read_only["codigo_" + iNumLinha] = "off";
    ajax_read_only["operadoravulso_" + iNumLinha] = "off";
    ajax_read_only["valoravulso_" + iNumLinha] = "off";
    ajax_read_only["dataemissao_" + iNumLinha] = "off";
    ajax_read_only["datavencimento_" + iNumLinha] = "off";
    ajax_read_only["obstemp_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["operadoravulso_" + iNumLinha] = "on";
    ajax_read_only["valoravulso_" + iNumLinha] = "on";
    ajax_read_only["dataemissao_" + iNumLinha] = "on";
    ajax_read_only["datavencimento_" + iNumLinha] = "on";
    ajax_read_only["obstemp_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["codigoidentificador_" + iNumLinha] = null;
    ajax_error_list["codigo_" + iNumLinha] = null;
    ajax_error_list["operadoravulso_" + iNumLinha] = null;
    ajax_error_list["valoravulso_" + iNumLinha] = null;
    ajax_error_list["dataemissao_" + iNumLinha] = null;
    ajax_error_list["datavencimento_" + iNumLinha] = null;
    ajax_error_list["obstemp_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "codigoidentificador_": new Array(),
    "codigo_": new Array(),
    "operadoravulso_": new Array(),
    "valoravulso_": new Array(),
    "dataemissao_": new Array(),
    "datavencimento_": new Array(),
    "obstemp_": new Array(),
    "status_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["codigoidentificador_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["codigoidentificador_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["codigoidentificador_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["codigoidentificador_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["codigoidentificador_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["operadoravulso_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["operadoravulso_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["operadoravulso_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["operadoravulso_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["operadoravulso_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["valoravulso_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["valoravulso_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["valoravulso_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["valoravulso_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["valoravulso_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["dataemissao_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["dataemissao_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["dataemissao_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["dataemissao_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["dataemissao_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["datavencimento_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["datavencimento_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["datavencimento_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["datavencimento_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["datavencimento_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["obstemp_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["obstemp_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["obstemp_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["obstemp_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["obstemp_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['codigoidentificador_'])) ? $this->nmgp_cmp_readonly['codigoidentificador_'] : 'on';
?>
    scAjaxFieldRead("codigoidentificador_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['operadoravulso_'])) ? $this->nmgp_cmp_readonly['operadoravulso_'] : 'off';
?>
    scAjaxFieldRead("operadoravulso_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['valoravulso_'])) ? $this->nmgp_cmp_readonly['valoravulso_'] : 'off';
?>
    scAjaxFieldRead("valoravulso_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['dataemissao_'])) ? $this->nmgp_cmp_readonly['dataemissao_'] : 'off';
?>
    scAjaxFieldRead("dataemissao_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['datavencimento_'])) ? $this->nmgp_cmp_readonly['datavencimento_'] : 'off';
?>
    scAjaxFieldRead("datavencimento_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['obstemp_'])) ? $this->nmgp_cmp_readonly['obstemp_'] : 'off';
?>
    scAjaxFieldRead("obstemp_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("codigoidentificador_" + iSeq, "on");
    scAjaxFieldRead("codigo_" + iSeq, "on");
    scAjaxFieldRead("operadoravulso_" + iSeq, "on");
    scAjaxFieldRead("valoravulso_" + iSeq, "on");
    scAjaxFieldRead("dataemissao_" + iSeq, "on");
    scAjaxFieldRead("datavencimento_" + iSeq, "on");
    scAjaxFieldRead("obstemp_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["codigoidentificador_" + iRow] || "on" == ajax_error_count["codigo_" + iRow] || "on" == ajax_error_count["operadoravulso_" + iRow] || "on" == ajax_error_count["valoravulso_" + iRow] || "on" == ajax_error_count["dataemissao_" + iRow] || "on" == ajax_error_count["datavencimento_" + iRow] || "on" == ajax_error_count["obstemp_" + iRow] || "on" == ajax_error_count["status_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_codigoidentificador_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_codigo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_operadoravulso_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_valoravulso_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_dataemissao_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_datavencimento_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_obstemp_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["codigoidentificador_" + iRow] && "off" == ajax_error_count["codigo_" + iRow] && "off" == ajax_error_count["operadoravulso_" + iRow] && "off" == ajax_error_count["valoravulso_" + iRow] && "off" == ajax_error_count["dataemissao_" + iRow] && "off" == ajax_error_count["datavencimento_" + iRow] && "off" == ajax_error_count["obstemp_" + iRow] && "off" == ajax_error_count["status_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["codigoidentificador_" + iRow] = "off";
        ajax_error_count["codigo_" + iRow] = "off";
        ajax_error_count["operadoravulso_" + iRow] = "off";
        ajax_error_count["valoravulso_" + iRow] = "off";
        ajax_error_count["dataemissao_" + iRow] = "off";
        ajax_error_count["datavencimento_" + iRow] = "off";
        ajax_error_count["obstemp_" + iRow] = "off";
      ...
      $("#hidden_field_data_codigoidentificador_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_codigo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_operadoravulso_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_valoravulso_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_dataemissao_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_datavencimento_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_obstemp_" + iRow).removeClass("scFormErrorLine");
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("codigoidentificador_" == sIndex)
    {
