<?php
@session_start() ;
$_SESSION['scriptcase']['grid_vicidial_list_1']['sc_process_barr'] = true;
require_once('../grid1/index.php');
unset($_SESSION['scriptcase']['grid_vicidial_list_1']['sc_process_barr']);
$ExportCtrl = new grid_vicidial_list_1_export_control;
$ExportCtrl->Export_barr();

class grid_vicidial_list_1_export_control
{
