...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "last_login_date";$Nm_datas[] = "last_login_date";$Nm_numeric[] = "user_id";$Nm_numeric[] = "user_level";$Nm_numeric[] = "qc_user_level";$Nm_numeric[] = "failed_login_count";$Nm_numeric[] = "max_inbound_calls";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_full_name_cond" name="full_name_cond" onChange="nm_campos_between(document.getElementById('id_vis_full_name'), this, 'full_name')">
      ...
      <br><span id="id_hide_full_name"  <?php echo $str_hide_full_name?>><?php
      if ($full_name != "")
      {
      $full_name_look = substr($this->Db->qstr($full_name), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_user_id_cond" name="user_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_user_id'), this, 'user_id')">
      ...
      <br><span id="id_hide_user_id"  <?php echo $str_hide_user_id?>><?php
      if ($user_id != "")
      {
      $user_id_look = substr($this->Db->qstr($user_id), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_user_id" name="user_id_autocomp" size="9"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_user_id"  <?php echo $str_display_user_id; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_user_id_input_2" name="user_id_input_2" value="<?php echo NM_encode_input($user_id_input_2) ?>"  size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_user_cond" name="user_cond" onChange="nm_campos_between(document.getElementById('id_vis_user'), this, 'user')">
      ...
      <br><span id="id_hide_user"  <?php echo $str_hide_user?>><?php
      if ($user != "")
      {
      $user_look = substr($this->Db->qstr($user), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_pass_cond" name="pass_cond" onChange="nm_campos_between(document.getElementById('id_vis_pass'), this, 'pass')">
      ...
      <br><span id="id_hide_pass"  <?php echo $str_hide_pass?>><?php
      if ($pass != "")
      {
      $pass_look = substr($this->Db->qstr($pass), 1, -1); 
      $nmgp_def_dados = array(); 
