...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_vicidial_users"]))
   {
      unset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_vicidial_users"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_vicidial_users'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_vicidial_users']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_vicidial_users']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_vicidial_users']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_vicidial_users']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_vicidial_users']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_vicidial_users</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_vicidial_users']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_vicidial_users']['embutida_filho'] as $ind => $sc_init)
          {
