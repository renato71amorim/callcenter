<?php
@session_start() ;
$_SESSION['scriptcase']['grid_vicidial_users']['sc_process_barr'] = true;
require_once('../grid_vicidial_users/index.php');
unset($_SESSION['scriptcase']['grid_vicidial_users']['sc_process_barr']);
$ExportCtrl = new grid_vicidial_users_export_control;
$ExportCtrl->Export_barr();

class grid_vicidial_users_export_control
{
