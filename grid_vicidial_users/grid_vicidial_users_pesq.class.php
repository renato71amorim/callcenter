...
class grid_vicidial_users_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_vicidial_users_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_vicidial_users_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_vicidial_users_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_full_name')
      {
          $full_name = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_full_name($full_name);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_user_id')
      {
          $user_id = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_user_id($user_id);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_pass')
      {
          $pass = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_pass($pass);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_full_name($full_name)
   {
      $full_name = substr($this->Db->qstr($full_name), 1, -1);
            $full_name_look = substr($this->Db->qstr($full_name), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct full_name from " . $this->Ini->nm_tabela . " where user_level = 1     and user_id > 2 and  full_name like '%" . $full_name . "%' order by full_name"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_user_id($user_id)
   {
      $user_id = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $user_id);
      $user_id = substr($this->Db->qstr($user_id), 1, -1);
            $user_id_look = substr($this->Db->qstr($user_id), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct user_id from " . $this->Ini->nm_tabela . " where user_level = 1     and user_id > 2 and  user_id like '%" . $user_id . "%' order by user_id"; 
      }
   ...
   function lookup_ajax_user($user)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct user from " . $this->Ini->nm_tabela . " where user_level = 1     and user_id > 2 and  user like '%" . $user . "%' order by user"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_pass($pass)
   {
      $pass = substr($this->Db->qstr($pass), 1, -1);
            $pass_look = substr($this->Db->qstr($pass), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct pass from " . $this->Ini->nm_tabela . " where user_level = 1     and user_id > 2 and  pass like '%" . $pass . "%' order by pass"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "last_login_date";$Nm_datas[] = "last_login_date";
      if (in_array($campo_join, $Nm_datas))
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - vicidial_users</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_vicidial_users/grid_vicidial_users_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_vicidial_users_ajax_search.js"></script>
 <script type="text/javascript" src="grid_vicidial_users_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_vicidial_users_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_vicidial_users']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_vicidial_users']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_full_name_cond#NMF#' + search_get_sel_txt('SC_full_name_cond') + '@NMF@';
  str_out += 'SC_full_name#NMF#' + search_get_text('SC_full_name') + '@NMF@';
  str_out += 'id_ac_full_name#NMF#' + search_get_text('id_ac_full_name') + '@NMF@';
  str_out += 'SC_user_id_cond#NMF#' + search_get_sel_txt('SC_user_id_cond') + '@NMF@';
  str_out += 'SC_user_id#NMF#' + search_get_text('SC_user_id') + '@NMF@';
  str_out += 'id_ac_user_id#NMF#' + search_get_text('id_ac_user_id') + '@NMF@';
  str_out += 'SC_user_id_input_2#NMF#' + search_get_text('SC_user_id_input_2') + '@NMF@';
  ...
  str_out += 'SC_pass_cond#NMF#' + search_get_sel_txt('SC_pass_cond') + '@NMF@';
  str_out += 'SC_pass#NMF#' + search_get_text('SC_pass') + '@NMF@';
  str_out += 'id_ac_pass#NMF#' + search_get_text('id_ac_pass') + '@NMF@';
   ...
   $("#id_ac_full_name").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_full_name",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_full_name").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_full_name").val( $(this).val() );
       }
     }
   });
   $("#id_ac_pass").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_pass",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_pass").val( $(this).val() );
       }
     }
   });
   $("#id_ac_user_id").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_user_id",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - vicidial_users</span></td>
...
<?php
   ...
   {
      global 
             $full_name_cond, $full_name, $full_name_autocomp,
             $user_id_cond, $user_id, $user_id_input_2, $user_id_autocomp,
             $user_cond, $user, $user_autocomp,
             $pass_cond, $pass, $pass_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $full_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca']['full_name']; 
          $full_name_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca']['full_name_cond']; 
          $user_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca']['user_id']; 
          $user_id_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca']['user_id_input_2']; 
          $user_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca']['user_id_cond']; 
          $user = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca']['user']; 
          $user_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca']['user_cond']; 
          $pass = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca']['pass']; 
          $pass_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca']['pass_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca']['NM_operador']; 
      } 
      if (!isset($full_name_cond) || empty($full_name_cond))
      {
         $full_name_cond = "qp";
      }
      if (!isset($user_id_cond) || empty($user_id_cond))
      {
         $user_id_cond = "gt";
      }
      if (!isset($user_cond) || empty($user_cond))
      {
         $user_cond = "qp";
      }
      if (!isset($pass_cond) || empty($pass_cond))
      {
         $pass_cond = "qp";
      }
      ...
      $str_hide_full_name = (in_array($full_name_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_user_id = (in_array($user_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_user = (in_array($user_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_pass = (in_array($pass_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_full_name = ('bw' == $full_name_cond) ? $display_aberto : $display_fechado;
      $str_display_user_id = ('bw' == $user_id_cond) ? $display_aberto : $display_fechado;
      $str_display_user = ('bw' == $user_cond) ? $display_aberto : $display_fechado;
      $str_display_pass = ('bw' == $pass_cond) ? $display_aberto : $display_fechado;
      ...
      {
         $tmp_pos = strpos($full_name, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $full_name = substr($full_name, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($user_id, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $user_id = substr($user_id, 0, $tmp_pos);
         }
      }
      if (!isset($user) || $user == "")
      {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_full_name_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['full_name'])) ? $this->New_label['full_name'] : "Full Name"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_full_name_cond" name="full_name_cond" onChange="nm_campos_between(document.getElementById('id_vis_full_name'), this, 'full_name')">
       <OPTION value="qp" <?php if ("qp" == $full_name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $full_name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $full_name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $full_name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_full_name" <?php echo $str_hide_full_name?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['full_name'])) ? $this->New_label['full_name'] : "Full Name";
 $nmgp_tab_label .= "full_name?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
      ...
      $full_name_look = substr($this->Db->qstr($full_name), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct full_name from " . $this->Ini->nm_tabela . " where user_level = 1     and user_id > 2 and full_name = '$full_name_look' order by full_name"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$full_name]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$full_name];
      }
      else
      {
          $sAutocompValue = $full_name;
      }
?>
<INPUT  type="text" id="SC_full_name" name="full_name" value="<?php echo NM_encode_input($full_name) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_full_name" name="full_name_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_user_id_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['user_id'])) ? $this->New_label['user_id'] : "User Id"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_user_id_cond" name="user_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_user_id'), this, 'user_id')">
       <OPTION value="gt" <?php if ("gt" == $user_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $user_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $user_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $user_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_user_id" <?php echo $str_hide_user_id?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['user_id'])) ? $this->New_label['user_id'] : "User Id";
 $nmgp_tab_label .= "user_id?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct user_id from " . $this->Ini->nm_tabela . " where user_level = 1     and user_id > 2 and user_id = $user_id_look order by user_id"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct user_id from " . $this->Ini->nm_tabela . " where user_level = 1     and user_id > 2 and user_id = $user_id_look order by user_id"; 
      ...
      if (isset($nmgp_def_dados[0][$user_id]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$user_id];
      }
      else
      {
            nmgp_Form_Num_Val($user_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $user_id;
      }
?>
<INPUT  type="text" id="SC_user_id" name="user_id" value="<?php echo NM_encode_input($user_id) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_user_id" name="user_id_autocomp" size="9"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_user_id"  <?php echo $str_display_user_id; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_user_id_input_2" name="user_id_input_2" value="<?php echo NM_encode_input($user_id_input_2) ?>"  size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_user_cond" name="user_cond" onChange="nm_campos_between(document.getElementById('id_vis_user'), this, 'user')">
       <OPTION value="qp" <?php if ("qp" == $user_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $user_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $user_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $user_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
      ...
      $user_look = substr($this->Db->qstr($user), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct user from " . $this->Ini->nm_tabela . " where user_level = 1     and user_id > 2 and user = '$user_look' order by user"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_user" name="user_autocomp" size="20"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_pass_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['pass'])) ? $this->New_label['pass'] : "Pass"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_pass_cond" name="pass_cond" onChange="nm_campos_between(document.getElementById('id_vis_pass'), this, 'pass')">
       <OPTION value="qp" <?php if ("qp" == $pass_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $pass_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $pass_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $pass_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_pass" <?php echo $str_hide_pass?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['pass'])) ? $this->New_label['pass'] : "Pass";
 $nmgp_tab_label .= "pass?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $pass_look = substr($this->Db->qstr($pass), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct pass from " . $this->Ini->nm_tabela . " where user_level = 1     and user_id > 2 and pass = '$pass_look' order by pass"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$pass]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$pass];
      }
      else
      {
          $sAutocompValue = $pass;
...
?>
<INPUT  type="text" id="SC_pass" name="pass" value="<?php echo NM_encode_input($pass) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_pass" name="pass_autocomp" size="20"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_vicidial_users_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_vicidial_users']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_vicidial_users']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.full_name_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_full_name'), document.F1.full_name_cond, 'full_name');
   document.F1.full_name.value = "";
   document.F1.full_name_autocomp.value = "";
   document.F1.user_id_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_user_id'), document.F1.user_id_cond, 'user_id');
   document.F1.user_id.value = "";
   document.F1.user_id_autocomp.value = "";
   document.F1.user_id_input_2.value = "";
   document.F1.user_cond.value = 'qp';
   ...
   document.F1.pass_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_pass'), document.F1.pass_cond, 'pass');
   document.F1.pass.value = "";
   document.F1.pass_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "dinamica_publicado/grid_vicidial_users";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_full_name_cond'] = 'cond';
      $tp_fields['SC_full_name'] = 'text_aut';
      $tp_fields['id_ac_full_name'] = 'text_aut';
      $tp_fields['SC_user_id_cond'] = 'cond';
      $tp_fields['SC_user_id'] = 'text_aut';
      $tp_fields['id_ac_user_id'] = 'text_aut';
      $tp_fields['SC_user_id_input_2'] = 'text';
      $tp_fields['SC_user_cond'] = 'cond';
      $tp_fields['SC_user'] = 'text_aut';
      $tp_fields['id_ac_user'] = 'text_aut';
      $tp_fields['SC_pass_cond'] = 'cond';
      $tp_fields['SC_pass'] = 'text_aut';
      $tp_fields['id_ac_pass'] = 'text_aut';
   ...
   {
      global $full_name_cond, $full_name, $full_name_autocomp,
             $user_id_cond, $user_id, $user_id_input_2, $user_id_autocomp,
             $user_cond, $user, $user_autocomp,
             $pass_cond, $pass, $pass_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($full_name_autocomp) && empty($full_name))
      {
          $full_name = $full_name_autocomp;
      }
      if (!empty($user_id_autocomp) && empty($user_id))
      {
          $user_id = $user_id_autocomp;
      }
      if (!empty($user_autocomp) && empty($user))
      {
          $user = $user_autocomp;
      }
      if (!empty($pass_autocomp) && empty($pass))
      {
          $pass = $pass_autocomp;
      }
      $full_name_cond_salva = $full_name_cond; 
      if (!isset($full_name_input_2) || $full_name_input_2 == "")
      {
          $full_name_input_2 = $full_name;
      }
      $user_id_cond_salva = $user_id_cond; 
      if (!isset($user_id_input_2) || $user_id_input_2 == "")
      {
          $user_id_input_2 = $user_id;
      }
      ...
      $pass_cond_salva = $pass_cond; 
      if (!isset($pass_input_2) || $pass_input_2 == "")
      {
          $pass_input_2 = $pass;
      }
      if ($user_id_cond != "in")
      {
          nm_limpa_numero($user_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($user_id_cond != "in")
      {
          nm_limpa_numero($user_id_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca']['full_name'] = $full_name; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca']['full_name_cond'] = $full_name_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca']['user_id'] = $user_id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca']['user_id_input_2'] = $user_id_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca']['user_id_cond'] = $user_id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca']['user'] = $user; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca']['user_cond'] = $user_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca']['pass'] = $pass; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca']['pass_cond'] = $pass_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca'] = $Temp_Busca;
      }
      if ($user_id_cond != "in" && $user_id_cond != "bw" && !empty($user_id) && !is_numeric($user_id))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : User Id";
      }
      if ($user_id_cond == "bw" && ((!empty($user_id) && !is_numeric($user_id)) || (!empty($user_id_input_2) && !is_numeric($user_id_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : User Id";
      }
      if (!empty($this->Campos_Mens_erro)) 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['full_name'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['full_name'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['full_name'] = $full_name;
      }
      $user_id_look = substr($this->Db->qstr($user_id), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($user_id))
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['user_id'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['user_id'] = $cmp1;
      }
      else
      {
          $cmp1 = $user_id;
      ...
      $Conteudo = $user_id_input_2;
      if (strtoupper($user_id_cond) != "II" && strtoupper($user_id_cond) != "QP" && strtoupper($user_id_cond) != "NP" && strtoupper($user_id_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['user_id_input_2'] = $Conteudo;
      $user_look = substr($this->Db->qstr($user), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct user from " . $this->Ini->nm_tabela . " where user_level = 1     and user_id > 2 and user = '$user_look' order by user"; 
      unset($cmp1,$cmp2);
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['pass'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['pass'] = $pass;
      }

      //----- $full_name
      $this->Date_part = false;
      if (isset($full_name) || $full_name_cond == "nu" || $full_name_cond == "nn" || $full_name_cond == "ep" || $full_name_cond == "ne")
      {
         $this->monta_condicao("full_name", $full_name_cond, $full_name, "", "full_name");
      }

      //----- $user_id
      $this->Date_part = false;
      if (isset($user_id) || $user_id_cond == "nu" || $user_id_cond == "nn" || $user_id_cond == "ep" || $user_id_cond == "ne")
      {
         $this->monta_condicao("user_id", $user_id_cond, $user_id, $user_id_input_2, "user_id");
      }
      ...
      //----- $pass
      $this->Date_part = false;
      if (isset($pass) || $pass_cond == "nu" || $pass_cond == "nn" || $pass_cond == "ep" || $pass_cond == "ne")
      {
         $this->monta_condicao("pass", $pass_cond, $pass, "", "pass");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vicidial_users']['cond_pesq'] .= $this->NM_operador;
