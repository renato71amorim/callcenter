...
<?php
   ...
   $Ord_Cmp = new grid_vicidial_users_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_vicidial_users_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['user'] = "user";
   $tab_labels["user"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['labels']["user"])) ? $_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['labels']["user"] : "User";
   $tab_ger_campos['full_name'] = "on";
   $tab_def_campos['full_name'] = "full_name";
   $tab_labels["full_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['labels']["full_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['labels']["full_name"] : "Full Name";
   $tab_ger_campos['pass'] = "on";
   $tab_def_campos['pass'] = "pass";
   $tab_labels["pass"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['labels']["pass"])) ? $_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['labels']["pass"] : "Pass";
   $tab_ger_campos['user_level'] = "on";
   $tab_def_campos['user_level'] = "user_level";
   $tab_labels["user_level"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['labels']["user_level"])) ? $_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['labels']["user_level"] : "User Level";
   $tab_ger_campos['user_group'] = "on";
   $tab_def_campos['user_group'] = "user_group";
   $tab_labels["user_group"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['labels']["user_group"])) ? $_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['labels']["user_group"] : "User Group";
   $tab_ger_campos['phone_login'] = "on";
   $tab_def_campos['phone_login'] = "phone_login";
   $tab_labels["phone_login"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['labels']["phone_login"])) ? $_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['labels']["phone_login"] : "Phone Login";
   $tab_ger_campos['phone_pass'] = "on";
   $tab_def_campos['phone_pass'] = "phone_pass";
   $tab_labels["phone_pass"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['labels']["phone_pass"])) ? $_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['labels']["phone_pass"] : "Phone Pass";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['ordem_quebra'] as $campo => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_vicidial_users_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_vicidial_users']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
