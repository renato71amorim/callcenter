...
class grid_doacoes_auditar_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_doacoes_auditar_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_doacoes_auditar_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_doacoes_auditar_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_sexo')
      {
          $sexo = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_sexo($sexo);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_codigoidentificador')
      {
          $codigoidentificador = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_codigoidentificador($codigoidentificador);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_sexo($sexo)
   {
      ...
      $nm_comando = "select distinct Sexo from " . $this->Ini->nm_tabela . " where status = 1 and  Sexo like '%" . $sexo . "%' order by Sexo"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_codigoidentificador($codigoidentificador)
   {
      $codigoidentificador = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $codigoidentificador);
      $codigoidentificador = substr($this->Db->qstr($codigoidentificador), 1, -1);
            $codigoidentificador_look = substr($this->Db->qstr($codigoidentificador), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct CodigoIdentificador from " . $this->Ini->nm_tabela . " where status = 1 and  CodigoIdentificador like '%" . $codigoidentificador . "%' order by CodigoIdentificador"; 
      }
   ...
   function lookup_ajax_codigo($codigo)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct Codigo from " . $this->Ini->nm_tabela . " where status = 1 and  Codigo like '%" . $codigo . "%' order by Codigo"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct Codigo from " . $this->Ini->nm_tabela . " where status = 1 and  Codigo like '%" . $codigo . "%' order by Codigo"; 
   ...
   function lookup_ajax_nome($nome)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Nome from " . $this->Ini->nm_tabela . " where status = 1 and  Nome like '%" . $nome . "%' order by Nome"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "DataEmissao";$Nm_datas[] = "DataEmissao";$Nm_datas[] = "DataVencimento";$Nm_datas[] = "DataVencimento";
      if (in_array($campo_join, $Nm_datas))
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - doacoes_auditar</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_doacoes_auditar/grid_doacoes_auditar_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_doacoes_auditar_ajax_search.js"></script>
 <script type="text/javascript" src="grid_doacoes_auditar_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_doacoes_auditar_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_doacoes_auditar']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_doacoes_auditar']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_sexo_cond#NMF#' + search_get_sel_txt('SC_sexo_cond') + '@NMF@';
  str_out += 'SC_sexo#NMF#' + search_get_text('SC_sexo') + '@NMF@';
  str_out += 'id_ac_sexo#NMF#' + search_get_text('id_ac_sexo') + '@NMF@';
  str_out += 'SC_codigoidentificador_cond#NMF#' + search_get_sel_txt('SC_codigoidentificador_cond') + '@NMF@';
  str_out += 'SC_codigoidentificador#NMF#' + search_get_text('SC_codigoidentificador') + '@NMF@';
  str_out += 'id_ac_codigoidentificador#NMF#' + search_get_text('id_ac_codigoidentificador') + '@NMF@';
  str_out += 'SC_codigoidentificador_input_2#NMF#' + search_get_text('SC_codigoidentificador_input_2') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   ...
   $("#id_ac_codigoidentificador").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_codigoidentificador",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_codigoidentificador").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_codigoidentificador").val( $(this).val() );
       }
     }
   });
   $("#id_ac_sexo").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_sexo",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - doacoes_auditar</span></td>
...
<?php
   ...
   {
      global 
             $sexo_cond, $sexo, $sexo_autocomp,
             $codigoidentificador_cond, $codigoidentificador, $codigoidentificador_input_2, $codigoidentificador_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $sexo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca']['sexo']; 
          $sexo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca']['sexo_cond']; 
          $codigoidentificador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca']['codigoidentificador']; 
          $codigoidentificador_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca']['codigoidentificador_input_2']; 
          $codigoidentificador_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca']['codigoidentificador_cond']; 
          $codigo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca']['codigo']; 
          $codigo_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca']['codigo_input_2']; 
          $codigo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca']['codigo_cond']; 
          $nome = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca']['nome']; 
          $nome_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca']['nome_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca']['NM_operador']; 
      } 
      if (!isset($sexo_cond) || empty($sexo_cond))
      {
         $sexo_cond = "qp";
      }
      if (!isset($codigoidentificador_cond) || empty($codigoidentificador_cond))
      {
         $codigoidentificador_cond = "gt";
      }
      ...
      $str_hide_sexo = (in_array($sexo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_codigoidentificador = (in_array($codigoidentificador_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_sexo = ('bw' == $sexo_cond) ? $display_aberto : $display_fechado;
      $str_display_codigoidentificador = ('bw' == $codigoidentificador_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($codigoidentificador) || $codigoidentificador == "")
      {
          $codigoidentificador = "";
      }
      if (isset($codigoidentificador) && !empty($codigoidentificador))
      {
         $tmp_pos = strpos($codigoidentificador, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $codigoidentificador = substr($codigoidentificador, 0, $tmp_pos);
         }
      }
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_sexo_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['sexo'])) ? $this->New_label['sexo'] : "Sexo"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_sexo_cond" name="sexo_cond" onChange="nm_campos_between(document.getElementById('id_vis_sexo'), this, 'sexo')">
       <OPTION value="qp" <?php if ("qp" == $sexo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $sexo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $sexo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $sexo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_sexo" <?php echo $str_hide_sexo?> valign="top">
...
<?php
      ...
      $sexo_look = substr($this->Db->qstr($sexo), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Sexo from " . $this->Ini->nm_tabela . " where status = 1 and Sexo = '$sexo_look' order by Sexo"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_sexo" name="sexo" value="<?php echo NM_encode_input($sexo) ?>"  size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_sexo" name="sexo_autocomp" size="1"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_codigoidentificador_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['codigoidentificador'])) ? $this->New_label['codigoidentificador'] : "Codigo Identificador"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_codigoidentificador_cond" name="codigoidentificador_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigoidentificador'), this, 'codigoidentificador')">
       <OPTION value="gt" <?php if ("gt" == $codigoidentificador_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $codigoidentificador_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $codigoidentificador_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $codigoidentificador_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_codigoidentificador" <?php echo $str_hide_codigoidentificador?> valign="top">
 ...
 $nmgp_tab_label .= "codigoidentificador?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $codigoidentificador_look = substr($this->Db->qstr($codigoidentificador), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($codigoidentificador))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct CodigoIdentificador from " . $this->Ini->nm_tabela . " where status = 1 and CodigoIdentificador = $codigoidentificador_look order by CodigoIdentificador"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct CodigoIdentificador from " . $this->Ini->nm_tabela . " where status = 1 and CodigoIdentificador = $codigoidentificador_look order by CodigoIdentificador"; 
      ...
      if (isset($nmgp_def_dados[0][$codigoidentificador]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$codigoidentificador];
      }
      else
      {
            nmgp_Form_Num_Val($codigoidentificador, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $codigoidentificador;
      }
?>
<INPUT  type="text" id="SC_codigoidentificador" name="codigoidentificador" value="<?php echo NM_encode_input($codigoidentificador) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_codigoidentificador" name="codigoidentificador_autocomp" size="19"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_codigoidentificador"  <?php echo $str_display_codigoidentificador; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_codigoidentificador_input_2" name="codigoidentificador_input_2" value="<?php echo NM_encode_input($codigoidentificador_input_2) ?>"  size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct Codigo from " . $this->Ini->nm_tabela . " where status = 1 and Codigo = $codigo_look order by Codigo"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct Codigo from " . $this->Ini->nm_tabela . " where status = 1 and Codigo = $codigo_look order by Codigo"; 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_codigo" name="codigo_autocomp" size="19"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
       ...
       <TR valign="top">
        <TD id="id_vis_codigo"  <?php echo $str_display_codigo; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_codigo_input_2" name="codigo_input_2" value="<?php echo NM_encode_input($codigo_input_2) ?>"  size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
...
<?php
      ...
      $nome_look = substr($this->Db->qstr($nome), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Nome from " . $this->Ini->nm_tabela . " where status = 1 and Nome = '$nome_look' order by Nome"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<?php
   if (is_file("grid_doacoes_auditar_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_doacoes_auditar']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_doacoes_auditar']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.sexo_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_sexo'), document.F1.sexo_cond, 'sexo');
   document.F1.sexo.value = "";
   document.F1.sexo_autocomp.value = "";
   document.F1.codigoidentificador_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_codigoidentificador'), document.F1.codigoidentificador_cond, 'codigoidentificador');
   document.F1.codigoidentificador.value = "";
   document.F1.codigoidentificador_autocomp.value = "";
   document.F1.codigoidentificador_input_2.value = "";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "dinamica_publicado/grid_doacoes_auditar";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_sexo_cond'] = 'cond';
      $tp_fields['SC_sexo'] = 'text_aut';
      $tp_fields['id_ac_sexo'] = 'text_aut';
      $tp_fields['SC_codigoidentificador_cond'] = 'cond';
      $tp_fields['SC_codigoidentificador'] = 'text_aut';
      $tp_fields['id_ac_codigoidentificador'] = 'text_aut';
      $tp_fields['SC_codigoidentificador_input_2'] = 'text';
   ...
   {
      global $sexo_cond, $sexo, $sexo_autocomp,
             $codigoidentificador_cond, $codigoidentificador, $codigoidentificador_input_2, $codigoidentificador_autocomp,
             $codigo_cond, $codigo, $codigo_input_2, $codigo_autocomp,
             $nome_cond, $nome, $nome_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($sexo_autocomp) && empty($sexo))
      {
          $sexo = $sexo_autocomp;
      }
      if (!empty($codigoidentificador_autocomp) && empty($codigoidentificador))
      {
          $codigoidentificador = $codigoidentificador_autocomp;
      }
      ...
      $codigoidentificador_cond_salva = $codigoidentificador_cond; 
      if (!isset($codigoidentificador_input_2) || $codigoidentificador_input_2 == "")
      {
          $codigoidentificador_input_2 = $codigoidentificador;
      }
      ...
      if ($codigoidentificador_cond != "in")
      {
          nm_limpa_numero($codigoidentificador, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($codigoidentificador_cond != "in")
      {
          nm_limpa_numero($codigoidentificador_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($codigo_cond != "in")
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca']['sexo'] = $sexo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca']['sexo_cond'] = $sexo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca']['codigoidentificador'] = $codigoidentificador; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca']['codigoidentificador_input_2'] = $codigoidentificador_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca']['codigoidentificador_cond'] = $codigoidentificador_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca']['codigo'] = $codigo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca']['codigo_input_2'] = $codigo_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca']['codigo_cond'] = $codigo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca']['nome'] = $nome; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca']['nome_cond'] = $nome_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca'] = $Temp_Busca;
      }
      if ($codigoidentificador_cond != "in" && $codigoidentificador_cond != "bw" && !empty($codigoidentificador) && !is_numeric($codigoidentificador))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Codigo Identificador";
      }
      if ($codigoidentificador_cond == "bw" && ((!empty($codigoidentificador) && !is_numeric($codigoidentificador)) || (!empty($codigoidentificador_input_2) && !is_numeric($codigoidentificador_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Codigo Identificador";
      }
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['sexo'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['sexo'] = $sexo;
      }
      $codigoidentificador_look = substr($this->Db->qstr($codigoidentificador), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($codigoidentificador))
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['codigoidentificador'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['codigoidentificador'] = $cmp1;
      }
      else
      {
          $cmp1 = $codigoidentificador;
      ...
      $Conteudo = $codigoidentificador_input_2;
      if (strtoupper($codigoidentificador_cond) != "II" && strtoupper($codigoidentificador_cond) != "QP" && strtoupper($codigoidentificador_cond) != "NP" && strtoupper($codigoidentificador_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['codigoidentificador_input_2'] = $Conteudo;
      $codigo_look = substr($this->Db->qstr($codigo), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($codigo))
   { 
      ...
      if (isset($sexo) || $sexo_cond == "nu" || $sexo_cond == "nn" || $sexo_cond == "ep" || $sexo_cond == "ne")
      {
      ...
      //----- $codigoidentificador
      $this->Date_part = false;
      if (isset($codigoidentificador) || $codigoidentificador_cond == "nu" || $codigoidentificador_cond == "nn" || $codigoidentificador_cond == "ep" || $codigoidentificador_cond == "ne")
      {
         $this->monta_condicao("CodigoIdentificador", $codigoidentificador_cond, $codigoidentificador, $codigoidentificador_input_2, "codigoidentificador");
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doacoes_auditar']['cond_pesq'] .= $this->NM_operador;
