...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_doacoes_auditar"]))
   {
      unset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_doacoes_auditar"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_doacoes_auditar']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_doacoes_auditar']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_doacoes_auditar']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_doacoes_auditar']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_doacoes_auditar']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_doacoes_auditar</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_doacoes_auditar']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_doacoes_auditar']['embutida_filho'] as $ind => $sc_init)
          {
