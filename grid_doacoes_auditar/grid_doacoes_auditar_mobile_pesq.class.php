...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "DataEmissao";$Nm_datas[] = "DataEmissao";$Nm_datas[] = "DataVencimento";$Nm_datas[] = "DataVencimento";$Nm_numeric[] = "codigoidentificador";$Nm_numeric[] = "codigo";$Nm_numeric[] = "operador";$Nm_numeric[] = "codigorua";$Nm_numeric[] = "setor_rua";$Nm_numeric[] = "valor";$Nm_numeric[] = "mesmensal";$Nm_numeric[] = "lead_id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_sexo_cond" name="sexo_cond" onChange="nm_campos_between(document.getElementById('id_vis_sexo'), this, 'sexo')">
      ...
      <br><span id="id_hide_sexo"  <?php echo $str_hide_sexo?>><?php
      if ($sexo != "")
      {
      $sexo_look = substr($this->Db->qstr($sexo), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_codigoidentificador_cond" name="codigoidentificador_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigoidentificador'), this, 'codigoidentificador')">
      ...
      <br><span id="id_hide_codigoidentificador"  <?php echo $str_hide_codigoidentificador?>><?php
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_codigoidentificador" name="codigoidentificador_autocomp" size="19"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_codigoidentificador"  <?php echo $str_display_codigoidentificador; ?> class="scFilterFieldFontEven">
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_codigo" name="codigo_autocomp" size="19"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        ...
        <SPAN id="id_vis_codigo"  <?php echo $str_display_codigo; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_codigo_input_2" name="codigo_input_2" value="<?php echo NM_encode_input($codigo_input_2) ?>"  size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
