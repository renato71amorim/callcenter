<?php
@session_start() ;
$_SESSION['scriptcase']['grid_doacoes_auditar']['sc_process_barr'] = true;
require_once('../grid_doacoes_auditar/index.php');
unset($_SESSION['scriptcase']['grid_doacoes_auditar']['sc_process_barr']);
$ExportCtrl = new grid_doacoes_auditar_export_control;
$ExportCtrl->Export_barr();

class grid_doacoes_auditar_export_control
{
