...
<?php
   ...
   $Ord_Cmp = new grid_doacoes_auditar_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_doacoes_auditar_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['labels']["codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['labels']["codigo"] : "Codigo";
   $tab_ger_campos['nome'] = "on";
   $tab_def_campos['nome'] = "Nome";
   $tab_labels["nome"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['labels']["nome"])) ? $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['labels']["nome"] : "Nome";
   $tab_ger_campos['bairro'] = "on";
   $tab_def_campos['bairro'] = "Bairro";
   $tab_labels["bairro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['labels']["bairro"])) ? $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['labels']["bairro"] : "Bairro";
   $tab_ger_campos['localidade'] = "on";
   $tab_def_campos['localidade'] = "Localidade";
   $tab_labels["localidade"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['labels']["localidade"])) ? $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['labels']["localidade"] : "Localidade";
   $tab_ger_campos['valor'] = "on";
   $tab_def_campos['valor'] = "Valor";
   $tab_labels["valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['labels']["valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['labels']["valor"] : "Valor";
   $tab_ger_campos['ouvir'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ouvir'] = "Ouvir";
   }
   else
   {
       $tab_def_campos['ouvir'] = "";
   }
   $tab_labels["ouvir"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['labels']["ouvir"])) ? $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['labels']["ouvir"] : "Ouvir";
   $tab_ger_campos['ouvir'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['ordem_quebra'] as $campo => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_doacoes_auditar_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_doacoes_auditar']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
