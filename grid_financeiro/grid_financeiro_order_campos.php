<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_financeiro']['glo_nm_path_imag_temp'] . "/sc_apl_default_dinamica_publicado.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_financeiro_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_financeiro_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_financeiro']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_financeiro']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["codigo"] : "Codigo";
   $tab_ger_campos['nomerecibo'] = "on";
   $tab_def_campos['nomerecibo'] = "NomeRecibo";
   $tab_labels["nomerecibo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["nomerecibo"])) ? $_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["nomerecibo"] : "Nome";
   $tab_ger_campos['operadormensal'] = "on";
   $tab_def_campos['operadormensal'] = "OperadorMensal";
   $tab_labels["operadormensal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["operadormensal"])) ? $_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["operadormensal"] : "Op Mensal";
   $tab_ger_campos['operadoravulso'] = "on";
   $tab_def_campos['operadoravulso'] = "OperadorAvulso";
   $tab_labels["operadoravulso"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["operadoravulso"])) ? $_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["operadoravulso"] : "Op Avulso";
   ...
   {
       $tab_def_campos['valor'] = "";
   }
   $tab_labels["valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["valor"] : "Valor";
   $tab_ger_campos['cobrador'] = "on";
   $tab_def_campos['cobrador'] = "Cobrador";
   $tab_labels["cobrador"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["cobrador"])) ? $_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["cobrador"] : "Cobrador";
   $tab_ger_campos['dataemissao'] = "on";
   $tab_def_campos['dataemissao'] = "DataEmissao";
   $tab_labels["dataemissao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["dataemissao"])) ? $_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["dataemissao"] : "Emissao";
   $tab_ger_campos['datavencimento'] = "on";
   $tab_def_campos['datavencimento'] = "DataVencimento";
   $tab_labels["datavencimento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["datavencimento"])) ? $_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["datavencimento"] : "Vencimento";
   $tab_ger_campos['status'] = "on";
   $tab_def_campos['status'] = "Status";
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["status"] : "Status";
   $tab_ger_campos['usuario'] = "on";
   $tab_def_campos['usuario'] = "Usuario";
   $tab_labels["usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["usuario"] : "Usuario";
   $tab_ger_campos['timestamp'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['timestamp'] = "sc_def_col_1";
   }
   else
   {
       $tab_def_campos['timestamp'] = "`TimeStamp`";
   }
   $tab_labels["timestamp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["timestamp"])) ? $_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["timestamp"] : "Atualizacao";
   $tab_ger_campos['valor'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_financeiro']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_financeiro']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_financeiro']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_financeiro']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_financeiro']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_financeiro']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_financeiro']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_financeiro']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_financeiro']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_financeiro']['ordem_quebra'] as $campo => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_financeiro']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_financeiro']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - financeiro</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_financeiro_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_financeiro']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_financeiro']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_financeiro']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_financeiro']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_financeiro']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
