<?php
@session_start() ;
$_SESSION['scriptcase']['grid_financeiro']['sc_process_barr'] = true;
require_once('../grid_financeiro/index.php');
unset($_SESSION['scriptcase']['grid_financeiro']['sc_process_barr']);
$ExportCtrl = new grid_financeiro_export_control;
$ExportCtrl->Export_barr();

class grid_financeiro_export_control
{
