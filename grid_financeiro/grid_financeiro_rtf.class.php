...
class grid_financeiro_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_financeiro.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_financeiro']['contr_erro'] = 'off'; 
   ...
   function NM_export_operadormensal()
   {
         ...
         $this->operadormensal = str_replace('<', '&lt;', $this->operadormensal);
         $this->operadormensal = str_replace('>', '&gt;', $this->operadormensal);
         $this->Texto_tag .= "<td>" . $this->operadormensal . "</td>\r\n";
   }
   //----- operadoravulso
   ...
   function NM_export_cobrador()
   {
         ...
         $this->cobrador = str_replace('<', '&lt;', $this->cobrador);
         $this->cobrador = str_replace('>', '&gt;', $this->cobrador);
         $this->Texto_tag .= "<td>" . $this->cobrador . "</td>\r\n";
   }
   //----- dataemissao
   function NM_export_dataemissao()
   {
         ...
         $this->dataemissao = str_replace('<', '&lt;', $this->dataemissao);
         $this->dataemissao = str_replace('>', '&gt;', $this->dataemissao);
         $this->Texto_tag .= "<td>" . $this->dataemissao . "</td>\r\n";
   }
   //----- datavencimento
   function NM_export_datavencimento()
   {
         ...
         $this->datavencimento = str_replace('<', '&lt;', $this->datavencimento);
         $this->datavencimento = str_replace('>', '&gt;', $this->datavencimento);
         $this->Texto_tag .= "<td>" . $this->datavencimento . "</td>\r\n";
   }
   //----- status
   ...
   function NM_export_numeroserie()
   {
         ...
         $this->numeroserie = str_replace('<', '&lt;', $this->numeroserie);
         $this->numeroserie = str_replace('>', '&gt;', $this->numeroserie);
         $this->Texto_tag .= "<td>" . $this->numeroserie . "</td>\r\n";
   }
   //----- valormensal
   function NM_export_valormensal()
   {
         ...
         $this->valormensal = str_replace('<', '&lt;', $this->valormensal);
         $this->valormensal = str_replace('>', '&gt;', $this->valormensal);
         $this->Texto_tag .= "<td>" . $this->valormensal . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - financeiro :: RTF</TITLE>
