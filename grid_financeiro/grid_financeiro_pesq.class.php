...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - financeiro</TITLE>
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_codigo" name="codigo_autocomp" size="19"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_numerorecibo_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['numerorecibo'])) ? $this->New_label['numerorecibo'] : "Numero"; ?></TD>
      
      <INPUT type="hidden" id="SC_numerorecibo_cond" name="numerorecibo_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_numerorecibo" <?php echo $str_hide_numerorecibo?> valign="top">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_numerorecibo" name="numerorecibo_autocomp" size="7"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 7, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_numeroserie_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['numeroserie'])) ? $this->New_label['numeroserie'] : "Serie"; ?></TD>
      
      <INPUT type="hidden" id="SC_numeroserie_cond" name="numeroserie_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_numeroserie" <?php echo $str_hide_numeroserie?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_numeroserie" name="numeroserie_autocomp" size="3"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 3, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_nomerecibo_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['nomerecibo'])) ? $this->New_label['nomerecibo'] : "Nome"; ?></TD>
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_status" name="status_autocomp" size="5"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 5, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_datavencimento_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['datavencimento'])) ? $this->New_label['datavencimento'] : "Vencimento"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_datavencimento_cond" name="datavencimento_cond" onChange="nm_campos_between(document.getElementById('id_vis_datavencimento'), this, 'datavencimento')">
     ...
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_datavencimento" <?php echo $str_hide_datavencimento?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
?>
       ...
       <TR valign="top">
        <TD id="id_vis_datavencimento"  <?php echo $str_display_datavencimento; ?> class="scFilterFieldFontEven">
...
?>
      ...
      <TD id='SC_dataemissao_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['dataemissao'])) ? $this->New_label['dataemissao'] : "Emissao"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_dataemissao_cond" name="dataemissao_cond" onChange="nm_campos_between(document.getElementById('id_vis_dataemissao'), this, 'dataemissao')">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_dataemissao" <?php echo $str_hide_dataemissao?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
?>
       ...
       <TR valign="top">
        <TD id="id_vis_dataemissao"  <?php echo $str_display_dataemissao; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>
         <BR>
...
?>
      ...
      <TD id='SC_cobrador_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['cobrador'])) ? $this->New_label['cobrador'] : "Cobrador"; ?></TD>
      
      <INPUT type="hidden" id="SC_cobrador_cond" name="cobrador_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cobrador" <?php echo $str_hide_cobrador?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_cobrador" name="cobrador_autocomp" size="19"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_operadoravulso_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['operadoravulso'])) ? $this->New_label['operadoravulso'] : "Op Avulso"; ?></TD>
      
      <INPUT type="hidden" id="SC_operadoravulso_cond" name="operadoravulso_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_operadoravulso" <?php echo $str_hide_operadoravulso?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_operadoravulso" name="operadoravulso_autocomp" size="19"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_operadormensal_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['operadormensal'])) ? $this->New_label['operadormensal'] : "Op Mensal"; ?></TD>
      
      <INPUT type="hidden" id="SC_operadormensal_cond" name="operadormensal_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_operadormensal" <?php echo $str_hide_operadormensal?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
