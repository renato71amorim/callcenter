  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_doacoes_auditar" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_doacoes_auditar_form();
	}

  // ---------- Validate codigo
  function do_ajax_form_doacoes_auditar_validate_codigo()
  {
    var nomeCampo_codigo = "codigo";
    var var_codigo = scAjaxGetFieldHidden(nomeCampo_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doacoes_auditar_validate_codigo(var_codigo, var_script_case_init, do_ajax_form_doacoes_auditar_validate_codigo_cb);
  } // do_ajax_form_doacoes_auditar_validate_codigo

  function do_ajax_form_doacoes_auditar_validate_codigo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doacoes_auditar_validate_codigo_cb

  // ---------- Validate nome
  function do_ajax_form_doacoes_auditar_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doacoes_auditar_validate_nome(var_nome, var_script_case_init, do_ajax_form_doacoes_auditar_validate_nome_cb);
  } // do_ajax_form_doacoes_auditar_validate_nome

  function do_ajax_form_doacoes_auditar_validate_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doacoes_auditar_validate_nome_cb

  // ---------- Validate sexo
  function do_ajax_form_doacoes_auditar_validate_sexo()
  {
    var nomeCampo_sexo = "sexo";
    var var_sexo = scAjaxGetFieldText(nomeCampo_sexo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doacoes_auditar_validate_sexo(var_sexo, var_script_case_init, do_ajax_form_doacoes_auditar_validate_sexo_cb);
  } // do_ajax_form_doacoes_auditar_validate_sexo

  function do_ajax_form_doacoes_auditar_validate_sexo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sexo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doacoes_auditar_validate_sexo_cb

  // ---------- Validate tipo
  function do_ajax_form_doacoes_auditar_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldText(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doacoes_auditar_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_doacoes_auditar_validate_tipo_cb);
  } // do_ajax_form_doacoes_auditar_validate_tipo

  function do_ajax_form_doacoes_auditar_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doacoes_auditar_validate_tipo_cb

  // ---------- Validate ddd
  function do_ajax_form_doacoes_auditar_validate_ddd()
  {
    var nomeCampo_ddd = "ddd";
    var var_ddd = scAjaxGetFieldText(nomeCampo_ddd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doacoes_auditar_validate_ddd(var_ddd, var_script_case_init, do_ajax_form_doacoes_auditar_validate_ddd_cb);
  } // do_ajax_form_doacoes_auditar_validate_ddd

  function do_ajax_form_doacoes_auditar_validate_ddd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ddd";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doacoes_auditar_validate_ddd_cb

  // ---------- Validate fone1
  function do_ajax_form_doacoes_auditar_validate_fone1()
  {
    var nomeCampo_fone1 = "fone1";
    var var_fone1 = scAjaxGetFieldText(nomeCampo_fone1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doacoes_auditar_validate_fone1(var_fone1, var_script_case_init, do_ajax_form_doacoes_auditar_validate_fone1_cb);
  } // do_ajax_form_doacoes_auditar_validate_fone1

  function do_ajax_form_doacoes_auditar_validate_fone1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fone1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doacoes_auditar_validate_fone1_cb

  // ---------- Validate fone2
  function do_ajax_form_doacoes_auditar_validate_fone2()
  {
    var nomeCampo_fone2 = "fone2";
    var var_fone2 = scAjaxGetFieldText(nomeCampo_fone2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doacoes_auditar_validate_fone2(var_fone2, var_script_case_init, do_ajax_form_doacoes_auditar_validate_fone2_cb);
  } // do_ajax_form_doacoes_auditar_validate_fone2

  function do_ajax_form_doacoes_auditar_validate_fone2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fone2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doacoes_auditar_validate_fone2_cb

  // ---------- Validate codigorua
  function do_ajax_form_doacoes_auditar_validate_codigorua()
  {
    var nomeCampo_codigorua = "codigorua";
    var var_codigorua = scAjaxGetFieldText(nomeCampo_codigorua);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doacoes_auditar_validate_codigorua(var_codigorua, var_script_case_init, do_ajax_form_doacoes_auditar_validate_codigorua_cb);
  } // do_ajax_form_doacoes_auditar_validate_codigorua

  function do_ajax_form_doacoes_auditar_validate_codigorua_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doacoes_auditar_validate_codigorua_cb

  // ---------- Validate cep
  function do_ajax_form_doacoes_auditar_validate_cep()
  {
    var nomeCampo_cep = "cep";
    var var_cep = scAjaxGetFieldText(nomeCampo_cep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doacoes_auditar_validate_cep(var_cep, var_script_case_init, do_ajax_form_doacoes_auditar_validate_cep_cb);
  } // do_ajax_form_doacoes_auditar_validate_cep

  function do_ajax_form_doacoes_auditar_validate_cep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cep";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doacoes_auditar_validate_cep_cb

  // ---------- Validate logadouro
  function do_ajax_form_doacoes_auditar_validate_logadouro()
  {
    var nomeCampo_logadouro = "logadouro";
    var var_logadouro = scAjaxGetFieldText(nomeCampo_logadouro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doacoes_auditar_validate_logadouro(var_logadouro, var_script_case_init, do_ajax_form_doacoes_auditar_validate_logadouro_cb);
  } // do_ajax_form_doacoes_auditar_validate_logadouro

  function do_ajax_form_doacoes_auditar_validate_logadouro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doacoes_auditar_validate_logadouro_cb

  // ---------- Validate numero
  function do_ajax_form_doacoes_auditar_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldText(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doacoes_auditar_validate_numero(var_numero, var_script_case_init, do_ajax_form_doacoes_auditar_validate_numero_cb);
  } // do_ajax_form_doacoes_auditar_validate_numero

  function do_ajax_form_doacoes_auditar_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doacoes_auditar_validate_numero_cb

  // ---------- Validate complemento
  function do_ajax_form_doacoes_auditar_validate_complemento()
  {
    var nomeCampo_complemento = "complemento";
    var var_complemento = scAjaxGetFieldText(nomeCampo_complemento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doacoes_auditar_validate_complemento(var_complemento, var_script_case_init, do_ajax_form_doacoes_auditar_validate_complemento_cb);
  } // do_ajax_form_doacoes_auditar_validate_complemento

  function do_ajax_form_doacoes_auditar_validate_complemento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doacoes_auditar_validate_complemento_cb

  // ---------- Validate pontodereferencia
  function do_ajax_form_doacoes_auditar_validate_pontodereferencia()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doacoes_auditar_validate_pontodereferencia(var_pontodereferencia, var_script_case_init, do_ajax_form_doacoes_auditar_validate_pontodereferencia_cb);
  } // do_ajax_form_doacoes_auditar_validate_pontodereferencia

  function do_ajax_form_doacoes_auditar_validate_pontodereferencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doacoes_auditar_validate_pontodereferencia_cb

  // ---------- Validate bairro
  function do_ajax_form_doacoes_auditar_validate_bairro()
  {
    var nomeCampo_bairro = "bairro";
    var var_bairro = scAjaxGetFieldText(nomeCampo_bairro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doacoes_auditar_validate_bairro(var_bairro, var_script_case_init, do_ajax_form_doacoes_auditar_validate_bairro_cb);
  } // do_ajax_form_doacoes_auditar_validate_bairro

  function do_ajax_form_doacoes_auditar_validate_bairro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bairro";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doacoes_auditar_validate_bairro_cb

  // ---------- Validate localidade
  function do_ajax_form_doacoes_auditar_validate_localidade()
  {
    var nomeCampo_localidade = "localidade";
    var var_localidade = scAjaxGetFieldText(nomeCampo_localidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doacoes_auditar_validate_localidade(var_localidade, var_script_case_init, do_ajax_form_doacoes_auditar_validate_localidade_cb);
  } // do_ajax_form_doacoes_auditar_validate_localidade

  function do_ajax_form_doacoes_auditar_validate_localidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doacoes_auditar_validate_localidade_cb

  // ---------- Validate setor_rua
  function do_ajax_form_doacoes_auditar_validate_setor_rua()
  {
    var nomeCampo_setor_rua = "setor_rua";
    var var_setor_rua = scAjaxGetFieldText(nomeCampo_setor_rua);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doacoes_auditar_validate_setor_rua(var_setor_rua, var_script_case_init, do_ajax_form_doacoes_auditar_validate_setor_rua_cb);
  } // do_ajax_form_doacoes_auditar_validate_setor_rua

  function do_ajax_form_doacoes_auditar_validate_setor_rua_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doacoes_auditar_validate_setor_rua_cb

  // ---------- Validate operador
  function do_ajax_form_doacoes_auditar_validate_operador()
  {
    var nomeCampo_operador = "operador";
    var var_operador = scAjaxGetFieldText(nomeCampo_operador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doacoes_auditar_validate_operador(var_operador, var_script_case_init, do_ajax_form_doacoes_auditar_validate_operador_cb);
  } // do_ajax_form_doacoes_auditar_validate_operador

  function do_ajax_form_doacoes_auditar_validate_operador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doacoes_auditar_validate_operador_cb

  // ---------- Validate datavencimento
  function do_ajax_form_doacoes_auditar_validate_datavencimento()
  {
    var nomeCampo_datavencimento = "datavencimento";
    var var_datavencimento = scAjaxGetFieldText(nomeCampo_datavencimento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doacoes_auditar_validate_datavencimento(var_datavencimento, var_script_case_init, do_ajax_form_doacoes_auditar_validate_datavencimento_cb);
  } // do_ajax_form_doacoes_auditar_validate_datavencimento

  function do_ajax_form_doacoes_auditar_validate_datavencimento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doacoes_auditar_validate_datavencimento_cb

  // ---------- Validate valor
  function do_ajax_form_doacoes_auditar_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldText(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doacoes_auditar_validate_valor(var_valor, var_script_case_init, do_ajax_form_doacoes_auditar_validate_valor_cb);
  } // do_ajax_form_doacoes_auditar_validate_valor

  function do_ajax_form_doacoes_auditar_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doacoes_auditar_validate_valor_cb

  // ---------- Validate obs
  function do_ajax_form_doacoes_auditar_validate_obs()
  {
    var nomeCampo_obs = "obs";
    var var_obs = scAjaxGetFieldText(nomeCampo_obs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doacoes_auditar_validate_obs(var_obs, var_script_case_init, do_ajax_form_doacoes_auditar_validate_obs_cb);
  } // do_ajax_form_doacoes_auditar_validate_obs

  function do_ajax_form_doacoes_auditar_validate_obs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "obs";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doacoes_auditar_validate_obs_cb

  // ---------- Validate mesmensal
  function do_ajax_form_doacoes_auditar_validate_mesmensal()
  {
    var nomeCampo_mesmensal = "mesmensal";
    var var_mesmensal = scAjaxGetFieldText(nomeCampo_mesmensal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doacoes_auditar_validate_mesmensal(var_mesmensal, var_script_case_init, do_ajax_form_doacoes_auditar_validate_mesmensal_cb);
  } // do_ajax_form_doacoes_auditar_validate_mesmensal

  function do_ajax_form_doacoes_auditar_validate_mesmensal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doacoes_auditar_validate_mesmensal_cb

  // ---------- Validate status
  function do_ajax_form_doacoes_auditar_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldText(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doacoes_auditar_validate_status(var_status, var_script_case_init, do_ajax_form_doacoes_auditar_validate_status_cb);
  } // do_ajax_form_doacoes_auditar_validate_status

  function do_ajax_form_doacoes_auditar_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doacoes_auditar_validate_status_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_doacoes_auditar_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_doacoes_auditar_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_doacoes_auditar_submit_form(var_codigo, var_nome, var_sexo, var_tipo, var_ddd, var_fone1, var_fone2, var_codigorua, var_cep, var_logadouro, var_numero, var_complemento, var_pontodereferencia, var_bairro, var_localidade, var_setor_rua, var_operador, var_datavencimento, var_valor, var_obs, var_mesmensal, var_status, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_doacoes_auditar_submit_form_cb);
  } // do_ajax_form_doacoes_auditar_submit_form

  function do_ajax_form_doacoes_auditar_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_doacoes_auditar_submit_form_cb_after_alert);
  } // do_ajax_form_doacoes_auditar_submit_form_cb
  function do_ajax_form_doacoes_auditar_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_doacoes_auditar_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_doacoes_auditar_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_doacoes_auditar_navigate_form(var_codigoidentificador, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_doacoes_auditar_navigate_form_cb);
  } // do_ajax_form_doacoes_auditar_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_auditar']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_doacoes_auditar_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_doacoes_auditar_navigate_form_cb_after_alert);
  } // do_ajax_form_doacoes_auditar_navigate_form_cb
  function do_ajax_form_doacoes_auditar_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_doacoes_auditar_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_doacoes_auditar_navigate_form_cb_after_alert
  function sc_hide_form_doacoes_auditar_form()
  {
