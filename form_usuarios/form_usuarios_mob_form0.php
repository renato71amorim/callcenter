...
else
{
    ...
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_codigo_line" id="hidden_field_data_codigo" style="<?php echo $sStyleHidden_codigo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_codigo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_codigo_label"><span id="id_label_codigo"><?php echo $this->nm_new_label['codigo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['php_cmp_required']['codigo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['php_cmp_required']['codigo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_senha_line" id="hidden_field_data_senha" style="<?php echo $sStyleHidden_senha; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_senha_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_senha_label"><span id="id_label_senha"><?php echo $this->nm_new_label['senha']; ?></span></span><br>
...
<?php } else { ?>
<span id="id_read_on_senha" class="sc-ui-readonly-senha css_senha_line" style="<?php echo $sStyleReadLab_senha; ?>"><?php echo $this->senha; ?></span><span id="id_read_off_senha" class="css_read_off_senha" style="white-space: nowrap;<?php echo $sStyleReadInp_senha; ?>">
 <input class="sc-js-input scFormObjectOdd css_senha_obj" style="" id="id_sc_field_senha" type=text name="senha" value="<?php echo $this->form_encode_input($senha) ?>"
 size=45 maxlength=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['ramal_iax']))
    {
        $this->nm_new_label['ramal_iax'] = "Ramal";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $ramal_iax = $this->ramal_iax;
   $sStyleHidden_ramal_iax = '';
   if (isset($this->nmgp_cmp_hidden['ramal_iax']) && $this->nmgp_cmp_hidden['ramal_iax'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['ramal_iax']);
       $sStyleHidden_ramal_iax = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_ramal_iax = 'display: none;';
   $sStyleReadInp_ramal_iax = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['ramal_iax']) && $this->nmgp_cmp_readonly['ramal_iax'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['ramal_iax']);
       $sStyleReadLab_ramal_iax = '';
       $sStyleReadInp_ramal_iax = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['ramal_iax']) && $this->nmgp_cmp_hidden['ramal_iax'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="ramal_iax" value="<?php echo $this->form_encode_input($ramal_iax) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_ramal_iax_line" id="hidden_field_data_ramal_iax" style="<?php echo $sStyleHidden_ramal_iax; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ramal_iax_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ramal_iax_label"><span id="id_label_ramal_iax"><?php echo $this->nm_new_label['ramal_iax']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["ramal_iax"]) &&  $this->nmgp_cmp_readonly["ramal_iax"] == "on") { 

 ?>
<input type="hidden" name="ramal_iax" value="<?php echo $this->form_encode_input($ramal_iax) . "\">" . $ramal_iax . ""; ?>
<?php } else { ?>
<span id="id_read_on_ramal_iax" class="sc-ui-readonly-ramal_iax css_ramal_iax_line" style="<?php echo $sStyleReadLab_ramal_iax; ?>"><?php echo $this->ramal_iax; ?></span><span id="id_read_off_ramal_iax" class="css_read_off_ramal_iax" style="white-space: nowrap;<?php echo $sStyleReadInp_ramal_iax; ?>">
 <input class="sc-js-input scFormObjectOdd css_ramal_iax_obj" style="" id="id_sc_field_ramal_iax" type=text name="ramal_iax" value="<?php echo $this->form_encode_input($ramal_iax) ?>"
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_ramal_iax_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_ramal_iax_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['agente']))
    {
        $this->nm_new_label['agente'] = "Agente";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $agente = $this->agente;
   $sStyleHidden_agente = '';
   if (isset($this->nmgp_cmp_hidden['agente']) && $this->nmgp_cmp_hidden['agente'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['agente']);
       $sStyleHidden_agente = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_agente = 'display: none;';
   $sStyleReadInp_agente = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['agente']) && $this->nmgp_cmp_readonly['agente'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['agente']);
       $sStyleReadLab_agente = '';
       $sStyleReadInp_agente = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['agente']) && $this->nmgp_cmp_hidden['agente'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="agente" value="<?php echo $this->form_encode_input($agente) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_agente_line" id="hidden_field_data_agente" style="<?php echo $sStyleHidden_agente; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_agente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_agente_label"><span id="id_label_agente"><?php echo $this->nm_new_label['agente']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["agente"]) &&  $this->nmgp_cmp_readonly["agente"] == "on") { 

 ?>
<input type="hidden" name="agente" value="<?php echo $this->form_encode_input($agente) . "\">" . $agente . ""; ?>
<?php } else { ?>
<span id="id_read_on_agente" class="sc-ui-readonly-agente css_agente_line" style="<?php echo $sStyleReadLab_agente; ?>"><?php echo $this->agente; ?></span><span id="id_read_off_agente" class="css_read_off_agente" style="white-space: nowrap;<?php echo $sStyleReadInp_agente; ?>">
 <input class="sc-js-input scFormObjectOdd css_agente_obj" style="" id="id_sc_field_agente" type=text name="agente" value="<?php echo $this->form_encode_input($agente) ?>"
 size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['agente']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['agente']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['agente']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_agente_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_agente_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['campanha']))
    {
        $this->nm_new_label['campanha'] = "Campanha";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $sStyleHidden_campanha = '';
   if (isset($this->nmgp_cmp_hidden['campanha']) && $this->nmgp_cmp_hidden['campanha'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['campanha']);
       $sStyleHidden_campanha = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_campanha = 'display: none;';
   $sStyleReadInp_campanha = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['campanha']) && $this->nmgp_cmp_readonly['campanha'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['campanha']);
       $sStyleReadLab_campanha = '';
       $sStyleReadInp_campanha = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['campanha']) && $this->nmgp_cmp_hidden['campanha'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="campanha" value="<?php echo $this->form_encode_input($campanha) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_campanha_line" id="hidden_field_data_campanha" style="<?php echo $sStyleHidden_campanha; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_campanha_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_campanha_label"><span id="id_label_campanha"><?php echo $this->nm_new_label['campanha']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["campanha"]) &&  $this->nmgp_cmp_readonly["campanha"] == "on") { 

 ?>
<input type="hidden" name="campanha" value="<?php echo $this->form_encode_input($campanha) . "\">" . $campanha . ""; ?>
<?php } else { ?>
<span id="id_read_on_campanha" class="sc-ui-readonly-campanha css_campanha_line" style="<?php echo $sStyleReadLab_campanha; ?>"><?php echo $this->campanha; ?></span><span id="id_read_off_campanha" class="css_read_off_campanha" style="white-space: nowrap;<?php echo $sStyleReadInp_campanha; ?>">
 <input class="sc-js-input scFormObjectOdd css_campanha_obj" style="" id="id_sc_field_campanha" type=text name="campanha" value="<?php echo $this->form_encode_input($campanha) ?>"
 size=45 maxlength=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_campanha_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_campanha_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['bases']))
    {
        $this->nm_new_label['bases'] = "Bases";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $bases = $this->bases;
   $sStyleHidden_bases = '';
   if (isset($this->nmgp_cmp_hidden['bases']) && $this->nmgp_cmp_hidden['bases'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['bases']);
       $sStyleHidden_bases = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_bases = 'display: none;';
   $sStyleReadInp_bases = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['bases']) && $this->nmgp_cmp_readonly['bases'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['bases']);
       $sStyleReadLab_bases = '';
       $sStyleReadInp_bases = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['bases']) && $this->nmgp_cmp_hidden['bases'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="bases" value="<?php echo $this->form_encode_input($bases) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_bases_line" id="hidden_field_data_bases" style="<?php echo $sStyleHidden_bases; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_bases_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_bases_label"><span id="id_label_bases"><?php echo $this->nm_new_label['bases']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["bases"]) &&  $this->nmgp_cmp_readonly["bases"] == "on") { 

 ?>
<input type="hidden" name="bases" value="<?php echo $this->form_encode_input($bases) . "\">" . $bases . ""; ?>
<?php } else { ?>
<span id="id_read_on_bases" class="sc-ui-readonly-bases css_bases_line" style="<?php echo $sStyleReadLab_bases; ?>"><?php echo $this->bases; ?></span><span id="id_read_off_bases" class="css_read_off_bases" style="white-space: nowrap;<?php echo $sStyleReadInp_bases; ?>">
 <input class="sc-js-input scFormObjectOdd css_bases_obj" style="" id="id_sc_field_bases" type=text name="bases" value="<?php echo $this->form_encode_input($bases) ?>"
 size=50 maxlength=200 alt="{datatype: 'text', maxLength: 200, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_bases_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_bases_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['permissao']))
    {
        $this->nm_new_label['permissao'] = "Permissao";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $sStyleHidden_permissao = '';
   if (isset($this->nmgp_cmp_hidden['permissao']) && $this->nmgp_cmp_hidden['permissao'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['permissao']);
       $sStyleHidden_permissao = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_permissao = 'display: none;';
   $sStyleReadInp_permissao = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['permissao']) && $this->nmgp_cmp_readonly['permissao'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['permissao']);
       $sStyleReadLab_permissao = '';
       $sStyleReadInp_permissao = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['permissao']) && $this->nmgp_cmp_hidden['permissao'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="permissao" value="<?php echo $this->form_encode_input($permissao) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_permissao_line" id="hidden_field_data_permissao" style="<?php echo $sStyleHidden_permissao; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_permissao_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_permissao_label"><span id="id_label_permissao"><?php echo $this->nm_new_label['permissao']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["permissao"]) &&  $this->nmgp_cmp_readonly["permissao"] == "on") { 

 ?>
<input type="hidden" name="permissao" value="<?php echo $this->form_encode_input($permissao) . "\">" . $permissao . ""; ?>
<?php } else { ?>
<span id="id_read_on_permissao" class="sc-ui-readonly-permissao css_permissao_line" style="<?php echo $sStyleReadLab_permissao; ?>"><?php echo $this->permissao; ?></span><span id="id_read_off_permissao" class="css_read_off_permissao" style="white-space: nowrap;<?php echo $sStyleReadInp_permissao; ?>">
 <input class="sc-js-input scFormObjectOdd css_permissao_obj" style="" id="id_sc_field_permissao" type=text name="permissao" value="<?php echo $this->form_encode_input($permissao) ?>"
 size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['permissao']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['permissao']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['permissao']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_permissao_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_permissao_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ativo_line" id="hidden_field_data_ativo" style="<?php echo $sStyleHidden_ativo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ativo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ativo_label"><span id="id_label_ativo"><?php echo $this->nm_new_label['ativo']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["ativo"]) &&  $this->nmgp_cmp_readonly["ativo"] == "on") { 

$ativo_look = "";
 if ($this->ativo == "1") { $ativo_look .= "Sim" ;} 
 if ($this->ativo == "0") { $ativo_look .= "Não" ;} 
...
$ativo_look = "";
 ...
 if (empty($ativo_look)) { $ativo_look = $this->ativo; }
?>
<span id="id_read_on_ativo" class="css_ativo_line"  style="<?php echo $sStyleReadLab_ativo; ?>"><?php echo $this->form_encode_input($ativo_look); ?></span><span id="id_read_off_ativo" class="css_read_off_ativo" style="white-space: nowrap; <?php echo $sStyleReadInp_ativo; ?>">
 <span id="idAjaxSelect_ativo"><select class="sc-js-input scFormObjectOdd css_ativo_obj" style="" id="id_sc_field_ativo" name="ativo" size="1" alt="{type: 'select', enterTab: false}">
 <option  value="1" <?php  if ($this->ativo == "1") { echo " selected" ;} ?>>Sim</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_ativo'][] = '1'; ?>
 <option  value="0" <?php  if ($this->ativo == "0") { echo " selected" ;} ?>>Não</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_ativo'][] = '0'; ?>
 </select></span>
</span><?php  }?>
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
