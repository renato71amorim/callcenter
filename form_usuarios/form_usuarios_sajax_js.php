...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate codigo
  function do_ajax_form_usuarios_validate_codigo()
  {
    var nomeCampo_codigo = "codigo";
    var var_codigo = scAjaxGetFieldText(nomeCampo_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_codigo(var_codigo, var_script_case_init, do_ajax_form_usuarios_validate_codigo_cb);
  } // do_ajax_form_usuarios_validate_codigo

  function do_ajax_form_usuarios_validate_codigo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_codigo_cb

  // ---------- Validate nome
  function do_ajax_form_usuarios_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_nome(var_nome, var_script_case_init, do_ajax_form_usuarios_validate_nome_cb);
  } // do_ajax_form_usuarios_validate_nome

  function do_ajax_form_usuarios_validate_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_nome_cb

  // ---------- Validate tipo
  function do_ajax_form_usuarios_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldText(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_usuarios_validate_tipo_cb);
  } // do_ajax_form_usuarios_validate_tipo

  function do_ajax_form_usuarios_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_tipo_cb
  ...
  // ---------- Validate senha
  function do_ajax_form_usuarios_validate_senha()
  {
    var nomeCampo_senha = "senha";
    var var_senha = scAjaxGetFieldText(nomeCampo_senha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_senha(var_senha, var_script_case_init, do_ajax_form_usuarios_validate_senha_cb);
  } // do_ajax_form_usuarios_validate_senha

  function do_ajax_form_usuarios_validate_senha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "senha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_senha_cb

  // ---------- Validate ramal_iax
  function do_ajax_form_usuarios_validate_ramal_iax()
  {
    var nomeCampo_ramal_iax = "ramal_iax";
    var var_ramal_iax = scAjaxGetFieldText(nomeCampo_ramal_iax);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_ramal_iax(var_ramal_iax, var_script_case_init, do_ajax_form_usuarios_validate_ramal_iax_cb);
  } // do_ajax_form_usuarios_validate_ramal_iax

  function do_ajax_form_usuarios_validate_ramal_iax_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_ramal_iax_cb

  // ---------- Validate agente
  function do_ajax_form_usuarios_validate_agente()
  {
    var nomeCampo_agente = "agente";
    var var_agente = scAjaxGetFieldText(nomeCampo_agente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_agente(var_agente, var_script_case_init, do_ajax_form_usuarios_validate_agente_cb);
  } // do_ajax_form_usuarios_validate_agente

  function do_ajax_form_usuarios_validate_agente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "agente";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_agente_cb

  // ---------- Validate campanha
  function do_ajax_form_usuarios_validate_campanha()
  {
    var nomeCampo_campanha = "campanha";
    var var_campanha = scAjaxGetFieldText(nomeCampo_campanha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_campanha(var_campanha, var_script_case_init, do_ajax_form_usuarios_validate_campanha_cb);
  } // do_ajax_form_usuarios_validate_campanha

  function do_ajax_form_usuarios_validate_campanha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_campanha_cb

  // ---------- Validate operador
  function do_ajax_form_usuarios_validate_operador()
  {
    var nomeCampo_operador = "operador";
    var var_operador = scAjaxGetFieldText(nomeCampo_operador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_operador(var_operador, var_script_case_init, do_ajax_form_usuarios_validate_operador_cb);
  } // do_ajax_form_usuarios_validate_operador

  function do_ajax_form_usuarios_validate_operador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_operador_cb

  // ---------- Validate bases
  function do_ajax_form_usuarios_validate_bases()
  {
    var nomeCampo_bases = "bases";
    var var_bases = scAjaxGetFieldText(nomeCampo_bases);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_bases(var_bases, var_script_case_init, do_ajax_form_usuarios_validate_bases_cb);
  } // do_ajax_form_usuarios_validate_bases

  function do_ajax_form_usuarios_validate_bases_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bases";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_bases_cb

  // ---------- Validate permissao
  function do_ajax_form_usuarios_validate_permissao()
  {
    var nomeCampo_permissao = "permissao";
    var var_permissao = scAjaxGetFieldText(nomeCampo_permissao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_permissao(var_permissao, var_script_case_init, do_ajax_form_usuarios_validate_permissao_cb);
  } // do_ajax_form_usuarios_validate_permissao

  function do_ajax_form_usuarios_validate_permissao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_permissao_cb

  // ---------- Validate ativo
  function do_ajax_form_usuarios_validate_ativo()
  {
    var nomeCampo_ativo = "ativo";
    var var_ativo = scAjaxGetFieldSelect(nomeCampo_ativo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_ativo(var_ativo, var_script_case_init, do_ajax_form_usuarios_validate_ativo_cb);
  } // do_ajax_form_usuarios_validate_ativo

  function do_ajax_form_usuarios_validate_ativo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ativo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_ativo_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_usuarios_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_usuarios_submit_form(var_codigo, var_nome, var_tipo, var_usuario, var_senha, var_ramal_iax, var_agente, var_campanha, var_operador, var_bases, var_permissao, var_ativo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_usuarios_submit_form_cb);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_usuarios_submit_form_cb_after_alert);
  } // do_ajax_form_usuarios_submit_form_cb
  function do_ajax_form_usuarios_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_usuarios_submit_form_cb_after_alert
  ...
  function do_ajax_form_usuarios_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_usuarios_navigate_form(var_codigo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_usuarios_navigate_form_cb);
...
?>
  function do_ajax_form_usuarios_navigate_form_cb(sResp)
  {
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_usuarios_navigate_form_cb_after_alert);
  } // do_ajax_form_usuarios_navigate_form_cb
  function do_ajax_form_usuarios_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
?>
  ...
  } // do_ajax_form_usuarios_navigate_form_cb_after_alert
