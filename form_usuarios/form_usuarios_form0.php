...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_codigo_label" id="hidden_field_label_codigo" style="<?php echo $sStyleHidden_codigo; ?>"><span id="id_label_codigo"><?php echo $this->nm_new_label['codigo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['php_cmp_required']['codigo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['php_cmp_required']['codigo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ramal_iax_label" id="hidden_field_label_ramal_iax" style="<?php echo $sStyleHidden_ramal_iax; ?>"><span id="id_label_ramal_iax"><?php echo $this->nm_new_label['ramal_iax']; ?></span></TD>
    <TD class="scFormDataOdd css_ramal_iax_line" id="hidden_field_data_ramal_iax" style="<?php echo $sStyleHidden_ramal_iax; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ramal_iax_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_agente_label" id="hidden_field_label_agente" style="<?php echo $sStyleHidden_agente; ?>"><span id="id_label_agente"><?php echo $this->nm_new_label['agente']; ?></span></TD>
    <TD class="scFormDataOdd css_agente_line" id="hidden_field_data_agente" style="<?php echo $sStyleHidden_agente; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_agente_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_campanha_label" id="hidden_field_label_campanha" style="<?php echo $sStyleHidden_campanha; ?>"><span id="id_label_campanha"><?php echo $this->nm_new_label['campanha']; ?></span></TD>
    <TD class="scFormDataOdd css_campanha_line" id="hidden_field_data_campanha" style="<?php echo $sStyleHidden_campanha; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_campanha_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_bases_label" id="hidden_field_label_bases" style="<?php echo $sStyleHidden_bases; ?>"><span id="id_label_bases"><?php echo $this->nm_new_label['bases']; ?></span></TD>
    <TD class="scFormDataOdd css_bases_line" id="hidden_field_data_bases" style="<?php echo $sStyleHidden_bases; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_bases_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_permissao_label" id="hidden_field_label_permissao" style="<?php echo $sStyleHidden_permissao; ?>"><span id="id_label_permissao"><?php echo $this->nm_new_label['permissao']; ?></span></TD>
    <TD class="scFormDataOdd css_permissao_line" id="hidden_field_data_permissao" style="<?php echo $sStyleHidden_permissao; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_permissao_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['Lookup_ativo'][] = '1'; ?>
 <option  value="0" <?php  if ($this->ativo == "0") { echo " selected" ;} ?>>Não</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['Lookup_ativo'][] = '0'; ?>
 </select></span>
</span><?php  }?>
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
