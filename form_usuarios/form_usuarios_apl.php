...
//
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['Gera_log_access'] = false;
      }
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['SC_sep_date1'];
       }
       $dt  = $delim . date('Y-m-d H:i:s') . $delim1;
       $usr = isset($_SESSION['usr_login']) ? $_SESSION['usr_login'] : "";
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_usuarios', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_usuarios', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
    ...
    function ValidateField_codigo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->codigo, 10, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Codigo; " ; 
                  if (!isset($Campos_Erros['codigo']))
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['php_cmp_required']['codigo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['php_cmp_required']['codigo'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Codigo" ; 
              if (!isset($Campos_Erros['codigo']))
    ...
    function ValidateField_agente(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->agente, 10, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Agente; " ; 
                  if (!isset($Campos_Erros['agente']))
    ...
    function ValidateField_operador(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->operador, 10, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_permissao(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->permissao, 10, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['codigo']['keyVal'] = form_usuarios_pack_protect_string($this->nmgp_dados_form['codigo']);
          }
   } // ajax_return_values
...
$aLookup[] = array(form_usuarios_pack_protect_string('1') => form_usuarios_pack_protect_string("Sim"));
$aLookup[] = array(form_usuarios_pack_protect_string('0') => form_usuarios_pack_protect_string("Não"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['Lookup_ativo'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['Lookup_ativo'][] = '0';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"ativo\"";
          ...
          {
              $this->NM_ajax_info['fldList']['ativo']['valList'][$i] = form_usuarios_pack_protect_string($v);
          }
...
//----------- 
   ...
   { 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['parms'] = "codigo?#?$this->codigo?@?"; 
      }
      $this->NM_commit_db(); 
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['dados_select'];
