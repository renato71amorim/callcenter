...
<?php
   ...
   $Ord_Cmp = new grid_ruas_1_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_ruas_1_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ruas_1']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ruas_1']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["codigorua"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ruas_1']['labels']["codigorua"])) ? $_SESSION['sc_session'][$sc_init]['grid_ruas_1']['labels']["codigorua"] : "Codigo Rua";
   $tab_ger_campos['nomerua'] = "on";
   $tab_def_campos['nomerua'] = "NomeRua";
   $tab_labels["nomerua"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ruas_1']['labels']["nomerua"])) ? $_SESSION['sc_session'][$sc_init]['grid_ruas_1']['labels']["nomerua"] : "Nome Rua";
   $tab_ger_campos['bairro'] = "on";
   $tab_def_campos['bairro'] = "Bairro";
   $tab_labels["bairro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ruas_1']['labels']["bairro"])) ? $_SESSION['sc_session'][$sc_init]['grid_ruas_1']['labels']["bairro"] : "Bairro";
   $tab_ger_campos['cidade'] = "on";
   $tab_def_campos['cidade'] = "Cidade";
   $tab_labels["cidade"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ruas_1']['labels']["cidade"])) ? $_SESSION['sc_session'][$sc_init]['grid_ruas_1']['labels']["cidade"] : "Cidade";
   $tab_ger_campos['uf'] = "on";
   $tab_def_campos['uf'] = "UF";
   $tab_labels["uf"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ruas_1']['labels']["uf"])) ? $_SESSION['sc_session'][$sc_init]['grid_ruas_1']['labels']["uf"] : "UF";
   $tab_ger_campos['cep'] = "on";
   $tab_def_campos['cep'] = "CEP";
   $tab_labels["cep"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ruas_1']['labels']["cep"])) ? $_SESSION['sc_session'][$sc_init]['grid_ruas_1']['labels']["cep"] : "CEP";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_ruas_1']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_ruas_1']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_ruas_1']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ruas_1']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ruas_1']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_ruas_1']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_ruas_1']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_ruas_1']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_ruas_1']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_ruas_1']['ordem_quebra'] as $campo => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_ruas_1']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_ruas_1']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_ruas_1_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_ruas_1']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_ruas_1']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_ruas_1']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_ruas_1']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_ruas_1']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
