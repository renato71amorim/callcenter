...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_app_logged_submit_form_cb_after_alert);
  } // do_ajax_app_logged_submit_form_cb
  function do_ajax_app_logged_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_app_logged_submit_form_cb_after_alert
...
?>
  function do_ajax_app_logged_navigate_form_cb(sResp)
  {
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_app_logged_navigate_form_cb_after_alert);
  } // do_ajax_app_logged_navigate_form_cb
  function do_ajax_app_logged_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_app_logged_navigate_form_cb_after_alert
