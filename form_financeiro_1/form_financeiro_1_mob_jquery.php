...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_dataemissao_hora' + iSeqRow).bind('blur', function() { sc_form_financeiro_1_dataemissao_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_financeiro_1_dataemissao_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_datavencimento_hora' + iSeqRow).bind('blur', function() { sc_form_financeiro_1_datavencimento_onblur(this, iSeqRow) })
                                                 .bind('focus', function() { sc_form_financeiro_1_datavencimento_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_timestamp_hora' + iSeqRow).bind('blur', function() { sc_form_financeiro_1_timestamp_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_financeiro_1_timestamp_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_ultimocontato_hora' + iSeqRow).bind('blur', function() { sc_form_financeiro_1_ultimocontato_onblur(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_financeiro_1_ultimocontato_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_financeiro_1_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_dataemissao" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_financeiro_1_mob_validate_dataemissao(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_datavencimento" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_financeiro_1_mob_validate_datavencimento(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_timestamp" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_financeiro_1_mob_validate_timestamp(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_ultimocontato" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_financeiro_1_mob_validate_ultimocontato(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
