...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate priv_admin
  function do_ajax_app_form_edit_users_mob_validate_priv_admin()
  {
    var nomeCampo_priv_admin = "priv_admin";
    var var_priv_admin = scAjaxGetFieldRadio(nomeCampo_priv_admin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_edit_users_mob_validate_priv_admin(var_priv_admin, var_script_case_init, do_ajax_app_form_edit_users_mob_validate_priv_admin_cb);
  } // do_ajax_app_form_edit_users_mob_validate_priv_admin

  function do_ajax_app_form_edit_users_mob_validate_priv_admin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_edit_users_mob_validate_priv_admin_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_app_form_edit_users_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_form_edit_users_mob_submit_form(var_login, var_pswd, var_confirm_pswd, var_name, var_email, var_active, var_priv_admin, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_edit_users_mob_submit_form_cb);
...
?>
  ...
  function do_ajax_app_form_edit_users_mob_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_form_edit_users_mob_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_app_form_edit_users_mob_navigate_form_cb);
...
?>
  ...
  var ajax_error_list = {
    ...
    "priv_admin": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_users_fild_priv_admin'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
