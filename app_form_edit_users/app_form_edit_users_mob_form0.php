...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - " . $this->Ini->Nm_lang['lang_tble_sec_users'] . ""); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_tble_sec_users'] . ""); } ?></TITLE>
...
<?php 
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['fast_search'][2] : "";
?> 
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pswd_line" id="hidden_field_data_pswd" style="<?php echo $sStyleHidden_pswd; ?>"> <span class="scFormLabelOddFormat css_pswd_label"><span id="id_label_pswd"><?php echo $this->nm_new_label['pswd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['php_cmp_required']['pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['php_cmp_required']['pswd'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_confirm_pswd_line" id="hidden_field_data_confirm_pswd" style="<?php echo $sStyleHidden_confirm_pswd; ?>"> <span class="scFormLabelOddFormat css_confirm_pswd_label"><span id="id_label_confirm_pswd"><?php echo $this->nm_new_label['confirm_pswd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['php_cmp_required']['confirm_pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['php_cmp_required']['confirm_pswd'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_name_line" id="hidden_field_data_name" style="<?php echo $sStyleHidden_name; ?>"> <span class="scFormLabelOddFormat css_name_label"><span id="id_label_name"><?php echo $this->nm_new_label['name']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_active_line" id="hidden_field_data_active" style="<?php echo $sStyleHidden_active; ?>"> <span class="scFormLabelOddFormat css_active_label"><span id="id_label_active"><?php echo $this->nm_new_label['active']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_priv_admin_line" id="hidden_field_data_priv_admin" style="<?php echo $sStyleHidden_priv_admin; ?>"> <span class="scFormLabelOddFormat css_priv_admin_label"><span id="id_label_priv_admin"><?php echo $this->nm_new_label['priv_admin']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["priv_admin"]) &&  $this->nmgp_cmp_readonly["priv_admin"] == "on") { 

 if ("Y" == $this->priv_admin) { $priv_admin_look = "" . $this->Ini->Nm_lang['lang_opt_yes'] . "";} 
 if ("N" == $this->priv_admin) { $priv_admin_look = "" . $this->Ini->Nm_lang['lang_opt_no'] . "";} 
?>
...
<?php
 ...
 if ("N" == $this->priv_admin) { $priv_admin_look = "" . $this->Ini->Nm_lang['lang_opt_no'] . "";} 
?>
<span id="id_read_on_priv_admin"  class="css_priv_admin_line" style="<?php echo $sStyleReadLab_priv_admin; ?>"><?php echo $this->form_encode_input($priv_admin_look); ?></span><span id="id_read_off_priv_admin" class="css_read_off_priv_admin css_priv_admin_line" style="<?php echo $sStyleReadInp_priv_admin; ?>"><div id="idAjaxRadio_priv_admin" style="display: inline-block"  class="css_priv_admin_line">
<TABLE cellspacing=0 cellpadding=0 border=0><TR>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_priv_admin'][] = 'Y'; ?>
<?php  if ("Y" == $this->priv_admin)  { echo " checked" ;} ?>  onClick="" ><label for="<?php echo $tempOptionId ?>"><?php echo $this->Ini->Nm_lang['lang_opt_yes']; ?></label></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_priv_admin'][] = 'N'; ?>
<?php  if ("N" == $this->priv_admin)  { echo " checked" ;} ?><?php  if (empty($this->priv_admin)) { echo " checked" ;} ?>  onClick="" ><label for="<?php echo $tempOptionId ?>"><?php echo $this->Ini->Nm_lang['lang_opt_no']; ?></label></TD>
</TR></TABLE>
</div>
</span><?php  }?>
 </TD>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bexcluir", "scBtnFn_sys_format_exc()", "scBtnFn_sys_format_exc()", "sc_b_del_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-21", "", "");?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script type="text/javascript">
	...
	function scBtnFn_sys_format_exc() {
		...
		if ($("#sc_b_del_b.sc-unique-btn-21").length && $("#sc_b_del_b.sc-unique-btn-21").is(":visible")) {
			nm_atualiza ('excluir');
			 return;
		}
	}
