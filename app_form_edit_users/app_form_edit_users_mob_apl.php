   ...
   function ini_controle()
   {
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_form_edit_users_mob']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_form_edit_users_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_tble_sec_users'] . "";
      ...
      if ($this->nmgp_opcao == "fast_search")  
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['opcao'] = "inicio";
...
//
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $this->login = sc_strip_script($this->login, $_SESSION['scriptcase']['charset']);
          $this->login = sc_strip_tags($this->login, $_SESSION['scriptcase']['charset']);
          $this->pswd = sc_strip_script($this->pswd, $_SESSION['scriptcase']['charset']);
          $this->pswd = sc_strip_tags($this->pswd, $_SESSION['scriptcase']['charset']);
          $this->name = sc_strip_script($this->name, $_SESSION['scriptcase']['charset']);
          $this->name = sc_strip_tags($this->name, $_SESSION['scriptcase']['charset']);
          $this->confirm_pswd = sc_strip_script($this->confirm_pswd, $_SESSION['scriptcase']['charset']);
          $this->confirm_pswd = sc_strip_tags($this->confirm_pswd, $_SESSION['scriptcase']['charset']);
...
<HEAD>
 <TITLE><?php echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_tble_sec_users'] . "") ?></TITLE>
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       $delim  = "'";
       $delim1 = "'";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['SC_sep_date1'];
       }
       $dt  = $delim . date('Y-m-d H:i:s') . $delim1;
       $usr = isset($_SESSION['usr_login']) ? $_SESSION['usr_login'] : "";
       if (in_array(strtolower($this->Ini->nm_con_unicep['tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Ini->nm_db_unicep->qstr($usr) . ", 'app_form_edit_users_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Ini->nm_db_unicep->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Ini->nm_db_unicep->qstr($usr) . ", 'app_form_edit_users_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Ini->nm_db_unicep->qstr($texto) . ")"; 
       } 
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           ...
           case 'active':
               ...
               break;
           case 'priv_admin':
               return "" . $this->Ini->Nm_lang['lang_sec_users_fild_priv_admin'] . "";
               break;
           case 'activation_code':
               return "" . $this->Ini->Nm_lang['lang_sec_users_fild_activation_code'] . "";
               break;
       }
...
//---------------------------------------------------------
    ...
    function ValidateField_priv_admin(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->priv_admin != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_priv_admin']) && !in_array($this->priv_admin, $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_priv_admin']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
$aLookup[] = array(app_form_edit_users_mob_pack_protect_string('Y') => app_form_edit_users_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_opt_yes'] . ""));
$aLookup[] = array(app_form_edit_users_mob_pack_protect_string('N') => app_form_edit_users_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_opt_no'] . ""));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_priv_admin'][] = 'Y';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_priv_admin'][] = 'N';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          if (isset($this->NM_ajax_info['select_html']['priv_admin']) && !empty($this->NM_ajax_info['select_html']['priv_admin']))
          {
              $sOptComp = $this->NM_ajax_info['select_html']['priv_admin'];
          }
          ...
          {
              $this->NM_ajax_info['fldList']['priv_admin']['valList'][$i] = app_form_edit_users_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
  ...
  function nm_proc_onload($bFormat = true)
  {
      ...
      {
          if (!isset($this->nmgp_cmp_hidden["active"]))
          {
              $this->nmgp_cmp_hidden["active"] = "off"; $this->NM_ajax_info['fieldDisplay']['active'] = 'off';
          }
          if (!isset($this->nmgp_cmp_hidden["priv_admin"]))
          {
              $this->nmgp_cmp_hidden["priv_admin"] = "off"; $this->NM_ajax_info['fieldDisplay']['priv_admin'] = 'off';
          }
      }
      else
      {
...
{
    $original_priv_admin = $this->priv_admin;
}
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    if (($original_priv_admin != $this->priv_admin || (isset($bFlagRead_priv_admin) && $bFlagRead_priv_admin)))
    {
        $this->ajax_return_values_priv_admin(true);
    }
}
$_SESSION['scriptcase']['app_form_edit_users_mob']['contr_erro'] = 'off'; 
      }
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
             ...
             { 
              ...
              $this->nmgp_refresh_fields = array_diff(array('login', 'pswd', 'confirm_pswd', 'name', 'email', 'active', 'priv_admin'), $aDoNotUpdate);
              $this->ajax_return_values();
...
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
      ...
      { 
          ...
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->login))
          {
              $Key_Where = "login < '$this->login' "; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_app_form_edit_users_mob = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['reg_start'] > $qt_geral_reg_app_form_edit_users_mob)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['reg_start'] = $qt_geral_reg_app_form_edit_users_mob; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_app_form_edit_users_mob) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['total'] + 1; 
...
//-- 
   ...
   {  
     ...
     $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(login) from " . $this->Ini->nm_tabela . " where login < '$this->login'" . $str_where_filter; 
     $rs = $this->Db->Execute("select max(login) from " . $this->Ini->nm_tabela . " where login < '$this->login'" . $str_where_filter); 
     if ($rs === false && !$rs->EOF && $GLOBALS["NM_ERRO_IBASE"] != 1) 
     { 
         $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dber'], $this->Db->ErrorMsg()); 
         exit ; 
     ...
     { 
         $this->login = substr($this->Db->qstr($rs->fields[0]), 1, -1); 
         $rs->Close();  
         $this->nmgp_opcao = "igual";  
         return ;  
     } 
...
//-- 
   ...
   {  
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $str_where_filter = ('' != $str_where_param) ? ' and ' . $str_where_param : '';
     $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(login) from " . $this->Ini->nm_tabela . " where login > '$this->login'" . $str_where_filter; 
     $rs = $this->Db->Execute("select min(login) from " . $this->Ini->nm_tabela . " where login > '$this->login'" . $str_where_filter); 
     if ($rs === false && !$rs->EOF && $GLOBALS["NM_ERRO_IBASE"] != 1) 
     { 
         $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dber'], $this->Db->ErrorMsg()); 
         exit ; 
...
//-- 
   ...
   {   
     ...
     $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(login) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
     $rs = $this->Db->Execute("select min(login) from " . $this->Ini->nm_tabela . " " . $str_where_filter); 
     if ($rs === false && !$rs->EOF && $GLOBALS["NM_ERRO_IBASE"] != 1) 
     { 
         $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dber'], $this->Db->ErrorMsg()); 
         exit ; 
...
//-- 
   ...
   { 
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $str_where_filter = ('' != $str_where_param) ? ' where ' . $str_where_param : '';
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(login) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
         $rs = $this->Db->Execute("select max(login) from " . $this->Ini->nm_tabela . " " . $str_where_filter); 
     if ($rs === false && !$rs->EOF && $GLOBALS["NM_ERRO_IBASE"] != 1) 
     { 
         $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dber'], $this->Db->ErrorMsg()); 
         exit ; 
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['dados_select'];
...
// 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['reg_start'] + 1;
...
$mail_smtp_server = 'contato@tlmksocial.com.br';        
$mail_smtp_user = 'contato@tlmksocial.com.br';                   
$mail_smtp_pass = 'odete31030966';			
$mail_from = 'contato@tlmksocial.com.br';          
...
$mail_format      = 'H';                       
    ...
    $sc_mail_port     = "smtp.tlmksocial.com.br";
    $sc_mail_tp_port  = "S";
...
<?php
 ...
 function new_date_format($type, $field)
 {
   ...
   function Form_lookup_priv_admin()
   {
       ...
       $nmgp_def_dados .= "" . $this->Ini->Nm_lang['lang_opt_no'] . "?#?N?#?S?@?";
       $todo = explode("?@?", $nmgp_def_dados);
       return $todo;
