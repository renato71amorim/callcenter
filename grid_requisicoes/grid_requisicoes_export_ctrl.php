<?php
@session_start() ;
$_SESSION['scriptcase']['grid_requisicoes']['sc_process_barr'] = true;
require_once('../grid_requisicoes/index.php');
unset($_SESSION['scriptcase']['grid_requisicoes']['sc_process_barr']);
$ExportCtrl = new grid_requisicoes_export_control;
$ExportCtrl->Export_barr();

class grid_requisicoes_export_control
{
