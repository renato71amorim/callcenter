...
<?php
   ...
   $Ord_Cmp = new grid_requisicoes_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_requisicoes_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_requisicoes']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_requisicoes']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['idrequisicao'] = "idRequisicao";
   $tab_labels["idrequisicao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_requisicoes']['labels']["idrequisicao"])) ? $_SESSION['sc_session'][$sc_init]['grid_requisicoes']['labels']["idrequisicao"] : "Id Requisicao";
   $tab_ger_campos['codcontribuinte'] = "on";
   $tab_def_campos['codcontribuinte'] = "CodContribuinte";
   $tab_labels["codcontribuinte"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_requisicoes']['labels']["codcontribuinte"])) ? $_SESSION['sc_session'][$sc_init]['grid_requisicoes']['labels']["codcontribuinte"] : "Cod Contribuinte";
   $tab_ger_campos['nomecontribuinte'] = "on";
   $tab_def_campos['nomecontribuinte'] = "NomeContribuinte";
   $tab_labels["nomecontribuinte"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_requisicoes']['labels']["nomecontribuinte"])) ? $_SESSION['sc_session'][$sc_init]['grid_requisicoes']['labels']["nomecontribuinte"] : "Nome Contribuinte";
   $tab_ger_campos['fone1'] = "on";
   $tab_def_campos['fone1'] = "Fone1";
   $tab_labels["fone1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_requisicoes']['labels']["fone1"])) ? $_SESSION['sc_session'][$sc_init]['grid_requisicoes']['labels']["fone1"] : "Fone 1";
   $tab_ger_campos['fone2'] = "on";
   $tab_def_campos['fone2'] = "Fone2";
   $tab_labels["fone2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_requisicoes']['labels']["fone2"])) ? $_SESSION['sc_session'][$sc_init]['grid_requisicoes']['labels']["fone2"] : "Fone 2";
   $tab_ger_campos['fone3'] = "on";
   $tab_def_campos['fone3'] = "Fone3";
   $tab_labels["fone3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_requisicoes']['labels']["fone3"])) ? $_SESSION['sc_session'][$sc_init]['grid_requisicoes']['labels']["fone3"] : "Fone 3";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_requisicoes']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_requisicoes']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_requisicoes']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_requisicoes']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_requisicoes']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_requisicoes']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_requisicoes']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_requisicoes']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_requisicoes']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_requisicoes']['ordem_quebra'] as $campo => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_requisicoes']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_requisicoes']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_requisicoes_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_requisicoes']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_requisicoes']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_requisicoes']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_requisicoes']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_requisicoes']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
