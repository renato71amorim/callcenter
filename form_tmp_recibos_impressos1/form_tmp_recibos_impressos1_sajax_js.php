  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tmp_recibos_impressos1" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tmp_recibos_impressos1_form();
	}

  // ---------- Validate codigoidentificador
  function do_ajax_form_tmp_recibos_impressos1_validate_codigoidentificador()
  {
    ...
    x_ajax_form_tmp_recibos_impressos1_validate_codigoidentificador(var_codigoidentificador, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_validate_codigoidentificador_cb);
  } // do_ajax_form_tmp_recibos_impressos1_validate_codigoidentificador

  function do_ajax_form_tmp_recibos_impressos1_validate_codigoidentificador_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_validate_codigoidentificador_cb

  // ---------- Validate numerorecibo
  function do_ajax_form_tmp_recibos_impressos1_validate_numerorecibo()
  {
    var nomeCampo_numerorecibo = "numerorecibo";
    var var_numerorecibo = scAjaxGetFieldText(nomeCampo_numerorecibo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_validate_numerorecibo(var_numerorecibo, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_validate_numerorecibo_cb);
  } // do_ajax_form_tmp_recibos_impressos1_validate_numerorecibo

  function do_ajax_form_tmp_recibos_impressos1_validate_numerorecibo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_validate_numerorecibo_cb

  // ---------- Validate numeroserie
  function do_ajax_form_tmp_recibos_impressos1_validate_numeroserie()
  {
    var nomeCampo_numeroserie = "numeroserie";
    var var_numeroserie = scAjaxGetFieldText(nomeCampo_numeroserie);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_validate_numeroserie(var_numeroserie, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_validate_numeroserie_cb);
  } // do_ajax_form_tmp_recibos_impressos1_validate_numeroserie

  function do_ajax_form_tmp_recibos_impressos1_validate_numeroserie_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_validate_numeroserie_cb

  // ---------- Validate codigo
  function do_ajax_form_tmp_recibos_impressos1_validate_codigo()
  {
    var nomeCampo_codigo = "codigo";
    var var_codigo = scAjaxGetFieldText(nomeCampo_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_validate_codigo(var_codigo, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_validate_codigo_cb);
  } // do_ajax_form_tmp_recibos_impressos1_validate_codigo

  function do_ajax_form_tmp_recibos_impressos1_validate_codigo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codigo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_validate_codigo_cb

  // ---------- Validate nomerecibo
  function do_ajax_form_tmp_recibos_impressos1_validate_nomerecibo()
  {
    var nomeCampo_nomerecibo = "nomerecibo";
    var var_nomerecibo = scAjaxGetFieldText(nomeCampo_nomerecibo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_validate_nomerecibo(var_nomerecibo, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_validate_nomerecibo_cb);
  } // do_ajax_form_tmp_recibos_impressos1_validate_nomerecibo

  function do_ajax_form_tmp_recibos_impressos1_validate_nomerecibo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_validate_nomerecibo_cb

  // ---------- Validate emissao
  function do_ajax_form_tmp_recibos_impressos1_validate_emissao()
  {
    var nomeCampo_emissao = "emissao";
    var var_emissao = scAjaxGetFieldText(nomeCampo_emissao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_validate_emissao(var_emissao, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_validate_emissao_cb);
  } // do_ajax_form_tmp_recibos_impressos1_validate_emissao

  function do_ajax_form_tmp_recibos_impressos1_validate_emissao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "emissao";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_validate_emissao_cb

  // ---------- Validate vencimento
  function do_ajax_form_tmp_recibos_impressos1_validate_vencimento()
  {
    var nomeCampo_vencimento = "vencimento";
    var var_vencimento = scAjaxGetFieldText(nomeCampo_vencimento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_validate_vencimento(var_vencimento, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_validate_vencimento_cb);
  } // do_ajax_form_tmp_recibos_impressos1_validate_vencimento

  function do_ajax_form_tmp_recibos_impressos1_validate_vencimento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "vencimento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_validate_vencimento_cb

  // ---------- Validate valor
  function do_ajax_form_tmp_recibos_impressos1_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldText(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_validate_valor(var_valor, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_validate_valor_cb);
  } // do_ajax_form_tmp_recibos_impressos1_validate_valor

  function do_ajax_form_tmp_recibos_impressos1_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_validate_valor_cb

  // ---------- Validate situacao_atual
  function do_ajax_form_tmp_recibos_impressos1_validate_situacao_atual()
  {
    var nomeCampo_situacao_atual = "situacao_atual";
    var var_situacao_atual = scAjaxGetFieldText(nomeCampo_situacao_atual);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_validate_situacao_atual(var_situacao_atual, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_validate_situacao_atual_cb);
  } // do_ajax_form_tmp_recibos_impressos1_validate_situacao_atual

  function do_ajax_form_tmp_recibos_impressos1_validate_situacao_atual_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "situacao_atual";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_validate_situacao_atual_cb

  // ---------- Validate situacao_ult_dia_mes
  function do_ajax_form_tmp_recibos_impressos1_validate_situacao_ult_dia_mes()
  {
    var nomeCampo_situacao_ult_dia_mes = "situacao_ult_dia_mes";
    var var_situacao_ult_dia_mes = scAjaxGetFieldText(nomeCampo_situacao_ult_dia_mes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_validate_situacao_ult_dia_mes(var_situacao_ult_dia_mes, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_validate_situacao_ult_dia_mes_cb);
  } // do_ajax_form_tmp_recibos_impressos1_validate_situacao_ult_dia_mes

  function do_ajax_form_tmp_recibos_impressos1_validate_situacao_ult_dia_mes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "situacao_ult_dia_mes";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_validate_situacao_ult_dia_mes_cb

  // ---------- Validate referencia_emissao
  function do_ajax_form_tmp_recibos_impressos1_validate_referencia_emissao()
  {
    var nomeCampo_referencia_emissao = "referencia_emissao";
    var var_referencia_emissao = scAjaxGetFieldText(nomeCampo_referencia_emissao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_validate_referencia_emissao(var_referencia_emissao, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_validate_referencia_emissao_cb);
  } // do_ajax_form_tmp_recibos_impressos1_validate_referencia_emissao

  function do_ajax_form_tmp_recibos_impressos1_validate_referencia_emissao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "referencia_emissao";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_validate_referencia_emissao_cb

  // ---------- Validate referencia_finalizado
  function do_ajax_form_tmp_recibos_impressos1_validate_referencia_finalizado()
  {
    var nomeCampo_referencia_finalizado = "referencia_finalizado";
    var var_referencia_finalizado = scAjaxGetFieldText(nomeCampo_referencia_finalizado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_validate_referencia_finalizado(var_referencia_finalizado, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_validate_referencia_finalizado_cb);
  } // do_ajax_form_tmp_recibos_impressos1_validate_referencia_finalizado

  function do_ajax_form_tmp_recibos_impressos1_validate_referencia_finalizado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "referencia_finalizado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_validate_referencia_finalizado_cb

  // ---------- Validate mesmensal
  function do_ajax_form_tmp_recibos_impressos1_validate_mesmensal()
  {
    var nomeCampo_mesmensal = "mesmensal";
    var var_mesmensal = scAjaxGetFieldText(nomeCampo_mesmensal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_validate_mesmensal(var_mesmensal, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_validate_mesmensal_cb);
  } // do_ajax_form_tmp_recibos_impressos1_validate_mesmensal

  function do_ajax_form_tmp_recibos_impressos1_validate_mesmensal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_validate_mesmensal_cb

  // ---------- Validate setores
  function do_ajax_form_tmp_recibos_impressos1_validate_setores()
  {
    var nomeCampo_setores = "setores";
    var var_setores = scAjaxGetFieldText(nomeCampo_setores);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_validate_setores(var_setores, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_validate_setores_cb);
  } // do_ajax_form_tmp_recibos_impressos1_validate_setores

  function do_ajax_form_tmp_recibos_impressos1_validate_setores_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "setores";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_validate_setores_cb

  // ---------- Validate mesextenso
  function do_ajax_form_tmp_recibos_impressos1_validate_mesextenso()
  {
    var nomeCampo_mesextenso = "mesextenso";
    var var_mesextenso = scAjaxGetFieldText(nomeCampo_mesextenso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_validate_mesextenso(var_mesextenso, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_validate_mesextenso_cb);
  } // do_ajax_form_tmp_recibos_impressos1_validate_mesextenso

  function do_ajax_form_tmp_recibos_impressos1_validate_mesextenso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mesextenso";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_validate_mesextenso_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tmp_recibos_impressos1_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tmp_recibos_impressos1_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_emissao = scAjaxGetFieldText("emissao");
    var var_vencimento = scAjaxGetFieldText("vencimento");
    var var_valor = scAjaxGetFieldText("valor");
    var var_situacao_atual = scAjaxGetFieldText("situacao_atual");
    var var_situacao_ult_dia_mes = scAjaxGetFieldText("situacao_ult_dia_mes");
    var var_referencia_emissao = scAjaxGetFieldText("referencia_emissao");
    var var_referencia_finalizado = scAjaxGetFieldText("referencia_finalizado");
    var var_mesmensal = scAjaxGetFieldText("mesmensal");
    var var_setores = scAjaxGetFieldText("setores");
    var var_mesextenso = scAjaxGetFieldText("mesextenso");
    ...
    scAjaxProcOn();
    x_ajax_form_tmp_recibos_impressos1_submit_form(var_codigoidentificador, var_numerorecibo, var_numeroserie, var_codigo, var_nomerecibo, var_emissao, var_vencimento, var_valor, var_situacao_atual, var_situacao_ult_dia_mes, var_referencia_emissao, var_referencia_finalizado, var_mesmensal, var_setores, var_mesextenso, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tmp_recibos_impressos1_submit_form_cb);
  } // do_ajax_form_tmp_recibos_impressos1_submit_form

  function do_ajax_form_tmp_recibos_impressos1_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("emissao");
      scAjaxHideErrorDisplay("vencimento");
      scAjaxHideErrorDisplay("valor");
      scAjaxHideErrorDisplay("situacao_atual");
      scAjaxHideErrorDisplay("situacao_ult_dia_mes");
      scAjaxHideErrorDisplay("referencia_emissao");
      scAjaxHideErrorDisplay("referencia_finalizado");
      scAjaxHideErrorDisplay("mesmensal");
      scAjaxHideErrorDisplay("setores");
      scAjaxHideErrorDisplay("mesextenso");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tmp_recibos_impressos1_submit_form_cb_after_alert);
  } // do_ajax_form_tmp_recibos_impressos1_submit_form_cb
  function do_ajax_form_tmp_recibos_impressos1_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tmp_recibos_impressos1_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tmp_recibos_impressos1_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tmp_recibos_impressos1_navigate_form(var_codigoidentificador, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_navigate_form_cb);
  } // do_ajax_form_tmp_recibos_impressos1_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tmp_recibos_impressos1_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tmp_recibos_impressos1_navigate_form_cb_after_alert);
  } // do_ajax_form_tmp_recibos_impressos1_navigate_form_cb
  function do_ajax_form_tmp_recibos_impressos1_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tmp_recibos_impressos1_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tmp_recibos_impressos1_navigate_form_cb_after_alert
  function sc_hide_form_tmp_recibos_impressos1_form()
  {
  ...
  ajax_field_list[4] = "nomerecibo";
  ajax_field_list[5] = "emissao";
  ajax_field_list[6] = "vencimento";
  ajax_field_list[7] = "valor";
  ajax_field_list[8] = "situacao_atual";
  ajax_field_list[9] = "situacao_ult_dia_mes";
  ajax_field_list[10] = "referencia_emissao";
  ajax_field_list[11] = "referencia_finalizado";
  ajax_field_list[12] = "mesmensal";
  ajax_field_list[13] = "setores";
  ajax_field_list[14] = "mesextenso";
  ...
  var ajax_error_list = {
    ...
    "emissao": {"label": "Emissao", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "vencimento": {"label": "Vencimento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "valor": {"label": "Valor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "situacao_atual": {"label": "Situacao Atual", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "situacao_ult_dia_mes": {"label": "Situacao Ult Dia Mes", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "referencia_emissao": {"label": "Referencia Emissao", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "referencia_finalizado": {"label": "Referencia Finalizado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "setores": {"label": "Setores", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mesextenso": {"label": "Mes Extenso", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "emissao": new Array(),
    "vencimento": new Array(),
    "valor": new Array(),
    "situacao_atual": new Array(),
    "situacao_ult_dia_mes": new Array(),
    "referencia_emissao": new Array(),
    "referencia_finalizado": new Array(),
    "mesmensal": new Array(),
    "setores": new Array(),
    "mesextenso": new Array()
  };
  ...
  ajax_field_mult["emissao"][1] = "emissao";
  ajax_field_mult["vencimento"][1] = "vencimento";
  ajax_field_mult["valor"][1] = "valor";
  ajax_field_mult["situacao_atual"][1] = "situacao_atual";
  ajax_field_mult["situacao_ult_dia_mes"][1] = "situacao_ult_dia_mes";
  ajax_field_mult["referencia_emissao"][1] = "referencia_emissao";
  ajax_field_mult["referencia_finalizado"][1] = "referencia_finalizado";
  ajax_field_mult["mesmensal"][1] = "mesmensal";
  ajax_field_mult["setores"][1] = "setores";
  ajax_field_mult["mesextenso"][1] = "mesextenso";
  ...
  var ajax_field_id = {
    ...
    "emissao": new Array("hidden_field_label_emissao", "hidden_field_data_emissao"),
    "vencimento": new Array("hidden_field_label_vencimento", "hidden_field_data_vencimento"),
    "valor": new Array("hidden_field_label_valor", "hidden_field_data_valor"),
    "situacao_atual": new Array("hidden_field_label_situacao_atual", "hidden_field_data_situacao_atual"),
    "situacao_ult_dia_mes": new Array("hidden_field_label_situacao_ult_dia_mes", "hidden_field_data_situacao_ult_dia_mes"),
    "referencia_emissao": new Array("hidden_field_label_referencia_emissao", "hidden_field_data_referencia_emissao"),
    "referencia_finalizado": new Array("hidden_field_label_referencia_finalizado", "hidden_field_data_referencia_finalizado"),
    "mesmensal": new Array("hidden_field_label_mesmensal", "hidden_field_data_mesmensal"),
    "setores": new Array("hidden_field_label_setores", "hidden_field_data_setores"),
    "mesextenso": new Array("hidden_field_label_mesextenso", "hidden_field_data_mesextenso")
  };
  ...
  var ajax_read_only = {
    ...
    "valor": "off",
    "situacao_atual": "off",
    "situacao_ult_dia_mes": "off",
    "referencia_emissao": "off",
    "referencia_finalizado": "off",
    "mesmensal": "off",
    "setores": "off",
    "mesextenso": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("situacao_ult_dia_mes" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("referencia_finalizado" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
