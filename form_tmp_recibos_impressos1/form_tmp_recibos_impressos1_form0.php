...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_tmp_recibos_impressos1_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tmp_recibos_impressos1_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_tmp_recibos_impressos1_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tmp_recibos_impressos1'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tmp_recibos_impressos1'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_codigoidentificador_label" id="hidden_field_label_codigoidentificador" style="<?php echo $sStyleHidden_codigoidentificador; ?>"><span id="id_label_codigoidentificador"><?php echo $this->nm_new_label['codigoidentificador']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['php_cmp_required']['codigoidentificador']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['php_cmp_required']['codigoidentificador'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emissao_label" id="hidden_field_label_emissao" style="<?php echo $sStyleHidden_emissao; ?>"><span id="id_label_emissao"><?php echo $this->nm_new_label['emissao']; ?></span></TD>
    <TD class="scFormDataOdd css_emissao_line" id="hidden_field_data_emissao" style="<?php echo $sStyleHidden_emissao; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emissao_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_vencimento_label" id="hidden_field_label_vencimento" style="<?php echo $sStyleHidden_vencimento; ?>"><span id="id_label_vencimento"><?php echo $this->nm_new_label['vencimento']; ?></span></TD>
    <TD class="scFormDataOdd css_vencimento_line" id="hidden_field_data_vencimento" style="<?php echo $sStyleHidden_vencimento; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vencimento_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_situacao_atual_label" id="hidden_field_label_situacao_atual" style="<?php echo $sStyleHidden_situacao_atual; ?>"><span id="id_label_situacao_atual"><?php echo $this->nm_new_label['situacao_atual']; ?></span></TD>
    <TD class="scFormDataOdd css_situacao_atual_line" id="hidden_field_data_situacao_atual" style="<?php echo $sStyleHidden_situacao_atual; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_situacao_atual_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_situacao_ult_dia_mes_label" id="hidden_field_label_situacao_ult_dia_mes" style="<?php echo $sStyleHidden_situacao_ult_dia_mes; ?>"><span id="id_label_situacao_ult_dia_mes"><?php echo $this->nm_new_label['situacao_ult_dia_mes']; ?></span></TD>
    <TD class="scFormDataOdd css_situacao_ult_dia_mes_line" id="hidden_field_data_situacao_ult_dia_mes" style="<?php echo $sStyleHidden_situacao_ult_dia_mes; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_situacao_ult_dia_mes_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_referencia_emissao_label" id="hidden_field_label_referencia_emissao" style="<?php echo $sStyleHidden_referencia_emissao; ?>"><span id="id_label_referencia_emissao"><?php echo $this->nm_new_label['referencia_emissao']; ?></span></TD>
    <TD class="scFormDataOdd css_referencia_emissao_line" id="hidden_field_data_referencia_emissao" style="<?php echo $sStyleHidden_referencia_emissao; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_referencia_emissao_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_referencia_finalizado_label" id="hidden_field_label_referencia_finalizado" style="<?php echo $sStyleHidden_referencia_finalizado; ?>"><span id="id_label_referencia_finalizado"><?php echo $this->nm_new_label['referencia_finalizado']; ?></span></TD>
    <TD class="scFormDataOdd css_referencia_finalizado_line" id="hidden_field_data_referencia_finalizado" style="<?php echo $sStyleHidden_referencia_finalizado; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_referencia_finalizado_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_mesextenso_label" id="hidden_field_label_mesextenso" style="<?php echo $sStyleHidden_mesextenso; ?>"><span id="id_label_mesextenso"><?php echo $this->nm_new_label['mesextenso']; ?></span></TD>
    <TD class="scFormDataOdd css_mesextenso_line" id="hidden_field_data_mesextenso" style="<?php echo $sStyleHidden_mesextenso; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_mesextenso_line" style="vertical-align: top;padding: 0px">
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tmp_recibos_impressos1");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tmp_recibos_impressos1");
 parent.scAjaxDetailHeight("form_tmp_recibos_impressos1", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
