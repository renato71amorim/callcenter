  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tmp_recibos_impressos1_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tmp_recibos_impressos1_mob_form();
	}

  // ---------- Validate codigoidentificador
  function do_ajax_form_tmp_recibos_impressos1_mob_validate_codigoidentificador()
  {
    ...
    x_ajax_form_tmp_recibos_impressos1_mob_validate_codigoidentificador(var_codigoidentificador, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_mob_validate_codigoidentificador_cb);
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_codigoidentificador

  function do_ajax_form_tmp_recibos_impressos1_mob_validate_codigoidentificador_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_codigoidentificador_cb

  // ---------- Validate numerorecibo
  function do_ajax_form_tmp_recibos_impressos1_mob_validate_numerorecibo()
  {
    var nomeCampo_numerorecibo = "numerorecibo";
    var var_numerorecibo = scAjaxGetFieldText(nomeCampo_numerorecibo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_mob_validate_numerorecibo(var_numerorecibo, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_mob_validate_numerorecibo_cb);
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_numerorecibo

  function do_ajax_form_tmp_recibos_impressos1_mob_validate_numerorecibo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_numerorecibo_cb

  // ---------- Validate numeroserie
  function do_ajax_form_tmp_recibos_impressos1_mob_validate_numeroserie()
  {
    var nomeCampo_numeroserie = "numeroserie";
    var var_numeroserie = scAjaxGetFieldText(nomeCampo_numeroserie);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_mob_validate_numeroserie(var_numeroserie, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_mob_validate_numeroserie_cb);
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_numeroserie

  function do_ajax_form_tmp_recibos_impressos1_mob_validate_numeroserie_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_numeroserie_cb

  // ---------- Validate codigo
  function do_ajax_form_tmp_recibos_impressos1_mob_validate_codigo()
  {
    var nomeCampo_codigo = "codigo";
    var var_codigo = scAjaxGetFieldText(nomeCampo_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_mob_validate_codigo(var_codigo, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_mob_validate_codigo_cb);
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_codigo

  function do_ajax_form_tmp_recibos_impressos1_mob_validate_codigo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codigo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_codigo_cb

  // ---------- Validate nomerecibo
  function do_ajax_form_tmp_recibos_impressos1_mob_validate_nomerecibo()
  {
    var nomeCampo_nomerecibo = "nomerecibo";
    var var_nomerecibo = scAjaxGetFieldText(nomeCampo_nomerecibo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_mob_validate_nomerecibo(var_nomerecibo, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_mob_validate_nomerecibo_cb);
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_nomerecibo

  function do_ajax_form_tmp_recibos_impressos1_mob_validate_nomerecibo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_nomerecibo_cb

  // ---------- Validate emissao
  function do_ajax_form_tmp_recibos_impressos1_mob_validate_emissao()
  {
    var nomeCampo_emissao = "emissao";
    var var_emissao = scAjaxGetFieldText(nomeCampo_emissao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_mob_validate_emissao(var_emissao, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_mob_validate_emissao_cb);
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_emissao

  function do_ajax_form_tmp_recibos_impressos1_mob_validate_emissao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "emissao";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_emissao_cb

  // ---------- Validate vencimento
  function do_ajax_form_tmp_recibos_impressos1_mob_validate_vencimento()
  {
    var nomeCampo_vencimento = "vencimento";
    var var_vencimento = scAjaxGetFieldText(nomeCampo_vencimento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_mob_validate_vencimento(var_vencimento, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_mob_validate_vencimento_cb);
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_vencimento

  function do_ajax_form_tmp_recibos_impressos1_mob_validate_vencimento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_vencimento_cb

  // ---------- Validate valor
  function do_ajax_form_tmp_recibos_impressos1_mob_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldText(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_mob_validate_valor(var_valor, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_mob_validate_valor_cb);
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_valor

  function do_ajax_form_tmp_recibos_impressos1_mob_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_valor_cb

  // ---------- Validate situacao_atual
  function do_ajax_form_tmp_recibos_impressos1_mob_validate_situacao_atual()
  {
    var nomeCampo_situacao_atual = "situacao_atual";
    var var_situacao_atual = scAjaxGetFieldText(nomeCampo_situacao_atual);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_mob_validate_situacao_atual(var_situacao_atual, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_mob_validate_situacao_atual_cb);
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_situacao_atual

  function do_ajax_form_tmp_recibos_impressos1_mob_validate_situacao_atual_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_situacao_atual_cb

  // ---------- Validate situacao_ult_dia_mes
  function do_ajax_form_tmp_recibos_impressos1_mob_validate_situacao_ult_dia_mes()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_mob_validate_situacao_ult_dia_mes(var_situacao_ult_dia_mes, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_mob_validate_situacao_ult_dia_mes_cb);
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_situacao_ult_dia_mes

  function do_ajax_form_tmp_recibos_impressos1_mob_validate_situacao_ult_dia_mes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_situacao_ult_dia_mes_cb

  // ---------- Validate referencia_emissao
  function do_ajax_form_tmp_recibos_impressos1_mob_validate_referencia_emissao()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_mob_validate_referencia_emissao(var_referencia_emissao, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_mob_validate_referencia_emissao_cb);
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_referencia_emissao

  function do_ajax_form_tmp_recibos_impressos1_mob_validate_referencia_emissao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_referencia_emissao_cb

  // ---------- Validate referencia_finalizado
  function do_ajax_form_tmp_recibos_impressos1_mob_validate_referencia_finalizado()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_mob_validate_referencia_finalizado(var_referencia_finalizado, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_mob_validate_referencia_finalizado_cb);
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_referencia_finalizado

  function do_ajax_form_tmp_recibos_impressos1_mob_validate_referencia_finalizado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_referencia_finalizado_cb

  // ---------- Validate mesmensal
  function do_ajax_form_tmp_recibos_impressos1_mob_validate_mesmensal()
  {
    var nomeCampo_mesmensal = "mesmensal";
    var var_mesmensal = scAjaxGetFieldText(nomeCampo_mesmensal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_mob_validate_mesmensal(var_mesmensal, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_mob_validate_mesmensal_cb);
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_mesmensal

  function do_ajax_form_tmp_recibos_impressos1_mob_validate_mesmensal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_mesmensal_cb

  // ---------- Validate setores
  function do_ajax_form_tmp_recibos_impressos1_mob_validate_setores()
  {
    var nomeCampo_setores = "setores";
    var var_setores = scAjaxGetFieldText(nomeCampo_setores);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_mob_validate_setores(var_setores, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_mob_validate_setores_cb);
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_setores

  function do_ajax_form_tmp_recibos_impressos1_mob_validate_setores_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "setores";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_setores_cb

  // ---------- Validate mesextenso
  function do_ajax_form_tmp_recibos_impressos1_mob_validate_mesextenso()
  {
    var nomeCampo_mesextenso = "mesextenso";
    var var_mesextenso = scAjaxGetFieldText(nomeCampo_mesextenso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tmp_recibos_impressos1_mob_validate_mesextenso(var_mesextenso, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_mob_validate_mesextenso_cb);
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_mesextenso

  function do_ajax_form_tmp_recibos_impressos1_mob_validate_mesextenso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tmp_recibos_impressos1_mob_validate_mesextenso_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tmp_recibos_impressos1_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tmp_recibos_impressos1_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tmp_recibos_impressos1_mob_submit_form(var_codigoidentificador, var_numerorecibo, var_numeroserie, var_codigo, var_nomerecibo, var_emissao, var_vencimento, var_valor, var_situacao_atual, var_situacao_ult_dia_mes, var_referencia_emissao, var_referencia_finalizado, var_mesmensal, var_setores, var_mesextenso, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tmp_recibos_impressos1_mob_submit_form_cb);
  } // do_ajax_form_tmp_recibos_impressos1_mob_submit_form

  function do_ajax_form_tmp_recibos_impressos1_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tmp_recibos_impressos1_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tmp_recibos_impressos1_mob_submit_form_cb
  function do_ajax_form_tmp_recibos_impressos1_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tmp_recibos_impressos1_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tmp_recibos_impressos1_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tmp_recibos_impressos1_mob_navigate_form(var_codigoidentificador, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tmp_recibos_impressos1_mob_navigate_form_cb);
  } // do_ajax_form_tmp_recibos_impressos1_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tmp_recibos_impressos1_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tmp_recibos_impressos1_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tmp_recibos_impressos1_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tmp_recibos_impressos1_mob_navigate_form_cb
  function do_ajax_form_tmp_recibos_impressos1_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tmp_recibos_impressos1_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tmp_recibos_impressos1_mob_navigate_form_cb_after_alert
  function sc_hide_form_tmp_recibos_impressos1_mob_form()
  {
