...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_emissao_hora' + iSeqRow).bind('blur', function() { sc_form_tmp_recibos_impressos1_emissao_hora_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_tmp_recibos_impressos1_emissao_hora_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_vencimento_hora' + iSeqRow).bind('blur', function() { sc_form_tmp_recibos_impressos1_vencimento_hora_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_tmp_recibos_impressos1_vencimento_hora_onfocus(this, iSeqRow) });
...
function sc_form_tmp_recibos_impressos1_emissao_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tmp_recibos_impressos1_validate_emissao();
  scCssBlur(oThis);
}
...
function sc_form_tmp_recibos_impressos1_emissao_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_tmp_recibos_impressos1_vencimento_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tmp_recibos_impressos1_validate_vencimento();
  scCssBlur(oThis);
}
...
function sc_form_tmp_recibos_impressos1_vencimento_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_tmp_recibos_impressos1_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_emissao" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tmp_recibos_impressos1_validate_emissao(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_vencimento" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tmp_recibos_impressos1_validate_vencimento(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
