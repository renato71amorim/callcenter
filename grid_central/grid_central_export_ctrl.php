<?php
@session_start() ;
$_SESSION['scriptcase']['grid_central']['sc_process_barr'] = true;
require_once('../grid_central/index.php');
unset($_SESSION['scriptcase']['grid_central']['sc_process_barr']);
$ExportCtrl = new grid_central_export_control;
$ExportCtrl->Export_barr();

class grid_central_export_control
{
