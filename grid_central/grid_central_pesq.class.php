...
class grid_central_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_central_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_central_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_central_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_codigocentral')
      {
          $codigocentral = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_codigocentral($codigocentral);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_codigocentral($codigocentral)
   {
      $codigocentral = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $codigocentral);
      $codigocentral = substr($this->Db->qstr($codigocentral), 1, -1);
            $codigocentral_look = substr($this->Db->qstr($codigocentral), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct CodigoCentral from " . $this->Ini->nm_tabela . " where  CodigoCentral like '%" . $codigocentral . "%' order by CodigoCentral"; 
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - central</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_central/grid_central_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_central_ajax_search.js"></script>
 <script type="text/javascript" src="grid_central_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_central_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_central']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_central']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_codigocentral_cond#NMF#' + search_get_sel_txt('SC_codigocentral_cond') + '@NMF@';
  str_out += 'SC_codigocentral#NMF#' + search_get_text('SC_codigocentral') + '@NMF@';
  str_out += 'id_ac_codigocentral#NMF#' + search_get_text('id_ac_codigocentral') + '@NMF@';
  str_out += 'SC_codigocentral_input_2#NMF#' + search_get_text('SC_codigocentral_input_2') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_codigocentral").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_codigocentral",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_codigocentral").val(ui.item.value);
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - central</span></td>
...
<?php
   ...
   {
      global 
             $codigocentral_cond, $codigocentral, $codigocentral_input_2, $codigocentral_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $codigocentral = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['campos_busca']['codigocentral']; 
          $codigocentral_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['campos_busca']['codigocentral_input_2']; 
          $codigocentral_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['campos_busca']['codigocentral_cond']; 
          $descricao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['campos_busca']['descricao']; 
          $descricao_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['campos_busca']['descricao_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['campos_busca']['NM_operador']; 
      } 
      if (!isset($codigocentral_cond) || empty($codigocentral_cond))
      {
         $codigocentral_cond = "gt";
      }
      ...
      $str_hide_codigocentral = (in_array($codigocentral_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_descricao = (in_array($descricao_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_codigocentral = ('bw' == $codigocentral_cond) ? $display_aberto : $display_fechado;
      $str_display_descricao = ('bw' == $descricao_cond) ? $display_aberto : $display_fechado;

      if (!isset($codigocentral) || $codigocentral == "")
      {
          $codigocentral = "";
      }
      if (isset($codigocentral) && !empty($codigocentral))
      {
         $tmp_pos = strpos($codigocentral, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $codigocentral = substr($codigocentral, 0, $tmp_pos);
         }
      }
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_codigocentral_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['codigocentral'])) ? $this->New_label['codigocentral'] : "Codigo Central"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_codigocentral_cond" name="codigocentral_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigocentral'), this, 'codigocentral')">
       <OPTION value="gt" <?php if ("gt" == $codigocentral_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $codigocentral_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $codigocentral_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $codigocentral_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_codigocentral" <?php echo $str_hide_codigocentral?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['codigocentral'])) ? $this->New_label['codigocentral'] : "Codigo Central";
 $nmgp_tab_label .= "codigocentral?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
      ...
      $codigocentral_look = substr($this->Db->qstr($codigocentral), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($codigocentral))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct CodigoCentral from " . $this->Ini->nm_tabela . " where CodigoCentral = $codigocentral_look order by CodigoCentral"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct CodigoCentral from " . $this->Ini->nm_tabela . " where CodigoCentral = $codigocentral_look order by CodigoCentral"; 
      ...
      if (isset($nmgp_def_dados[0][$codigocentral]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$codigocentral];
      }
      else
      {
            nmgp_Form_Num_Val($codigocentral, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $codigocentral;
      }
?>
<INPUT  type="text" id="SC_codigocentral" name="codigocentral" value="<?php echo NM_encode_input($codigocentral) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_codigocentral" name="codigocentral_autocomp" size="11"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_codigocentral"  <?php echo $str_display_codigocentral; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_codigocentral_input_2" name="codigocentral_input_2" value="<?php echo NM_encode_input($codigocentral_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_descricao" name="descricao_autocomp" size="30"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_central_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_central']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_central']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.codigocentral_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_codigocentral'), document.F1.codigocentral_cond, 'codigocentral');
   document.F1.codigocentral.value = "";
   document.F1.codigocentral_autocomp.value = "";
   document.F1.codigocentral_input_2.value = "";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "dinamica_publicado/grid_central";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_codigocentral_cond'] = 'cond';
      $tp_fields['SC_codigocentral'] = 'text_aut';
      $tp_fields['id_ac_codigocentral'] = 'text_aut';
      $tp_fields['SC_codigocentral_input_2'] = 'text';
   ...
   {
      global $codigocentral_cond, $codigocentral, $codigocentral_input_2, $codigocentral_autocomp,
      ...
      if (!empty($codigocentral_autocomp) && empty($codigocentral))
      {
          $codigocentral = $codigocentral_autocomp;
      }
      if (!empty($descricao_autocomp) && empty($descricao))
      {
          $descricao = $descricao_autocomp;
      }
      $codigocentral_cond_salva = $codigocentral_cond; 
      if (!isset($codigocentral_input_2) || $codigocentral_input_2 == "")
      {
          $codigocentral_input_2 = $codigocentral;
      }
      ...
      if ($codigocentral_cond != "in")
      {
          nm_limpa_numero($codigocentral, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($codigocentral_cond != "in")
      {
          nm_limpa_numero($codigocentral_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['campos_busca']['codigocentral'] = $codigocentral; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['campos_busca']['codigocentral_input_2'] = $codigocentral_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['campos_busca']['codigocentral_cond'] = $codigocentral_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['campos_busca']['descricao'] = $descricao; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['campos_busca']['descricao_cond'] = $descricao_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['campos_busca'] = $Temp_Busca;
      }
      if ($codigocentral_cond != "in" && $codigocentral_cond != "bw" && !empty($codigocentral) && !is_numeric($codigocentral))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Codigo Central";
      }
      if ($codigocentral_cond == "bw" && ((!empty($codigocentral) && !is_numeric($codigocentral)) || (!empty($codigocentral_input_2) && !is_numeric($codigocentral_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Codigo Central";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['codigocentral'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['codigocentral'] = $cmp1;
      }
      else
      {
          $cmp1 = $codigocentral;
      ...
      $Conteudo = $codigocentral_input_2;
      if (strtoupper($codigocentral_cond) != "II" && strtoupper($codigocentral_cond) != "QP" && strtoupper($codigocentral_cond) != "NP" && strtoupper($codigocentral_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['codigocentral_input_2'] = $Conteudo;
      $descricao_look = substr($this->Db->qstr($descricao), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Descricao from " . $this->Ini->nm_tabela . " where Descricao = '$descricao_look' order by Descricao"; 
      unset($cmp1,$cmp2);
      ...
      if (isset($codigocentral) || $codigocentral_cond == "nu" || $codigocentral_cond == "nn" || $codigocentral_cond == "ep" || $codigocentral_cond == "ne")
      {
         $this->monta_condicao("CodigoCentral", $codigocentral_cond, $codigocentral, $codigocentral_input_2, "codigocentral");
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_central']['cond_pesq'] .= $this->NM_operador;
