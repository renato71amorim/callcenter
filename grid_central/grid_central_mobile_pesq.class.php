...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "codigocentral";$Nm_numeric[] = "codigocentral";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_codigocentral_cond" name="codigocentral_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigocentral'), this, 'codigocentral')">
      ...
      <br><span id="id_hide_codigocentral"  <?php echo $str_hide_codigocentral?>><?php
      if ($codigocentral != "")
      {
      $codigocentral_look = substr($this->Db->qstr($codigocentral), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_codigocentral" name="codigocentral_autocomp" size="11"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_codigocentral"  <?php echo $str_display_codigocentral; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_codigocentral_input_2" name="codigocentral_input_2" value="<?php echo NM_encode_input($codigocentral_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
