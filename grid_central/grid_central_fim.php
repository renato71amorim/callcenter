...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_central"]))
   {
      unset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_central"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_central'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_central']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_central']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_central']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_central']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_central']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_central']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_central']['embutida_filho'] as $ind => $sc_init)
          {
