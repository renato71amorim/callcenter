<?php
@session_start() ;
$_SESSION['scriptcase']['grid_vicidial_list_2']['sc_process_barr'] = true;
require_once('../grid2/index.php');
unset($_SESSION['scriptcase']['grid_vicidial_list_2']['sc_process_barr']);
$ExportCtrl = new grid_vicidial_list_2_export_control;
$ExportCtrl->Export_barr();

class grid_vicidial_list_2_export_control
{
