<?php
@session_start() ;
$_SESSION['scriptcase']['grid_vicidial_list_todos_dia']['sc_process_barr'] = true;
require_once('../grid_todos_dia/index.php');
unset($_SESSION['scriptcase']['grid_vicidial_list_todos_dia']['sc_process_barr']);
$ExportCtrl = new grid_vicidial_list_todos_dia_export_control;
$ExportCtrl->Export_barr();

class grid_vicidial_list_todos_dia_export_control
{
