  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_extrato_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_extrato_mob_form();
	}

  // ---------- Validate datainicial
  function do_ajax_control_extrato_mob_validate_datainicial()
  {
    var nomeCampo_datainicial = "datainicial";
    var var_datainicial = scAjaxGetFieldText(nomeCampo_datainicial);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_datainicial = scAjaxGetFieldText(nomeCampo_datainicial);
      x_ajax_control_extrato_mob_validate_datainicial(var_datainicial, var_script_case_init, do_ajax_control_extrato_mob_validate_datainicial_cb);
    }, 200);
  } // do_ajax_control_extrato_mob_validate_datainicial

  function do_ajax_control_extrato_mob_validate_datainicial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "datainicial";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_extrato_mob_validate_datainicial_cb

  // ---------- Validate datafinal
  function do_ajax_control_extrato_mob_validate_datafinal()
  {
    var nomeCampo_datafinal = "datafinal";
    var var_datafinal = scAjaxGetFieldText(nomeCampo_datafinal);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_datafinal = scAjaxGetFieldText(nomeCampo_datafinal);
      x_ajax_control_extrato_mob_validate_datafinal(var_datafinal, var_script_case_init, do_ajax_control_extrato_mob_validate_datafinal_cb);
    }, 200);
  } // do_ajax_control_extrato_mob_validate_datafinal

  function do_ajax_control_extrato_mob_validate_datafinal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "datafinal";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors || ($("#ui-datepicker-div").length && $("#ui-datepicker-div").filter(":visible").length))
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_extrato_mob_validate_datafinal_cb

  // ---------- Validate tipo
  function do_ajax_control_extrato_mob_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_extrato_mob_validate_tipo(var_tipo, var_script_case_init, do_ajax_control_extrato_mob_validate_tipo_cb);
  } // do_ajax_control_extrato_mob_validate_tipo

  function do_ajax_control_extrato_mob_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_extrato_mob_validate_tipo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_extrato_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_extrato_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_datainicial = scAjaxGetFieldText("datainicial");
    var var_datafinal = scAjaxGetFieldText("datafinal");
    ...
    scAjaxProcOn();
    x_ajax_control_extrato_mob_submit_form(var_datainicial, var_datafinal, var_tipo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_extrato_mob_submit_form_cb);
  } // do_ajax_control_extrato_mob_submit_form

  function do_ajax_control_extrato_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_extrato_mob_submit_form_cb_after_alert);
  } // do_ajax_control_extrato_mob_submit_form_cb
  function do_ajax_control_extrato_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_extrato_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_extrato_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_extrato_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_extrato_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_extrato_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_extrato_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_extrato_mob_navigate_form_cb
  function do_ajax_control_extrato_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_extrato_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_extrato_mob_navigate_form_cb_after_alert
  function sc_hide_control_extrato_mob_form()
  {
  ...
  ajax_field_list[0] = "datainicial";
  ajax_field_list[1] = "datafinal";
  ...
  var ajax_error_list = {
    "datainicial": {"label": "Data Inicial", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "datafinal": {"label": "Data Final", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["datainicial"][1] = "datainicial";
  ajax_field_mult["datafinal"][1] = "datafinal";
  ajax_field_mult["tipo"][1] = "tipo";

  var ajax_field_id = {
    "datainicial": new Array("hidden_field_label_datainicial", "hidden_field_data_datainicial"),
    "datafinal": new Array("hidden_field_label_datafinal", "hidden_field_data_datafinal"),
