  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_extrato" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_extrato_form();
	}

  // ---------- Validate datainicial
  function do_ajax_control_extrato_validate_datainicial()
  {
    ...
    setTimeout(function() {
      var var_datainicial = scAjaxGetFieldText(nomeCampo_datainicial);
      x_ajax_control_extrato_validate_datainicial(var_datainicial, var_script_case_init, do_ajax_control_extrato_validate_datainicial_cb);
    }, 200);
  } // do_ajax_control_extrato_validate_datainicial

  function do_ajax_control_extrato_validate_datainicial_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_extrato_validate_datainicial_cb

  // ---------- Validate datafinal
  function do_ajax_control_extrato_validate_datafinal()
  {
    ...
    setTimeout(function() {
      var var_datafinal = scAjaxGetFieldText(nomeCampo_datafinal);
      x_ajax_control_extrato_validate_datafinal(var_datafinal, var_script_case_init, do_ajax_control_extrato_validate_datafinal_cb);
    }, 200);
  } // do_ajax_control_extrato_validate_datafinal

  function do_ajax_control_extrato_validate_datafinal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_extrato_validate_datafinal_cb

  // ---------- Validate tipo
  function do_ajax_control_extrato_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_extrato_validate_tipo(var_tipo, var_script_case_init, do_ajax_control_extrato_validate_tipo_cb);
  } // do_ajax_control_extrato_validate_tipo

  function do_ajax_control_extrato_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_extrato_validate_tipo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_extrato_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_extrato_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_extrato_submit_form(var_datainicial, var_datafinal, var_tipo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_extrato_submit_form_cb);
  } // do_ajax_control_extrato_submit_form

  function do_ajax_control_extrato_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_extrato_submit_form_cb_after_alert);
  } // do_ajax_control_extrato_submit_form_cb
  function do_ajax_control_extrato_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_extrato_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_extrato_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_extrato_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_extrato']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_extrato_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_extrato_navigate_form_cb_after_alert);
  } // do_ajax_control_extrato_navigate_form_cb
  function do_ajax_control_extrato_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_extrato_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_extrato_navigate_form_cb_after_alert
  function sc_hide_control_extrato_form()
  {
