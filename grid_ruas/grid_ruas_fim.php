...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_ruas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_ruas"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ruas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_ruas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ruas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_ruas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_ruas']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_ruas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_ruas']['embutida_filho'] as $ind => $sc_init)
          {
