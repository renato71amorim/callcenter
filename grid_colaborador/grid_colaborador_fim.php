...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_colaborador"]))
   {
      unset($_SESSION['session_sec_aplicacao']["dinamica_publicado_____grid_colaborador"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_colaborador'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_colaborador']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_colaborador']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_colaborador']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_colaborador']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_colaborador']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_colaborador']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_colaborador']['embutida_filho'] as $ind => $sc_init)
          {
