...
<?php
   ...
   $Ord_Cmp = new grid_colaborador_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_colaborador_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_colaborador']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_colaborador']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_colaborador']['labels']["codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_colaborador']['labels']["codigo"] : "Codigo";
   $tab_ger_campos['nomerecibo'] = "on";
   $tab_def_campos['nomerecibo'] = "NomeRecibo";
   $tab_labels["nomerecibo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_colaborador']['labels']["nomerecibo"])) ? $_SESSION['sc_session'][$sc_init]['grid_colaborador']['labels']["nomerecibo"] : "Nome Recibo";
   $tab_ger_campos['observacao'] = "on";
   $tab_def_campos['observacao'] = "Observacao";
   $tab_labels["observacao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_colaborador']['labels']["observacao"])) ? $_SESSION['sc_session'][$sc_init]['grid_colaborador']['labels']["observacao"] : "Observacao";
   $tab_ger_campos['dtiniciocolab'] = "on";
   $tab_def_campos['dtiniciocolab'] = "DtInicioColab";
   $tab_labels["dtiniciocolab"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_colaborador']['labels']["dtiniciocolab"])) ? $_SESSION['sc_session'][$sc_init]['grid_colaborador']['labels']["dtiniciocolab"] : "Dt Inicio Colab";
   $tab_ger_campos['dtultimacolab'] = "on";
   $tab_def_campos['dtultimacolab'] = "DtUltimaColab";
   $tab_labels["dtultimacolab"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_colaborador']['labels']["dtultimacolab"])) ? $_SESSION['sc_session'][$sc_init]['grid_colaborador']['labels']["dtultimacolab"] : "Dt Ultima Colab";
   $tab_ger_campos['operadoravulso'] = "on";
   $tab_def_campos['operadoravulso'] = "OperadorAvulso";
   $tab_labels["operadoravulso"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_colaborador']['labels']["operadoravulso"])) ? $_SESSION['sc_session'][$sc_init]['grid_colaborador']['labels']["operadoravulso"] : "Operador Avulso";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_colaborador']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_colaborador']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_colaborador']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_colaborador']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_colaborador']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_colaborador']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_colaborador']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_colaborador']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_colaborador']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_colaborador']['ordem_quebra'] as $campo => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_colaborador']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_colaborador']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_colaborador_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_colaborador']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_colaborador']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_colaborador']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_colaborador']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_colaborador']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
