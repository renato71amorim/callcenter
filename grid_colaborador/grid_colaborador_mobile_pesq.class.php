...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "DtInicioColab";$Nm_datas[] = "DtInicioColab";$Nm_datas[] = "DtUltimaColab";$Nm_datas[] = "DtUltimaColab";$Nm_datas[] = "DtUltimaColabAv";$Nm_datas[] = "DtUltimaColabAv";$Nm_numeric[] = "codigo";$Nm_numeric[] = "operadoravulso";$Nm_numeric[] = "operadormensal";$Nm_numeric[] = "valoravulso";$Nm_numeric[] = "valormensal";$Nm_numeric[] = "cobrador";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_dtiniciocolab_cond" name="dtiniciocolab_cond" onChange="nm_campos_between(document.getElementById('id_vis_dtiniciocolab'), this, 'dtiniciocolab')">
      ...
      <br><span id="id_hide_dtiniciocolab"  <?php echo $str_hide_dtiniciocolab?>>
<?php
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_dtiniciocolab"  <?php echo $str_display_dtiniciocolab; ?> class="scFilterFieldFontOdd">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_codigo" name="codigo_autocomp" size="19"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_codigo"  <?php echo $str_display_codigo; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_codigo_input_2" name="codigo_input_2" value="<?php echo NM_encode_input($codigo_input_2) ?>"  size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nomerecibo_cond" name="nomerecibo_cond" onChange="nm_campos_between(document.getElementById('id_vis_nomerecibo'), this, 'nomerecibo')">
      ...
      <br><span id="id_hide_nomerecibo"  <?php echo $str_hide_nomerecibo?>><?php
      if ($nomerecibo != "")
      {
      $nomerecibo_look = substr($this->Db->qstr($nomerecibo), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_observacao_cond" name="observacao_cond" onChange="nm_campos_between(document.getElementById('id_vis_observacao'), this, 'observacao')">
      ...
      <br><span id="id_hide_observacao"  <?php echo $str_hide_observacao?>><?php
      if ($observacao != "")
      {
      $observacao_look = substr($this->Db->qstr($observacao), 1, -1); 
      $nmgp_def_dados = array(); 
