...
class grid_colaborador_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_colaborador_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_colaborador_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_colaborador_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_observacao')
      {
          $observacao = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_observacao($observacao);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_observacao($observacao)
   {
      $observacao = substr($this->Db->qstr($observacao), 1, -1);
            $observacao_look = substr($this->Db->qstr($observacao), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Observacao from " . $this->Ini->nm_tabela . " where  Observacao like '%" . $observacao . "%' order by Observacao"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "DtInicioColab";$Nm_datas[] = "DtInicioColab";$Nm_datas[] = "DtUltimaColab";$Nm_datas[] = "DtUltimaColab";$Nm_datas[] = "DtUltimaColabAv";$Nm_datas[] = "DtUltimaColabAv";
      if (in_array($campo_join, $Nm_datas))
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - colaborador</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_colaborador/grid_colaborador_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_colaborador_ajax_search.js"></script>
 <script type="text/javascript" src="grid_colaborador_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_colaborador_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_colaborador']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_colaborador']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_dtiniciocolab_cond#NMF#' + search_get_sel_txt('SC_dtiniciocolab_cond') + '@NMF@';
  str_out += 'SC_dtiniciocolab_dia#NMF#' + search_get_sel_txt('SC_dtiniciocolab_dia') + '@NMF@';
  str_out += 'SC_dtiniciocolab_mes#NMF#' + search_get_sel_txt('SC_dtiniciocolab_mes') + '@NMF@';
  str_out += 'SC_dtiniciocolab_ano#NMF#' + search_get_sel_txt('SC_dtiniciocolab_ano') + '@NMF@';
  str_out += 'SC_dtiniciocolab_input_2_dia#NMF#' + search_get_sel_txt('SC_dtiniciocolab_input_2_dia') + '@NMF@';
  str_out += 'SC_dtiniciocolab_input_2_mes#NMF#' + search_get_sel_txt('SC_dtiniciocolab_input_2_mes') + '@NMF@';
  str_out += 'SC_dtiniciocolab_input_2_ano#NMF#' + search_get_sel_txt('SC_dtiniciocolab_input_2_ano') + '@NMF@';
  str_out += 'SC_dtiniciocolab_hor#NMF#' + search_get_sel_txt('SC_dtiniciocolab_hor') + '@NMF@';
  str_out += 'SC_dtiniciocolab_min#NMF#' + search_get_sel_txt('SC_dtiniciocolab_min') + '@NMF@';
  str_out += 'SC_dtiniciocolab_seg#NMF#' + search_get_sel_txt('SC_dtiniciocolab_seg') + '@NMF@';
  str_out += 'SC_dtiniciocolab_input_2_hor#NMF#' + search_get_sel_txt('SC_dtiniciocolab_input_2_hor') + '@NMF@';
  str_out += 'SC_dtiniciocolab_input_2_min#NMF#' + search_get_sel_txt('SC_dtiniciocolab_input_2_min') + '@NMF@';
  str_out += 'SC_dtiniciocolab_input_2_seg#NMF#' + search_get_sel_txt('SC_dtiniciocolab_input_2_seg') + '@NMF@';
  ...
  str_out += 'SC_observacao_cond#NMF#' + search_get_sel_txt('SC_observacao_cond') + '@NMF@';
  str_out += 'SC_observacao#NMF#' + search_get_text('SC_observacao') + '@NMF@';
  str_out += 'id_ac_observacao#NMF#' + search_get_text('id_ac_observacao') + '@NMF@';
   ...
   $("#id_ac_observacao").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_observacao",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_observacao").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - colaborador</span></td>
...
<?php
   ...
   {
      global 
             $dtiniciocolab_cond, $dtiniciocolab, $dtiniciocolab_dia, $dtiniciocolab_mes, $dtiniciocolab_ano, $dtiniciocolab_hor, $dtiniciocolab_min, $dtiniciocolab_seg, $dtiniciocolab_input_2_dia, $dtiniciocolab_input_2_mes, $dtiniciocolab_input_2_ano, $dtiniciocolab_input_2_min, $dtiniciocolab_input_2_hor, $dtiniciocolab_input_2_seg,
             $codigo_cond, $codigo, $codigo_input_2, $codigo_autocomp,
             $nomerecibo_cond, $nomerecibo, $nomerecibo_autocomp,
             $observacao_cond, $observacao, $observacao_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $dtiniciocolab_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_dia']; 
          $dtiniciocolab_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_mes']; 
          $dtiniciocolab_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_ano']; 
          $dtiniciocolab_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_input_2_dia']; 
          $dtiniciocolab_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_input_2_mes']; 
          $dtiniciocolab_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_input_2_ano']; 
          $dtiniciocolab_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_hor']; 
          $dtiniciocolab_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_min']; 
          $dtiniciocolab_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_seg']; 
          $dtiniciocolab_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_input_2_hor']; 
          $dtiniciocolab_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_input_2_min']; 
          $dtiniciocolab_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_input_2_seg']; 
          $dtiniciocolab_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_cond']; 
          $codigo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['codigo']; 
          $codigo_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['codigo_input_2']; 
          $codigo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['codigo_cond']; 
          $nomerecibo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['nomerecibo']; 
          $nomerecibo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['nomerecibo_cond']; 
          $observacao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['observacao']; 
          $observacao_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['observacao_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['NM_operador']; 
      } 
      if (!isset($dtiniciocolab_cond) || empty($dtiniciocolab_cond))
      {
         $dtiniciocolab_cond = "eq";
      }
      ...
      if (!isset($observacao_cond) || empty($observacao_cond))
      {
         $observacao_cond = "qp";
      }
      ...
      $str_hide_dtiniciocolab = (in_array($dtiniciocolab_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_hide_observacao = (in_array($observacao_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_dtiniciocolab = ('bw' == $dtiniciocolab_cond) ? $display_aberto : $display_fechado;
      ...
      $str_display_observacao = ('bw' == $observacao_cond) ? $display_aberto : $display_fechado;

      if (!isset($dtiniciocolab) || $dtiniciocolab == "")
      {
          $dtiniciocolab = "";
      }
      if (isset($dtiniciocolab) && !empty($dtiniciocolab))
      {
         $tmp_pos = strpos($dtiniciocolab, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $dtiniciocolab = substr($dtiniciocolab, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($observacao, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $observacao = substr($observacao, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_dtiniciocolab_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['dtiniciocolab'])) ? $this->New_label['dtiniciocolab'] : "Dt Inicio Colab"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_dtiniciocolab_cond" name="dtiniciocolab_cond" onChange="nm_campos_between(document.getElementById('id_vis_dtiniciocolab'), this, 'dtiniciocolab')">
       <OPTION value="eq" <?php if ("eq" == $dtiniciocolab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $dtiniciocolab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $dtiniciocolab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $dtiniciocolab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_dtiniciocolab" <?php echo $str_hide_dtiniciocolab?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['dtiniciocolab'])) ? $this->New_label['dtiniciocolab'] : "Dt Inicio Colab";
 $nmgp_tab_label .= "dtiniciocolab?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
  ...
  {
?>
<span id='id_date_part_dtiniciocolab_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_dtiniciocolab_dia" name="dtiniciocolab_dia" value="<?php echo NM_encode_input($dtiniciocolab_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_dtiniciocolab_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_dtiniciocolab_mes" name="dtiniciocolab_mes" value="<?php echo NM_encode_input($dtiniciocolab_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_dtiniciocolab_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_dtiniciocolab_ano" name="dtiniciocolab_ano" value="<?php echo NM_encode_input($dtiniciocolab_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_dtiniciocolab_HH' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_dtiniciocolab_hor" name="dtiniciocolab_hor" value="<?php echo NM_encode_input($dtiniciocolab_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_dtiniciocolab_II' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_dtiniciocolab_min" name="dtiniciocolab_min" value="<?php echo NM_encode_input($dtiniciocolab_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_dtiniciocolab_SS' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_dtiniciocolab_seg" name="dtiniciocolab_seg" value="<?php echo NM_encode_input($dtiniciocolab_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
?>
        <SPAN id="id_css_dtiniciocolab"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_dtiniciocolab"  <?php echo $str_display_dtiniciocolab; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<span id='id_date_part_dtiniciocolab_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_dtiniciocolab_input_2_dia" name="dtiniciocolab_input_2_dia" value="<?php echo NM_encode_input($dtiniciocolab_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_dtiniciocolab_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_dtiniciocolab_input_2_mes" name="dtiniciocolab_input_2_mes" value="<?php echo NM_encode_input($dtiniciocolab_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_dtiniciocolab_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_dtiniciocolab_input_2_ano" name="dtiniciocolab_input_2_ano" value="<?php echo NM_encode_input($dtiniciocolab_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_dtiniciocolab_input_2_HH' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_dtiniciocolab_input_2_hor" name="dtiniciocolab_input_2_hor" value="<?php echo NM_encode_input($dtiniciocolab_input_2_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_dtiniciocolab_input_2_II' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_dtiniciocolab_input_2_min" name="dtiniciocolab_input_2_min" value="<?php echo NM_encode_input($dtiniciocolab_input_2_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_dtiniciocolab_input_2_SS' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_dtiniciocolab_input_2_seg" name="dtiniciocolab_input_2_seg" value="<?php echo NM_encode_input($dtiniciocolab_input_2_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
?>
      ...
      <TD id='SC_codigo_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['codigo'])) ? $this->New_label['codigo'] : "Codigo"; ?></TD>
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_codigo" name="codigo_autocomp" size="19"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_codigo"  <?php echo $str_display_codigo; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_codigo_input_2" name="codigo_input_2" value="<?php echo NM_encode_input($codigo_input_2) ?>"  size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_nomerecibo_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['nomerecibo'])) ? $this->New_label['nomerecibo'] : "Nome Recibo"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_nomerecibo_cond" name="nomerecibo_cond" onChange="nm_campos_between(document.getElementById('id_vis_nomerecibo'), this, 'nomerecibo')">
       <OPTION value="qp" <?php if ("qp" == $nomerecibo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nomerecibo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nomerecibo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nomerecibo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nomerecibo" <?php echo $str_hide_nomerecibo?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nomerecibo" name="nomerecibo_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_observacao_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['observacao'])) ? $this->New_label['observacao'] : "Observacao"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_observacao_cond" name="observacao_cond" onChange="nm_campos_between(document.getElementById('id_vis_observacao'), this, 'observacao')">
       <OPTION value="qp" <?php if ("qp" == $observacao_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $observacao_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $observacao_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $observacao_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_observacao" <?php echo $str_hide_observacao?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['observacao'])) ? $this->New_label['observacao'] : "Observacao";
 $nmgp_tab_label .= "observacao?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $observacao_look = substr($this->Db->qstr($observacao), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Observacao from " . $this->Ini->nm_tabela . " where Observacao = '$observacao_look' order by Observacao"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$observacao]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$observacao];
      }
      else
      {
          $sAutocompValue = $observacao;
      }
?>
<INPUT  type="text" id="SC_observacao" name="observacao" value="<?php echo NM_encode_input($observacao) ?>"  size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_observacao" name="observacao_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_colaborador_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_colaborador']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_colaborador']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.dtiniciocolab_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_dtiniciocolab'), document.F1.dtiniciocolab_cond, 'dtiniciocolab');
   document.F1.dtiniciocolab_dia.value = "";
   document.F1.dtiniciocolab_mes.value = "";
   document.F1.dtiniciocolab_ano.value = "";
   document.F1.dtiniciocolab_input_2_dia.value = "";
   document.F1.dtiniciocolab_input_2_mes.value = "";
   document.F1.dtiniciocolab_input_2_ano.value = "";
   document.F1.dtiniciocolab_hor.value = "";
   document.F1.dtiniciocolab_min.value = "";
   document.F1.dtiniciocolab_seg.value = "";
   document.F1.dtiniciocolab_input_2_hor.value = "";
   document.F1.dtiniciocolab_input_2_min.value = "";
   document.F1.dtiniciocolab_input_2_seg.value = "";
   ...
   document.F1.observacao_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_observacao'), document.F1.observacao_cond, 'observacao');
   document.F1.observacao.value = "";
   document.F1.observacao_autocomp.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_dtiniciocolab_dia').bind('change', function() {sc_grid_colaborador_valida_dia(this)});
    $('#SC_dtiniciocolab_hor').bind('change', function() {sc_grid_colaborador_valida_hora(this)});
    $('#SC_dtiniciocolab_input_2_dia').bind('change', function() {sc_grid_colaborador_valida_dia(this)});
    $('#SC_dtiniciocolab_input_2_hor').bind('change', function() {sc_grid_colaborador_valida_hora(this)});
    $('#SC_dtiniciocolab_input_2_mes').bind('change', function() {sc_grid_colaborador_valida_mes(this)});
    $('#SC_dtiniciocolab_input_2_min').bind('change', function() {sc_grid_colaborador_valida_min(this)});
    $('#SC_dtiniciocolab_input_2_seg').bind('change', function() {sc_grid_colaborador_valida_seg(this)});
    $('#SC_dtiniciocolab_mes').bind('change', function() {sc_grid_colaborador_valida_mes(this)});
    $('#SC_dtiniciocolab_min').bind('change', function() {sc_grid_colaborador_valida_min(this)});
    $('#SC_dtiniciocolab_seg').bind('change', function() {sc_grid_colaborador_valida_seg(this)});
 }
 function sc_grid_colaborador_valida_dia(obj)
 {
 ...
 function sc_grid_colaborador_valida_mes(obj)
 {
 ...
 function sc_grid_colaborador_valida_hora(obj)
 {
 ...
 function sc_grid_colaborador_valida_min(obj)
 {
 ...
 function sc_grid_colaborador_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "dinamica_publicado/grid_colaborador";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_dtiniciocolab_cond'] = 'cond';
      $tp_fields['SC_dtiniciocolab_dia'] = 'text';
      $tp_fields['SC_dtiniciocolab_mes'] = 'text';
      $tp_fields['SC_dtiniciocolab_ano'] = 'text';
      $tp_fields['SC_dtiniciocolab_input_2_dia'] = 'text';
      $tp_fields['SC_dtiniciocolab_input_2_mes'] = 'text';
      $tp_fields['SC_dtiniciocolab_input_2_ano'] = 'text';
      $tp_fields['SC_dtiniciocolab_hor'] = 'text';
      $tp_fields['SC_dtiniciocolab_min'] = 'text';
      $tp_fields['SC_dtiniciocolab_seg'] = 'text';
      $tp_fields['SC_dtiniciocolab_input_2_hor'] = 'text';
      $tp_fields['SC_dtiniciocolab_input_2_min'] = 'text';
      $tp_fields['SC_dtiniciocolab_input_2_seg'] = 'text';
      ...
      $tp_fields['SC_observacao_cond'] = 'cond';
      $tp_fields['SC_observacao'] = 'text_aut';
      $tp_fields['id_ac_observacao'] = 'text_aut';
   ...
   {
      global $dtiniciocolab_cond, $dtiniciocolab, $dtiniciocolab_dia, $dtiniciocolab_mes, $dtiniciocolab_ano, $dtiniciocolab_hor, $dtiniciocolab_min, $dtiniciocolab_seg, $dtiniciocolab_input_2_dia, $dtiniciocolab_input_2_mes, $dtiniciocolab_input_2_ano, $dtiniciocolab_input_2_min, $dtiniciocolab_input_2_hor, $dtiniciocolab_input_2_seg,
             $codigo_cond, $codigo, $codigo_input_2, $codigo_autocomp,
             $nomerecibo_cond, $nomerecibo, $nomerecibo_autocomp,
             $observacao_cond, $observacao, $observacao_autocomp, $nmgp_tab_label;
      ...
      if (!empty($observacao_autocomp) && empty($observacao))
      {
          $observacao = $observacao_autocomp;
      }
      $dtiniciocolab_cond_salva = $dtiniciocolab_cond; 
      if (!isset($dtiniciocolab_input_2_dia) || $dtiniciocolab_input_2_dia == "")
      {
          $dtiniciocolab_input_2_dia = $dtiniciocolab_dia;
      }
      if (!isset($dtiniciocolab_input_2_mes) || $dtiniciocolab_input_2_mes == "")
      {
          $dtiniciocolab_input_2_mes = $dtiniciocolab_mes;
      }
      if (!isset($dtiniciocolab_input_2_ano) || $dtiniciocolab_input_2_ano == "")
      {
          $dtiniciocolab_input_2_ano = $dtiniciocolab_ano;
      }
      if (!isset($dtiniciocolab_input_2_hor) || $dtiniciocolab_input_2_hor == "")
      {
          $dtiniciocolab_input_2_hor = $dtiniciocolab_hor;
      }
      if (!isset($dtiniciocolab_input_2_min) || $dtiniciocolab_input_2_min == "")
      {
          $dtiniciocolab_input_2_min = $dtiniciocolab_min;
      }
      if (!isset($dtiniciocolab_input_2_seg) || $dtiniciocolab_input_2_seg == "")
      {
          $dtiniciocolab_input_2_seg = $dtiniciocolab_seg;
      }
      ...
      $observacao_cond_salva = $observacao_cond; 
      if (!isset($observacao_input_2) || $observacao_input_2 == "")
      {
          $observacao_input_2 = $observacao;
      }
      if ($codigo_cond != "in")
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_dia'] = $dtiniciocolab_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_mes'] = $dtiniciocolab_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_ano'] = $dtiniciocolab_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_input_2_dia'] = $dtiniciocolab_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_input_2_mes'] = $dtiniciocolab_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_input_2_ano'] = $dtiniciocolab_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_hor'] = $dtiniciocolab_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_min'] = $dtiniciocolab_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_seg'] = $dtiniciocolab_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_input_2_hor'] = $dtiniciocolab_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_input_2_min'] = $dtiniciocolab_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_input_2_seg'] = $dtiniciocolab_input_2_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_cond'] = $dtiniciocolab_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['codigo'] = $codigo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['codigo_input_2'] = $codigo_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['codigo_cond'] = $codigo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['nomerecibo'] = $nomerecibo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['nomerecibo_cond'] = $nomerecibo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['observacao'] = $observacao; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['observacao_cond'] = $observacao_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca'] = $Temp_Busca;
      }
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['observacao'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['observacao'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['observacao'] = $observacao;
      }

      //----- $dtiniciocolab
      $this->Date_part = false;
      if ($dtiniciocolab_cond != "bi_TP")
      {
          $dtiniciocolab_cond = strtoupper($dtiniciocolab_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $dtiniciocolab_ano;
          $Dtxt .= $dtiniciocolab_mes;
          $Dtxt .= $dtiniciocolab_dia;
          $Dtxt .= $dtiniciocolab_hor;
          $Dtxt .= $dtiniciocolab_min;
          $Dtxt .= $dtiniciocolab_seg;
          $val[0]['ano'] = $dtiniciocolab_ano;
          $val[0]['mes'] = $dtiniciocolab_mes;
          $val[0]['dia'] = $dtiniciocolab_dia;
          $val[0]['hor'] = $dtiniciocolab_hor;
          $val[0]['min'] = $dtiniciocolab_min;
          $val[0]['seg'] = $dtiniciocolab_seg;
          if ($dtiniciocolab_cond == "BW")
          {
              $val[1]['ano'] = $dtiniciocolab_input_2_ano;
              $val[1]['mes'] = $dtiniciocolab_input_2_mes;
              $val[1]['dia'] = $dtiniciocolab_input_2_dia;
              $val[1]['hor'] = $dtiniciocolab_input_2_hor;
              $val[1]['min'] = $dtiniciocolab_input_2_min;
              $val[1]['seg'] = $dtiniciocolab_input_2_seg;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DH", "DATETIME", $dtiniciocolab_cond, "", "datahora");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $dtiniciocolab = $val[0];
          $this->cmp_formatado['dtiniciocolab'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['dtiniciocolab'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['dtiniciocolab'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY his"));
          if ($dtiniciocolab_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $dtiniciocolab_input_2     = $val[1];
              $this->cmp_formatado['dtiniciocolab_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']['dtiniciocolab_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['dtiniciocolab_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['dtiniciocolab_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY his"));
          }
          if (!empty($Dtxt) || $dtiniciocolab_cond == "NU" || $dtiniciocolab_cond == "NN"|| $dtiniciocolab_cond == "EP"|| $dtiniciocolab_cond == "NE")
          {
              $this->monta_condicao("DtInicioColab", $dtiniciocolab_cond, $dtiniciocolab, $dtiniciocolab_input_2, 'dtiniciocolab', 'DATETIME');
          }
      }
      ...
      //----- $observacao
      $this->Date_part = false;
      if (isset($observacao) || $observacao_cond == "nu" || $observacao_cond == "nn" || $observacao_cond == "ep" || $observacao_cond == "ne")
      {
         $this->monta_condicao("Observacao", $observacao_cond, $observacao, "", "observacao");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_colaborador']['cond_pesq'] .= $this->NM_operador;
