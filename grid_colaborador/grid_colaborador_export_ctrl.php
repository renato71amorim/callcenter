<?php
@session_start() ;
$_SESSION['scriptcase']['grid_colaborador']['sc_process_barr'] = true;
require_once('../grid_colaborador/index.php');
unset($_SESSION['scriptcase']['grid_colaborador']['sc_process_barr']);
$ExportCtrl = new grid_colaborador_export_control;
$ExportCtrl->Export_barr();

class grid_colaborador_export_control
{
