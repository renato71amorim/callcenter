  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_requisicoes" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_requisicoes_form();
	}

  // ---------- Validate idrequisicao
  function do_ajax_form_requisicoes_validate_idrequisicao()
  {
    var nomeCampo_idrequisicao = "idrequisicao";
    var var_idrequisicao = scAjaxGetFieldHidden(nomeCampo_idrequisicao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_validate_idrequisicao(var_idrequisicao, var_script_case_init, do_ajax_form_requisicoes_validate_idrequisicao_cb);
  } // do_ajax_form_requisicoes_validate_idrequisicao

  function do_ajax_form_requisicoes_validate_idrequisicao_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_validate_idrequisicao_cb

  // ---------- Validate codcontribuinte
  function do_ajax_form_requisicoes_validate_codcontribuinte()
  {
    var nomeCampo_codcontribuinte = "codcontribuinte";
    var var_codcontribuinte = scAjaxGetFieldText(nomeCampo_codcontribuinte);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_validate_codcontribuinte(var_codcontribuinte, var_script_case_init, do_ajax_form_requisicoes_validate_codcontribuinte_cb);
  } // do_ajax_form_requisicoes_validate_codcontribuinte

  function do_ajax_form_requisicoes_validate_codcontribuinte_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_validate_codcontribuinte_cb

  // ---------- Validate nomecontribuinte
  function do_ajax_form_requisicoes_validate_nomecontribuinte()
  {
    var nomeCampo_nomecontribuinte = "nomecontribuinte";
    var var_nomecontribuinte = scAjaxGetFieldText(nomeCampo_nomecontribuinte);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_validate_nomecontribuinte(var_nomecontribuinte, var_script_case_init, do_ajax_form_requisicoes_validate_nomecontribuinte_cb);
  } // do_ajax_form_requisicoes_validate_nomecontribuinte

  function do_ajax_form_requisicoes_validate_nomecontribuinte_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_validate_nomecontribuinte_cb

  // ---------- Validate fone1
  function do_ajax_form_requisicoes_validate_fone1()
  {
    var nomeCampo_fone1 = "fone1";
    var var_fone1 = scAjaxGetFieldText(nomeCampo_fone1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_validate_fone1(var_fone1, var_script_case_init, do_ajax_form_requisicoes_validate_fone1_cb);
  } // do_ajax_form_requisicoes_validate_fone1

  function do_ajax_form_requisicoes_validate_fone1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fone1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_validate_fone1_cb

  // ---------- Validate fone2
  function do_ajax_form_requisicoes_validate_fone2()
  {
    var nomeCampo_fone2 = "fone2";
    var var_fone2 = scAjaxGetFieldText(nomeCampo_fone2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_validate_fone2(var_fone2, var_script_case_init, do_ajax_form_requisicoes_validate_fone2_cb);
  } // do_ajax_form_requisicoes_validate_fone2

  function do_ajax_form_requisicoes_validate_fone2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fone2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_validate_fone2_cb

  // ---------- Validate fone3
  function do_ajax_form_requisicoes_validate_fone3()
  {
    var nomeCampo_fone3 = "fone3";
    var var_fone3 = scAjaxGetFieldText(nomeCampo_fone3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_validate_fone3(var_fone3, var_script_case_init, do_ajax_form_requisicoes_validate_fone3_cb);
  } // do_ajax_form_requisicoes_validate_fone3

  function do_ajax_form_requisicoes_validate_fone3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fone3";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_validate_fone3_cb

  // ---------- Validate fone4
  function do_ajax_form_requisicoes_validate_fone4()
  {
    var nomeCampo_fone4 = "fone4";
    var var_fone4 = scAjaxGetFieldText(nomeCampo_fone4);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_validate_fone4(var_fone4, var_script_case_init, do_ajax_form_requisicoes_validate_fone4_cb);
  } // do_ajax_form_requisicoes_validate_fone4

  function do_ajax_form_requisicoes_validate_fone4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fone4";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_validate_fone4_cb

  // ---------- Validate operadora
  function do_ajax_form_requisicoes_validate_operadora()
  {
    var nomeCampo_operadora = "operadora";
    var var_operadora = scAjaxGetFieldText(nomeCampo_operadora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_validate_operadora(var_operadora, var_script_case_init, do_ajax_form_requisicoes_validate_operadora_cb);
  } // do_ajax_form_requisicoes_validate_operadora

  function do_ajax_form_requisicoes_validate_operadora_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_validate_operadora_cb

  // ---------- Validate finalizada
  function do_ajax_form_requisicoes_validate_finalizada()
  {
    var nomeCampo_finalizada = "finalizada";
    var var_finalizada = scAjaxGetFieldText(nomeCampo_finalizada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_validate_finalizada(var_finalizada, var_script_case_init, do_ajax_form_requisicoes_validate_finalizada_cb);
  } // do_ajax_form_requisicoes_validate_finalizada

  function do_ajax_form_requisicoes_validate_finalizada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_validate_finalizada_cb

  // ---------- Validate dtfinalizacao
  function do_ajax_form_requisicoes_validate_dtfinalizacao()
  {
    var nomeCampo_dtfinalizacao = "dtfinalizacao";
    var var_dtfinalizacao = scAjaxGetFieldText(nomeCampo_dtfinalizacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_validate_dtfinalizacao(var_dtfinalizacao, var_script_case_init, do_ajax_form_requisicoes_validate_dtfinalizacao_cb);
  } // do_ajax_form_requisicoes_validate_dtfinalizacao

  function do_ajax_form_requisicoes_validate_dtfinalizacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_validate_dtfinalizacao_cb

  // ---------- Validate dtgerada
  function do_ajax_form_requisicoes_validate_dtgerada()
  {
    var nomeCampo_dtgerada = "dtgerada";
    var var_dtgerada = scAjaxGetFieldText(nomeCampo_dtgerada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_validate_dtgerada(var_dtgerada, var_script_case_init, do_ajax_form_requisicoes_validate_dtgerada_cb);
  } // do_ajax_form_requisicoes_validate_dtgerada

  function do_ajax_form_requisicoes_validate_dtgerada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_validate_dtgerada_cb

  // ---------- Validate status
  function do_ajax_form_requisicoes_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldText(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_validate_status(var_status, var_script_case_init, do_ajax_form_requisicoes_validate_status_cb);
  } // do_ajax_form_requisicoes_validate_status

  function do_ajax_form_requisicoes_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_validate_status_cb

  // ---------- Validate setor
  function do_ajax_form_requisicoes_validate_setor()
  {
    var nomeCampo_setor = "setor";
    var var_setor = scAjaxGetFieldText(nomeCampo_setor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_validate_setor(var_setor, var_script_case_init, do_ajax_form_requisicoes_validate_setor_cb);
  } // do_ajax_form_requisicoes_validate_setor

  function do_ajax_form_requisicoes_validate_setor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "setor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_validate_setor_cb

  // ---------- Validate comentario
  function do_ajax_form_requisicoes_validate_comentario()
  {
    var nomeCampo_comentario = "comentario";
    var var_comentario = scAjaxGetFieldText(nomeCampo_comentario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_validate_comentario(var_comentario, var_script_case_init, do_ajax_form_requisicoes_validate_comentario_cb);
  } // do_ajax_form_requisicoes_validate_comentario

  function do_ajax_form_requisicoes_validate_comentario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_validate_comentario_cb

  // ---------- Validate diamensal
  function do_ajax_form_requisicoes_validate_diamensal()
  {
    var nomeCampo_diamensal = "diamensal";
    var var_diamensal = scAjaxGetFieldText(nomeCampo_diamensal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_validate_diamensal(var_diamensal, var_script_case_init, do_ajax_form_requisicoes_validate_diamensal_cb);
  } // do_ajax_form_requisicoes_validate_diamensal

  function do_ajax_form_requisicoes_validate_diamensal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_validate_diamensal_cb

  // ---------- Validate tiporequisicao
  function do_ajax_form_requisicoes_validate_tiporequisicao()
  {
    var nomeCampo_tiporequisicao = "tiporequisicao";
    var var_tiporequisicao = scAjaxGetFieldText(nomeCampo_tiporequisicao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_validate_tiporequisicao(var_tiporequisicao, var_script_case_init, do_ajax_form_requisicoes_validate_tiporequisicao_cb);
  } // do_ajax_form_requisicoes_validate_tiporequisicao

  function do_ajax_form_requisicoes_validate_tiporequisicao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_validate_tiporequisicao_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_requisicoes_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_requisicoes_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_requisicoes_submit_form(var_idrequisicao, var_codcontribuinte, var_nomecontribuinte, var_fone1, var_fone2, var_fone3, var_fone4, var_operadora, var_finalizada, var_dtfinalizacao, var_dtgerada, var_status, var_setor, var_comentario, var_diamensal, var_tiporequisicao, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_requisicoes_submit_form_cb);
  } // do_ajax_form_requisicoes_submit_form

  function do_ajax_form_requisicoes_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_requisicoes_submit_form_cb_after_alert);
  } // do_ajax_form_requisicoes_submit_form_cb
  function do_ajax_form_requisicoes_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_requisicoes_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_requisicoes_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_requisicoes_navigate_form(var_idrequisicao, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_requisicoes_navigate_form_cb);
  } // do_ajax_form_requisicoes_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_requisicoes']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_requisicoes_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_requisicoes_navigate_form_cb_after_alert);
  } // do_ajax_form_requisicoes_navigate_form_cb
  function do_ajax_form_requisicoes_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_requisicoes_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_requisicoes_navigate_form_cb_after_alert
  function sc_hide_form_requisicoes_form()
  {
