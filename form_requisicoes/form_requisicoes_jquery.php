...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_dtfinalizacao_hora' + iSeqRow).bind('blur', function() { sc_form_requisicoes_dtfinalizacao_hora_onblur(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_requisicoes_dtfinalizacao_hora_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_dtgerada_hora' + iSeqRow).bind('blur', function() { sc_form_requisicoes_dtgerada_hora_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_requisicoes_dtgerada_hora_onfocus(this, iSeqRow) });
...
function sc_form_requisicoes_dtfinalizacao_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_requisicoes_validate_dtfinalizacao();
  scCssBlur(oThis);
}
...
function sc_form_requisicoes_dtfinalizacao_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_requisicoes_dtgerada_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_requisicoes_validate_dtgerada();
  scCssBlur(oThis);
}
...
function sc_form_requisicoes_dtgerada_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_requisicoes_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_dtfinalizacao" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_requisicoes_validate_dtfinalizacao(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_dtgerada" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_requisicoes_validate_dtgerada(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
