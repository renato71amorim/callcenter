  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_requisicoes_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_requisicoes_mob_form();
	}

  // ---------- Validate idrequisicao
  function do_ajax_form_requisicoes_mob_validate_idrequisicao()
  {
    var nomeCampo_idrequisicao = "idrequisicao";
    var var_idrequisicao = scAjaxGetFieldHidden(nomeCampo_idrequisicao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_mob_validate_idrequisicao(var_idrequisicao, var_script_case_init, do_ajax_form_requisicoes_mob_validate_idrequisicao_cb);
  } // do_ajax_form_requisicoes_mob_validate_idrequisicao

  function do_ajax_form_requisicoes_mob_validate_idrequisicao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idrequisicao";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_mob_validate_idrequisicao_cb

  // ---------- Validate codcontribuinte
  function do_ajax_form_requisicoes_mob_validate_codcontribuinte()
  {
    var nomeCampo_codcontribuinte = "codcontribuinte";
    var var_codcontribuinte = scAjaxGetFieldText(nomeCampo_codcontribuinte);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_mob_validate_codcontribuinte(var_codcontribuinte, var_script_case_init, do_ajax_form_requisicoes_mob_validate_codcontribuinte_cb);
  } // do_ajax_form_requisicoes_mob_validate_codcontribuinte

  function do_ajax_form_requisicoes_mob_validate_codcontribuinte_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codcontribuinte";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_mob_validate_codcontribuinte_cb

  // ---------- Validate nomecontribuinte
  function do_ajax_form_requisicoes_mob_validate_nomecontribuinte()
  {
    var nomeCampo_nomecontribuinte = "nomecontribuinte";
    var var_nomecontribuinte = scAjaxGetFieldText(nomeCampo_nomecontribuinte);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_mob_validate_nomecontribuinte(var_nomecontribuinte, var_script_case_init, do_ajax_form_requisicoes_mob_validate_nomecontribuinte_cb);
  } // do_ajax_form_requisicoes_mob_validate_nomecontribuinte

  function do_ajax_form_requisicoes_mob_validate_nomecontribuinte_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nomecontribuinte";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_mob_validate_nomecontribuinte_cb

  // ---------- Validate fone1
  function do_ajax_form_requisicoes_mob_validate_fone1()
  {
    var nomeCampo_fone1 = "fone1";
    var var_fone1 = scAjaxGetFieldText(nomeCampo_fone1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_mob_validate_fone1(var_fone1, var_script_case_init, do_ajax_form_requisicoes_mob_validate_fone1_cb);
  } // do_ajax_form_requisicoes_mob_validate_fone1

  function do_ajax_form_requisicoes_mob_validate_fone1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fone1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_mob_validate_fone1_cb

  // ---------- Validate fone2
  function do_ajax_form_requisicoes_mob_validate_fone2()
  {
    var nomeCampo_fone2 = "fone2";
    var var_fone2 = scAjaxGetFieldText(nomeCampo_fone2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_mob_validate_fone2(var_fone2, var_script_case_init, do_ajax_form_requisicoes_mob_validate_fone2_cb);
  } // do_ajax_form_requisicoes_mob_validate_fone2

  function do_ajax_form_requisicoes_mob_validate_fone2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fone2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_mob_validate_fone2_cb

  // ---------- Validate fone3
  function do_ajax_form_requisicoes_mob_validate_fone3()
  {
    var nomeCampo_fone3 = "fone3";
    var var_fone3 = scAjaxGetFieldText(nomeCampo_fone3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_mob_validate_fone3(var_fone3, var_script_case_init, do_ajax_form_requisicoes_mob_validate_fone3_cb);
  } // do_ajax_form_requisicoes_mob_validate_fone3

  function do_ajax_form_requisicoes_mob_validate_fone3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fone3";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_mob_validate_fone3_cb

  // ---------- Validate fone4
  function do_ajax_form_requisicoes_mob_validate_fone4()
  {
    var nomeCampo_fone4 = "fone4";
    var var_fone4 = scAjaxGetFieldText(nomeCampo_fone4);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_mob_validate_fone4(var_fone4, var_script_case_init, do_ajax_form_requisicoes_mob_validate_fone4_cb);
  } // do_ajax_form_requisicoes_mob_validate_fone4

  function do_ajax_form_requisicoes_mob_validate_fone4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fone4";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_mob_validate_fone4_cb

  // ---------- Validate operadora
  function do_ajax_form_requisicoes_mob_validate_operadora()
  {
    var nomeCampo_operadora = "operadora";
    var var_operadora = scAjaxGetFieldText(nomeCampo_operadora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_mob_validate_operadora(var_operadora, var_script_case_init, do_ajax_form_requisicoes_mob_validate_operadora_cb);
  } // do_ajax_form_requisicoes_mob_validate_operadora

  function do_ajax_form_requisicoes_mob_validate_operadora_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "operadora";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_mob_validate_operadora_cb

  // ---------- Validate finalizada
  function do_ajax_form_requisicoes_mob_validate_finalizada()
  {
    var nomeCampo_finalizada = "finalizada";
    var var_finalizada = scAjaxGetFieldText(nomeCampo_finalizada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_mob_validate_finalizada(var_finalizada, var_script_case_init, do_ajax_form_requisicoes_mob_validate_finalizada_cb);
  } // do_ajax_form_requisicoes_mob_validate_finalizada

  function do_ajax_form_requisicoes_mob_validate_finalizada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "finalizada";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_mob_validate_finalizada_cb

  // ---------- Validate dtfinalizacao
  function do_ajax_form_requisicoes_mob_validate_dtfinalizacao()
  {
    var nomeCampo_dtfinalizacao = "dtfinalizacao";
    var var_dtfinalizacao = scAjaxGetFieldText(nomeCampo_dtfinalizacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_mob_validate_dtfinalizacao(var_dtfinalizacao, var_script_case_init, do_ajax_form_requisicoes_mob_validate_dtfinalizacao_cb);
  } // do_ajax_form_requisicoes_mob_validate_dtfinalizacao

  function do_ajax_form_requisicoes_mob_validate_dtfinalizacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dtfinalizacao";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_mob_validate_dtfinalizacao_cb

  // ---------- Validate dtgerada
  function do_ajax_form_requisicoes_mob_validate_dtgerada()
  {
    var nomeCampo_dtgerada = "dtgerada";
    var var_dtgerada = scAjaxGetFieldText(nomeCampo_dtgerada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_mob_validate_dtgerada(var_dtgerada, var_script_case_init, do_ajax_form_requisicoes_mob_validate_dtgerada_cb);
  } // do_ajax_form_requisicoes_mob_validate_dtgerada

  function do_ajax_form_requisicoes_mob_validate_dtgerada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dtgerada";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_mob_validate_dtgerada_cb

  // ---------- Validate status
  function do_ajax_form_requisicoes_mob_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldText(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_mob_validate_status(var_status, var_script_case_init, do_ajax_form_requisicoes_mob_validate_status_cb);
  } // do_ajax_form_requisicoes_mob_validate_status

  function do_ajax_form_requisicoes_mob_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_mob_validate_status_cb

  // ---------- Validate setor
  function do_ajax_form_requisicoes_mob_validate_setor()
  {
    var nomeCampo_setor = "setor";
    var var_setor = scAjaxGetFieldText(nomeCampo_setor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_mob_validate_setor(var_setor, var_script_case_init, do_ajax_form_requisicoes_mob_validate_setor_cb);
  } // do_ajax_form_requisicoes_mob_validate_setor

  function do_ajax_form_requisicoes_mob_validate_setor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "setor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_mob_validate_setor_cb

  // ---------- Validate comentario
  function do_ajax_form_requisicoes_mob_validate_comentario()
  {
    var nomeCampo_comentario = "comentario";
    var var_comentario = scAjaxGetFieldText(nomeCampo_comentario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_mob_validate_comentario(var_comentario, var_script_case_init, do_ajax_form_requisicoes_mob_validate_comentario_cb);
  } // do_ajax_form_requisicoes_mob_validate_comentario

  function do_ajax_form_requisicoes_mob_validate_comentario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_mob_validate_comentario_cb

  // ---------- Validate diamensal
  function do_ajax_form_requisicoes_mob_validate_diamensal()
  {
    var nomeCampo_diamensal = "diamensal";
    var var_diamensal = scAjaxGetFieldText(nomeCampo_diamensal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_mob_validate_diamensal(var_diamensal, var_script_case_init, do_ajax_form_requisicoes_mob_validate_diamensal_cb);
  } // do_ajax_form_requisicoes_mob_validate_diamensal

  function do_ajax_form_requisicoes_mob_validate_diamensal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "diamensal";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_mob_validate_diamensal_cb

  // ---------- Validate tiporequisicao
  function do_ajax_form_requisicoes_mob_validate_tiporequisicao()
  {
    var nomeCampo_tiporequisicao = "tiporequisicao";
    var var_tiporequisicao = scAjaxGetFieldText(nomeCampo_tiporequisicao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_requisicoes_mob_validate_tiporequisicao(var_tiporequisicao, var_script_case_init, do_ajax_form_requisicoes_mob_validate_tiporequisicao_cb);
  } // do_ajax_form_requisicoes_mob_validate_tiporequisicao

  function do_ajax_form_requisicoes_mob_validate_tiporequisicao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tiporequisicao";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_requisicoes_mob_validate_tiporequisicao_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_requisicoes_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_requisicoes_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idrequisicao = scAjaxGetFieldHidden("idrequisicao");
    var var_codcontribuinte = scAjaxGetFieldText("codcontribuinte");
    var var_nomecontribuinte = scAjaxGetFieldText("nomecontribuinte");
    ...
    var var_operadora = scAjaxGetFieldText("operadora");
    var var_finalizada = scAjaxGetFieldText("finalizada");
    var var_dtfinalizacao = scAjaxGetFieldText("dtfinalizacao");
    var var_dtgerada = scAjaxGetFieldText("dtgerada");
    ...
    var var_diamensal = scAjaxGetFieldText("diamensal");
    var var_tiporequisicao = scAjaxGetFieldText("tiporequisicao");
    ...
    scAjaxProcOn();
    x_ajax_form_requisicoes_mob_submit_form(var_idrequisicao, var_codcontribuinte, var_nomecontribuinte, var_fone1, var_fone2, var_fone3, var_fone4, var_operadora, var_finalizada, var_dtfinalizacao, var_dtgerada, var_status, var_setor, var_comentario, var_diamensal, var_tiporequisicao, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_requisicoes_mob_submit_form_cb);
  } // do_ajax_form_requisicoes_mob_submit_form

  function do_ajax_form_requisicoes_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idrequisicao");
      scAjaxHideErrorDisplay("codcontribuinte");
      scAjaxHideErrorDisplay("nomecontribuinte");
      scAjaxHideErrorDisplay("fone1");
      scAjaxHideErrorDisplay("fone2");
      scAjaxHideErrorDisplay("fone3");
      scAjaxHideErrorDisplay("fone4");
      scAjaxHideErrorDisplay("operadora");
      scAjaxHideErrorDisplay("finalizada");
      scAjaxHideErrorDisplay("dtfinalizacao");
      scAjaxHideErrorDisplay("dtgerada");
      scAjaxHideErrorDisplay("status");
      scAjaxHideErrorDisplay("setor");
      scAjaxHideErrorDisplay("comentario");
      scAjaxHideErrorDisplay("diamensal");
      scAjaxHideErrorDisplay("tiporequisicao");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_requisicoes_mob_submit_form_cb_after_alert);
  } // do_ajax_form_requisicoes_mob_submit_form_cb
  function do_ajax_form_requisicoes_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_requisicoes_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_requisicoes_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("diamensal");
    scAjaxHideErrorDisplay("tiporequisicao");
    var var_idrequisicao = document.F2.idrequisicao.value;
    ...
    scAjaxProcOn();
    x_ajax_form_requisicoes_mob_navigate_form(var_idrequisicao, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_requisicoes_mob_navigate_form_cb);
  } // do_ajax_form_requisicoes_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_requisicoes_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_requisicoes_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idrequisicao.value = scAjaxGetKeyValue("idrequisicao");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_requisicoes_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_requisicoes_mob_navigate_form_cb
  function do_ajax_form_requisicoes_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_requisicoes_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_requisicoes_mob_navigate_form_cb_after_alert
  function sc_hide_form_requisicoes_mob_form()
  {
  ...
  ajax_field_list[0] = "idrequisicao";
  ajax_field_list[1] = "codcontribuinte";
  ajax_field_list[2] = "nomecontribuinte";
  ajax_field_list[3] = "fone1";
  ajax_field_list[4] = "fone2";
  ajax_field_list[5] = "fone3";
  ajax_field_list[6] = "fone4";
  ajax_field_list[7] = "operadora";
  ajax_field_list[8] = "finalizada";
  ajax_field_list[9] = "dtfinalizacao";
  ajax_field_list[10] = "dtgerada";
  ajax_field_list[11] = "status";
  ajax_field_list[12] = "setor";
  ajax_field_list[13] = "comentario";
  ajax_field_list[14] = "diamensal";
  ajax_field_list[15] = "tiporequisicao";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idrequisicao": {"label": "Id Requisicao", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "codcontribuinte": {"label": "Cod Contribuinte", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nomecontribuinte": {"label": "Nome Contribuinte", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "operadora": {"label": "Operadora", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "finalizada": {"label": "Finalizada", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "dtfinalizacao": {"label": "Dt Finalizacao", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "dtgerada": {"label": "Dt Gerada", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "diamensal": {"label": "Dia Mensal", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tiporequisicao": {"label": "Tipo Requisicao", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "idrequisicao": new Array(),
    "codcontribuinte": new Array(),
    "nomecontribuinte": new Array(),
    "fone1": new Array(),
    "fone2": new Array(),
    "fone3": new Array(),
    "fone4": new Array(),
    "operadora": new Array(),
    "finalizada": new Array(),
    "dtfinalizacao": new Array(),
    "dtgerada": new Array(),
    "status": new Array(),
    "setor": new Array(),
    "comentario": new Array(),
    "diamensal": new Array(),
    "tiporequisicao": new Array()
  };
  ajax_field_mult["idrequisicao"][1] = "idrequisicao";
  ajax_field_mult["codcontribuinte"][1] = "codcontribuinte";
  ajax_field_mult["nomecontribuinte"][1] = "nomecontribuinte";
  ajax_field_mult["fone1"][1] = "fone1";
  ajax_field_mult["fone2"][1] = "fone2";
  ajax_field_mult["fone3"][1] = "fone3";
  ajax_field_mult["fone4"][1] = "fone4";
  ajax_field_mult["operadora"][1] = "operadora";
  ajax_field_mult["finalizada"][1] = "finalizada";
  ajax_field_mult["dtfinalizacao"][1] = "dtfinalizacao";
  ajax_field_mult["dtgerada"][1] = "dtgerada";
  ajax_field_mult["status"][1] = "status";
  ajax_field_mult["setor"][1] = "setor";
  ajax_field_mult["comentario"][1] = "comentario";
  ajax_field_mult["diamensal"][1] = "diamensal";
  ajax_field_mult["tiporequisicao"][1] = "tiporequisicao";

  var ajax_field_id = {
    "idrequisicao": new Array("hidden_field_label_idrequisicao", "hidden_field_data_idrequisicao"),
    "codcontribuinte": new Array("hidden_field_label_codcontribuinte", "hidden_field_data_codcontribuinte"),
    "nomecontribuinte": new Array("hidden_field_label_nomecontribuinte", "hidden_field_data_nomecontribuinte"),
    ...
    "operadora": new Array("hidden_field_label_operadora", "hidden_field_data_operadora"),
    "finalizada": new Array("hidden_field_label_finalizada", "hidden_field_data_finalizada"),
    "dtfinalizacao": new Array("hidden_field_label_dtfinalizacao", "hidden_field_data_dtfinalizacao"),
    "dtgerada": new Array("hidden_field_label_dtgerada", "hidden_field_data_dtgerada"),
    ...
    "diamensal": new Array("hidden_field_label_diamensal", "hidden_field_data_diamensal"),
    "tiporequisicao": new Array("hidden_field_label_tiporequisicao", "hidden_field_data_tiporequisicao")
  };

  var ajax_read_only = {
    "idrequisicao": "on",
    "codcontribuinte": "off",
    "nomecontribuinte": "off",
    "fone1": "off",
    "fone2": "off",
    "fone3": "off",
    "fone4": "off",
