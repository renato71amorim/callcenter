...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_codigo' + iSeqRow).bind('blur', function() { sc_form_doacoes_gerar_recibo_codigo_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_doacoes_gerar_recibo_codigo_onfocus(this, iSeqRow) });
  $('#id_sc_field_nome' + iSeqRow).bind('blur', function() { sc_form_doacoes_gerar_recibo_nome_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_doacoes_gerar_recibo_nome_onfocus(this, iSeqRow) });
  $('#id_sc_field_sexo' + iSeqRow).bind('blur', function() { sc_form_doacoes_gerar_recibo_sexo_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_doacoes_gerar_recibo_sexo_onfocus(this, iSeqRow) });
  $('#id_sc_field_tipo' + iSeqRow).bind('blur', function() { sc_form_doacoes_gerar_recibo_tipo_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_doacoes_gerar_recibo_tipo_onfocus(this, iSeqRow) });
  $('#id_sc_field_ddd' + iSeqRow).bind('blur', function() { sc_form_doacoes_gerar_recibo_ddd_onblur(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_doacoes_gerar_recibo_ddd_onfocus(this, iSeqRow) });
  $('#id_sc_field_fone1' + iSeqRow).bind('blur', function() { sc_form_doacoes_gerar_recibo_fone1_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_doacoes_gerar_recibo_fone1_onfocus(this, iSeqRow) });
  $('#id_sc_field_fone2' + iSeqRow).bind('blur', function() { sc_form_doacoes_gerar_recibo_fone2_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_doacoes_gerar_recibo_fone2_onfocus(this, iSeqRow) });
  $('#id_sc_field_operador' + iSeqRow).bind('blur', function() { sc_form_doacoes_gerar_recibo_operador_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_doacoes_gerar_recibo_operador_onfocus(this, iSeqRow) });
  $('#id_sc_field_codigorua' + iSeqRow).bind('blur', function() { sc_form_doacoes_gerar_recibo_codigorua_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_doacoes_gerar_recibo_codigorua_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_doacoes_gerar_recibo_codigorua_onfocus(this, iSeqRow) });
  $('#id_sc_field_logadouro' + iSeqRow).bind('blur', function() { sc_form_doacoes_gerar_recibo_logadouro_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_doacoes_gerar_recibo_logadouro_onfocus(this, iSeqRow) });
  $('#id_sc_field_numero' + iSeqRow).bind('blur', function() { sc_form_doacoes_gerar_recibo_numero_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_doacoes_gerar_recibo_numero_onfocus(this, iSeqRow) });
  $('#id_sc_field_complemento' + iSeqRow).bind('blur', function() { sc_form_doacoes_gerar_recibo_complemento_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_doacoes_gerar_recibo_complemento_onfocus(this, iSeqRow) });
  $('#id_sc_field_pontodereferencia' + iSeqRow).bind('blur', function() { sc_form_doacoes_gerar_recibo_pontodereferencia_onblur(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_doacoes_gerar_recibo_pontodereferencia_onfocus(this, iSeqRow) });
  $('#id_sc_field_bairro' + iSeqRow).bind('blur', function() { sc_form_doacoes_gerar_recibo_bairro_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_doacoes_gerar_recibo_bairro_onfocus(this, iSeqRow) });
  $('#id_sc_field_localidade' + iSeqRow).bind('blur', function() { sc_form_doacoes_gerar_recibo_localidade_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_doacoes_gerar_recibo_localidade_onfocus(this, iSeqRow) });
  $('#id_sc_field_setor_rua' + iSeqRow).bind('blur', function() { sc_form_doacoes_gerar_recibo_setor_rua_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_doacoes_gerar_recibo_setor_rua_onfocus(this, iSeqRow) });
  $('#id_sc_field_cep' + iSeqRow).bind('blur', function() { sc_form_doacoes_gerar_recibo_cep_onblur(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_doacoes_gerar_recibo_cep_onfocus(this, iSeqRow) });
  $('#id_sc_field_datavencimento' + iSeqRow).bind('blur', function() { sc_form_doacoes_gerar_recibo_datavencimento_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_doacoes_gerar_recibo_datavencimento_onfocus(this, iSeqRow) });
  $('#id_sc_field_valor' + iSeqRow).bind('blur', function() { sc_form_doacoes_gerar_recibo_valor_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_doacoes_gerar_recibo_valor_onfocus(this, iSeqRow) });
  $('#id_sc_field_obs' + iSeqRow).bind('blur', function() { sc_form_doacoes_gerar_recibo_obs_onblur(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_doacoes_gerar_recibo_obs_onfocus(this, iSeqRow) });
  $('#id_sc_field_mesmensal' + iSeqRow).bind('blur', function() { sc_form_doacoes_gerar_recibo_mesmensal_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_doacoes_gerar_recibo_mesmensal_onfocus(this, iSeqRow) });
  $('#id_sc_field_status' + iSeqRow).bind('blur', function() { sc_form_doacoes_gerar_recibo_status_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_doacoes_gerar_recibo_status_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_doacoes_gerar_recibo_codigo_onblur(oThis, iSeqRow) {
  do_ajax_form_doacoes_gerar_recibo_mob_validate_codigo();
  scCssBlur(oThis);
}

function sc_form_doacoes_gerar_recibo_codigo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_doacoes_gerar_recibo_nome_onblur(oThis, iSeqRow) {
  do_ajax_form_doacoes_gerar_recibo_mob_validate_nome();
  scCssBlur(oThis);
}

function sc_form_doacoes_gerar_recibo_nome_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_doacoes_gerar_recibo_sexo_onblur(oThis, iSeqRow) {
  do_ajax_form_doacoes_gerar_recibo_mob_validate_sexo();
  scCssBlur(oThis);
}

function sc_form_doacoes_gerar_recibo_sexo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_doacoes_gerar_recibo_tipo_onblur(oThis, iSeqRow) {
  do_ajax_form_doacoes_gerar_recibo_mob_validate_tipo();
  scCssBlur(oThis);
}

function sc_form_doacoes_gerar_recibo_tipo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_doacoes_gerar_recibo_ddd_onblur(oThis, iSeqRow) {
  do_ajax_form_doacoes_gerar_recibo_mob_validate_ddd();
  scCssBlur(oThis);
}

function sc_form_doacoes_gerar_recibo_ddd_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_doacoes_gerar_recibo_fone1_onblur(oThis, iSeqRow) {
  do_ajax_form_doacoes_gerar_recibo_mob_validate_fone1();
  scCssBlur(oThis);
}

function sc_form_doacoes_gerar_recibo_fone1_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_doacoes_gerar_recibo_fone2_onblur(oThis, iSeqRow) {
  do_ajax_form_doacoes_gerar_recibo_mob_validate_fone2();
  scCssBlur(oThis);
}

function sc_form_doacoes_gerar_recibo_fone2_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_doacoes_gerar_recibo_operador_onblur(oThis, iSeqRow) {
  do_ajax_form_doacoes_gerar_recibo_mob_validate_operador();
  scCssBlur(oThis);
}

function sc_form_doacoes_gerar_recibo_operador_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_doacoes_gerar_recibo_codigorua_onblur(oThis, iSeqRow) {
  do_ajax_form_doacoes_gerar_recibo_mob_validate_codigorua();
  scCssBlur(oThis);
}

function sc_form_doacoes_gerar_recibo_codigorua_onchange(oThis, iSeqRow) {
  do_ajax_form_doacoes_gerar_recibo_mob_event_codigorua_onchange();
}

function sc_form_doacoes_gerar_recibo_codigorua_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_doacoes_gerar_recibo_logadouro_onblur(oThis, iSeqRow) {
  do_ajax_form_doacoes_gerar_recibo_mob_validate_logadouro();
  scCssBlur(oThis);
}

function sc_form_doacoes_gerar_recibo_logadouro_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_doacoes_gerar_recibo_numero_onblur(oThis, iSeqRow) {
  do_ajax_form_doacoes_gerar_recibo_mob_validate_numero();
  scCssBlur(oThis);
}

function sc_form_doacoes_gerar_recibo_numero_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_doacoes_gerar_recibo_complemento_onblur(oThis, iSeqRow) {
  do_ajax_form_doacoes_gerar_recibo_mob_validate_complemento();
  scCssBlur(oThis);
}

function sc_form_doacoes_gerar_recibo_complemento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_doacoes_gerar_recibo_pontodereferencia_onblur(oThis, iSeqRow) {
  do_ajax_form_doacoes_gerar_recibo_mob_validate_pontodereferencia();
  scCssBlur(oThis);
}

function sc_form_doacoes_gerar_recibo_pontodereferencia_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_doacoes_gerar_recibo_bairro_onblur(oThis, iSeqRow) {
  do_ajax_form_doacoes_gerar_recibo_mob_validate_bairro();
  scCssBlur(oThis);
}

function sc_form_doacoes_gerar_recibo_bairro_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_doacoes_gerar_recibo_localidade_onblur(oThis, iSeqRow) {
  do_ajax_form_doacoes_gerar_recibo_mob_validate_localidade();
  scCssBlur(oThis);
}

function sc_form_doacoes_gerar_recibo_localidade_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_doacoes_gerar_recibo_setor_rua_onblur(oThis, iSeqRow) {
  do_ajax_form_doacoes_gerar_recibo_mob_validate_setor_rua();
  scCssBlur(oThis);
}

function sc_form_doacoes_gerar_recibo_setor_rua_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_doacoes_gerar_recibo_cep_onblur(oThis, iSeqRow) {
  do_ajax_form_doacoes_gerar_recibo_mob_validate_cep();
  scCssBlur(oThis);
}

function sc_form_doacoes_gerar_recibo_cep_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_doacoes_gerar_recibo_datavencimento_onblur(oThis, iSeqRow) {
  do_ajax_form_doacoes_gerar_recibo_mob_validate_datavencimento();
  scCssBlur(oThis);
}

function sc_form_doacoes_gerar_recibo_datavencimento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_doacoes_gerar_recibo_valor_onblur(oThis, iSeqRow) {
  do_ajax_form_doacoes_gerar_recibo_mob_validate_valor();
  scCssBlur(oThis);
}

function sc_form_doacoes_gerar_recibo_valor_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_doacoes_gerar_recibo_obs_onblur(oThis, iSeqRow) {
  do_ajax_form_doacoes_gerar_recibo_mob_validate_obs();
  scCssBlur(oThis);
}

function sc_form_doacoes_gerar_recibo_obs_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_doacoes_gerar_recibo_mesmensal_onblur(oThis, iSeqRow) {
  do_ajax_form_doacoes_gerar_recibo_mob_validate_mesmensal();
  scCssBlur(oThis);
}

function sc_form_doacoes_gerar_recibo_mesmensal_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_doacoes_gerar_recibo_status_onblur(oThis, iSeqRow) {
  do_ajax_form_doacoes_gerar_recibo_mob_validate_status();
  scCssBlur(oThis);
}

function sc_form_doacoes_gerar_recibo_status_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_doacoes_gerar_recibo_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_datavencimento" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_doacoes_gerar_recibo_mob_validate_datavencimento(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_dataemissao" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_doacoes_gerar_recibo_mob_validate_dataemissao(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_timestamp" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_doacoes_gerar_recibo_mob_validate_timestamp(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
