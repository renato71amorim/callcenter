...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_doacoes_gerar_recibo/form_doacoes_gerar_recibo_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_doacoes_gerar_recibo_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_doacoes_gerar_recibo_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_doacoes_gerar_recibo']['error_buffer']) && '' != $_SESSION['scriptcase']['form_doacoes_gerar_recibo']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_doacoes_gerar_recibo']['error_buffer'];
}
...
<?php
 include_once("form_doacoes_gerar_recibo_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_doacoes_gerar_recibo_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_doacoes_gerar_recibo_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_doacoes_gerar_recibo_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['Lookup_sexo'][] = 'M'; ?>
 <option  value="F" <?php  if ($this->sexo == "F") { echo " selected" ;} ?>>Feminino</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['Lookup_sexo'][] = 'F'; ?>
 <option  value="N" <?php  if ($this->sexo == "N") { echo " selected" ;} ?>>Não se aplica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['Lookup_sexo'][] = 'N'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['Lookup_tipo'][] = 'L'; ?>
 <option  value="A" <?php  if ($this->tipo == "A") { echo " selected" ;} ?>>Avulso</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['Lookup_tipo'][] = 'A'; ?>
 <option  value="M" <?php  if ($this->tipo == "M") { echo " selected" ;} ?>>Mensal</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['Lookup_tipo'][] = 'M'; ?>
 <option  value="B" <?php  if ($this->tipo == "B") { echo " selected" ;} ?>>Bimestral</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['Lookup_tipo'][] = 'B'; ?>
 <option  value="T" <?php  if ($this->tipo == "T") { echo " selected" ;} ?>>Trimestral</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['Lookup_tipo'][] = 'T'; ?>
 <option  value="S" <?php  if ($this->tipo == "S") { echo " selected" ;} ?>>Semestral</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['Lookup_tipo'][] = 'S'; ?>
 </select></span>
</span><?php  }?>
...
<span id="id_read_on_codigorua" class="sc-ui-readonly-codigorua css_codigorua_line" style="<?php echo $sStyleReadLab_codigorua; ?>"><?php echo $this->codigorua; ?></span><span id="id_read_off_codigorua" class="css_read_off_codigorua" style="white-space: nowrap;<?php echo $sStyleReadInp_codigorua; ?>">
 ...
 size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['codigorua']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['codigorua']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['codigorua']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_form_doacoes_gerar_recibo_mob*scout' : '';
   if (isset($this->Ini->sc_lig_md5["grid_ruas"]) && $this->Ini->sc_lig_md5["grid_ruas"] == "S") {
       $Parms_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,codigorua,codigorua*scoutnm_evt_ret_busca*scinsc_form_doacoes_gerar_recibo_codigorua_onchange(this)*scout" . $Sc_iframe_master;
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_doacoes_gerar_recibo_mob@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,codigorua,codigorua*scoutnm_evt_ret_busca*scinsc_form_doacoes_gerar_recibo_codigorua_onchange(this)*scout" . $Sc_iframe_master;
   }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_logadouro_line" id="hidden_field_data_logadouro" style="<?php echo $sStyleHidden_logadouro; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_logadouro_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_logadouro_label"><span id="id_label_logadouro"><?php echo $this->nm_new_label['logadouro']; ?></span></span><br><input type="hidden" name="logadouro" value="<?php echo $this->form_encode_input($logadouro); ?>"><span id="id_ajax_label_logadouro"><?php echo nl2br($logadouro); ?></span>
<span class="scFormPopupBubble" style="display: inline-block"><span class="scFormPopupTrigger"><?php echo nmButtonOutput($this->arr_buttons, "bfieldhelp", "return false;", "return false;", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
</span><table class="scFormPopup"><tbody><?php
if (isset($_SESSION['scriptcase']['reg_conf']['html_dir']) && $_SESSION['scriptcase']['reg_conf']['html_dir'] == " DIR='RTL'") {
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_bairro_line" id="hidden_field_data_bairro" style="<?php echo $sStyleHidden_bairro; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_bairro_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_bairro_label"><span id="id_label_bairro"><?php echo $this->nm_new_label['bairro']; ?></span></span><br><input type="hidden" name="bairro" value="<?php echo $this->form_encode_input($bairro); ?>"><span id="id_ajax_label_bairro"><?php echo nl2br($bairro); ?></span>
<span class="scFormPopupBubble" style="display: inline-block"><span class="scFormPopupTrigger"><?php echo nmButtonOutput($this->arr_buttons, "bfieldhelp", "return false;", "return false;", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
</span><table class="scFormPopup"><tbody><?php
if (isset($_SESSION['scriptcase']['reg_conf']['html_dir']) && $_SESSION['scriptcase']['reg_conf']['html_dir'] == " DIR='RTL'") {
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_localidade_line" id="hidden_field_data_localidade" style="<?php echo $sStyleHidden_localidade; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_localidade_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_localidade_label"><span id="id_label_localidade"><?php echo $this->nm_new_label['localidade']; ?></span></span><br><input type="hidden" name="localidade" value="<?php echo $this->form_encode_input($localidade); ?>"><span id="id_ajax_label_localidade"><?php echo nl2br($localidade); ?></span>
<span class="scFormPopupBubble" style="display: inline-block"><span class="scFormPopupTrigger"><?php echo nmButtonOutput($this->arr_buttons, "bfieldhelp", "return false;", "return false;", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
</span><table class="scFormPopup"><tbody><?php
if (isset($_SESSION['scriptcase']['reg_conf']['html_dir']) && $_SESSION['scriptcase']['reg_conf']['html_dir'] == " DIR='RTL'") {
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_setor_rua_line" id="hidden_field_data_setor_rua" style="<?php echo $sStyleHidden_setor_rua; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_setor_rua_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_setor_rua_label"><span id="id_label_setor_rua"><?php echo $this->nm_new_label['setor_rua']; ?></span></span><br><input type="hidden" name="setor_rua" value="<?php echo $this->form_encode_input($setor_rua); ?>"><span id="id_ajax_label_setor_rua"><?php echo nl2br($setor_rua); ?></span>
<span class="scFormPopupBubble" style="display: inline-block"><span class="scFormPopupTrigger"><?php echo nmButtonOutput($this->arr_buttons, "bfieldhelp", "return false;", "return false;", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
</span><table class="scFormPopup"><tbody><?php
if (isset($_SESSION['scriptcase']['reg_conf']['html_dir']) && $_SESSION['scriptcase']['reg_conf']['html_dir'] == " DIR='RTL'") {
?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['Lookup_mesmensal'][] = '00'; ?>
 <option  value="01" <?php  if ($this->mesmensal == "01") { echo " selected" ;} ?>>Janeiro</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['Lookup_mesmensal'][] = '01'; ?>
 <option  value="02" <?php  if ($this->mesmensal == "02") { echo " selected" ;} ?>>Fevereiro</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['Lookup_mesmensal'][] = '02'; ?>
 <option  value="03" <?php  if ($this->mesmensal == "03") { echo " selected" ;} ?>>Março</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['Lookup_mesmensal'][] = '03'; ?>
 <option  value="04" <?php  if ($this->mesmensal == "04") { echo " selected" ;} ?>>Abril</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['Lookup_mesmensal'][] = '04'; ?>
 <option  value="05" <?php  if ($this->mesmensal == "05") { echo " selected" ;} ?>>Maio</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['Lookup_mesmensal'][] = '05'; ?>
 <option  value="06" <?php  if ($this->mesmensal == "06") { echo " selected" ;} ?>>Junho</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['Lookup_mesmensal'][] = '06'; ?>
 <option  value="07" <?php  if ($this->mesmensal == "07") { echo " selected" ;} ?>>Julho</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['Lookup_mesmensal'][] = '07'; ?>
 <option  value="08" <?php  if ($this->mesmensal == "08") { echo " selected" ;} ?>>Agosto</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['Lookup_mesmensal'][] = '08'; ?>
 <option  value="09" <?php  if ($this->mesmensal == "09") { echo " selected" ;} ?>>Setembro</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['Lookup_mesmensal'][] = '09'; ?>
 <option  value="10" <?php  if ($this->mesmensal == "10") { echo " selected" ;} ?>>Outubro</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['Lookup_mesmensal'][] = '10'; ?>
 <option  value="11" <?php  if ($this->mesmensal == "11") { echo " selected" ;} ?>>Novembro</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['Lookup_mesmensal'][] = '11'; ?>
 <option  value="12" <?php  if ($this->mesmensal == "12") { echo " selected" ;} ?>>Dezembro</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['Lookup_mesmensal'][] = '12'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['Lookup_status'][] = '1'; ?>
 <option  value="3" <?php  if ($this->status == "3") { echo " selected" ;} ?>>Descartado</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['Lookup_status'][] = '3'; ?>
 </select></span>
</span><?php  }?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_doacoes_gerar_recibo_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_doacoes_gerar_recibo_mob");
 parent.scAjaxDetailHeight("form_doacoes_gerar_recibo_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_doacoes_gerar_recibo_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
