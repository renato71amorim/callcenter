...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_vicidial_list_auditoria_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_vicidial_list_auditoria_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_vicidial_list_auditoria_js0.php");
?>
<script type="text/javascript" src="<?php  echo $this->Ini->path_js . "/nm_rpc.js" ?>"> 
</script> 
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_vicidial_list_auditoria'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_vicidial_list_auditoria'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_1'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_1'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['grid_goautodial_recordings_views_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_1'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['grid_goautodial_recordings_views_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 if (isset($this->Ini->sc_lig_md5["grid_goautodial_recordings_views"]) && $this->Ini->sc_lig_md5["grid_goautodial_recordings_views"] == "S") {
     ...
     $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_vicidial_list_auditoria@SC_par@" . md5($Parms_Lig);
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
 } else {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_vicidial_list_auditoria_empty.htm' : $this->Ini->link_grid_goautodial_recordings_views_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_sc_field_1']) && 'nmsc_iframe_liga_grid_goautodial_recordings_views' != $this->Ini->sc_lig_target['C_@scinf_sc_field_1'])
{
    ...
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_sc_field_1'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['grid_goautodial_recordings_views_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['Lookup_gender'][] = 'M'; ?>
 <option  value="F" <?php  if ($this->gender == "F") { echo " selected" ;} ?>>Feminino</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['Lookup_gender'][] = 'F'; ?>
 <option  value="N" <?php  if ($this->gender == "N") { echo " selected" ;} ?>>Não se aplica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['Lookup_gender'][] = 'N'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['Lookup_vendor_lead_code'][] = '1'; ?>
 <option  value="2" <?php  if ($this->vendor_lead_code == "2") { echo " selected" ;} ?>>Realizado</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['Lookup_vendor_lead_code'][] = '2'; ?>
 <option  value="3" <?php  if ($this->vendor_lead_code == "3") { echo " selected" ;} ?>>Descartado</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['Lookup_vendor_lead_code'][] = '3'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['Lookup_title'][] = 'S'; ?>
 <option  value="N" <?php  if ($this->title == "N") { echo " selected" ;} ?><?php  if (empty($this->title)) { echo " selected" ;} ?>>Não</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['Lookup_title'][] = 'N'; ?>
 </select></span>
</span><?php  }?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_vicidial_list_auditoria");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_vicidial_list_auditoria");
 parent.scAjaxDetailHeight("form_vicidial_list_auditoria", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
