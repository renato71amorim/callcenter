<?php
//
class form_vicidial_list_auditoria_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_vicidial_list_auditoria_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_vicidial_list_auditoria_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_vicidial_list_auditoria_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_vicidial_list_auditoria_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_vicidial_list_auditoria_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_vicidial_list_auditoria_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_vicidial_list_auditoria_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_vicidial_list_auditoria_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_vicidial_list_auditoria_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_vicidial_list_auditoria_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_vicidial_list_auditoria_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_vicidial_list_auditoria_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_vicidial_list_auditoria_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_vicidial_list_auditoria_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_vicidial_list_auditoria_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_vicidial_list_auditoria_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_vicidial_list_auditoria_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_vicidial_list_auditoria_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_vicidial_list_auditoria_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vicidial_list_auditoria_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vicidial_list_auditoria_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_vicidial_list_auditoria_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vicidial_list_auditoria_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - vicidial_list";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_vicidial_list_auditoria_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_vicidial_list_auditoria_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_vicidial_list_auditoria_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_list_auditoria_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_vicidial_list_auditoria_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_vicidial_list_auditoria_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_vicidial_list_auditoria_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_auditoria/form_vicidial_list_auditoria_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_vicidial_list_auditoria_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_vicidial_list_auditoria_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_vicidial_list_auditoria_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_auditoria/form_vicidial_list_auditoria_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_vicidial_list_auditoria_mob_erro.class.php"); 
      }
      $this->Erro      = new form_vicidial_list_auditoria_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['opcao']))
         { 
             if ($this->lead_id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_list_auditoria_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      ...
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['dados_select']['modify_date']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->modify_date = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['dados_select']['modify_date'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['dados_select']['user']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->user = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['dados_select']['user'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_vicidial_list_auditoria_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_vicidial_list_auditoria_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_vicidial_list_auditoria_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_vicidial_list_auditoria_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       $delim  = "'";
       $delim1 = "'";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['SC_sep_date1'];
       }
       $dt  = $delim . date('Y-m-d H:i:s') . $delim1;
       $usr = isset($_SESSION['usr_login']) ? $_SESSION['usr_login'] : "";
       if (in_array(strtolower($this->Ini->nm_con_unicep['tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Ini->nm_db_unicep->qstr($usr) . ", 'form_vicidial_list_auditoria_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Ini->nm_db_unicep->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Ini->nm_db_unicep->qstr($usr) . ", 'form_vicidial_list_auditoria_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Ini->nm_db_unicep->qstr($texto) . ")"; 
       } 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_vicidial_list_auditoria_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_vicidial_list_auditoria_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_vicidial_list_auditoria_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_vicidial_list_auditoria_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_status(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->status) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['Lookup_status']) && !in_array($this->status, $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['Lookup_status']))
               {
                   $hasError = true;
    ...
    function ValidateField_country_code(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->country_code) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['Lookup_country_code']) && !in_array($this->country_code, $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['Lookup_country_code']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_owner(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->owner) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['Lookup_owner']) && !in_array($this->owner, $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['Lookup_owner']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_province(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->province, 4, 2, -0, 999999, "N") == false)  
              { 
                  $hasError = true;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['lead_id']['keyVal'] = form_vicidial_list_auditoria_mob_pack_protect_string($this->nmgp_dados_form['lead_id']);
              ...
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['grid_goautodial_recordings_views_script_case_init'] ]['grid_goautodial_recordings_views']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['grid_goautodial_recordings_views_script_case_init'] ]['grid_goautodial_recordings_views']['total']);
              ...
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['grid_goautodial_recordings_views_script_case_init'] ]['grid_goautodial_recordings_views']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['grid_goautodial_recordings_views_script_case_init'] ]['grid_goautodial_recordings_views']['total']);
              }
          }
...
else
{
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_vicidial_list_auditoria_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_vicidial_list_auditoria_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['status']['valList'][$i] = form_vicidial_list_auditoria_mob_pack_protect_string($v);
          }
...
$aLookup[] = array(form_vicidial_list_auditoria_mob_pack_protect_string('M') => form_vicidial_list_auditoria_mob_pack_protect_string("Masculino"));
$aLookup[] = array(form_vicidial_list_auditoria_mob_pack_protect_string('F') => form_vicidial_list_auditoria_mob_pack_protect_string("Feminino"));
$aLookup[] = array(form_vicidial_list_auditoria_mob_pack_protect_string('N') => form_vicidial_list_auditoria_mob_pack_protect_string("Não se aplica"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['Lookup_gender'][] = 'M';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['Lookup_gender'][] = 'F';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['Lookup_gender'][] = 'N';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['gender']['valList'][$i] = form_vicidial_list_auditoria_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['country_code']['valList'][$i] = form_vicidial_list_auditoria_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['owner']['valList'][$i] = form_vicidial_list_auditoria_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_vicidial_list_auditoria_mob_pack_protect_string('1') => form_vicidial_list_auditoria_mob_pack_protect_string("Agendado"));
$aLookup[] = array(form_vicidial_list_auditoria_mob_pack_protect_string('2') => form_vicidial_list_auditoria_mob_pack_protect_string("Realizado"));
$aLookup[] = array(form_vicidial_list_auditoria_mob_pack_protect_string('3') => form_vicidial_list_auditoria_mob_pack_protect_string("Descartado"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['Lookup_vendor_lead_code'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['Lookup_vendor_lead_code'][] = '2';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['Lookup_vendor_lead_code'][] = '3';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['vendor_lead_code']['valList'][$i] = form_vicidial_list_auditoria_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_vicidial_list_auditoria_mob_pack_protect_string('S') => form_vicidial_list_auditoria_mob_pack_protect_string("Sim"));
$aLookup[] = array(form_vicidial_list_auditoria_mob_pack_protect_string('N') => form_vicidial_list_auditoria_mob_pack_protect_string("Não"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['Lookup_title'][] = 'S';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['Lookup_title'][] = 'N';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"title\"";
          ...
          {
              $this->NM_ajax_info['fldList']['title']['valList'][$i] = form_vicidial_list_auditoria_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_lead_id($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['reg_start'] = 0; 
              }
    ...
    if ("update" == $this->sc_evento && $this->nmgp_opcao != "nada") {
        ...
        $_SESSION['scriptcase']['form_vicidial_list_auditoria_mob']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_vicidial_list_auditoria_mob']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['parms'] = "lead_id?#?$this->lead_id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['parms'] = ""; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['reg_start']) ; 
          } 
          else  
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['reg_start']) ;  
              } 
          } 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['reg_start'] < $qt_geral_reg_form_vicidial_list_auditoria_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['dados_select'];
...
//-- 
      ...
      $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['grid_goautodial_recordings_views_script_case_init'] ]['grid_goautodial_recordings_views']['embutida_parms'] = "lead_id*scin" . $this->nmgp_dados_form['lead_id'] . "*scoutcall_date*scin" . $this->nmgp_dados_form['modify_date'] . "*scoutuser*scin" . $this->nmgp_dados_form['user'] . "*scoutNMSC_inicial*scininicio*scout";
  }
// 
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['dados_select'];
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_vicidial_list_auditoria_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_vicidial_list_auditoria_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['total'] = $qt_geral_reg_form_vicidial_list_auditoria_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_vicidial_list_auditoria_mob_pack_ajax_response();
      ...
      $Nm_datas['entry_date'] = "datetime";$Nm_datas['modify_date'] = "timestamp";$Nm_datas['date_of_birth'] = "date";$Nm_datas['last_local_call_time'] = "datetime";
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (isset($Nm_datas[$campo_join]))
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_vicidial_list_auditoria_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_vicidial_list_auditoria_mob_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['masterValue']))
{
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria_mob']['retorno_edit'] = "";
   }
