  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_vicidial_list_auditoria" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_vicidial_list_auditoria_form();
	}

  // ---------- Validate comments
  function do_ajax_form_vicidial_list_auditoria_validate_comments()
  {
    var nomeCampo_comments = "comments";
    var var_comments = scAjaxGetFieldHidden(nomeCampo_comments);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_auditoria_validate_comments(var_comments, var_script_case_init, do_ajax_form_vicidial_list_auditoria_validate_comments_cb);
  } // do_ajax_form_vicidial_list_auditoria_validate_comments

  function do_ajax_form_vicidial_list_auditoria_validate_comments_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_auditoria_validate_comments_cb

  // ---------- Validate modify_date
  function do_ajax_form_vicidial_list_auditoria_validate_modify_date()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_auditoria_validate_modify_date(var_modify_date, var_modify_date_hora, var_script_case_init, do_ajax_form_vicidial_list_auditoria_validate_modify_date_cb);
  } // do_ajax_form_vicidial_list_auditoria_validate_modify_date

  function do_ajax_form_vicidial_list_auditoria_validate_modify_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_auditoria_validate_modify_date_cb

  // ---------- Validate user
  function do_ajax_form_vicidial_list_auditoria_validate_user()
  {
    var nomeCampo_user = "user";
    var var_user = scAjaxGetFieldHidden(nomeCampo_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_auditoria_validate_user(var_user, var_script_case_init, do_ajax_form_vicidial_list_auditoria_validate_user_cb);
  } // do_ajax_form_vicidial_list_auditoria_validate_user

  function do_ajax_form_vicidial_list_auditoria_validate_user_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_auditoria_validate_user_cb

  // ---------- Validate phone_number
  function do_ajax_form_vicidial_list_auditoria_validate_phone_number()
  {
    var nomeCampo_phone_number = "phone_number";
    var var_phone_number = scAjaxGetFieldText(nomeCampo_phone_number);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_auditoria_validate_phone_number(var_phone_number, var_script_case_init, do_ajax_form_vicidial_list_auditoria_validate_phone_number_cb);
  } // do_ajax_form_vicidial_list_auditoria_validate_phone_number

  function do_ajax_form_vicidial_list_auditoria_validate_phone_number_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_auditoria_validate_phone_number_cb

  // ---------- Validate alt_phone
  function do_ajax_form_vicidial_list_auditoria_validate_alt_phone()
  {
    var nomeCampo_alt_phone = "alt_phone";
    var var_alt_phone = scAjaxGetFieldText(nomeCampo_alt_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_auditoria_validate_alt_phone(var_alt_phone, var_script_case_init, do_ajax_form_vicidial_list_auditoria_validate_alt_phone_cb);
  } // do_ajax_form_vicidial_list_auditoria_validate_alt_phone

  function do_ajax_form_vicidial_list_auditoria_validate_alt_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_auditoria_validate_alt_phone_cb

  // ---------- Validate email
  function do_ajax_form_vicidial_list_auditoria_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_auditoria_validate_email(var_email, var_script_case_init, do_ajax_form_vicidial_list_auditoria_validate_email_cb);
  } // do_ajax_form_vicidial_list_auditoria_validate_email

  function do_ajax_form_vicidial_list_auditoria_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_auditoria_validate_email_cb

  // ---------- Validate sc_field_1
  function do_ajax_form_vicidial_list_auditoria_validate_sc_field_1()
  {
    var nomeCampo_sc_field_1 = "sc_field_1";
    var var_sc_field_1 = scAjaxGetFieldText(nomeCampo_sc_field_1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_auditoria_validate_sc_field_1(var_sc_field_1, var_script_case_init, do_ajax_form_vicidial_list_auditoria_validate_sc_field_1_cb);
  } // do_ajax_form_vicidial_list_auditoria_validate_sc_field_1

  function do_ajax_form_vicidial_list_auditoria_validate_sc_field_1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_auditoria_validate_sc_field_1_cb

  // ---------- Validate status
  function do_ajax_form_vicidial_list_auditoria_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_auditoria_validate_status(var_status, var_script_case_init, do_ajax_form_vicidial_list_auditoria_validate_status_cb);
  } // do_ajax_form_vicidial_list_auditoria_validate_status

  function do_ajax_form_vicidial_list_auditoria_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_auditoria_validate_status_cb

  // ---------- Validate gender
  function do_ajax_form_vicidial_list_auditoria_validate_gender()
  {
    var nomeCampo_gender = "gender";
    var var_gender = scAjaxGetFieldSelect(nomeCampo_gender);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_auditoria_validate_gender(var_gender, var_script_case_init, do_ajax_form_vicidial_list_auditoria_validate_gender_cb);
  } // do_ajax_form_vicidial_list_auditoria_validate_gender

  function do_ajax_form_vicidial_list_auditoria_validate_gender_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "gender";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_auditoria_validate_gender_cb

  // ---------- Validate first_name
  function do_ajax_form_vicidial_list_auditoria_validate_first_name()
  {
    var nomeCampo_first_name = "first_name";
    var var_first_name = scAjaxGetFieldText(nomeCampo_first_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_auditoria_validate_first_name(var_first_name, var_script_case_init, do_ajax_form_vicidial_list_auditoria_validate_first_name_cb);
  } // do_ajax_form_vicidial_list_auditoria_validate_first_name

  function do_ajax_form_vicidial_list_auditoria_validate_first_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_auditoria_validate_first_name_cb

  // ---------- Validate postal_code
  function do_ajax_form_vicidial_list_auditoria_validate_postal_code()
  {
    var nomeCampo_postal_code = "postal_code";
    var var_postal_code = scAjaxGetFieldText(nomeCampo_postal_code);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_auditoria_validate_postal_code(var_postal_code, var_script_case_init, do_ajax_form_vicidial_list_auditoria_validate_postal_code_cb);
  } // do_ajax_form_vicidial_list_auditoria_validate_postal_code

  function do_ajax_form_vicidial_list_auditoria_validate_postal_code_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_auditoria_validate_postal_code_cb

  // ---------- Validate address1
  function do_ajax_form_vicidial_list_auditoria_validate_address1()
  {
    var nomeCampo_address1 = "address1";
    var var_address1 = scAjaxGetFieldText(nomeCampo_address1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_auditoria_validate_address1(var_address1, var_script_case_init, do_ajax_form_vicidial_list_auditoria_validate_address1_cb);
  } // do_ajax_form_vicidial_list_auditoria_validate_address1

  function do_ajax_form_vicidial_list_auditoria_validate_address1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_auditoria_validate_address1_cb

  // ---------- Validate middle_initial
  function do_ajax_form_vicidial_list_auditoria_validate_middle_initial()
  {
    var nomeCampo_middle_initial = "middle_initial";
    var var_middle_initial = scAjaxGetFieldText(nomeCampo_middle_initial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_auditoria_validate_middle_initial(var_middle_initial, var_script_case_init, do_ajax_form_vicidial_list_auditoria_validate_middle_initial_cb);
  } // do_ajax_form_vicidial_list_auditoria_validate_middle_initial

  function do_ajax_form_vicidial_list_auditoria_validate_middle_initial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_auditoria_validate_middle_initial_cb

  // ---------- Validate address2
  function do_ajax_form_vicidial_list_auditoria_validate_address2()
  {
    var nomeCampo_address2 = "address2";
    var var_address2 = scAjaxGetFieldText(nomeCampo_address2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_auditoria_validate_address2(var_address2, var_script_case_init, do_ajax_form_vicidial_list_auditoria_validate_address2_cb);
  } // do_ajax_form_vicidial_list_auditoria_validate_address2

  function do_ajax_form_vicidial_list_auditoria_validate_address2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_auditoria_validate_address2_cb

  // ---------- Validate address3
  function do_ajax_form_vicidial_list_auditoria_validate_address3()
  {
    var nomeCampo_address3 = "address3";
    var var_address3 = scAjaxGetFieldText(nomeCampo_address3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_auditoria_validate_address3(var_address3, var_script_case_init, do_ajax_form_vicidial_list_auditoria_validate_address3_cb);
  } // do_ajax_form_vicidial_list_auditoria_validate_address3

  function do_ajax_form_vicidial_list_auditoria_validate_address3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_auditoria_validate_address3_cb

  // ---------- Validate source_id
  function do_ajax_form_vicidial_list_auditoria_validate_source_id()
  {
    var nomeCampo_source_id = "source_id";
    var var_source_id = scAjaxGetFieldText(nomeCampo_source_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_auditoria_validate_source_id(var_source_id, var_script_case_init, do_ajax_form_vicidial_list_auditoria_validate_source_id_cb);
  } // do_ajax_form_vicidial_list_auditoria_validate_source_id

  function do_ajax_form_vicidial_list_auditoria_validate_source_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_auditoria_validate_source_id_cb

  // ---------- Validate city
  function do_ajax_form_vicidial_list_auditoria_validate_city()
  {
    var nomeCampo_city = "city";
    var var_city = scAjaxGetFieldText(nomeCampo_city);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_auditoria_validate_city(var_city, var_script_case_init, do_ajax_form_vicidial_list_auditoria_validate_city_cb);
  } // do_ajax_form_vicidial_list_auditoria_validate_city

  function do_ajax_form_vicidial_list_auditoria_validate_city_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "city";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_auditoria_validate_city_cb

  // ---------- Validate state
  function do_ajax_form_vicidial_list_auditoria_validate_state()
  {
    var nomeCampo_state = "state";
    var var_state = scAjaxGetFieldText(nomeCampo_state);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_auditoria_validate_state(var_state, var_script_case_init, do_ajax_form_vicidial_list_auditoria_validate_state_cb);
  } // do_ajax_form_vicidial_list_auditoria_validate_state

  function do_ajax_form_vicidial_list_auditoria_validate_state_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "state";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_auditoria_validate_state_cb

  // ---------- Validate country_code
  function do_ajax_form_vicidial_list_auditoria_validate_country_code()
  {
    var nomeCampo_country_code = "country_code";
    var var_country_code = scAjaxGetFieldSelect(nomeCampo_country_code);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_auditoria_validate_country_code(var_country_code, var_script_case_init, do_ajax_form_vicidial_list_auditoria_validate_country_code_cb);
  } // do_ajax_form_vicidial_list_auditoria_validate_country_code

  function do_ajax_form_vicidial_list_auditoria_validate_country_code_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_auditoria_validate_country_code_cb

  // ---------- Validate owner
  function do_ajax_form_vicidial_list_auditoria_validate_owner()
  {
    var nomeCampo_owner = "owner";
    var var_owner = scAjaxGetFieldSelect(nomeCampo_owner);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_auditoria_validate_owner(var_owner, var_script_case_init, do_ajax_form_vicidial_list_auditoria_validate_owner_cb);
  } // do_ajax_form_vicidial_list_auditoria_validate_owner

  function do_ajax_form_vicidial_list_auditoria_validate_owner_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "owner";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_auditoria_validate_owner_cb

  // ---------- Validate vendor_lead_code
  function do_ajax_form_vicidial_list_auditoria_validate_vendor_lead_code()
  {
    var nomeCampo_vendor_lead_code = "vendor_lead_code";
    var var_vendor_lead_code = scAjaxGetFieldSelect(nomeCampo_vendor_lead_code);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_auditoria_validate_vendor_lead_code(var_vendor_lead_code, var_script_case_init, do_ajax_form_vicidial_list_auditoria_validate_vendor_lead_code_cb);
  } // do_ajax_form_vicidial_list_auditoria_validate_vendor_lead_code

  function do_ajax_form_vicidial_list_auditoria_validate_vendor_lead_code_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_auditoria_validate_vendor_lead_code_cb

  // ---------- Validate province
  function do_ajax_form_vicidial_list_auditoria_validate_province()
  {
    var nomeCampo_province = "province";
    var var_province = scAjaxGetFieldText(nomeCampo_province);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_auditoria_validate_province(var_province, var_script_case_init, do_ajax_form_vicidial_list_auditoria_validate_province_cb);
  } // do_ajax_form_vicidial_list_auditoria_validate_province

  function do_ajax_form_vicidial_list_auditoria_validate_province_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_auditoria_validate_province_cb

  // ---------- Validate date_of_birth
  function do_ajax_form_vicidial_list_auditoria_validate_date_of_birth()
  {
    var nomeCampo_date_of_birth = "date_of_birth";
    var var_date_of_birth = scAjaxGetFieldText(nomeCampo_date_of_birth);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_auditoria_validate_date_of_birth(var_date_of_birth, var_script_case_init, do_ajax_form_vicidial_list_auditoria_validate_date_of_birth_cb);
  } // do_ajax_form_vicidial_list_auditoria_validate_date_of_birth

  function do_ajax_form_vicidial_list_auditoria_validate_date_of_birth_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_auditoria_validate_date_of_birth_cb

  // ---------- Validate title
  function do_ajax_form_vicidial_list_auditoria_validate_title()
  {
    var nomeCampo_title = "title";
    var var_title = scAjaxGetFieldSelect(nomeCampo_title);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_list_auditoria_validate_title(var_title, var_script_case_init, do_ajax_form_vicidial_list_auditoria_validate_title_cb);
  } // do_ajax_form_vicidial_list_auditoria_validate_title

  function do_ajax_form_vicidial_list_auditoria_validate_title_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "title";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_list_auditoria_validate_title_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_vicidial_list_auditoria_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_vicidial_list_auditoria_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_vicidial_list_auditoria_submit_form(var_comments, var_modify_date, var_modify_date_hora, var_user, var_phone_number, var_alt_phone, var_email, var_status, var_gender, var_first_name, var_postal_code, var_address1, var_middle_initial, var_address2, var_address3, var_source_id, var_city, var_state, var_country_code, var_owner, var_vendor_lead_code, var_province, var_date_of_birth, var_title, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_vicidial_list_auditoria_submit_form_cb);
  } // do_ajax_form_vicidial_list_auditoria_submit_form

  function do_ajax_form_vicidial_list_auditoria_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_vicidial_list_auditoria_submit_form_cb_after_alert);
  } // do_ajax_form_vicidial_list_auditoria_submit_form_cb
  function do_ajax_form_vicidial_list_auditoria_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_vicidial_list_auditoria_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_goautodial_recordings_views"] = "off";

  function do_ajax_form_vicidial_list_auditoria_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_vicidial_list_auditoria_navigate_form(var_lead_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_vicidial_list_auditoria_navigate_form_cb);
  } // do_ajax_form_vicidial_list_auditoria_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_list_auditoria']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_vicidial_list_auditoria_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_vicidial_list_auditoria_navigate_form_cb_after_alert);
  } // do_ajax_form_vicidial_list_auditoria_navigate_form_cb
  function do_ajax_form_vicidial_list_auditoria_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_vicidial_list_auditoria_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_vicidial_list_auditoria_navigate_form_cb_after_alert
  function sc_hide_form_vicidial_list_auditoria_form()
  {
