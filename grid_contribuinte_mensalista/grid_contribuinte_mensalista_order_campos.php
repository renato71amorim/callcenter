<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_contribuinte_mensalista']['glo_nm_path_imag_temp'] . "/sc_apl_default_dinamica_publicado.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_contribuinte_mensalista_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_contribuinte_mensalista_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['labels']["codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['labels']["codigo"] : "Codigo";
   $tab_ger_campos['nome'] = "on";
   $tab_def_campos['nome'] = "nome";
   $tab_labels["nome"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['labels']["nome"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['labels']["nome"] : "Nome";
   $tab_ger_campos['bairro'] = "on";
   $tab_def_campos['bairro'] = "bairro";
   $tab_labels["bairro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['labels']["bairro"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['labels']["bairro"] : "Bairro";
   $tab_ger_campos['cidade'] = "on";
   $tab_def_campos['cidade'] = "cidade";
   $tab_labels["cidade"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['labels']["cidade"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['labels']["cidade"] : "Cidade";
   $tab_ger_campos['ddd'] = "on";
   $tab_def_campos['ddd'] = "ddd";
   $tab_labels["ddd"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['labels']["ddd"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['labels']["ddd"] : "DDD";
   $tab_ger_campos['fone1'] = "on";
   $tab_def_campos['fone1'] = "fone1";
   $tab_labels["fone1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['labels']["fone1"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['labels']["fone1"] : "Fone 1";
   $tab_ger_campos['fone2'] = "on";
   $tab_def_campos['fone2'] = "fone2";
   $tab_labels["fone2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['labels']["fone2"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['labels']["fone2"] : "Fone 2";
   $tab_ger_campos['valor'] = "on";
   $tab_def_campos['valor'] = "valor";
   $tab_labels["valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['labels']["valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['labels']["valor"] : "Valor";
   $tab_ger_campos['data_inicio'] = "on";
   $tab_def_campos['data_inicio'] = "data_inicio";
   $tab_labels["data_inicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['labels']["data_inicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['labels']["data_inicio"] : "Data Inicio";
   $tab_ger_campos['data_ultima'] = "on";
   $tab_def_campos['data_ultima'] = "data_ultima";
   $tab_labels["data_ultima"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['labels']["data_ultima"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['labels']["data_ultima"] : "Data Ultima";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['ordem_quebra'] as $campo => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> Contribuintes Mensalista</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_contribuinte_mensalista_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_contribuinte_mensalista']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
