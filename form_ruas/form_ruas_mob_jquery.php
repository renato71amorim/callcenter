...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_codigorua' + iSeqRow).bind('blur', function() { sc_form_ruas_codigorua_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_ruas_codigorua_onfocus(this, iSeqRow) });
  $('#id_sc_field_nomerua' + iSeqRow).bind('blur', function() { sc_form_ruas_nomerua_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_ruas_nomerua_onfocus(this, iSeqRow) });
  $('#id_sc_field_bairro' + iSeqRow).bind('blur', function() { sc_form_ruas_bairro_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_ruas_bairro_onfocus(this, iSeqRow) });
  $('#id_sc_field_cidade' + iSeqRow).bind('blur', function() { sc_form_ruas_cidade_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_ruas_cidade_onfocus(this, iSeqRow) });
  $('#id_sc_field_uf' + iSeqRow).bind('blur', function() { sc_form_ruas_uf_onblur(this, iSeqRow) })
                                .bind('focus', function() { sc_form_ruas_uf_onfocus(this, iSeqRow) });
  $('#id_sc_field_cep' + iSeqRow).bind('blur', function() { sc_form_ruas_cep_onblur(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_ruas_cep_onfocus(this, iSeqRow) });
  $('#id_sc_field_tipologradouro' + iSeqRow).bind('blur', function() { sc_form_ruas_tipologradouro_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_ruas_tipologradouro_onfocus(this, iSeqRow) });
  $('#id_sc_field_setores' + iSeqRow).bind('blur', function() { sc_form_ruas_setores_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_ruas_setores_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_ruas_codigorua_onblur(oThis, iSeqRow) {
  do_ajax_form_ruas_mob_validate_codigorua();
  scCssBlur(oThis);
}

function sc_form_ruas_codigorua_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_ruas_nomerua_onblur(oThis, iSeqRow) {
  do_ajax_form_ruas_mob_validate_nomerua();
  scCssBlur(oThis);
}

function sc_form_ruas_nomerua_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_ruas_bairro_onblur(oThis, iSeqRow) {
  do_ajax_form_ruas_mob_validate_bairro();
  scCssBlur(oThis);
}

function sc_form_ruas_bairro_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_ruas_cidade_onblur(oThis, iSeqRow) {
  do_ajax_form_ruas_mob_validate_cidade();
  scCssBlur(oThis);
}

function sc_form_ruas_cidade_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_ruas_uf_onblur(oThis, iSeqRow) {
  do_ajax_form_ruas_mob_validate_uf();
  scCssBlur(oThis);
}

function sc_form_ruas_uf_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_ruas_cep_onblur(oThis, iSeqRow) {
  do_ajax_form_ruas_mob_validate_cep();
  scCssBlur(oThis);
}

function sc_form_ruas_cep_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_ruas_tipologradouro_onblur(oThis, iSeqRow) {
  do_ajax_form_ruas_mob_validate_tipologradouro();
  scCssBlur(oThis);
}

function sc_form_ruas_tipologradouro_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_ruas_setores_onblur(oThis, iSeqRow) {
  do_ajax_form_ruas_mob_validate_setores();
  scCssBlur(oThis);
}

function sc_form_ruas_setores_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_ruas_mob_form" + pageNo).hide();
}
