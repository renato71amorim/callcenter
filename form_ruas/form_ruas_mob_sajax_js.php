  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_ruas_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_ruas_mob_form();
	}

  // ---------- Validate codigorua
  function do_ajax_form_ruas_mob_validate_codigorua()
  {
    var nomeCampo_codigorua = "codigorua";
    var var_codigorua = scAjaxGetFieldText(nomeCampo_codigorua);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ruas_mob_validate_codigorua(var_codigorua, var_script_case_init, do_ajax_form_ruas_mob_validate_codigorua_cb);
  } // do_ajax_form_ruas_mob_validate_codigorua

  function do_ajax_form_ruas_mob_validate_codigorua_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ruas_mob_validate_codigorua_cb

  // ---------- Validate tipologradouro
  function do_ajax_form_ruas_mob_validate_tipologradouro()
  {
    var nomeCampo_tipologradouro = "tipologradouro";
    var var_tipologradouro = scAjaxGetFieldText(nomeCampo_tipologradouro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ruas_mob_validate_tipologradouro(var_tipologradouro, var_script_case_init, do_ajax_form_ruas_mob_validate_tipologradouro_cb);
  } // do_ajax_form_ruas_mob_validate_tipologradouro

  function do_ajax_form_ruas_mob_validate_tipologradouro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ruas_mob_validate_tipologradouro_cb

  // ---------- Validate nomerua
  function do_ajax_form_ruas_mob_validate_nomerua()
  {
    var nomeCampo_nomerua = "nomerua";
    var var_nomerua = scAjaxGetFieldText(nomeCampo_nomerua);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ruas_mob_validate_nomerua(var_nomerua, var_script_case_init, do_ajax_form_ruas_mob_validate_nomerua_cb);
  } // do_ajax_form_ruas_mob_validate_nomerua

  function do_ajax_form_ruas_mob_validate_nomerua_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nomerua";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ruas_mob_validate_nomerua_cb

  // ---------- Validate bairro
  function do_ajax_form_ruas_mob_validate_bairro()
  {
    var nomeCampo_bairro = "bairro";
    var var_bairro = scAjaxGetFieldText(nomeCampo_bairro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ruas_mob_validate_bairro(var_bairro, var_script_case_init, do_ajax_form_ruas_mob_validate_bairro_cb);
  } // do_ajax_form_ruas_mob_validate_bairro

  function do_ajax_form_ruas_mob_validate_bairro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bairro";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ruas_mob_validate_bairro_cb

  // ---------- Validate cidade
  function do_ajax_form_ruas_mob_validate_cidade()
  {
    var nomeCampo_cidade = "cidade";
    var var_cidade = scAjaxGetFieldText(nomeCampo_cidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ruas_mob_validate_cidade(var_cidade, var_script_case_init, do_ajax_form_ruas_mob_validate_cidade_cb);
  } // do_ajax_form_ruas_mob_validate_cidade

  function do_ajax_form_ruas_mob_validate_cidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cidade";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ruas_mob_validate_cidade_cb

  // ---------- Validate uf
  function do_ajax_form_ruas_mob_validate_uf()
  {
    var nomeCampo_uf = "uf";
    var var_uf = scAjaxGetFieldText(nomeCampo_uf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ruas_mob_validate_uf(var_uf, var_script_case_init, do_ajax_form_ruas_mob_validate_uf_cb);
  } // do_ajax_form_ruas_mob_validate_uf

  function do_ajax_form_ruas_mob_validate_uf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "uf";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ruas_mob_validate_uf_cb

  // ---------- Validate cep
  function do_ajax_form_ruas_mob_validate_cep()
  {
    var nomeCampo_cep = "cep";
    var var_cep = scAjaxGetFieldText(nomeCampo_cep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ruas_mob_validate_cep(var_cep, var_script_case_init, do_ajax_form_ruas_mob_validate_cep_cb);
  } // do_ajax_form_ruas_mob_validate_cep

  function do_ajax_form_ruas_mob_validate_cep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cep";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ruas_mob_validate_cep_cb

  // ---------- Validate setores
  function do_ajax_form_ruas_mob_validate_setores()
  {
    var nomeCampo_setores = "setores";
    var var_setores = scAjaxGetFieldText(nomeCampo_setores);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ruas_mob_validate_setores(var_setores, var_script_case_init, do_ajax_form_ruas_mob_validate_setores_cb);
  } // do_ajax_form_ruas_mob_validate_setores

  function do_ajax_form_ruas_mob_validate_setores_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "setores";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ruas_mob_validate_setores_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_ruas_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_ruas_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_ruas_mob_submit_form(var_codigorua, var_tipologradouro, var_nomerua, var_bairro, var_cidade, var_uf, var_cep, var_setores, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_ruas_mob_submit_form_cb);
  } // do_ajax_form_ruas_mob_submit_form

  function do_ajax_form_ruas_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_ruas_mob_submit_form_cb_after_alert);
  } // do_ajax_form_ruas_mob_submit_form_cb
  function do_ajax_form_ruas_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_ruas_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_ruas_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_ruas_mob_navigate_form(var_codigorua, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ruas_mob_navigate_form_cb);
  } // do_ajax_form_ruas_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ruas_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_ruas_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_ruas_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_ruas_mob_navigate_form_cb
  function do_ajax_form_ruas_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_ruas_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_ruas_mob_navigate_form_cb_after_alert
  function sc_hide_form_ruas_mob_form()
  {
  ...
  ajax_field_list[1] = "tipologradouro";
  ajax_field_list[2] = "nomerua";
  ajax_field_list[3] = "bairro";
  ajax_field_list[4] = "cidade";
  ajax_field_list[5] = "uf";
  ajax_field_list[6] = "cep";
  ajax_field_list[7] = "setores";
