  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_vicidial_users_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_vicidial_users_mob_form();
	}

  // ---------- Validate full_name
  function do_ajax_form_vicidial_users_mob_validate_full_name()
  {
    var nomeCampo_full_name = "full_name";
    var var_full_name = scAjaxGetFieldText(nomeCampo_full_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_users_mob_validate_full_name(var_full_name, var_script_case_init, do_ajax_form_vicidial_users_mob_validate_full_name_cb);
  } // do_ajax_form_vicidial_users_mob_validate_full_name

  function do_ajax_form_vicidial_users_mob_validate_full_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "full_name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_users_mob_validate_full_name_cb

  // ---------- Validate user
  function do_ajax_form_vicidial_users_mob_validate_user()
  {
    var nomeCampo_user = "user";
    var var_user = scAjaxGetFieldText(nomeCampo_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_users_mob_validate_user(var_user, var_script_case_init, do_ajax_form_vicidial_users_mob_validate_user_cb);
  } // do_ajax_form_vicidial_users_mob_validate_user

  function do_ajax_form_vicidial_users_mob_validate_user_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_users_mob_validate_user_cb

  // ---------- Validate pass
  function do_ajax_form_vicidial_users_mob_validate_pass()
  {
    var nomeCampo_pass = "pass";
    var var_pass = scAjaxGetFieldText(nomeCampo_pass);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_users_mob_validate_pass(var_pass, var_script_case_init, do_ajax_form_vicidial_users_mob_validate_pass_cb);
  } // do_ajax_form_vicidial_users_mob_validate_pass

  function do_ajax_form_vicidial_users_mob_validate_pass_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pass";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_users_mob_validate_pass_cb

  // ---------- Validate user_level
  function do_ajax_form_vicidial_users_mob_validate_user_level()
  {
    var nomeCampo_user_level = "user_level";
    var var_user_level = scAjaxGetFieldText(nomeCampo_user_level);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_users_mob_validate_user_level(var_user_level, var_script_case_init, do_ajax_form_vicidial_users_mob_validate_user_level_cb);
  } // do_ajax_form_vicidial_users_mob_validate_user_level

  function do_ajax_form_vicidial_users_mob_validate_user_level_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user_level";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_users_mob_validate_user_level_cb

  // ---------- Validate user_group
  function do_ajax_form_vicidial_users_mob_validate_user_group()
  {
    var nomeCampo_user_group = "user_group";
    var var_user_group = scAjaxGetFieldText(nomeCampo_user_group);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_users_mob_validate_user_group(var_user_group, var_script_case_init, do_ajax_form_vicidial_users_mob_validate_user_group_cb);
  } // do_ajax_form_vicidial_users_mob_validate_user_group

  function do_ajax_form_vicidial_users_mob_validate_user_group_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user_group";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_users_mob_validate_user_group_cb

  // ---------- Validate phone_login
  function do_ajax_form_vicidial_users_mob_validate_phone_login()
  {
    var nomeCampo_phone_login = "phone_login";
    var var_phone_login = scAjaxGetFieldText(nomeCampo_phone_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_users_mob_validate_phone_login(var_phone_login, var_script_case_init, do_ajax_form_vicidial_users_mob_validate_phone_login_cb);
  } // do_ajax_form_vicidial_users_mob_validate_phone_login

  function do_ajax_form_vicidial_users_mob_validate_phone_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "phone_login";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_users_mob_validate_phone_login_cb

  // ---------- Validate phone_pass
  function do_ajax_form_vicidial_users_mob_validate_phone_pass()
  {
    var nomeCampo_phone_pass = "phone_pass";
    var var_phone_pass = scAjaxGetFieldText(nomeCampo_phone_pass);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_users_mob_validate_phone_pass(var_phone_pass, var_script_case_init, do_ajax_form_vicidial_users_mob_validate_phone_pass_cb);
  } // do_ajax_form_vicidial_users_mob_validate_phone_pass

  function do_ajax_form_vicidial_users_mob_validate_phone_pass_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "phone_pass";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_users_mob_validate_phone_pass_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_vicidial_users_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_vicidial_users_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_full_name = scAjaxGetFieldText("full_name");
    var var_user = scAjaxGetFieldText("user");
    var var_pass = scAjaxGetFieldText("pass");
    var var_user_level = scAjaxGetFieldText("user_level");
    var var_user_group = scAjaxGetFieldText("user_group");
    var var_phone_login = scAjaxGetFieldText("phone_login");
    var var_phone_pass = scAjaxGetFieldText("phone_pass");
    var var_user_id = scAjaxGetFieldText("user_id");
    ...
    scAjaxProcOn();
    x_ajax_form_vicidial_users_mob_submit_form(var_full_name, var_user, var_pass, var_user_level, var_user_group, var_phone_login, var_phone_pass, var_user_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_vicidial_users_mob_submit_form_cb);
  } // do_ajax_form_vicidial_users_mob_submit_form

  function do_ajax_form_vicidial_users_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("full_name");
      scAjaxHideErrorDisplay("user");
      scAjaxHideErrorDisplay("pass");
      scAjaxHideErrorDisplay("user_level");
      scAjaxHideErrorDisplay("user_group");
      scAjaxHideErrorDisplay("phone_login");
      scAjaxHideErrorDisplay("phone_pass");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_vicidial_users_mob_submit_form_cb_after_alert);
  } // do_ajax_form_vicidial_users_mob_submit_form_cb
  function do_ajax_form_vicidial_users_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_vicidial_users_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_vicidial_users_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("phone_login");
    scAjaxHideErrorDisplay("phone_pass");
    var var_user_id = document.F2.user_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_vicidial_users_mob_navigate_form(var_user_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_vicidial_users_mob_navigate_form_cb);
  } // do_ajax_form_vicidial_users_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_vicidial_users_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.user_id.value = scAjaxGetKeyValue("user_id");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_vicidial_users_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_vicidial_users_mob_navigate_form_cb
  function do_ajax_form_vicidial_users_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_vicidial_users_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_vicidial_users_mob_navigate_form_cb_after_alert
  function sc_hide_form_vicidial_users_mob_form()
  {
  ...
  ajax_field_list[0] = "full_name";
  ajax_field_list[1] = "user";
  ajax_field_list[2] = "pass";
  ajax_field_list[3] = "user_level";
  ajax_field_list[4] = "user_group";
  ajax_field_list[5] = "phone_login";
  ajax_field_list[6] = "phone_pass";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "full_name": {"label": "Full Name", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "user": {"label": "User", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pass": {"label": "Pass", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "user_level": {"label": "User Level", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "user_group": {"label": "User Group", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "phone_login": {"label": "Phone Login", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "phone_pass": {"label": "Phone Pass", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "user": new Array(),
    "pass": new Array(),
    "user_level": new Array(),
    "user_group": new Array(),
    "phone_login": new Array(),
    "phone_pass": new Array()
  };
  ajax_field_mult["full_name"][1] = "full_name";
  ajax_field_mult["user"][1] = "user";
  ajax_field_mult["pass"][1] = "pass";
  ajax_field_mult["user_level"][1] = "user_level";
  ajax_field_mult["user_group"][1] = "user_group";
  ajax_field_mult["phone_login"][1] = "phone_login";
  ajax_field_mult["phone_pass"][1] = "phone_pass";

  var ajax_field_id = {
    "full_name": new Array("hidden_field_label_full_name", "hidden_field_data_full_name"),
    "user": new Array("hidden_field_label_user", "hidden_field_data_user"),
    "pass": new Array("hidden_field_label_pass", "hidden_field_data_pass"),
    "user_level": new Array("hidden_field_label_user_level", "hidden_field_data_user_level"),
    "user_group": new Array("hidden_field_label_user_group", "hidden_field_data_user_group"),
    "phone_login": new Array("hidden_field_label_phone_login", "hidden_field_data_phone_login"),
    "phone_pass": new Array("hidden_field_label_phone_pass", "hidden_field_data_phone_pass")
  };
