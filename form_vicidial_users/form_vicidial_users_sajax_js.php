  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_vicidial_users" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_vicidial_users_form();
	}

  // ---------- Validate full_name
  function do_ajax_form_vicidial_users_validate_full_name()
  {
    var nomeCampo_full_name = "full_name";
    var var_full_name = scAjaxGetFieldText(nomeCampo_full_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_users_validate_full_name(var_full_name, var_script_case_init, do_ajax_form_vicidial_users_validate_full_name_cb);
  } // do_ajax_form_vicidial_users_validate_full_name

  function do_ajax_form_vicidial_users_validate_full_name_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_users_validate_full_name_cb

  // ---------- Validate user
  function do_ajax_form_vicidial_users_validate_user()
  {
    var nomeCampo_user = "user";
    var var_user = scAjaxGetFieldText(nomeCampo_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_users_validate_user(var_user, var_script_case_init, do_ajax_form_vicidial_users_validate_user_cb);
  } // do_ajax_form_vicidial_users_validate_user

  function do_ajax_form_vicidial_users_validate_user_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_users_validate_user_cb

  // ---------- Validate pass
  function do_ajax_form_vicidial_users_validate_pass()
  {
    var nomeCampo_pass = "pass";
    var var_pass = scAjaxGetFieldText(nomeCampo_pass);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_users_validate_pass(var_pass, var_script_case_init, do_ajax_form_vicidial_users_validate_pass_cb);
  } // do_ajax_form_vicidial_users_validate_pass

  function do_ajax_form_vicidial_users_validate_pass_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pass";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_users_validate_pass_cb

  // ---------- Validate user_level
  function do_ajax_form_vicidial_users_validate_user_level()
  {
    var nomeCampo_user_level = "user_level";
    var var_user_level = scAjaxGetFieldText(nomeCampo_user_level);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_users_validate_user_level(var_user_level, var_script_case_init, do_ajax_form_vicidial_users_validate_user_level_cb);
  } // do_ajax_form_vicidial_users_validate_user_level

  function do_ajax_form_vicidial_users_validate_user_level_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_users_validate_user_level_cb

  // ---------- Validate user_group
  function do_ajax_form_vicidial_users_validate_user_group()
  {
    var nomeCampo_user_group = "user_group";
    var var_user_group = scAjaxGetFieldText(nomeCampo_user_group);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_users_validate_user_group(var_user_group, var_script_case_init, do_ajax_form_vicidial_users_validate_user_group_cb);
  } // do_ajax_form_vicidial_users_validate_user_group

  function do_ajax_form_vicidial_users_validate_user_group_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_users_validate_user_group_cb

  // ---------- Validate phone_login
  function do_ajax_form_vicidial_users_validate_phone_login()
  {
    var nomeCampo_phone_login = "phone_login";
    var var_phone_login = scAjaxGetFieldText(nomeCampo_phone_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_users_validate_phone_login(var_phone_login, var_script_case_init, do_ajax_form_vicidial_users_validate_phone_login_cb);
  } // do_ajax_form_vicidial_users_validate_phone_login

  function do_ajax_form_vicidial_users_validate_phone_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_users_validate_phone_login_cb

  // ---------- Validate phone_pass
  function do_ajax_form_vicidial_users_validate_phone_pass()
  {
    var nomeCampo_phone_pass = "phone_pass";
    var var_phone_pass = scAjaxGetFieldText(nomeCampo_phone_pass);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vicidial_users_validate_phone_pass(var_phone_pass, var_script_case_init, do_ajax_form_vicidial_users_validate_phone_pass_cb);
  } // do_ajax_form_vicidial_users_validate_phone_pass

  function do_ajax_form_vicidial_users_validate_phone_pass_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vicidial_users_validate_phone_pass_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_vicidial_users_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_vicidial_users_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_vicidial_users_submit_form(var_full_name, var_user, var_pass, var_user_level, var_user_group, var_phone_login, var_phone_pass, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_vicidial_users_submit_form_cb);
  } // do_ajax_form_vicidial_users_submit_form

  function do_ajax_form_vicidial_users_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_vicidial_users_submit_form_cb_after_alert);
  } // do_ajax_form_vicidial_users_submit_form_cb
  function do_ajax_form_vicidial_users_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_vicidial_users_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_vicidial_users_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_vicidial_users_navigate_form(var_user_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_vicidial_users_navigate_form_cb);
  } // do_ajax_form_vicidial_users_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_vicidial_users_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_vicidial_users_navigate_form_cb_after_alert);
  } // do_ajax_form_vicidial_users_navigate_form_cb
  function do_ajax_form_vicidial_users_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_vicidial_users_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_vicidial_users_navigate_form_cb_after_alert
  function sc_hide_form_vicidial_users_form()
  {
