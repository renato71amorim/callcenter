<?php
//
class form_vicidial_users_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_vicidial_users_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_vicidial_users_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_vicidial_users_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_vicidial_users_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_vicidial_users_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_vicidial_users_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_vicidial_users_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_vicidial_users_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_vicidial_users_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_vicidial_users_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_vicidial_users_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_vicidial_users_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_vicidial_users_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_vicidial_users_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_vicidial_users_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_vicidial_users_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_vicidial_users_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_vicidial_users_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_vicidial_users_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vicidial_users_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vicidial_users_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_vicidial_users_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vicidial_users_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - vicidial_users";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_vicidial_users_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_vicidial_users_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_vicidial_users_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vicidial_users_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_vicidial_users_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_vicidial_users_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_vicidial_users_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_vicidial_users_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_vicidial_users_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_vicidial_users/form_vicidial_users_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_vicidial_users_mob_erro.class.php"); 
      }
      $this->Erro      = new form_vicidial_users_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['opcao']))
         { 
             if ($this->user_id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_vicidial_users_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_vicidial_users_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_vicidial_users_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_vicidial_users_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_vicidial_users_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       $delim  = "'";
       $delim1 = "'";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['SC_sep_date1'];
       }
       $dt  = $delim . date('Y-m-d H:i:s') . $delim1;
       $usr = isset($_SESSION['usr_login']) ? $_SESSION['usr_login'] : "";
       if (in_array(strtolower($this->Ini->nm_con_unicep['tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Ini->nm_db_unicep->qstr($usr) . ", 'form_vicidial_users_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Ini->nm_db_unicep->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Ini->nm_db_unicep->qstr($usr) . ", 'form_vicidial_users_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Ini->nm_db_unicep->qstr($texto) . ")"; 
       } 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_vicidial_users_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_vicidial_users_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_vicidial_users_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_vicidial_users_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
    ...
    function ValidateField_user_level(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->user_level, 3, 0, -0, 999, "N") == false)  
              { 
                  $hasError = true;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['user_id']['keyVal'] = form_vicidial_users_mob_pack_protect_string($this->nmgp_dados_form['user_id']);
          }
   } // ajax_return_values
   ...
   function ajax_return_values_user_id($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['parms'] = "user_id?#?$this->user_id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['parms'] = ""; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['reg_start']) ; 
          } 
          else  
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['reg_start'] < $qt_geral_reg_form_vicidial_users_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['dados_select'];
                  $this->user = $this->nmgp_dados_select['user'];  
                  $this->pass = $this->nmgp_dados_select['pass'];  
                  $this->full_name = $this->nmgp_dados_select['full_name'];  
                  $this->user_level = $this->nmgp_dados_select['user_level'];  
                  $this->user_group = $this->nmgp_dados_select['user_group'];  
                  $this->phone_login = $this->nmgp_dados_select['phone_login'];  
                  $this->phone_pass = $this->nmgp_dados_select['phone_pass'];  
                  $this->delete_users = $this->nmgp_dados_select['delete_users'];  
                  $this->delete_user_groups = $this->nmgp_dados_select['delete_user_groups'];  
                  $this->delete_lists = $this->nmgp_dados_select['delete_lists'];  
                  $this->delete_campaigns = $this->nmgp_dados_select['delete_campaigns'];  
                  $this->delete_ingroups = $this->nmgp_dados_select['delete_ingroups'];  
                  $this->delete_remote_agents = $this->nmgp_dados_select['delete_remote_agents'];  
                  $this->load_leads = $this->nmgp_dados_select['load_leads'];  
                  $this->campaign_detail = $this->nmgp_dados_select['campaign_detail'];  
                  $this->ast_admin_access = $this->nmgp_dados_select['ast_admin_access'];  
                  $this->ast_delete_phones = $this->nmgp_dados_select['ast_delete_phones'];  
                  $this->delete_scripts = $this->nmgp_dados_select['delete_scripts'];  
                  $this->modify_leads = $this->nmgp_dados_select['modify_leads'];  
                  $this->hotkeys_active = $this->nmgp_dados_select['hotkeys_active'];  
                  $this->change_agent_campaign = $this->nmgp_dados_select['change_agent_campaign'];  
                  $this->agent_choose_ingroups = $this->nmgp_dados_select['agent_choose_ingroups'];  
                  $this->closer_campaigns = $this->nmgp_dados_select['closer_campaigns'];  
                  $this->scheduled_callbacks = $this->nmgp_dados_select['scheduled_callbacks'];  
                  $this->agentonly_callbacks = $this->nmgp_dados_select['agentonly_callbacks'];  
                  $this->agentcall_manual = $this->nmgp_dados_select['agentcall_manual'];  
                  $this->vicidial_recording = $this->nmgp_dados_select['vicidial_recording'];  
                  $this->vicidial_transfers = $this->nmgp_dados_select['vicidial_transfers'];  
                  $this->delete_filters = $this->nmgp_dados_select['delete_filters'];  
                  $this->alter_agent_interface_options = $this->nmgp_dados_select['alter_agent_interface_options'];  
                  $this->closer_default_blended = $this->nmgp_dados_select['closer_default_blended'];  
                  $this->delete_call_times = $this->nmgp_dados_select['delete_call_times'];  
                  $this->modify_call_times = $this->nmgp_dados_select['modify_call_times'];  
                  $this->modify_users = $this->nmgp_dados_select['modify_users'];  
                  $this->modify_campaigns = $this->nmgp_dados_select['modify_campaigns'];  
                  $this->modify_lists = $this->nmgp_dados_select['modify_lists'];  
                  $this->modify_scripts = $this->nmgp_dados_select['modify_scripts'];  
                  $this->modify_filters = $this->nmgp_dados_select['modify_filters'];  
                  $this->modify_ingroups = $this->nmgp_dados_select['modify_ingroups'];  
                  $this->modify_usergroups = $this->nmgp_dados_select['modify_usergroups'];  
                  $this->modify_remoteagents = $this->nmgp_dados_select['modify_remoteagents'];  
                  $this->modify_servers = $this->nmgp_dados_select['modify_servers'];  
                  $this->view_reports = $this->nmgp_dados_select['view_reports'];  
                  $this->vicidial_recording_override = $this->nmgp_dados_select['vicidial_recording_override'];  
                  $this->alter_custdata_override = $this->nmgp_dados_select['alter_custdata_override'];  
                  $this->qc_enabled = $this->nmgp_dados_select['qc_enabled'];  
                  $this->qc_user_level = $this->nmgp_dados_select['qc_user_level'];  
                  $this->qc_pass = $this->nmgp_dados_select['qc_pass'];  
                  $this->qc_finish = $this->nmgp_dados_select['qc_finish'];  
                  $this->qc_commit = $this->nmgp_dados_select['qc_commit'];  
                  $this->add_timeclock_log = $this->nmgp_dados_select['add_timeclock_log'];  
                  $this->modify_timeclock_log = $this->nmgp_dados_select['modify_timeclock_log'];  
                  $this->delete_timeclock_log = $this->nmgp_dados_select['delete_timeclock_log'];  
                  $this->alter_custphone_override = $this->nmgp_dados_select['alter_custphone_override'];  
                  $this->vdc_agent_api_access = $this->nmgp_dados_select['vdc_agent_api_access'];  
                  $this->modify_inbound_dids = $this->nmgp_dados_select['modify_inbound_dids'];  
                  $this->delete_inbound_dids = $this->nmgp_dados_select['delete_inbound_dids'];  
                  $this->active = $this->nmgp_dados_select['active'];  
                  $this->alert_enabled = $this->nmgp_dados_select['alert_enabled'];  
                  $this->download_lists = $this->nmgp_dados_select['download_lists'];  
                  $this->agent_shift_enforcement_override = $this->nmgp_dados_select['agent_shift_enforcement_override'];  
                  $this->manager_shift_enforcement_override = $this->nmgp_dados_select['manager_shift_enforcement_override'];  
                  $this->shift_override_flag = $this->nmgp_dados_select['shift_override_flag'];  
                  $this->export_reports = $this->nmgp_dados_select['export_reports'];  
                  $this->delete_from_dnc = $this->nmgp_dados_select['delete_from_dnc'];  
                  $this->email = $this->nmgp_dados_select['email'];  
                  $this->user_code = $this->nmgp_dados_select['user_code'];  
                  $this->territory = $this->nmgp_dados_select['territory'];  
                  $this->allow_alerts = $this->nmgp_dados_select['allow_alerts'];  
                  $this->agent_choose_territories = $this->nmgp_dados_select['agent_choose_territories'];  
                  $this->custom_one = $this->nmgp_dados_select['custom_one'];  
                  $this->custom_two = $this->nmgp_dados_select['custom_two'];  
                  $this->custom_three = $this->nmgp_dados_select['custom_three'];  
                  $this->custom_four = $this->nmgp_dados_select['custom_four'];  
                  $this->custom_five = $this->nmgp_dados_select['custom_five'];  
                  $this->voicemail_id = $this->nmgp_dados_select['voicemail_id'];  
                  $this->agent_call_log_view_override = $this->nmgp_dados_select['agent_call_log_view_override'];  
                  $this->callcard_admin = $this->nmgp_dados_select['callcard_admin'];  
                  $this->agent_choose_blended = $this->nmgp_dados_select['agent_choose_blended'];  
                  $this->realtime_block_user_info = $this->nmgp_dados_select['realtime_block_user_info'];  
                  $this->custom_fields_modify = $this->nmgp_dados_select['custom_fields_modify'];  
                  $this->force_change_password = $this->nmgp_dados_select['force_change_password'];  
                  $this->agent_lead_search_override = $this->nmgp_dados_select['agent_lead_search_override'];  
                  $this->modify_shifts = $this->nmgp_dados_select['modify_shifts'];  
                  $this->modify_phones = $this->nmgp_dados_select['modify_phones'];  
                  $this->modify_carriers = $this->nmgp_dados_select['modify_carriers'];  
                  $this->modify_labels = $this->nmgp_dados_select['modify_labels'];  
                  $this->modify_statuses = $this->nmgp_dados_select['modify_statuses'];  
                  $this->modify_voicemail = $this->nmgp_dados_select['modify_voicemail'];  
                  $this->modify_audiostore = $this->nmgp_dados_select['modify_audiostore'];  
                  $this->modify_moh = $this->nmgp_dados_select['modify_moh'];  
                  $this->modify_tts = $this->nmgp_dados_select['modify_tts'];  
                  $this->preset_contact_search = $this->nmgp_dados_select['preset_contact_search'];  
                  $this->modify_contacts = $this->nmgp_dados_select['modify_contacts'];  
                  $this->modify_same_user_level = $this->nmgp_dados_select['modify_same_user_level'];  
                  $this->admin_hide_lead_data = $this->nmgp_dados_select['admin_hide_lead_data'];  
                  $this->admin_hide_phone_data = $this->nmgp_dados_select['admin_hide_phone_data'];  
                  $this->agentcall_email = $this->nmgp_dados_select['agentcall_email'];  
                  $this->modify_email_accounts = $this->nmgp_dados_select['modify_email_accounts'];  
                  $this->failed_login_count = $this->nmgp_dados_select['failed_login_count'];  
                  $this->last_login_date = $this->nmgp_dados_select['last_login_date'];  
                  $this->last_ip = $this->nmgp_dados_select['last_ip'];  
                  $this->pass_hash = $this->nmgp_dados_select['pass_hash'];  
                  $this->alter_admin_interface_options = $this->nmgp_dados_select['alter_admin_interface_options'];  
                  $this->max_inbound_calls = $this->nmgp_dados_select['max_inbound_calls'];  
                  $this->modify_custom_dialplans = $this->nmgp_dados_select['modify_custom_dialplans'];  
              }
          }
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['foreign_key']))
          {
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['dados_select'];
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_vicidial_users_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_vicidial_users_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['total'] = $qt_geral_reg_form_vicidial_users_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_vicidial_users_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
      ...
      $Nm_datas['last_login_date'] = "datetime";
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (isset($Nm_datas[$campo_join]))
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_vicidial_users_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_vicidial_users_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vicidial_users_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
