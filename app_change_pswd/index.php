...
//
   ...
   $_SESSION['scriptcase']['app_change_pswd']['glo_nm_perfil']          = "pabx";
   $_SESSION['scriptcase']['app_change_pswd']['glo_nm_path_prod']       = "/principal/prod";
   $_SESSION['scriptcase']['app_change_pswd']['glo_nm_path_imagens']    = "/principal/file/img";
   $_SESSION['scriptcase']['app_change_pswd']['glo_nm_path_imag_temp']  = "/principal/tmp";
   $_SESSION['scriptcase']['app_change_pswd']['glo_nm_path_doc']        = "/var/ww/doc";
   $_SESSION['scriptcase']['app_change_pswd']['glo_con_unicep']         = "unicep";
   $NM_dir_atual = getcwd();
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      if (isset($_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['initialize']) && $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['initialize'])  
      { 
          $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['Gera_log_access'] = true;
      } 
      $this->conectDB();
      $this->conectExtra();
...
/*NM*/            $_SESSION['scriptcase']['app_change_pswd']['glo_nm_perfil'] = $NM_con_dest;
      ...
      if (!empty($perfil_trab))
      {
          ...
          carrega_perfil($_SESSION['scriptcase']['app_change_pswd']['glo_con_unicep'], $this->path_libs, "S");
          $this->nm_con_unicep['servidor'] = $_SESSION['scriptcase']['glo_servidor'];
          $this->nm_con_unicep['usuario']  = $_SESSION['scriptcase']['glo_usuario'];
          $this->nm_con_unicep['banco']    = $_SESSION['scriptcase']['glo_banco'];
          $this->nm_con_unicep['senha']    = $_SESSION['scriptcase']['glo_senha'];
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_change_pswd']['glo_nm_conexao'], $this->root . $this->path_prod, 'dinamica_publicado', 1, $this->force_db_utf8); 
      } 
      else 
      { 
...
// 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_change_pswd']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_change_pswd']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['app_change_pswd']['glo_nm_conexao'], $this->root . $this->path_prod, 'dinamica_publicado', 1, $this->force_db_utf8);
    }
    else {
