...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_data_hora' + iSeqRow).bind('blur', function() { sc_form_cancelamento_data_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_cancelamento_data_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_cancelamento_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_data" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_cancelamento_mob_validate_data(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
