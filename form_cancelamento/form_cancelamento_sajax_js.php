  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cancelamento" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cancelamento_form();
	}

  // ---------- Validate codigo
  function do_ajax_form_cancelamento_validate_codigo()
  {
    var nomeCampo_codigo = "codigo";
    var var_codigo = scAjaxGetFieldText(nomeCampo_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cancelamento_validate_codigo(var_codigo, var_script_case_init, do_ajax_form_cancelamento_validate_codigo_cb);
  } // do_ajax_form_cancelamento_validate_codigo

  function do_ajax_form_cancelamento_validate_codigo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cancelamento_validate_codigo_cb

  // ---------- Validate dia
  function do_ajax_form_cancelamento_validate_dia()
  {
    var nomeCampo_dia = "dia";
    var var_dia = scAjaxGetFieldText(nomeCampo_dia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cancelamento_validate_dia(var_dia, var_script_case_init, do_ajax_form_cancelamento_validate_dia_cb);
  } // do_ajax_form_cancelamento_validate_dia

  function do_ajax_form_cancelamento_validate_dia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dia";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cancelamento_validate_dia_cb

  // ---------- Validate mes
  function do_ajax_form_cancelamento_validate_mes()
  {
    var nomeCampo_mes = "mes";
    var var_mes = scAjaxGetFieldText(nomeCampo_mes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cancelamento_validate_mes(var_mes, var_script_case_init, do_ajax_form_cancelamento_validate_mes_cb);
  } // do_ajax_form_cancelamento_validate_mes

  function do_ajax_form_cancelamento_validate_mes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mes";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cancelamento_validate_mes_cb

  // ---------- Validate ano
  function do_ajax_form_cancelamento_validate_ano()
  {
    var nomeCampo_ano = "ano";
    var var_ano = scAjaxGetFieldText(nomeCampo_ano);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cancelamento_validate_ano(var_ano, var_script_case_init, do_ajax_form_cancelamento_validate_ano_cb);
  } // do_ajax_form_cancelamento_validate_ano

  function do_ajax_form_cancelamento_validate_ano_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ano";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cancelamento_validate_ano_cb

  // ---------- Validate valor
  function do_ajax_form_cancelamento_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldText(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cancelamento_validate_valor(var_valor, var_script_case_init, do_ajax_form_cancelamento_validate_valor_cb);
  } // do_ajax_form_cancelamento_validate_valor

  function do_ajax_form_cancelamento_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cancelamento_validate_valor_cb

  // ---------- Validate operador
  function do_ajax_form_cancelamento_validate_operador()
  {
    var nomeCampo_operador = "operador";
    var var_operador = scAjaxGetFieldText(nomeCampo_operador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cancelamento_validate_operador(var_operador, var_script_case_init, do_ajax_form_cancelamento_validate_operador_cb);
  } // do_ajax_form_cancelamento_validate_operador

  function do_ajax_form_cancelamento_validate_operador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cancelamento_validate_operador_cb

  // ---------- Validate tipocobranca
  function do_ajax_form_cancelamento_validate_tipocobranca()
  {
    var nomeCampo_tipocobranca = "tipocobranca";
    var var_tipocobranca = scAjaxGetFieldText(nomeCampo_tipocobranca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cancelamento_validate_tipocobranca(var_tipocobranca, var_script_case_init, do_ajax_form_cancelamento_validate_tipocobranca_cb);
  } // do_ajax_form_cancelamento_validate_tipocobranca

  function do_ajax_form_cancelamento_validate_tipocobranca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cancelamento_validate_tipocobranca_cb

  // ---------- Validate data
  function do_ajax_form_cancelamento_validate_data()
  {
    var nomeCampo_data = "data";
    var var_data = scAjaxGetFieldText(nomeCampo_data);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cancelamento_validate_data(var_data, var_script_case_init, do_ajax_form_cancelamento_validate_data_cb);
  } // do_ajax_form_cancelamento_validate_data

  function do_ajax_form_cancelamento_validate_data_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "data";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cancelamento_validate_data_cb

  // ---------- Validate motivocancelamento
  function do_ajax_form_cancelamento_validate_motivocancelamento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cancelamento_validate_motivocancelamento(var_motivocancelamento, var_script_case_init, do_ajax_form_cancelamento_validate_motivocancelamento_cb);
  } // do_ajax_form_cancelamento_validate_motivocancelamento

  function do_ajax_form_cancelamento_validate_motivocancelamento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cancelamento_validate_motivocancelamento_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_cancelamento_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cancelamento_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_cancelamento_submit_form(var_codigo, var_dia, var_mes, var_ano, var_valor, var_operador, var_tipocobranca, var_data, var_motivocancelamento, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cancelamento_submit_form_cb);
  } // do_ajax_form_cancelamento_submit_form

  function do_ajax_form_cancelamento_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_cancelamento_submit_form_cb_after_alert);
  } // do_ajax_form_cancelamento_submit_form_cb
  function do_ajax_form_cancelamento_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cancelamento_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cancelamento_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_cancelamento_navigate_form(var_codigo, var_operador, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cancelamento_navigate_form_cb);
  } // do_ajax_form_cancelamento_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cancelamento']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cancelamento_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cancelamento_navigate_form_cb_after_alert);
  } // do_ajax_form_cancelamento_navigate_form_cb
  function do_ajax_form_cancelamento_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_cancelamento_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_cancelamento_navigate_form_cb_after_alert
  function sc_hide_form_cancelamento_form()
  {
