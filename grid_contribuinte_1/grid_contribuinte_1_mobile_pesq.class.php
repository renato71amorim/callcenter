...
class grid_contribuinte_1_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_contribuinte_1_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_contribuinte_1_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_contribuinte_1_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_doador')
      {
          $doador = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_doador($doador);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_doador($doador)
   {
      $doador = substr($this->Db->qstr($doador), 1, -1);
            $doador_look = substr($this->Db->qstr($doador), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Doador from " . $this->Ini->nm_tabela . " where  Doador like '%" . $doador . "%' order by Doador"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "DataAniv";$Nm_datas[] = "DataAniv";$Nm_datas[] = "DataListagem";$Nm_datas[] = "DataListagem";$Nm_datas[] = "DataInclusaoProduto";$Nm_datas[] = "DataInclusaoProduto";$Nm_datas[] = "ReajusteData";$Nm_datas[] = "ReajusteData";$Nm_datas[] = "Data_Higienizacao";$Nm_datas[] = "Data_Higienizacao";$Nm_numeric[] = "codigo";$Nm_numeric[] = "codigorua";$Nm_numeric[] = "setor";$Nm_numeric[] = "operador";$Nm_numeric[] = "classificacao";$Nm_numeric[] = "idclientecompanhia";$Nm_numeric[] = "dgidclientecompanhia";$Nm_numeric[] = "codigocompanhia";$Nm_numeric[] = "produtoincluido";$Nm_numeric[] = "parceiro";$Nm_numeric[] = "permiteemail";$Nm_numeric[] = "ultimoaudiocampanha";$Nm_numeric[] = "qtdinvalido";$Nm_numeric[] = "higienizado";$Nm_numeric[] = "ligou";
      ...
      $Nm_datas[] = "DataAniv";$Nm_datas[] = "DataAniv";$Nm_datas[] = "DataListagem";$Nm_datas[] = "DataListagem";$Nm_datas[] = "DataInclusaoProduto";$Nm_datas[] = "DataInclusaoProduto";$Nm_datas[] = "ReajusteData";$Nm_datas[] = "ReajusteData";$Nm_datas[] = "Data_Higienizacao";$Nm_datas[] = "Data_Higienizacao";
      if (in_array($campo_join, $Nm_datas))
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_contribuinte_1/grid_contribuinte_1_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_contribuinte_1_ajax_search.js"></script>
 <script type="text/javascript" src="grid_contribuinte_1_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_contribuinte_1_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_contribuinte_1']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_contribuinte_1']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_doador_cond#NMF#' + search_get_sel_txt('SC_doador_cond') + '@NMF@';
  str_out += 'SC_doador#NMF#' + search_get_text('SC_doador') + '@NMF@';
  str_out += 'id_ac_doador#NMF#' + search_get_text('id_ac_doador') + '@NMF@';
   ...
   $("#id_ac_doador").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_doador",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - contribuinte</span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $doador_cond, $doador, $doador_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $codigorua = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca']['codigorua']; 
          $codigorua_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca']['codigorua_input_2']; 
          $codigorua_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca']['codigorua_cond']; 
          $codigo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca']['codigo']; 
          $codigo_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca']['codigo_input_2']; 
          $codigo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca']['codigo_cond']; 
          $nome = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca']['nome']; 
          $nome_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca']['nome_cond']; 
          $doador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca']['doador']; 
          $doador_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca']['doador_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($doador_cond) || empty($doador_cond))
      {
         $doador_cond = "qp";
      }
      ...
      $str_hide_doador = (in_array($doador_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_doador = ('bw' == $doador_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($doador) || $doador == "")
      {
          $doador = "";
      }
      if (isset($doador) && !empty($doador))
      {
         $tmp_pos = strpos($doador, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $doador = substr($doador, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_codigorua_cond" name="codigorua_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigorua'), this, 'codigorua')">
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_codigorua" name="codigorua_autocomp" size="19"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_codigorua"  <?php echo $str_display_codigorua; ?> class="scFilterFieldFontOdd">
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nome" name="nome_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
 ...
 $nmgp_tab_label .= "doador?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_doador_cond" name="doador_cond" onChange="nm_campos_between(document.getElementById('id_vis_doador'), this, 'doador')">
       <OPTION value="qp" <?php if ("qp" == $doador_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $doador_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $doador_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $doador_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_doador"  <?php echo $str_hide_doador?>><?php
      if ($doador != "")
      {
      $doador_look = substr($this->Db->qstr($doador), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Doador from " . $this->Ini->nm_tabela . " where Doador = '$doador_look' order by Doador"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$doador]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$doador];
      }
      else
      {
          $sAutocompValue = $doador;
      }
?>
<INPUT  type="text" id="SC_doador" name="doador" value="<?php echo NM_encode_input($doador) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_doador" name="doador_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_contribuinte_1_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_contribuinte_1']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_contribuinte_1']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.doador_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_doador'), document.F1.doador_cond, 'doador');
   document.F1.doador.value = "";
   document.F1.doador_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "dinamica_publicado/grid_contribuinte_1";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_doador_cond'] = 'cond';
      $tp_fields['SC_doador'] = 'text_aut';
      $tp_fields['id_ac_doador'] = 'text_aut';
   ...
   {
      global $codigorua_cond, $codigorua, $codigorua_input_2, $codigorua_autocomp,
             $codigo_cond, $codigo, $codigo_input_2, $codigo_autocomp,
             $nome_cond, $nome, $nome_autocomp,
             $doador_cond, $doador, $doador_autocomp, $nmgp_tab_label;
      ...
      if (!empty($doador_autocomp) && empty($doador))
      {
          $doador = $doador_autocomp;
      }
      ...
      $doador_cond_salva = $doador_cond; 
      if (!isset($doador_input_2) || $doador_input_2 == "")
      {
          $doador_input_2 = $doador;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca']['codigorua'] = $codigorua; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca']['codigorua_input_2'] = $codigorua_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca']['codigorua_cond'] = $codigorua_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca']['codigo'] = $codigo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca']['codigo_input_2'] = $codigo_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca']['codigo_cond'] = $codigo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca']['nome'] = $nome; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca']['nome_cond'] = $nome_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca']['doador'] = $doador; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca']['doador_cond'] = $doador_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca'] = $Temp_Busca;
      }
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['doador'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['doador'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['doador'] = $doador;
      }
      ...
      //----- $doador
      $this->Date_part = false;
      if (isset($doador) || $doador_cond == "nu" || $doador_cond == "nn" || $doador_cond == "ep" || $doador_cond == "ne")
      {
         $this->monta_condicao("Doador", $doador_cond, $doador, "", "doador");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contribuinte_1']['cond_pesq'] .= $this->NM_operador;
