...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - contribuinte</TITLE>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_codigorua_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['codigorua'])) ? $this->New_label['codigorua'] : "Codigo Rua"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_codigorua_cond" name="codigorua_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigorua'), this, 'codigorua')">
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_codigorua" name="codigorua_autocomp" size="19"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
       ...
       <TR valign="top">
        <TD id="id_vis_codigorua"  <?php echo $str_display_codigorua; ?> class="scFilterFieldFontOdd">
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nome" name="nome_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_doador_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['doador'])) ? $this->New_label['doador'] : "Doador"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_doador_cond" name="doador_cond" onChange="nm_campos_between(document.getElementById('id_vis_doador'), this, 'doador')">
     ...
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_doador" <?php echo $str_hide_doador?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
