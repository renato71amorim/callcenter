...
<?php
   ...
   $Ord_Cmp = new grid_contribuinte_1_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_contribuinte_1_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['labels']["codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['labels']["codigo"] : "Codigo";
   $tab_ger_campos['nome'] = "on";
   $tab_def_campos['nome'] = "Nome";
   $tab_labels["nome"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['labels']["nome"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['labels']["nome"] : "Nome";
   $tab_ger_campos['doador'] = "on";
   $tab_def_campos['doador'] = "Doador";
   $tab_labels["doador"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['labels']["doador"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['labels']["doador"] : "Doador";
   $tab_ger_campos['codigorua'] = "on";
   $tab_def_campos['codigorua'] = "CodigoRua";
   $tab_labels["codigorua"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['labels']["codigorua"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['labels']["codigorua"] : "Codigo Rua";
   $tab_ger_campos['numero'] = "on";
   $tab_def_campos['numero'] = "Numero";
   $tab_labels["numero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['labels']["numero"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['labels']["numero"] : "Numero";
   $tab_ger_campos['complemento'] = "on";
   $tab_def_campos['complemento'] = "Complemento";
   $tab_labels["complemento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['labels']["complemento"])) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['labels']["complemento"] : "Complemento";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['ordem_quebra'] as $campo => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_contribuinte_1_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_contribuinte_1']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
