  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_totais_agente" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_totais_agente_form();
	}

  // ---------- Validate user
  function do_ajax_form_totais_agente_validate_user()
  {
    var nomeCampo_user = "user";
    var var_user = scAjaxGetFieldText(nomeCampo_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_totais_agente_validate_user(var_user, var_script_case_init, do_ajax_form_totais_agente_validate_user_cb);
  } // do_ajax_form_totais_agente_validate_user

  function do_ajax_form_totais_agente_validate_user_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_totais_agente_validate_user_cb

  // ---------- Validate ligacoes
  function do_ajax_form_totais_agente_validate_ligacoes()
  {
    var nomeCampo_ligacoes = "ligacoes";
    var var_ligacoes = scAjaxGetFieldText(nomeCampo_ligacoes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_totais_agente_validate_ligacoes(var_ligacoes, var_script_case_init, do_ajax_form_totais_agente_validate_ligacoes_cb);
  } // do_ajax_form_totais_agente_validate_ligacoes

  function do_ajax_form_totais_agente_validate_ligacoes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_totais_agente_validate_ligacoes_cb

  // ---------- Validate doacoes
  function do_ajax_form_totais_agente_validate_doacoes()
  {
    var nomeCampo_doacoes = "doacoes";
    var var_doacoes = scAjaxGetFieldText(nomeCampo_doacoes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_totais_agente_validate_doacoes(var_doacoes, var_script_case_init, do_ajax_form_totais_agente_validate_doacoes_cb);
  } // do_ajax_form_totais_agente_validate_doacoes

  function do_ajax_form_totais_agente_validate_doacoes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "doacoes";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_totais_agente_validate_doacoes_cb

  // ---------- Validate ndoacoes
  function do_ajax_form_totais_agente_validate_ndoacoes()
  {
    var nomeCampo_ndoacoes = "ndoacoes";
    var var_ndoacoes = scAjaxGetFieldText(nomeCampo_ndoacoes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_totais_agente_validate_ndoacoes(var_ndoacoes, var_script_case_init, do_ajax_form_totais_agente_validate_ndoacoes_cb);
  } // do_ajax_form_totais_agente_validate_ndoacoes

  function do_ajax_form_totais_agente_validate_ndoacoes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_totais_agente_validate_ndoacoes_cb

  // ---------- Validate outras
  function do_ajax_form_totais_agente_validate_outras()
  {
    var nomeCampo_outras = "outras";
    var var_outras = scAjaxGetFieldText(nomeCampo_outras);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_totais_agente_validate_outras(var_outras, var_script_case_init, do_ajax_form_totais_agente_validate_outras_cb);
  } // do_ajax_form_totais_agente_validate_outras

  function do_ajax_form_totais_agente_validate_outras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "outras";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_totais_agente_validate_outras_cb

  // ---------- Validate tempo
  function do_ajax_form_totais_agente_validate_tempo()
  {
    var nomeCampo_tempo = "tempo";
    var var_tempo = scAjaxGetFieldText(nomeCampo_tempo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_totais_agente_validate_tempo(var_tempo, var_script_case_init, do_ajax_form_totais_agente_validate_tempo_cb);
  } // do_ajax_form_totais_agente_validate_tempo

  function do_ajax_form_totais_agente_validate_tempo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tempo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_totais_agente_validate_tempo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_totais_agente_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_totais_agente_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_totais_agente_submit_form(var_user, var_ligacoes, var_doacoes, var_ndoacoes, var_outras, var_tempo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_totais_agente_submit_form_cb);
  } // do_ajax_form_totais_agente_submit_form

  function do_ajax_form_totais_agente_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_totais_agente_submit_form_cb_after_alert);
  } // do_ajax_form_totais_agente_submit_form_cb
  function do_ajax_form_totais_agente_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_totais_agente_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_totais_agente_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_totais_agente_navigate_form(var_user, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_totais_agente_navigate_form_cb);
  } // do_ajax_form_totais_agente_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_totais_agente']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_totais_agente_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_totais_agente_navigate_form_cb_after_alert);
  } // do_ajax_form_totais_agente_navigate_form_cb
  function do_ajax_form_totais_agente_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_totais_agente_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_totais_agente_navigate_form_cb_after_alert
  function sc_hide_form_totais_agente_form()
  {
