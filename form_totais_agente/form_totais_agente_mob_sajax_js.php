  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_totais_agente_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_totais_agente_mob_form();
	}

  // ---------- Validate user
  function do_ajax_form_totais_agente_mob_validate_user()
  {
    var nomeCampo_user = "user";
    var var_user = scAjaxGetFieldText(nomeCampo_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_totais_agente_mob_validate_user(var_user, var_script_case_init, do_ajax_form_totais_agente_mob_validate_user_cb);
  } // do_ajax_form_totais_agente_mob_validate_user

  function do_ajax_form_totais_agente_mob_validate_user_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_totais_agente_mob_validate_user_cb

  // ---------- Validate ligacoes
  function do_ajax_form_totais_agente_mob_validate_ligacoes()
  {
    var nomeCampo_ligacoes = "ligacoes";
    var var_ligacoes = scAjaxGetFieldText(nomeCampo_ligacoes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_totais_agente_mob_validate_ligacoes(var_ligacoes, var_script_case_init, do_ajax_form_totais_agente_mob_validate_ligacoes_cb);
  } // do_ajax_form_totais_agente_mob_validate_ligacoes

  function do_ajax_form_totais_agente_mob_validate_ligacoes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ligacoes";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_totais_agente_mob_validate_ligacoes_cb

  // ---------- Validate doacoes
  function do_ajax_form_totais_agente_mob_validate_doacoes()
  {
    var nomeCampo_doacoes = "doacoes";
    var var_doacoes = scAjaxGetFieldText(nomeCampo_doacoes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_totais_agente_mob_validate_doacoes(var_doacoes, var_script_case_init, do_ajax_form_totais_agente_mob_validate_doacoes_cb);
  } // do_ajax_form_totais_agente_mob_validate_doacoes

  function do_ajax_form_totais_agente_mob_validate_doacoes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "doacoes";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_totais_agente_mob_validate_doacoes_cb

  // ---------- Validate ndoacoes
  function do_ajax_form_totais_agente_mob_validate_ndoacoes()
  {
    var nomeCampo_ndoacoes = "ndoacoes";
    var var_ndoacoes = scAjaxGetFieldText(nomeCampo_ndoacoes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_totais_agente_mob_validate_ndoacoes(var_ndoacoes, var_script_case_init, do_ajax_form_totais_agente_mob_validate_ndoacoes_cb);
  } // do_ajax_form_totais_agente_mob_validate_ndoacoes

  function do_ajax_form_totais_agente_mob_validate_ndoacoes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ndoacoes";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_totais_agente_mob_validate_ndoacoes_cb

  // ---------- Validate outras
  function do_ajax_form_totais_agente_mob_validate_outras()
  {
    var nomeCampo_outras = "outras";
    var var_outras = scAjaxGetFieldText(nomeCampo_outras);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_totais_agente_mob_validate_outras(var_outras, var_script_case_init, do_ajax_form_totais_agente_mob_validate_outras_cb);
  } // do_ajax_form_totais_agente_mob_validate_outras

  function do_ajax_form_totais_agente_mob_validate_outras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "outras";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_totais_agente_mob_validate_outras_cb

  // ---------- Validate tempo
  function do_ajax_form_totais_agente_mob_validate_tempo()
  {
    var nomeCampo_tempo = "tempo";
    var var_tempo = scAjaxGetFieldText(nomeCampo_tempo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_totais_agente_mob_validate_tempo(var_tempo, var_script_case_init, do_ajax_form_totais_agente_mob_validate_tempo_cb);
  } // do_ajax_form_totais_agente_mob_validate_tempo

  function do_ajax_form_totais_agente_mob_validate_tempo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tempo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_totais_agente_mob_validate_tempo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_totais_agente_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_totais_agente_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_user = scAjaxGetFieldText("user");
    var var_ligacoes = scAjaxGetFieldText("ligacoes");
    var var_doacoes = scAjaxGetFieldText("doacoes");
    var var_ndoacoes = scAjaxGetFieldText("ndoacoes");
    var var_outras = scAjaxGetFieldText("outras");
    var var_tempo = scAjaxGetFieldText("tempo");
    ...
    scAjaxProcOn();
    x_ajax_form_totais_agente_mob_submit_form(var_user, var_ligacoes, var_doacoes, var_ndoacoes, var_outras, var_tempo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_totais_agente_mob_submit_form_cb);
  } // do_ajax_form_totais_agente_mob_submit_form

  function do_ajax_form_totais_agente_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("ligacoes");
      scAjaxHideErrorDisplay("doacoes");
      scAjaxHideErrorDisplay("ndoacoes");
      scAjaxHideErrorDisplay("outras");
      scAjaxHideErrorDisplay("tempo");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_totais_agente_mob_submit_form_cb_after_alert);
  } // do_ajax_form_totais_agente_mob_submit_form_cb
  function do_ajax_form_totais_agente_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_totais_agente_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_totais_agente_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("outras");
    scAjaxHideErrorDisplay("tempo");
    var var_user = document.F2.user.value;
    ...
    scAjaxProcOn();
    x_ajax_form_totais_agente_mob_navigate_form(var_user, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_totais_agente_mob_navigate_form_cb);
  } // do_ajax_form_totais_agente_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_totais_agente_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_totais_agente_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.user.value = scAjaxGetKeyValue("user");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_totais_agente_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_totais_agente_mob_navigate_form_cb
  function do_ajax_form_totais_agente_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_totais_agente_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_totais_agente_mob_navigate_form_cb_after_alert
  function sc_hide_form_totais_agente_mob_form()
  {
  ...
  ajax_field_list[0] = "user";
  ajax_field_list[1] = "ligacoes";
  ajax_field_list[2] = "doacoes";
  ajax_field_list[3] = "ndoacoes";
  ajax_field_list[4] = "outras";
  ajax_field_list[5] = "tempo";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "user": {"label": "Agente", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ligacoes": {"label": "Ligações", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "doacoes": {"label": "Doações", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ndoacoes": {"label": "Não doações", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "outras": {"label": "Outras", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tempo": {"label": "Tempo (Acumulado na semana)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["ligacoes"][1] = "ligacoes";
  ajax_field_mult["doacoes"][1] = "doacoes";
  ajax_field_mult["ndoacoes"][1] = "ndoacoes";
  ajax_field_mult["outras"][1] = "outras";
  ajax_field_mult["tempo"][1] = "tempo";

  var ajax_field_id = {
    "user": new Array("hidden_field_label_user", "hidden_field_data_user"),
    "ligacoes": new Array("hidden_field_label_ligacoes", "hidden_field_data_ligacoes"),
    "doacoes": new Array("hidden_field_label_doacoes", "hidden_field_data_doacoes"),
    "ndoacoes": new Array("hidden_field_label_ndoacoes", "hidden_field_data_ndoacoes"),
    "outras": new Array("hidden_field_label_outras", "hidden_field_data_outras"),
    "tempo": new Array("hidden_field_label_tempo", "hidden_field_data_tempo")
  };
