...
class chart_Dados_Graficos_res_csv
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_csv()
   {
      ...
      $this->grava_arquivo();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['csv_res_grid']))
      {
          return;
      }
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo      .= ".csv";
      $this->Tit_doc       = "chart_Dados_Graficos.csv";
      $this->Tit_zip       = "chart_Dados_Graficos.zip";
      $this->Label_CSV     = "N";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['csv_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['csv_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['csv_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['csv_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['csv_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['csv_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['csv_name']);
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['csv_res_grid']) && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['csv_return']);
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['csv_res_grid']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['csv_res_file'] = $this->Csv_f;
      }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['csv_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['csv_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_chart_titl'] ?> - Dados_Graficos :: CSV</TITLE>
...
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['csv_return']); ?>"> 
</FORM> 
</td></tr></table>
</BODY>
</HTML>
