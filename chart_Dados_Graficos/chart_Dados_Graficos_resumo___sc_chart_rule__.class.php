...
class chart_Dados_Graficos_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['dashboard_info']['under_dashboard'] ? "off" : "on";

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['chart_Dados_Graficos'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['chart_Dados_Graficos'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['chart_Dados_Graficos']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['chart_Dados_Graficos']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['chart_Dados_Graficos']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['chart_Dados_Graficos']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['chart_Dados_Graficos']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['campos_busca'];
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['res_hrz'];
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']) && !$this->NM_export)
      {
          foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
          {
              if (in_array("chart_Dados_Graficos", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['contr_total_geral'] == "OK")
      {
          $this->array_total_user = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['arr_total']['user'];
      }
      else
      {
          $this->array_total_user = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['tot_geral'][1] == 0)
      {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['arr_total']['user'] = $this->array_total_user;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['json_use_label'])
       {
          $Lab_user = "user";
       }
       else
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['labels']['user']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['labels']['user'] = "User"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['labels']['ligacoes']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['labels']['ligacoes'] = "Ligacoes"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['labels']['doacao']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['labels']['doacao'] = "Doacao"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['labels']['percentual']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['labels']['percentual'] = "Percentual"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['labels']['valor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['labels']['valor'] = "Valor"; 
       }
       //-----
       $this->comp_field_nm = array(
           'user' => 0,
       ...
       $this->comp_sum = array(
           2 => "",
           3 => "Doacao(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['summarizing_fields_order']['__sc_chart_rule__']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['summarizing_fields_order']['__sc_chart_rule__'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['summarizing_fields_order']['__sc_chart_rule__'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['summarizing_fields_display']['__sc_chart_rule__'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['summarizing_fields_display']['__sc_chart_rule__'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['summarizing_fields_display']['__sc_chart_rule__'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['summarizing_fields_display']['__sc_chart_rule__'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['summarizing_fields_display']['__sc_chart_rule__'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['summarizing_fields_display']['__sc_chart_rule__'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['summarizing_fields_display']['__sc_chart_rule__'] as $i_sum => $d_sum)
           {
       ...
       $this->comp_sum_lnk = array(
           ...
           3 => array('field' => "doacao", 'show' => true),
       );
       ...
       //-----
       foreach ($this->array_total_user as $i_user => $d_user) {
           if (!in_array($i_user, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_user[4] ] = $d_user[3];
               $this->comp_label[0][ $d_user[4] ] = $d_user[3];
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_user => $l_user) {
           if (isset($this->array_total_user[$i_user])) {
               $this->comp_group[$i_user] = array();
           }
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@chart_Dados_Graficos@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function makeTabular(&$a_data)
   {
       ...
       {
           $a_labels = array();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['proc_pdf_vert'])
   {
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               'title'    => $this->getChartText(strip_tags("")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'user',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_user)),
               'label_y'  => $this->getChartText(strip_tags("")),
               'format'   => $this->formatChartValue(1),
           ),
           '0|2' => array(
               'title'    => $this->getChartText(strip_tags("Doacao(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'user',
               'field_y'  => $this->comp_sum_nm[3],
               'label_x'  => $this->getChartText(strip_tags($Lab_user)),
               'label_y'  => $this->getChartText(strip_tags("Doacao(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_charts'];
	}
	...
	function filterChartsByMultiseries() {
		...
		if ($applyFilter && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['summarizing_drill_down']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['summarizing_drill_down'])) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_charts'] as $chartIndex => $chartData) {
				$indexParts = explode('|', $chartIndex);
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_chart_Dados_Graficos_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_chart_Dados_Graficos_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['proc_pdf_vert']){ 
   ...
   function formatValue($total, $valor_campo)
   {
       ...
       if ($total == 2)
       {
           nmgp_Form_Num_Val($valor_campo, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "0", "S", "", "", "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']);
       }
       return $valor_campo;
   }
   ...
   function resumo_init()
   {
      ...
      $this->monta_html_ini();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
      {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_Dados_Graficos']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_Dados_Graficos']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_Dados_Graficos']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_Dados_Graficos']) . "_";
               } 
           }
       }
   ...
   function resumo_final()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['ajax_nav'])
      {
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "chart_Dados_Graficos_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      $this->Total   = new chart_Dados_Graficos_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo___sc_chart_rule__("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_user);
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_chart_titl'] . " - Dados_Graficos</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_Dados_Graficos_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_Dados_Graficos_jquery.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_Dados_Graficos_message.js\"></script>\r\n");
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "chart_Dados_Graficos/chart_Dados_Graficos_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_prod . "/third/jquery_plugin/thickbox/thickbox.css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_Dados_Graficos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_chart_Dados_Graficos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_Dados_Graficos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['num_css'] . '.css');
     ...
     else
     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("         dataType: \"html\",\r\n");
           $nm_saida->saida("         url: \"chart_Dados_Graficos_save_grid.php\",\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['dashboard_info']['remove_margin'] ? ' style="margin: 0"' : '';
          $nm_saida->saida(" <BODY class=\"" . $this->css_scGridPage . "\"" . $remove_margin . ">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['embutida'])
      {
      ...
      $nm_saida->saida("function scChartImageExportShow(exportType) {\r\n");
          $nm_saida->saida("  scShowCombinationImage(" . count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['Labels_GB']) . ", exportType, '');\r\n");
      $nm_saida->saida("}\r\n");
      ...
      $nm_saida->saida("function scChartWordExportShow(exportType) {\r\n");
          $nm_saida->saida("  scShowCombinationWord(exportType, \"bw\", \"\");\r\n");
      $nm_saida->saida("}\r\n");
      ...
      $nm_saida->saida("            </td>\r\n");
      $nm_saida->saida("          </tr>\r\n");
      $nm_saida->saida("          <input type=\"hidden\" id=\"sc-id-chart-word-pwd\" value=\"bw\" />\r\n");
      $nm_saida->saida("        </table>\r\n");
      $nm_saida->saida("      </td>\r\n");
      $nm_saida->saida("    </tr>\r\n");
      $nm_saida->saida("    <tr>\r\n");
...
;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_Dados_Graficos/chart_Dados_Graficos_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=" . s . "&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=chart&nm_all_modules=chart&password=n&summary_export_columns=N&pdf_zip=N&origem=chart&language=pt_br&conf_socor=S&is_chart_app=Y&nm_label_group=S&nm_all_cab=N&nm_all_label=N&nm_orient_grid=2&script_case_init=" . $this->Ini->sc_page . "&app_name=chart_Dados_Graficos&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_Dados_Graficos/chart_Dados_Graficos_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=&nm_all_modules=chart&password=n&origem=chart&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         ...
         if (is_file("chart_Dados_Graficos_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("chart_Dados_Graficos_help.txt"); 
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['chart_Dados_Graficos']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['chart_Dados_Graficos']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
$nm_saida->saida("       scJs_alert('" . $mensagem . "', $jsonParams);\r\n");
      ...
      elseif ($this->Ini->Export_html_zip || ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['graf_pdf'] == "S"))
      {
          $this->grafico_pdf();
      }
      else
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'chart_Dados_Graficos_config_pivot.php?nome_apl=chart_Dados_Graficos&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"chart_Dados_Graficos_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   </form> \r\n");
          ...
          $nm_saida->saida("               document.Fprint.action = \"chart_Dados_Graficos_export_ctrl.php\";\r\n");
          $nm_saida->saida("           }\r\n");
          $nm_saida->saida("           else\r\n");
          $nm_saida->saida("           {\r\n");
          ...
          $nm_saida->saida("               document.Fexport.action = \"chart_Dados_Graficos_export_ctrl.php\";\r\n");
      ...
      if (!extension_loaded("zip"))
      {
          ...
          $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
          $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['chart_Dados_Graficos_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@chart_Dados_Graficos@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_Dados_Graficos_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "chart_Dados_Graficos/chart_Dados_Graficos_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['skip_charts']))
   {
 ...
 { 
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_charts'] as $chart_index => $chart_data)
       {
 ...
 { 
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['this_chart_label'] = '';
           $this->Graf->monta_grafico($chart_index, 'pdf');
           if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['this_chart_label']) {
               $nm_saida->saida("<script type=\"text/javascript\">$(\"#$random_id\").html(\"{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['this_chart_label']}\")</script>\r\n");
           }
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['chart_list']))
   {
       $prim_graf = true;
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['chart_list'] as $arr_chart)
       {
           if (!$prim_graf)
           {
               $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
...
//--- 
 function grafico_bot()
 {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new chart_Dados_Graficos_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
       ...
       $nm_saida->saida("<TR>\r\n");
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['pivot_charts']);
       $sChartLang  = isset($this->Ini->Nm_lang['lang_pdff_pcht']) ? $this->Ini->Nm_lang['lang_pdff_pcht'] : 'Generating chart';
       if (!NM_is_utf8($sChartLang))
       {
           $sChartLang = sc_convert_encoding($sChartLang, "UTF-8", $_SESSION['scriptcase']['charset']);
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
       ...
       $nm_saida->saida("</TD>\r\n");
       $nm_saida->saida("</TR>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_doacao, $quebra_user, $quebra_user_orig)
   {
      //----- User
      if (!isset($this->array_total_user[$quebra_user_orig]))
      {
         $this->array_total_user[$quebra_user_orig][0] = 1;
         $this->array_total_user[$quebra_user_orig][1] = $sum_doacao;
         $this->array_total_user[$quebra_user_orig][2] = 1;
         $this->array_total_user[$quebra_user_orig][3] = $quebra_user;
         $this->array_total_user[$quebra_user_orig][4] = $quebra_user_orig;
      }
      else
      {
         $this->array_total_user[$quebra_user_orig][0]++;
         $this->array_total_user[$quebra_user_orig][1] += $sum_doacao;
         $this->array_total_user[$quebra_user_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Dados_Graficos']['where_pesq']; 
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'user');
     $campos_order = $this->Ini->Get_date_order_groupby("user", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->user = $rs_res->fields[0] ;  
            $this->ligacoes = $rs_res->fields[1] ;  
            $this->doacao = $rs_res->fields[2] ;  
            $this->doacao =  str_replace(",", ".", $this->doacao);
            $this->percentual = $rs_res->fields[3] ;  
            $this->valor = $rs_res->fields[4] ;  
            $this->user_orig = $this->user;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->doacao, $this->user, $this->user_orig);
            }
   }
//
