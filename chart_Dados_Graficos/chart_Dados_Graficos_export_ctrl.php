<?php
@session_start() ;
$_SESSION['scriptcase']['chart_Dados_Graficos']['sc_process_barr'] = true;
require_once('../chart_Dados_Graficos/index.php');
unset($_SESSION['scriptcase']['chart_Dados_Graficos']['sc_process_barr']);
$ExportCtrl = new chart_Dados_Graficos_export_control;
$ExportCtrl->Export_barr();

class chart_Dados_Graficos_export_control
{
